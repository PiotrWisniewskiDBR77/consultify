...
// ../../Library/Mobile Documents/com~apple~CloudDocs/Documents/Antygracity/DRD/consultify/node_modules/mermaid/dist/chunks/mermaid.core/chunk-FWX5IMBZ.mjs
var internalHelpers = {
...
var registerDefaultLayoutLoaders = __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: __name(async () => await import("./dagre-VKFMJZFB-F56IMXYY.js"), "loader")
    },
    {
      name: "swimlane",
      loader: __name(async () => await import("./swimlanes-5IMT3BWC-3ZGTDAX2.js"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
        loader: __name(async () => await import("./cose-bilkent-JH36ORCC-MUETHUOE.js"), "loader")
      }
    ] : []
  ]);
...
//# sourceMappingURL=chunk-UV4HJFXT.js.map
