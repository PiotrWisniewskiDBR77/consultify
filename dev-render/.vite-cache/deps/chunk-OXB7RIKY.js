...
// ../../Library/Mobile Documents/com~apple~CloudDocs/Documents/Antygracity/DRD/consultify/node_modules/@reactflow/core/dist/esm/index.mjs
var import_react3 = __toESM(require_react(), 1);

// ../../Library/Mobile Documents/com~apple~CloudDocs/Documents/Antygracity/DRD/consultify/node_modules/classcat/index.js
function cc(names) {
...
// ../../Library/Mobile Documents/com~apple~CloudDocs/Documents/Antygracity/DRD/consultify/node_modules/zustand/esm/traditional.mjs
...
// ../../Library/Mobile Documents/com~apple~CloudDocs/Documents/Antygracity/DRD/consultify/node_modules/zustand/esm/vanilla/shallow.mjs
...
// ../../Library/Mobile Documents/com~apple~CloudDocs/Documents/Antygracity/DRD/consultify/node_modules/zustand/esm/react/shallow.mjs
...
function Panel({ position, children, className, style: style2, ...rest }) {
  ...
  return import_react3.default.createElement("div", { className: cc(["react-flow__panel", className, ...positionClasses]), style: { ...style2, pointerEvents }, ...rest }, children);
}
function Attribution({ proOptions, position = "bottom-right" }) {
  ...
  return import_react3.default.createElement(
    ...
    import_react3.default.createElement("a", { href: "https://reactflow.dev", target: "_blank", rel: "noopener noreferrer", "aria-label": "React Flow attribution" }, "React Flow")
  );
}
var EdgeText = ({ x, y, label, labelStyle = {}, labelShowBg = true, labelBgStyle = {}, labelBgPadding = [2, 4], labelBgBorderRadius = 2, children, className, ...rest }) => {
  ...
  const [edgeTextBbox, setEdgeTextBbox] = (0, import_react3.useState)({ x: 0, y: 0, width: 0, height: 0 });
  ...
  return import_react3.default.createElement(
    ...
    labelShowBg && import_react3.default.createElement("rect", { width: edgeTextBbox.width + 2 * labelBgPadding[0], x: -labelBgPadding[0], y: -labelBgPadding[1], height: edgeTextBbox.height + 2 * labelBgPadding[1], className: "react-flow__edge-textbg", style: labelBgStyle, rx: labelBgBorderRadius, ry: labelBgBorderRadius }),
    import_react3.default.createElement("text", { className: "react-flow__edge-text", y: edgeTextBbox.height / 2, dy: "0.3em", ref: edgeRef, style: labelStyle }, label),
    children
  );
};
var EdgeText$1 = (0, import_react3.memo)(EdgeText);
...
var BaseEdge = ({ id, path, labelX, labelY, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style2, markerEnd, markerStart, interactionWidth = 20 }) => {
  return import_react3.default.createElement(
    ...
    null,
    import_react3.default.createElement("path", { id, style: style2, d: path, fill: "none", className: "react-flow__edge-path", markerEnd, markerStart }),
    interactionWidth && import_react3.default.createElement("path", { d: path, fill: "none", strokeOpacity: 0, strokeWidth: interactionWidth, className: "react-flow__edge-interaction" }),
    label && isNumeric(labelX) && isNumeric(labelY) ? import_react3.default.createElement(EdgeText$1, { x: labelX, y: labelY, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius }) : null
  );
};
...
var SimpleBezierEdge = (0, import_react3.memo)(({ sourceX, sourceY, targetX, targetY, sourcePosition = Position.Bottom, targetPosition = Position.Top, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style2, markerEnd, markerStart, interactionWidth }) => {
  ...
  return import_react3.default.createElement(BaseEdge, { path, labelX, labelY, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style2, markerEnd, markerStart, interactionWidth });
});
...
var SmoothStepEdge = (0, import_react3.memo)(({ sourceX, sourceY, targetX, targetY, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style2, sourcePosition = Position.Bottom, targetPosition = Position.Top, markerEnd, markerStart, pathOptions, interactionWidth }) => {
...
var StepEdge = (0, import_react3.memo)((props) => {
  var _a;
  return import_react3.default.createElement(SmoothStepEdge, { ...props, pathOptions: (0, import_react3.useMemo)(() => {
    var _a2;
...
var StraightEdge = (0, import_react3.memo)(({ sourceX, sourceY, targetX, targetY, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style2, markerEnd, markerStart, interactionWidth }) => {
...
var BezierEdge = (0, import_react3.memo)(({ sourceX, sourceY, targetX, targetY, sourcePosition = Position.Bottom, targetPosition = Position.Top, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style2, markerEnd, markerStart, pathOptions, interactionWidth }) => {
...
var Handle = (0, import_react3.forwardRef)(({ type = "source", position = Position.Top, isValidConnection, isConnectable = true, isConnectableStart = true, isConnectableEnd = true, id, onConnect, children, className, onMouseDown, onTouchStart, ...rest }, ref) => {
  var _a, _b;
  ...
  return import_react3.default.createElement("div", { "data-handleid": handleId, "data-nodeid": nodeId, "data-handlepos": position, "data-id": `${nodeId}-${handleId}-${type}`, className: cc([
    "react-flow__handle",
...
var Handle$1 = (0, import_react3.memo)(Handle);
var DefaultNode = ({ data, isConnectable, targetPosition = Position.Top, sourcePosition = Position.Bottom }) => {
  return import_react3.default.createElement(
    import_react3.default.Fragment,
    null,
    import_react3.default.createElement(Handle$1, { type: "target", position: targetPosition, isConnectable }),
    data == null ? void 0 : data.label,
    import_react3.default.createElement(Handle$1, { type: "source", position: sourcePosition, isConnectable })
  );
};
DefaultNode.displayName = "DefaultNode";
var DefaultNode$1 = (0, import_react3.memo)(DefaultNode);
var InputNode = ({ data, isConnectable, sourcePosition = Position.Bottom }) => import_react3.default.createElement(
  import_react3.default.Fragment,
  null,
  data == null ? void 0 : data.label,
  import_react3.default.createElement(Handle$1, { type: "source", position: sourcePosition, isConnectable })
...
var InputNode$1 = (0, import_react3.memo)(InputNode);
var OutputNode = ({ data, isConnectable, targetPosition = Position.Top }) => import_react3.default.createElement(
  import_react3.default.Fragment,
  null,
  import_react3.default.createElement(Handle$1, { type: "target", position: targetPosition, isConnectable }),
  data == null ? void 0 : data.label
...
var OutputNode$1 = (0, import_react3.memo)(OutputNode);
var GroupNode = () => null;
...
var SelectionListener = (0, import_react3.memo)(({ onSelectionChange }) => {
  const store = useStoreApi();
...
function Wrapper$1({ onSelectionChange }) {
  ...
  if (onSelectionChange || storeHasSelectionChange) {
    return import_react3.default.createElement(SelectionListener, { onSelectionChange });
  }
  return null;
}
var selector$d = (s) => ({
...
function AriaLiveMessage({ rfId }) {
  ...
  return import_react3.default.createElement("div", { id: `${ARIA_LIVE_MESSAGE}-${rfId}`, "aria-live": "assertive", "aria-atomic": "true", style: ariaLiveStyle }, ariaLiveMessage);
}
function A11yDescriptions({ rfId, disableKeyboardA11y }) {
  return import_react3.default.createElement(
    ...
    import_react3.default.createElement("div", { id: `${ARIA_EDGE_DESC_KEY}-${rfId}`, style }, "Press enter or space to select an edge. You can then press delete to remove it or escape to cancel."),
    !disableKeyboardA11y && import_react3.default.createElement(AriaLiveMessage, { rfId })
  );
}
...
var useViewportHelper = () => {
  ...
  const viewportHelperFunctions = (0, import_react3.useMemo)(() => {
...
function useReactFlow() {
  ...
  const store = useStoreApi();
  const getNodes = (0, import_react3.useCallback)(() => {
    return store.getState().getNodes().map((n) => ({ ...n }));
  }, []);
  const getNode = (0, import_react3.useCallback)((id) => {
    return store.getState().nodeInternals.get(id);
  }, []);
  const getEdges = (0, import_react3.useCallback)(() => {
    const { edges = [] } = store.getState();
    return edges.map((e) => ({ ...e }));
  }, []);
  const getEdge = (0, import_react3.useCallback)((id) => {
    const { edges = [] } = store.getState();
    return edges.find((e) => e.id === id);
  }, []);
  const setNodes = (0, import_react3.useCallback)((payload) => {
  ...
  const setEdges = (0, import_react3.useCallback)((payload) => {
  ...
  const addNodes = (0, import_react3.useCallback)((payload) => {
  ...
  const addEdges = (0, import_react3.useCallback)((payload) => {
  ...
  const toObject = (0, import_react3.useCallback)(() => {
  ...
  const deleteElements = (0, import_react3.useCallback)(({ nodes: nodesDeleted, edges: edgesDeleted }) => {
  ...
  const getNodeRect = (0, import_react3.useCallback)((nodeOrRect) => {
  ...
  const getIntersectingNodes = (0, import_react3.useCallback)((nodeOrRect, partially = true, nodes) => {
  ...
  const isNodeIntersecting = (0, import_react3.useCallback)((nodeOrRect, area, partially = true) => {
...
var ZoomPane = ({ onMove, onMoveStart, onMoveEnd, onPaneContextMenu, zoomOnScroll = true, zoomOnPinch = true, panOnScroll = false, panOnScrollSpeed = 0.5, panOnScrollMode = PanOnScrollMode.Free, zoomOnDoubleClick = true, elementsSelectable, panOnDrag = true, defaultViewport, translateExtent, minZoom, maxZoom, zoomActivationKeyCode, preventScrolling = true, children, noWheelClassName, noPanClassName }) => {
  const timerId = (0, import_react3.useRef)();
  const store = useStoreApi();
  const isZoomingOrPanning = (0, import_react3.useRef)(false);
  const zoomedWithRightMouseButton = (0, import_react3.useRef)(false);
  const zoomPane = (0, import_react3.useRef)(null);
  const prevTransform = (0, import_react3.useRef)({ x: 0, y: 0, zoom: 0 });
  const { d3Zoom, d3Selection, d3ZoomHandler, userSelectionActive } = useStore(selector$a, shallow);
  const zoomActivationKeyPressed = useKeyPress(zoomActivationKeyCode);
  const mouseButton = (0, import_react3.useRef)(0);
  const isPanScrolling = (0, import_react3.useRef)(false);
  const panScrollTimeout = (0, import_react3.useRef)();
  ...
  return import_react3.default.createElement("div", { className: "react-flow__renderer", ref: zoomPane, style: containerStyle }, children);
};
var selector$9 = (s) => ({
  userSelectionActive: s.userSelectionActive,
...
function UserSelection() {
  ...
  return import_react3.default.createElement("div", { className: "react-flow__selection react-flow__container", style: {
...
var Pane = (0, import_react3.memo)(({ isSelecting, selectionMode = SelectionMode.Full, panOnDrag, onSelectionStart, onSelectionEnd, onPaneClick, onPaneContextMenu, onPaneScroll, onPaneMouseEnter, onPaneMouseMove, onPaneMouseLeave, children }) => {
  ...
  return import_react3.default.createElement(
    ...
    children,
    import_react3.default.createElement(UserSelection, null)
  );
});
...
function useGetPointerPosition() {
  const store = useStoreApi();
  const getPointerPosition = (0, import_react3.useCallback)(({ sourceEvent }) => {
...
function useDrag({ nodeRef, disabled = false, noDragClassName, handleSelector, nodeId, isSelectable, selectNodesOnDrag }) {
  ...
  const dragItems = (0, import_react3.useRef)([]);
  const lastPos = (0, import_react3.useRef)({ x: null, y: null });
  const autoPanId = (0, import_react3.useRef)(0);
  const containerBounds = (0, import_react3.useRef)(null);
  const mousePosition = (0, import_react3.useRef)({ x: 0, y: 0 });
  const dragEvent = (0, import_react3.useRef)(null);
  const autoPanStarted = (0, import_react3.useRef)(false);
  const dragStarted = (0, import_react3.useRef)(false);
  const abortDrag = (0, import_react3.useRef)(false);
...
function useUpdateNodePositions() {
  const store = useStoreApi();
  const updatePositions = (0, import_react3.useCallback)((params) => {
...
var wrapNode = (NodeComponent) => {
  const NodeWrapper = ({ id, type, data, xPos, yPos, xPosOrigin, yPosOrigin, selected, onClick, onMouseEnter, onMouseMove, onMouseLeave, onContextMenu, onDoubleClick, style: style2, className, isDraggable, isSelectable, isConnectable, isFocusable, selectNodesOnDrag, sourcePosition, targetPosition, hidden, resizeObserver, dragHandle, zIndex, isParent, noDragClassName, noPanClassName, initialized, disableKeyboardA11y, ariaLabel, rfId, hasHandleBounds }) => {
    ...
    const prevNodeRef = (0, import_react3.useRef)(null);
    const prevSourcePosition = (0, import_react3.useRef)(sourcePosition);
    const prevTargetPosition = (0, import_react3.useRef)(targetPosition);
    const prevType = (0, import_react3.useRef)(type);
    ...
    return import_react3.default.createElement(
      ...
      import_react3.default.createElement(
        Provider,
        { value: id },
        import_react3.default.createElement(NodeComponent, { id, data, type, xPos, yPos, selected, isConnectable, sourcePosition, targetPosition, dragging, dragHandle, zIndex })
      )
    );
  };
  NodeWrapper.displayName = "NodeWrapper";
  return (0, import_react3.memo)(NodeWrapper);
};
var selector$7 = (s) => {
...
function NodesSelection({ onSelectionContextMenu, noPanClassName, disableKeyboardA11y }) {
  ...
  return import_react3.default.createElement(
    ...
    import_react3.default.createElement("div", { ref: nodeRef, className: "react-flow__nodesselection-rect", onContextMenu, tabIndex: disableKeyboardA11y ? void 0 : -1, onKeyDown: disableKeyboardA11y ? void 0 : onKeyDown, style: {
      width,
      height,
      top,
      left
...
var NodesSelection$1 = (0, import_react3.memo)(NodesSelection);
...
var FlowRenderer = ({ children, onPaneClick, onPaneMouseEnter, onPaneMouseMove, onPaneMouseLeave, onPaneContextMenu, onPaneScroll, deleteKeyCode, onMove, onMoveStart, onMoveEnd, selectionKeyCode, selectionOnDrag, selectionMode, onSelectionStart, onSelectionEnd, multiSelectionKeyCode, panActivationKeyCode, zoomActivationKeyCode, elementsSelectable, zoomOnScroll, zoomOnPinch, panOnScroll: _panOnScroll, panOnScrollSpeed, panOnScrollMode, zoomOnDoubleClick, panOnDrag: _panOnDrag, defaultViewport, translateExtent, minZoom, maxZoom, preventScrolling, onSelectionContextMenu, noWheelClassName, noPanClassName, disableKeyboardA11y }) => {
  ...
  return import_react3.default.createElement(
    ...
    import_react3.default.createElement(
      ...
      children,
      nodesSelectionActive && import_react3.default.createElement(NodesSelection$1, { onSelectionContextMenu, noPanClassName, disableKeyboardA11y })
    )
  );
};
FlowRenderer.displayName = "FlowRenderer";
var FlowRenderer$1 = (0, import_react3.memo)(FlowRenderer);
function useVisibleNodes(onlyRenderVisible) {
  const nodes = useStore((0, import_react3.useCallback)((s) => onlyRenderVisible ? getNodesInside(s.nodeInternals, { x: 0, y: 0, width: s.width, height: s.height }, s.transform, true) : s.getNodes(), [onlyRenderVisible]));
  return nodes;
}
...
var NodeRenderer = (props) => {
  ...
  const resizeObserverRef = (0, import_react3.useRef)();
  ...
  return import_react3.default.createElement("div", { className: "react-flow__nodes", style: containerStyle }, nodes.map((node) => {
    var _a, _b, _c;
...
var wrapEdge = (EdgeComponent) => {
  const EdgeWrapper = ({ id, className, type, data, onClick, onEdgeDoubleClick, selected, animated, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style2, source, target, sourceX, sourceY, targetX, targetY, sourcePosition, targetPosition, elementsSelectable, hidden, sourceHandleId, targetHandleId, onContextMenu, onMouseEnter, onMouseMove, onMouseLeave, reconnectRadius, onReconnect, onReconnectStart, onReconnectEnd, markerEnd, markerStart, rfId, ariaLabel, isFocusable, isReconnectable, pathOptions, interactionWidth, disableKeyboardA11y }) => {
    ...
    const store = useStoreApi();
    const markerStartUrl = (0, import_react3.useMemo)(() => `url('#${getMarkerId(markerStart, rfId)}')`, [markerStart, rfId]);
    const markerEndUrl = (0, import_react3.useMemo)(() => `url('#${getMarkerId(markerEnd, rfId)}')`, [markerEnd, rfId]);
    if (hidden) {
      return null;
    }
    ...
    return import_react3.default.createElement(
      ...
      !updating && import_react3.default.createElement(EdgeComponent, { id, source, target, selected, animated, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, data, style: style2, sourceX, sourceY, targetX, targetY, sourcePosition, targetPosition, sourceHandleId, targetHandleId, markerStart: markerStartUrl, markerEnd: markerEndUrl, pathOptions, interactionWidth }),
      isReconnectable && import_react3.default.createElement(
        import_react3.default.Fragment,
        null,
        (isReconnectable === "source" || isReconnectable === true) && import_react3.default.createElement(EdgeAnchor, { position: sourcePosition, centerX: sourceX, centerY: sourceY, radius: reconnectRadius, onMouseDown: onEdgeUpdaterSourceMouseDown, onMouseEnter: onEdgeUpdaterMouseEnter, onMouseOut: onEdgeUpdaterMouseOut, type: "source" }),
        (isReconnectable === "target" || isReconnectable === true) && import_react3.default.createElement(EdgeAnchor, { position: targetPosition, centerX: targetX, centerY: targetY, radius: reconnectRadius, onMouseDown: onEdgeUpdaterTargetMouseDown, onMouseEnter: onEdgeUpdaterMouseEnter, onMouseOut: onEdgeUpdaterMouseOut, type: "target" })
      )
    );
  };
  EdgeWrapper.displayName = "EdgeWrapper";
  return (0, import_react3.memo)(EdgeWrapper);
};
...
function useVisibleEdges(onlyRenderVisible, nodeInternals, elevateEdgesOnSelect) {
  const edges = useStore((0, import_react3.useCallback)((s) => {
...
var ArrowSymbol = ({ color = "none", strokeWidth = 1 }) => {
  return import_react3.default.createElement("polyline", { style: {
    stroke: color,
    strokeWidth
...
var Marker = ({ id, type, color, width = 12.5, height = 12.5, markerUnits = "strokeWidth", strokeWidth, orient = "auto-start-reverse" }) => {
  ...
  return import_react3.default.createElement(
    ...
    import_react3.default.createElement(Symbol2, { color, strokeWidth })
  );
};
...
var MarkerDefinitions = ({ defaultColor, rfId }) => {
  const markers = useStore(
    (0, import_react3.useCallback)(markerSelector({ defaultColor, rfId }), [defaultColor, rfId]),
    // the id includes all marker options, so we just need to look at that part of the marker
    (a, b) => !(a.length !== b.length || a.some((m, i) => m.id !== b[i].id))
  );
  return import_react3.default.createElement("defs", null, markers.map((marker) => import_react3.default.createElement(Marker, { id: marker.id, key: marker.id, type: marker.type, color: marker.color, width: marker.width, height: marker.height, markerUnits: marker.markerUnits, strokeWidth: marker.strokeWidth, orient: marker.orient })));
};
...
var EdgeRenderer = ({ defaultMarkerColor, onlyRenderVisibleElements, elevateEdgesOnSelect, rfId, edgeTypes, noPanClassName, onEdgeContextMenu, onEdgeMouseEnter, onEdgeMouseMove, onEdgeMouseLeave, onEdgeClick, onEdgeDoubleClick, onReconnect, onReconnectStart, onReconnectEnd, reconnectRadius, children, disableKeyboardA11y }) => {
  ...
  return import_react3.default.createElement(
    import_react3.default.Fragment,
    null,
    edgeTree.map(({ level, edges, isMaxLevel }) => import_react3.default.createElement(
      "svg",
      { key: level, style: { zIndex: level }, width, height, className: "react-flow__edges react-flow__container" },
      isMaxLevel && import_react3.default.createElement(MarkerDefinitions$1, { defaultColor: defaultMarkerColor, rfId }),
      import_react3.default.createElement("g", null, edges.map((edge) => {
...
var EdgeRenderer$1 = (0, import_react3.memo)(EdgeRenderer);
var selector$3 = (s) => `translate(${s.transform[0]}px,${s.transform[1]}px) scale(${s.transform[2]})`;
function Viewport({ children }) {
  const transform = useStore(selector$3);
  return import_react3.default.createElement("div", { className: "react-flow__viewport react-flow__container", style: { transform } }, children);
}
...
var ConnectionLine = ({ nodeId, handleType, style: style2, type = ConnectionLineType.Bezier, CustomComponent, connectionStatus }) => {
  var _a, _b, _c;
  const { fromNode, handleId, toX, toY, connectionMode } = useStore((0, import_react3.useCallback)((s) => ({
  ...
  if (CustomComponent) {
    return import_react3.default.createElement(CustomComponent, { connectionLineType: type, connectionLineStyle: style2, fromNode, fromHandle, fromX, fromY, toX, toY, fromPosition, toPosition, connectionStatus });
  }
  let dAttr = "";
  const pathParams = {
    sourceX: fromX,
  ...
  return import_react3.default.createElement("path", { d: dAttr, fill: "none", className: "react-flow__connection-path", style: style2 });
};
...
function ConnectionLineWrapper({ containerStyle: containerStyle2, style: style2, type, component }) {
  ...
  return import_react3.default.createElement(
    ...
    import_react3.default.createElement(
      ...
      import_react3.default.createElement(ConnectionLine, { nodeId, handleType, style: style2, type, CustomComponent: component, connectionStatus })
    )
  );
}
function useNodeOrEdgeTypes(nodeOrEdgeTypes, createTypes) {
  const typesKeysRef = (0, import_react3.useRef)(null);
  const store = useStoreApi();
  const typesParsed = (0, import_react3.useMemo)(() => {
    var _a, _b;
    if (true) {
  ...
  return import_react3.default.createElement(
    ...
    import_react3.default.createElement(
      ...
      import_react3.default.createElement(
        ...
        import_react3.default.createElement(ConnectionLineWrapper, { style: connectionLineStyle, type: connectionLineType, component: connectionLineComponent, containerStyle: connectionLineContainerStyle })
      ),
      import_react3.default.createElement("div", { className: "react-flow__edgelabel-renderer" }),
      import_react3.default.createElement(NodeRenderer$1, { nodeTypes: nodeTypesWrapped, onNodeClick, onNodeDoubleClick, onNodeMouseEnter, onNodeMouseMove, onNodeMouseLeave, onNodeContextMenu, selectNodesOnDrag, onlyRenderVisibleElements, noPanClassName, noDragClassName, disableKeyboardA11y, nodeOrigin, nodeExtent, rfId })
    )
  );
};
GraphView.displayName = "GraphView";
var GraphView$1 = (0, import_react3.memo)(GraphView);
var infiniteExtent = [
...
var ReactFlowProvider = ({ children }) => {
  ...
  return import_react3.default.createElement(Provider$1, { value: storeRef.current }, children);
};
...
var Wrapper = ({ children }) => {
  ...
  return import_react3.default.createElement(ReactFlowProvider, null, children);
};
...
function useUpdateNodeInternals() {
  const store = useStoreApi();
  return (0, import_react3.useCallback)((id) => {
...
function createUseItemsState(applyChanges2) {
  return (initialItems) => {
    ...
    const onItemsChange = (0, import_react3.useCallback)((changes) => setItems((items2) => applyChanges2(changes, items2)), []);
...
//# sourceMappingURL=chunk-OXB7RIKY.js.map
