...
const draft: TemplateDraft = {
  ...
  deck: [
    {
      id: 'slide-1',
      title: 'Wyniki Q3 2026',
      archetype: 'cover',
      hint: 'Tytuł + data + logo',
      aiFilled: false,
    },
    {
      id: 'slide-2',
    ...
    },
    {
      ...
      archetype: 'chart',
      hint: 'Wykres słupkowy 4 kwartały',
      aiFilled: true,
    },
    {
      id: 'slide-5',
      title: 'Ryzyka vs szanse',
      archetype: 'two-column',
      hint: 'Lewa: ryzyka, prawa: szanse',
      aiFilled: true,
    },
    {
      id: 'slide-6',
