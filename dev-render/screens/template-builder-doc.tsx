  ...
  doc: [
    {
      ...
      block: 'paragraph',
      depth: 'short',
      hint: '3 kluczowe wnioski + rekomendacja',
      aiFilled: true,
    },
    {
      id: 'sec-2',
      title: 'Postęp vs plan',
      block: 'kpi',
      depth: 'medium',
      hint: 'Pasek KPI: % ukończenia, budżet, ryzyka',
      aiFilled: true,
    },
    {
      id: 'sec-3',
      ...
      block: 'table',
      depth: 'medium',
      hint: 'Tabela: kamień · termin · status',
      aiFilled: true,
    },
    {
      id: 'sec-4',
      title: 'Ryzyka i działania',
      block: 'bullets',
      depth: 'long',
      hint: 'Lista RAID z właścicielem',
      aiFilled: true,
    },
    {
      id: 'sec-5',
