...
export const adminClasses = {
  ...
  // Button variants
  btn: {
    primary: 'px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white text-sm font-medium rounded-lg transition-colors disabled:opacity-50',
    secondary: 'px-4 py-2 border border-white/10 hover:border-white/20 hover:bg-white/[0.02] text-slate-300 text-sm font-medium rounded-lg transition-colors',
