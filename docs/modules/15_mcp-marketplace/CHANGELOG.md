...
# Changelog — MCP Marketplace / DBR77

## 2026-05-10

- Added function-first contract layer for module 15 (`2/2` functions).
...
- Corrected META identity to As-Is appview mapping (`AppView.MCP_MARKETPLACE_COMING_SOON`).
