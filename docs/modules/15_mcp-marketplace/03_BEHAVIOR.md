...
- MUST be read-first for P0.
- MUST preserve asset provenance/license during import.
- MUST require explicit permission and audit for publish/order/license mutations.
