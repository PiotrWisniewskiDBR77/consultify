...
# SSOT — MCP Marketplace (DBR77)

## Priority order (when sources conflict)

1. `DRD/consultify/docs/modules/15_mcp-marketplace/00_META.md` … `07_ACCEPTANCE_AND_TESTS.md` (ten kontrakt)
2. `DRD/consultify/docs/product/INTEGRATIONS_SYNC_MCP_PLAN_V3.md`
3. `DRD/consultify/docs/product/DOCUMENTATION_REGISTRY.md`

## Primary module sources (to migrate into contract)

- `DRD/consultify/docs/product/INTEGRATIONS_SYNC_MCP_PLAN_V3.md` (sekcja 5.2 MCP‑Marketplace)
