...
- MUST keep the chat control surface legible: source scope, attachments, model/tool state and approvals visible.
- MUST place contextual AI/action controls in Menu 3 / command row when attached to a module context.
- MUST show citations and confidence/assumption posture for decision-impacting answers.
- MUST support split/workbench mode when the conversation creates or edits a live artifact.
