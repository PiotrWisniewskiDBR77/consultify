...
| Mapped labels | Canonical ID | Value |
| --- | --- | ---: |
| Segment assets Investments in joint ventures and associatesa 2025 | fsl-pl-other-fin | 6.111 |
...
| Expenditure on research and development 2025 | fsl-pl-rnd | 274301 |
...
| Inventory holding gains (losses)b 1 2025 | -1.237 |
...
| Interest expense on other liabilities measured at amortized costd 2025 | 3.419 |
...
| Less: Comprehensive income (loss) attributable to noncontrolling interests 2024 | fsl-pl-net-parent | 9 |
...
| Mapped labels | Canonical ID | Value |
| --- | --- | ---: |
| Energy generation and storage 2024 | fsl-pl-revenue-service | 10.086 |
