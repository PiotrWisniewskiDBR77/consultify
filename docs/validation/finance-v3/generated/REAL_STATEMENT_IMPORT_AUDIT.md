...
- Tier 1 (auto): 3 | Tier 2 (LLM confirmed): 0 | Tier 3 (review): 0 | Tier 4 (excluded): 0
- Auto-confirm eligible: YES
- 100% coverage — all lines mapped with high confidence, auto-confirm eligible
...
**Policy Assessment:**
- Effective coverage: **100%** ✅
- Tier 1 (auto): 11 | Tier 2 (LLM confirmed): 0 | Tier 3 (review): 0 | Tier 4 (excluded): 1
- Auto-confirm eligible: YES
- 100% coverage — all lines mapped with high confidence, auto-confirm eligible
...
**Policy Assessment:**
- Effective coverage: **100%** ✅
- Tier 1 (auto): 28 | Tier 2 (LLM confirmed): 0 | Tier 3 (review): 0 | Tier 4 (excluded): 1
- Auto-confirm eligible: YES
- 100% coverage — all lines mapped with high confidence, auto-confirm eligible
...
| Wpływy ze sprzedaży rzeczowych aktywów trwałych 2024 | fsl-cf-investing-disposal-ppe | 774 |
...
**Policy Assessment:**
- Effective coverage: **19%** ⚠️
- Tier 1 (auto): 65 | Tier 2 (LLM confirmed): 0 | Tier 3 (review): 278 | Tier 4 (excluded): 53
- Auto-confirm eligible: NO
- 19% coverage — below 90% target, 278 line(s) need review
...
| Pozostałe 2023 | fsl-bs-other-provisions | 721 |
...
| Instrumenty pochodne 2023 | fsl-bs-derivative-instruments | 324305 |
...
**Policy Assessment:**
- Effective coverage: **100%** ✅
- Tier 1 (auto): 20 | Tier 2 (LLM confirmed): 0 | Tier 3 (review): 0 | Tier 4 (excluded): 1
- Auto-confirm eligible: YES
- 100% coverage — all lines mapped with high confidence, auto-confirm eligible
...
**Policy Assessment:**
- Effective coverage: **100%** ✅
- Tier 1 (auto): 26 | Tier 2 (LLM confirmed): 0 | Tier 3 (review): 0 | Tier 4 (excluded): 1
- Auto-confirm eligible: YES
- 100% coverage — all lines mapped with high confidence, auto-confirm eligible
...
| Wpływy ze sprzedaży rzeczowych aktywów trwałych 2023 | fsl-cf-investing-disposal-ppe | 12196 |
...
**Policy Assessment:**
- Effective coverage: **100%** ✅
- Tier 1 (auto): 29 | Tier 2 (LLM confirmed): 1 | Tier 3 (review): 0 | Tier 4 (excluded): 0
- Auto-confirm eligible: YES
- 100% coverage — all lines mapped with high confidence, auto-confirm eligible
...
**Policy Assessment:**
- Effective coverage: **100%** ✅
- Tier 1 (auto): 16 | Tier 2 (LLM confirmed): 0 | Tier 3 (review): 0 | Tier 4 (excluded): 1
- Auto-confirm eligible: YES
- 100% coverage — all lines mapped with high confidence, auto-confirm eligible
...
**Policy Assessment:**
- Effective coverage: **100%** ✅
- Tier 1 (auto): 28 | Tier 2 (LLM confirmed): 0 | Tier 3 (review): 0 | Tier 4 (excluded): 2
- Auto-confirm eligible: YES
- 100% coverage — all lines mapped with high confidence, auto-confirm eligible
...
| Wpływy ze sprzedaży rzeczowych aktywów trwałych 2024 | fsl-cf-investing-disposal-ppe | 1758 |
...
**Policy Assessment:**
- Effective coverage: **38%** ⚠️
- Tier 1 (auto): 11 | Tier 2 (LLM confirmed): 5 | Tier 3 (review): 26 | Tier 4 (excluded): 3
- Auto-confirm eligible: NO
- 38% coverage — below 90% target, 26 line(s) need review

| Mapped labels | Canonical ID | Value |
| --- | --- | ---: |
| Zmniejszenie z tytułu zbycia 2022 | fsl-bs-other-tax-payables | -23 |
| Środki pieniężne na rachunkach bankowych 2022 | fsl-bs-cash-operating | 25548 |
| Środki pieniężne na rachunkach VAT (split payment) 2022 | fsl-bs-cash-restricted | 3381 |
...
| Umorzenie akcji własnych 2022 | fsl-bs-treasury-shares | -13 |
...
| płatne powyżej 1 roku do 2 lat 2022 | fsl-bs-long-term-debt | 3119 |
| Kredyty i pożyczki krótkoterminowe 2022 | fsl-bs-short-term-debt | 237350 |
...
**Policy Assessment:**
- Effective coverage: **100%** ✅
- Tier 1 (auto): 18 | Tier 2 (LLM confirmed): 0 | Tier 3 (review): 0 | Tier 4 (excluded): 3
- Auto-confirm eligible: YES
- 100% coverage — all lines mapped with high confidence, auto-confirm eligible
...
**Policy Assessment:**
- Effective coverage: **100%** ✅
- Tier 1 (auto): 21 | Tier 2 (LLM confirmed): 0 | Tier 3 (review): 0 | Tier 4 (excluded): 1
- Auto-confirm eligible: YES
- 100% coverage — all lines mapped with high confidence, auto-confirm eligible
...
| Document | Statement | Raw Coverage | Effective Coverage | T1 Auto | T2 LLM | T3 Review | T4 Excluded | Auto-Confirm |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| Apator SA Raport R 2024 | BS | 100% | **100%** | 3 | 0 | 0 | 0 | ✅ |
| Apator SA Raport R 2024 | P&L | 100% | **100%** | 11 | 0 | 0 | 1 | ✅ |
| Apator SA Raport R 2024 | CF | 100% | **100%** | 28 | 0 | 0 | 1 | ✅ |
| Grupa Apator Raport RS 2023 | BS | 19% | **19%** | 65 | 0 | 278 | 53 | — |
| Grupa Apator Raport RS 2023 | P&L | 100% | **100%** | 20 | 0 | 0 | 1 | ✅ |
| Grupa Apator Raport RS 2023 | CF | 100% | **100%** | 26 | 0 | 0 | 1 | ✅ |
| Grupa Apator Raport RS 2024 | BS | 100% | **100%** | 29 | 1 | 0 | 0 | ✅ |
| Grupa Apator Raport RS 2024 | P&L | 100% | **100%** | 16 | 0 | 0 | 1 | ✅ |
| Grupa Apator Raport RS 2024 | CF | 100% | **100%** | 28 | 0 | 0 | 2 | ✅ |
| Raport skonsolidowany Apator | BS | 38% | **38%** | 11 | 5 | 26 | 3 | — |
| Raport skonsolidowany Apator | P&L | 100% | **100%** | 18 | 0 | 0 | 3 | ✅ |
| Raport skonsolidowany Apator | CF | 100% | **100%** | 21 | 0 | 0 | 1 | ✅ |
