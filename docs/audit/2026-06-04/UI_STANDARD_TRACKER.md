...
3. **Kolory**: akcent = **Burgundy Crimson `#85182F`** (locked; skala 500 #A82D49 / 600 #85182F / 700 #6D1427) „lekko"; zero off-brand (indigo/violet/fuchsia/purple); zero hardcoded hex poza tokenami; neutrale = navy/slate. **Ramki:** slate-200 floor (light) / white/10 (dark), kolorowy border tylko crimson active/focus. Patrz `_DESIGN_STANDARD.md`.
