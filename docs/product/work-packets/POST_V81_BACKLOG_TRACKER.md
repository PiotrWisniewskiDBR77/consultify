...
- [ ] assess whether post-callback verification / ready-state promotion continuity or post-auth refresh / recovery continuity is now the next smallest honest broader-sync packet
