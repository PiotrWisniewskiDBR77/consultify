...
- [ ] assess whether callback-driven governed refresh secret materialization continuity or deeper authority alignment is now the next smallest honest broader-sync packet
