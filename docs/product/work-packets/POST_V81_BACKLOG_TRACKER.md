...
- [ ] assess whether enterprise onboarding pricing-tier selection continuity or client-access breadth now contains the next smallest honest broader-partner packet
