...
- [ ] assess whether `FinancialStatementImportWizard` values-save continuity is the next honest broader Finance packet after the manual detect/extract/map closure
