...
- [ ] assess whether real governed refresh execution continuity or auth-break recovery resolution continuity is now the next smallest honest broader-sync packet
