...
| broader `Mobile` redesign | `T4` | `Parking lot` | `active` | `Manager` | chartered in `docs/product/work-packets/T4_BROADER_MOBILE_REDESIGN_CHARTER.md`; split-brain map recorded in `evidence/355-v81-broader-mobile-redesign-split-brain-map.md`; first real bounded packet landed in `evidence/356-v81-broader-mobile-redesign-table-preview-mobile-overlay-seam.md`; next move is to assess the next honest broader-mobile packet |
