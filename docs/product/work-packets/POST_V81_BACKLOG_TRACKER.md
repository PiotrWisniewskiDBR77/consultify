...
- [ ] assess whether remaining client-access employee/access-link/project breadth can be split honestly before broader statement-source migration or payout-settings continuity
