...
- [ ] assess whether governed refresh execution / refresh-result continuity or auth-break escalation / recovery continuity is now the next smallest honest broader-sync packet
