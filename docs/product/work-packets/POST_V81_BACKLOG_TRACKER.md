...
- [ ] assess whether canonical org-level connect initiation authority continuity or real governed refresh execution continuity is now the next smallest honest broader-sync packet
