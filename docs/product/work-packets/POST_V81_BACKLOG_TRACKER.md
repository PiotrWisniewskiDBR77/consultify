...
- [ ] assess whether legacy alias /api/integrations/:provider/connect authority continuity or real governed refresh execution continuity is now the next smallest honest broader-sync packet
