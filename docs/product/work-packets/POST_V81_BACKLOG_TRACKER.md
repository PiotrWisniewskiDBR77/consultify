...
- [ ] assess whether `FinancialStatementImportWizard` continuity is the next honest broader Finance packet after active workspace recovery-chain closure
