...
- [ ] assess whether remaining client-access employee or access-link breadth can be split honestly before broader statement-source migration or payout-settings continuity
