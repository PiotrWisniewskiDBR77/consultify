...
- [ ] assess whether broader statement-source migration or placeholder-only payout-settings save continuity is now the next smallest honest partner packet
