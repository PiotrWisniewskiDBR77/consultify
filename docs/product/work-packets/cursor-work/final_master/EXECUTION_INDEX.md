...
| 28 | Assessment | `final-v8-contracts/FINAL_IMPLEMENTATION_PLAN_28_ASSESSMENT_2026-03-29.md` | P28-A / P28-B / P28-C | verified(evidence) — P28-B/C: workbench + `whatNext`/preset DRD + E2E `assessmentWorkbench.p28b-e2e.test.ts`; **P28-C** regresje `assessmentWorkbench.p28c-regression.test.ts` (read-only/completed, `P28_PROMOTION_GUARD`); smoke `smoke-p28-workbench-b.ts` + **`smoke-p28-workbench-c.ts`**; evidence **`P28_B_ROLLOUT_2026-03-31.md`** + **`P28_C_VERIFICATION_ROLLOUT_2026-03-31.md`**; lock **`locks/P28-C.md`** |
| 29 | Program partnerski | `final-v8-contracts/FINAL_IMPLEMENTATION_PLAN_29_PROGRAM_PARTNERSKI_2026-03-29.md` | P29-A / P29-B / P29-C | verified(evidence) — P29-B/C: ledger + status `whatNext`/`hold` + superadmin; **P29-C** 409 `P29_PAYOUT_SETTINGS_INCOMPLETE` na `request-payout-phase` (`isPartnerPayoutDestinationComplete`); testy `p29-payout-readiness.contract.test.ts`; smoke **`smoke-p29-partner-program-b.ts`** + **`smoke-p29-partner-program-c.ts`**; evidence **`P29_B_ROLLOUT_2026-03-31.md`** + **`P29_C_VERIFICATION_ROLLOUT_2026-03-31.md`**; lock **`locks/P29-C.md`** |
