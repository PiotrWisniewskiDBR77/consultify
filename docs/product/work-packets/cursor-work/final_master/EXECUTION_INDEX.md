...
| 07 | Notatnik | `final-v8-contracts/FINAL_IMPLEMENTATION_PLAN_07_NOTATNIK_2026-03-29.md` | P07-A / P07-B / P07-C | verified(evidence) 100% — notebookCanon: 11 capture entries, provenance language (source/user_edit/ai_transform), 6 attachment lifecycle states, 9 error taxonomy entries, 14 search filters, 3 handoff targets (Radar/Inicjatywy/Teresa), 4 anti-duplicate rules, 10 degraded scenarios, 11/11 acceptance; 55 tests; evidence `evidence/P07_VERIFIED_CLOSEOUT_2026-03-31.md` |
| 08 | Teresa | `final-v8-contracts/FINAL_IMPLEMENTATION_PLAN_08_TERESA_2026-03-29.md` | P08-A / P08-B / P08-C | verified(evidence) 100% — teresaCopilotCanon: 4 P0 handoff targets, 6-state action envelope governance, 6 hard rules (approve≠review, no silent writes), voice posture + fallback, citation/uncertainty posture, Anna boundary, write ownership, 10 degraded scenarios, 12/12 acceptance; 49 tests; evidence `evidence/P08_VERIFIED_CLOSEOUT_2026-03-31.md` |
