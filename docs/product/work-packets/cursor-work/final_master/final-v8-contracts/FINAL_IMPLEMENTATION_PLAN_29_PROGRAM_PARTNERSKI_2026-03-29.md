...
| P29-C | verified(evidence) | `PLACEHOLDER_P29C_COMMIT` | P29-B + 409 `P29_PAYOUT_SETTINGS_INCOMPLETE` + `tests/integration/p29-payout-readiness.contract.test.ts`; smoke `smoke-p29-partner-program-c.ts` | `final_master/evidence/P29_C_VERIFICATION_ROLLOUT_2026-03-31.md`; `npx tsx server/scripts/smoke-p29-partner-program-c.ts` | Rollback: disable program routes; dual-control payout / ledger-degraded snapshot deferred (see evidence) |
