...
| broader `Partner Program` parity | active | accepted lane closed visible payout / campaign / profile seams; payout-history and statement-history continuity are now governed by V8-first reads, while onboarding, client access, payout-settings, referred-customer lifecycle, and wider statement breadth still remain | `10` | remaining partner breadth is closed or explicitly retired |
