...
| broader `Sync` completion | active | accepted sync lane closed bounded observability and lifecycle controls; wider connect/onboarding and OAuth/provider completion breadth remains and is now promoted | `15` | remaining sync completion breadth is closed or explicitly retired |
