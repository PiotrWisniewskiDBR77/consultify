...
This document uses the **project role vocabulary** from `docs/product/SYSTEM_ARCHITECTURE_BRIEF.md`.

- **Business Owner / Sponsor**: accountable for strategic decisions; final approval authority
- **Transformation Lead**: responsible for initiative lifecycle; owns transformation logic
- **Consultant / Domain Expert**: creates tools/assessments and initiative drafts (advisory)
- **Execution Lead (PM / Delivery)**: responsible for execution; owns tasks and delivery
