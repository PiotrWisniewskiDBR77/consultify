...
3. `MINDMAP_NAVIGATION_NODE_OPERATIONS_AND_AI_COPILOT_V8.md`
4. `MINDMAP_CHAT_SIDEKICK_AND_COLLABORATIVE_IDEA_RUNTIME_V8.md`
5. `MINDMAP_V1_IMPLEMENTATION_PLAN.md`
6. `MINDMAP_COMPLETION_FINDINGS_2026-03-12.md`
7. `MINDMAP_DEVELOPMENT_STATUS_2026-03-15.md`
8. `IDEA_WORKSPACE_NAVIGATION_AND_CANVAS_ORCHESTRATION_V8.md`

This order matters:

- first understand readiness and truth level,
- then read the core product contract,
- then lock navigation, node operations, and branch-level AI copilot behavior,
