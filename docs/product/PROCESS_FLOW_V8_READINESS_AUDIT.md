...
3. `PROCESS_FLOW_QUANTITATIVE_ANALYSIS_AND_AUTOMATION_INTELLIGENCE_V8.md`
4. `IDEA_WORKSPACE_NAVIGATION_AND_CANVAS_ORCHESTRATION_V8.md`
5. `IDEA_WORKSPACE_V5_SSOT.md`
6. `WORKSTATION_CANVAS_FINAL_MASTER_PLAN_2026-03-16.md`
7. `WORKSTATION_CANVAS_IMPLEMENTATION_PLAN_2026-03-16.md`
8. `PROCESS_MYWORK_TO_DELIVERABLES_V3.md`

This order matters:

- first understand readiness truth,
- then read the final product contract,
- then lock quantitative analysis, VSM intelligence, and automation-planning behavior,
