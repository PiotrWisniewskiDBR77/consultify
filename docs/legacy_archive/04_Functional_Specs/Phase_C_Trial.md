...
## 3. Trial Constraints
- **Duration**: Fixed **30‑day** period from `trial_start_timestamp`.
- **Initiative Limit**: Up to **5** initiatives may be created.
- **Invitation Limit**: Up to **3** additional team members can be invited.
- **Export Limit**: One **PDF report** export is allowed.
- **AI Token Usage**:
  - **Budget**: **10 000** AI tokens per trial.
...
3. **Extend Trial** – a one‑time **7‑day** extension (admin‑approved only).
