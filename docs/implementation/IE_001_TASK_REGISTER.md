...
- The historical isolated candidate was owner-accepted on 2026-08-11. The reconstructed code
  candidate `cd5f5f858390d82694926e130ea77faa97f855ad` passes repository-wide type-check,
  strict server build and production build, and is deployed on Railway demo as
  `d4bc7cd4-46cd-435c-bdc0-3440995d26fa`.
- IE-099 remains `READY_FOR_REVIEW` until the deployed candidate is accepted in the logged-in demo.
  Historical commit evidence remains recorded in `IE_001_EVIDENCE_LOG.md`.
