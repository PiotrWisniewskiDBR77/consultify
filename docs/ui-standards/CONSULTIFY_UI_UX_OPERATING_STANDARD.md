...
1. `docs/ui-standards/CONSULTIFY_UI_UX_GOLDEN_STANDARD.md` - najwyższe źródło prawdy: UI/UX, grafika, komponenty, zasady pracy.
2. `docs/ui-standards/CONSULTIFY_UI_UX_OPERATING_STANDARD.md` - ten dokument, operacyjny kontrakt pracy.
3. `docs/ui-standards/UI_UX_COMPONENT_APPROVAL_AND_MIGRATION_MASTER_PLAN.md` - roboczy plan zatwierdzania komponentów i migracji.
4. `docs/ui-standards/UI_UX_CANON_V3.md` - główny kanon decyzji UI/UX v3.
5. `docs/ui-standards/FROZEN_LAYOUTS.md` - układy zamrożone, których nie wolno rozjechać.
6. Szczegółowe standardy z `docs/ui-standards/00-foundation`, `01-shell-layout`, `02-components`, `03-modules`.
7. Implementacje referencyjne wskazane w dokumentach.
8. Stare dokumenty, duplikaty ` 2.md`, ` 3.md` i lokalne snapshoty - tylko jako kontekst historyczny, nie jako standard.
