...
Wave 2 code candidate: `3ab15ebb2930bc42bc143f743c362f987c0ac512`
...
| 3 | `FIN-MVP-CUTOVER-001` | `PARTIAL` | Finance exact-six and Statement identity are closed; fresh/repeat/dry migration and real-PG owner-flow evidence are retained. The final audit also restored eight governed V8 budget handlers lost by merge `826dac93da`; mounted routes plus inventory pass `90/90`. Exact-current writer count is `25/52 retired`, `27 open`. | The remaining enabled legacy Finance mutation doors still require governed successors or explicit retained-owner decisions, ID-space/backfill/usage proof and rollback across the full denominator. | Close one bounded writer family at a time; do not infer global cutover from Statement exact-six or the route restoration. |
