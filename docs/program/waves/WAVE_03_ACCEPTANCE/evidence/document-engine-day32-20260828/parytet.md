...
| Style | RÓŻNICA ŚWIADOMA | Wzorzec: 22 stylów / 638 inline rFonts; org A: 35/0; org B: 35/0. |
...
| Uczciwość pustych sekcji | PARYTET | Placeholdery: org A 102, org B 102; dane tabel i radaru pozostają. |
| Widoczność pominięć | PARYTET | Pełne i częściowe pominięcia wraz z kodami są obecne w XML org A. |

Tabele: org A 17, org B 17.
