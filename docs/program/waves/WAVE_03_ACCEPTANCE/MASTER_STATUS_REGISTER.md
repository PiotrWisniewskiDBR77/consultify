...
| 4 | `ASM` | Assessment | `TECHNICAL_PREFLIGHT` | `d268800dcc` source candidate; mount pending | `G00–G03 PASS/PASS_FOR_PREFLIGHT; G04–G05 IN_PROGRESS; 75/75 focused PASS` | 0 | 0 | 0 | 0 | `ASM-PF-001 fixed; owner fixture pending` | Organization owner screen intentionally retained |
