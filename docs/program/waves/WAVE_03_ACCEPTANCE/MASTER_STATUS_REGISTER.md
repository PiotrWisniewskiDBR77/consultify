...
|     5 | `INI`  | Initiatives     | `EXPERT_NO_GO / REMEDIATION_REQUIRED / OWNER_RETEST_PENDING` | current product source `1885ea5cde`; three-expert source review inspected `2cf780d62f9a`; historical runtime `3d61730fd8ad` retained only as historical evidence | substantial runtime-v1/card/Plan/Capacity/Execution source foundation; focused expert tech audit 19/19 PASS; current runtime/DB/browser/readback not verified |       4 |       6 |       3 |       0 | `PENDING / NO-GO`; implicit DEV fixtures and DEV API bypass are P0; one Initiative→Execution identity, Plan/Capacity workflows and current exact-SHA evidence remain open | Preserve historical evidence; close `INI-C01..C13`, freeze once, then one proportional qualification and owner retest |
