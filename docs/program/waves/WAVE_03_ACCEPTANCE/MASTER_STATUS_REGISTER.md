...
|     5 | `INI`  | Initiatives     | `EXPERT_NO_GO / REMEDIATION_REQUIRED / OWNER_RETEST_PENDING` | source checkpoint `b88f23e1494b`; RealDB harness checkpoint `dca9c7ba0f`; three-expert review inspected `2cf780d62f9a`; historical runtime retained only as historical evidence | `INI-C01 SOURCE_FIX_PASS`; Hub `17/17`, Plan/Capacity domain+surface `9/9`, isolated Plan/Capacity RealDB `3/3` PASS with residue `0`; current HTTP/browser readback not verified |       3 |       6 |       3 |       0 | `PENDING / NO-GO`; one Initiative→Execution identity, current exact-SHA qualification and HTTP/browser completion of Plan/Capacity remain open | Preserve historical evidence; prove `INI-C03..C04`, complete `INI-C02` browser replay, close remaining packages, freeze once, then owner retest |
