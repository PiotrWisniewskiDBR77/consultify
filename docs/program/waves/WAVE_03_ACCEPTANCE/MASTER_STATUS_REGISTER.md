...
|     5 | `INI`  | Initiatives     | `EXPERT_NO_GO / REMEDIATION_REQUIRED / OWNER_RETEST_PENDING` | source checkpoint `b88f23e1494b`; three-expert source review inspected `2cf780d62f9a`; historical runtime `3d61730fd8ad` retained only as historical evidence | `INI-C01 SOURCE_FIX_PASS`; ordinary local Plan/Capacity canonical API path enabled; Hub `17/17` and Plan/Capacity domain+surface `9/9` PASS; current DB/browser/readback not verified |       3 |       6 |       3 |       0 | `PENDING / NO-GO`; Plan/Capacity persistence replay, one Initiative→Execution identity and current exact-SHA qualification remain P0 | Preserve historical evidence; prove `INI-C02..C04`, close remaining packages, freeze once, then one proportional qualification and owner retest |
