...
|     5 | `INI`  | Initiatives     | `EXPERT_NO_GO / REMEDIATION_REQUIRED / OWNER_RETEST_PENDING` | source `b88f23e1494b`; RealDB harness `dca9c7ba0f`; scenario durability `4e5fbbe0f6`; canonical Execution join `68d59c4774`; three-expert review inspected `2cf780d62f9a`; historical runtime retained only as historical evidence | `INI-C01 SOURCE_FIX_PASS`; Hub `17/17`, Plan/Capacity domain+surface `9/9`, Plan/Capacity RealDB `3/3`, Initiative→Execution RealDB `2/2` PASS; clean restart/browser at `68d59c4774` reopened published Plan v2, Capacity v2 (`2026-W35`) and the identical canonical Initiative in Execution; historical demo rows absent; residue `0` |       3 |       6 |       3 |       0 | `PENDING / NO-GO`; `INI-C02` and `INI-C03` are technically browser-proven but remain owner-unaccepted; `INI-C04` and the remaining expert packages stay open | Complete `INI-C04` and remaining expert packages, freeze once, then owner retest |
