...
| --- | --- | --- | --- | --- |
| R.1 strażnik `forbiddenCanonicalComponent` | DONE_CURRENT_SHA | do uzupełnienia po commicie | 5/5 PASS + manifest PASS | Generyczna pętla, walidacja pola, przypadek ostatniej trasy, komenda npm |
| R.2 blokada tylnych drzwi sampleData | PENDING | — | — | — |
