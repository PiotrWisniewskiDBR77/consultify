...
| 3 | Remaining registered table surfaces | all other kebab, right-click, Preview and bulk adapters | `NOT_INVENTORIED` |

## Captured surface findings

| Finding | Module | Route/tab | Entity | Triggers compared | Observed gap | Required policy | Evidence | State |
|---|---|---|---|---|---|---|---|---|
