...
git merge-base --is-ancestor fe33ce8036 github-backup/codex/m03-admin-20260824 \
...
git log --oneline fe33ce8036..github-backup/codex/day207-write-proposal-20260831 | wc -l
...
markera `fe33ce8036`. **Dyżur 207, potrzebny do ogniwa 3, nie był** przodkiem markera w chwili
jego ustalenia.

**(K2) ★★ Ale 207 wszedł na linię integracyjną PO markerze — i to jest zwykły postęp trunk, nie
rozjazd na obcą gałąź.** Zmierzone: `git merge-base fe33ce8036 68e8cd1ead` zwraca `fe33ce8036` —
...
worktree, zbudowany per standardowa procedura `§0.1` **dokładnie na markerze** `fe33ce8036`,
...
Każda z nich to **rozkaz pomiarowy**. Numery linii oznaczone „na markerze" pochodzą z `fe33ce8036`
...
- **T1.** Dyżury 205/206/209/210 są scalone na markerze `fe33ce8036`; dyżur 207 nie był.
- **T2.** `fe33ce8036` jest ścisłym przodkiem merge-commitu dyżuru 207 (`68e8cd1ead`) — fast-forward
...
`fe33ce8036`, dostaje mechanizm dyżuru 207 (flagę `ENABLE_TERESA_TOOL_LOOP_WRITE`, writer
