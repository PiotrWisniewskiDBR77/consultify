> ★★ **AKTUALIZACJA MARKERA (31.08, nadzorca).** Marker podniesiony do `3dda45820b`.
...
```bash
git -C "$VAULT" log --oneline 3dda45820b..github-backup/codex/m03-admin-20260824
git -C "$VAULT" diff --name-only 3dda45820b..github-backup/codex/m03-admin-20260824
```
...
```bash
git -C "$WT" diff --name-only 3dda45820b..HEAD
```
...
git merge-base --is-ancestor 3dda45820b github-backup/codex/m03-admin-20260824 \
...
git log --oneline 3dda45820b..github-backup/codex/day207-write-proposal-20260831 | wc -l
...
markera `3dda45820b`. **Dyżur 207, potrzebny do ogniwa 3, nie był** przodkiem markera w chwili
jego ustalenia.

**(K2) ★★ Ale 207 wszedł na linię integracyjną PO markerze — i to jest zwykły postęp trunk, nie
rozjazd na obcą gałąź.** Zmierzone: `git merge-base 3dda45820b 68e8cd1ead` zwraca `3dda45820b` —
...
worktree, zbudowany per standardowa procedura `§0.1` **dokładnie na markerze** `3dda45820b`,
...
Każda z nich to **rozkaz pomiarowy**. Numery linii oznaczone „na markerze" pochodzą z `3dda45820b`
...
- **T1.** Dyżury 205/206/209/210 są scalone na markerze `3dda45820b`; dyżur 207 nie był.
- **T2.** `3dda45820b` jest ścisłym przodkiem merge-commitu dyżuru 207 (`68e8cd1ead`) — fast-forward
...
`3dda45820b`, dostaje mechanizm dyżuru 207 (flagę `ENABLE_TERESA_TOOL_LOOP_WRITE`, writer
