...
Zmierzone dziś (tip `e96e003abd`): narzędzie czatu `generate_initiative`
...
- **Każdą cytowaną linię kodu/dokumentu sprawdzasz sam przed wklejeniem do
  ...
  `e96e003abd`, ale pliki żyją (repo dzielone z dyżurami równoległymi) —
