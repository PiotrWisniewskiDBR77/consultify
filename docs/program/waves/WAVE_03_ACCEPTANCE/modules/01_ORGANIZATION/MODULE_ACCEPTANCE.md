...
|---|---|---|---|
| G00 | Scope, routes, dependencies, 82-task links and exclusions | `IN_PROGRESS` | Initial contract recorded; authoritative task-link audit pending. |
