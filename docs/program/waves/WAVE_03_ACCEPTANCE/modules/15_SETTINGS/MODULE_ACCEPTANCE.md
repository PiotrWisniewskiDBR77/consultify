...
ID: `SET`
Routes: `/settings`
Current gate: `OWNER_UI_DIRECTION_ACCEPTED / DAY55_TECHNICAL_PARTIAL / OWNER_REVIEW_PENDING`
...
| G15 | Integrator self-QA and impacted regression | `PASS_FOCUSED / FULL_BROWSER_AND_FINAL_SCOPE_PENDING` | Day 55 focused tests and real-PG suites are recorded per package in the report; 8 D.1 and 4 F.2 harness screenshots exist. B.1 full browser runtime, Help 50/50 and F.1 8/8 groups remain evidence-missing. |
