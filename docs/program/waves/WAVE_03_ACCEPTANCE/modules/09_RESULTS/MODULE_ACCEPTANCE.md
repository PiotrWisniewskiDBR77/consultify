...
| G01 | Exact baseline and client/server/runtime/DB/migrations | `PASS_FOR_EXACT_RUNTIME_PREFLIGHT` | Exact source `fd4a7bcbc609`; dirty fingerprint `578712d7ac61ae0cd7adba3bfbe3c21f179de0dc9cd9836170e2020c34b56889`; retained FINAL fixture DB `consultify_w3_results_owner_final_20260821_c`; exact runtime `3968/3969`. Health, readiness and frontend were `200`; server/client build identity, `817` migrations, marker and manifest SHA were verified. The owned runtime was identity-stopped after browser replay while preserving DB/manifest. This is not owner or release approval. |
