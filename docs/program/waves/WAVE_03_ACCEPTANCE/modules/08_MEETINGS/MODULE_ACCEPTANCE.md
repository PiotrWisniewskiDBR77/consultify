...
|---|---|---|---|---|---|
| _prepare before G07_ | `/meeting` | _pending_ | Create note → inspect proposal → approve/reject → inspect receipt | Live transcript provider | Meeting flow, action extraction, approval trust, follow-up clarity |
