...
ID: `FIN`
Routes: `/finance`
Current gate: `NOT_STARTED / FIN_UI_CANON_PARTIAL`
...
|---|---|---|---|
| G00 | Scope, routes, dependencies, 82-task links and exclusions | `NOT_STARTED` | `FIN-UI-CANON-001` |
...
Accepted SHA: —
Date: —
Accepted-out/deferred: `FIN-MVP-CUTOVER-001` remains later-wave scope unless a Wave 3 blocker exposes direct dependency.
Evidence manifest: —
