...
| G06 | Desktop/tablet, PL/EN, themes, states, a11y, console/HTTP | `NOT_STARTED` | Dyżur 284: pełna macierz 8 kadrów na każdy ekran A/B; pomiar czerwony (pozostały zwinięte sekcje i/lub naruszenia axe, błędy renderu są w rejestrze). Poprzedni stan bramki: `PASS_TECHNICAL / OWNER_QUALITY_DEBT_OPEN`. |
