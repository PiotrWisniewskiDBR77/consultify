...
| G06 | Desktop/tablet, PL/EN, themes, states, a11y, console/HTTP | `NOT_STARTED` | Dyżur 284: pełna macierz 8 kadrów na każdy ekran A/B; pomiar czerwony (pozostały zwinięte sekcje i/lub naruszenia axe, błędy renderu są w rejestrze). Poprzedni stan bramki: `PARTIAL_OWNER_PACKET_20_OF_20_WITH_FINDINGS / DAY120_FIXTURE_INSIGHT_MEASURABLE_6_OF_6_OWNER_ACCEPTANCE_PENDING`. |
