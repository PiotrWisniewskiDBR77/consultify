...
| 3 | Tools | `/discovery-tools/*` -> `src/components/Discovery/DiscoveryToolsHub` and governed tool workspaces | `server/scripts/seed-wave3-tools-owner-review.ts` | `modules/03_TOOLS/MODULE_ACCEPTANCE.md` | Retained Dynamic SWOT proof exists; final-candidate replay and owner quality decision remain open. |
