...
| wszystkie | Czy zaakceptować brak pełnego baseline Vitest po OOM i oprzeć bramkę wyłącznie na testach celowanych? | Nie. | Po Tak pełna bramka regresji zostałaby świadomie osłabiona; rekomendacja: podzielić baseline na deterministyczne shardy z limitem pamięci. |
