...
| Historia aktywności | `notificationCardContract.ts:171-198` | etykieta „HISTORIA”; zrzut | dziennik aktywności → writer zdarzeń `notificationService.ts` | etykieta inna | kosmetyka |
...
| Typ karty „Notification” | kontrakt/rejestr: polska nazwa „Powiadomienie” | `NotificationDetailView.tsx`; zrzut | i18n UI | angielski | blokuje MVP |
