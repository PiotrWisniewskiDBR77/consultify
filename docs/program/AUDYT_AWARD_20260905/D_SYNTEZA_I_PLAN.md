...
| P7 | **Nawigacja KPI po myśli właściciela** | Rejestr → lista zestawienia z opisem i pozycjami → karta pojedynczego wskaźnika; analogicznie dla OKR | Wyniki | M | P3 | Otwarcie rejestru i trzy kliknięcia prowadzą do karty wskaźnika, bez skrótów i ślepych uliczek |
