...
| linia integracyjna | `~/Developer/wt/fable-inicjatywy` = `b4b5fe48af` (F3 scalone 02:20; blok Codexa 1 + C1/C2-FIX, F5, raporty A1/A2/A3, instrukcje Codex 2/3) — NIE wdrożona |
| baza dla Codexa | `origin/integracja/20260911` = `b4b5fe48af` (marker Codexa 2/3 pozostaje `19440011e9`) (push tam nie buduje niczego) |
...
2. N1 — `wt/n1-karty-a` (Wniosek/Decyzja/Powiadomienie), `a82ba1278483781e0.output`. 3. N2 — `wt/n2-karty-b` (Sesja wywiadu/Wzorzec/Karta działania), `aa282349fbc23d636.output`. Obie na `3c7af01835` (linia + 18 commitów Codexa P13-A + odbiór A1). 4. F3 — SCALONE (`7101c94304`, `e7ec2f8ac1`). 5. F4 — `wt/f4-ocena-rodzina`, `a1ebef6c9843af767.output`.
