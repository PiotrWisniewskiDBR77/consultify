...
| ekran | cytat doslowny | data | decyzja pierwotna | klasyfikacja | uzasadnienie |
| --- | --- | --- | :-: | :-: | --- |
| `results-three-pairs` | „To jest jakis hisotryczny ekran. chyba juz tem dawno nie wyglada. - mam nadzieje" | 2026-09-01 05:54 | `nie` | `DO_NAPRAWY` | Wlasciciel twierdzi, ze ekran w rejestrze nie odpowiada dzisiejszemu produktowi — to sprawdzalne przez porownanie kadru z aplikacja. |
...
| 4 | `results-three-pairs` | Wyniki | R11 kadr przyrzadu | Ekran w rejestrze pokazuje dzisiejszy widok Wynikow (te same Menu 2/3 co w produkcie) albo zostaje z rejestru zdjety. |
