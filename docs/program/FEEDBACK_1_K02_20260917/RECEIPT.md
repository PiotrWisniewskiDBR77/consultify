...
Zbiorczy przebieg testów skupionych przed uruchomieniem bazy: **43 PASS, 16 SKIP**; pominięte przypadki były testami wymagającymi RealPG. Następnie całą tę część wykonano osobno na własnej bazie, jak opisano niżej.
