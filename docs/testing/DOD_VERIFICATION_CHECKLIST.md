# DoD Verification Checklist — V2 + V3

> Lista obszarów do sprawdzenia wyekstrahowana z DoD każdego taska.
> Źródło: `docs/product/DOD_INVENTORY_V2_V3.md`, `docs/product/V3_IMPLEMENTATION_PROGRAM.md`, `docs/plans/V2_TASK_SPECS.md` 

| Metryka | Wartość |
| --- | --- |
| V3 tasków | 54 |
| V2 tasków | 122 |
| **Łącznie checkpointów** | **513** |

**Podział:** V3 ~157 | V2 ~356 (T008 bez DoD)

---

## V3 — Platform & Product (54 taski)
