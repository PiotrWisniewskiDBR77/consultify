...
| 8 | Results | beta | [`modules/07_rezultaty/CURRENT_CONTRACT.md`](modules/07_rezultaty/CURRENT_CONTRACT.md) | skonsolidowany · **KOREKTA 1.09: OKR i ROI SĄ widoczne na demo** (zmienna środowiskowa omija flagi); mianownik `135` **wycofany** · **SSOT 05.09: [`modules/07_rezultaty/SSOT_WYNIKI_KPI_OKR_ROI.md`](modules/07_rezultaty/SSOT_WYNIKI_KPI_OKR_ROI.md)** (trzy poziomy, wzorce raportów KPI/OKR, metodyka ROI, mechanika odchylenia) |
