# M11 — Narzędzia — Karta audytu (Protokół V1)

**Data:** YYYY-MM-DD · **Branch:** `<branch>` (commit `<sha>`) · **Audytor:** Claude + agenci (KOD/TESTY/KANON+SEC)
**Wejścia:** _MODULE_MAP_V2 wpis M11 · inwentarz `docs/audit/2026-06-11/inventory/INV_C_wywiad_narzedzia_audyty.md` · poprzednia karta `<link>` · plany `<linki>`
