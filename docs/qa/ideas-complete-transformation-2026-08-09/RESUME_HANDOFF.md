...
| E02 DoD machine check | DONE | New `scripts/check-action-coverage.{sh,awk}` ratchet (baseline 288), wired into `check-actions.sh` as R10 + pre-commit; negative-control proven to bind |
