...
_This document is the canonical source of truth for PMO standards compliance in Consultinity._
_All development must align with this specification._
_Deviations require explicit approval and documentation update._
