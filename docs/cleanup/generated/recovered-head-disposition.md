...
- `REPRESENTED_SUPERSEDED`: **86**
- `REPRESENTED_CANONICAL`: **66**
- `REJECTED_DESTRUCTIVE_SNAPSHOT`: **4**
- `INTEGRATED_CANONICAL`: **20**
- `CANDIDATE_INTEGRATION`: **10**
- `OWNER_DECISION_REQUIRED`: **0**
- `SEMANTIC_REVIEW_REQUIRED`: **20**
