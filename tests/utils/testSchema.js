export const TEST_SCHEMA = [
  ...
  `CREATE TABLE IF NOT EXISTS tasks (
        ...
        FOREIGN KEY(backup_assignee_id) REFERENCES users(id) ON DELETE SET NULL,
  ...
  // audit_log (legacy/canonical) table used by multiple routes/services
  ...
  `CREATE TABLE IF NOT EXISTS user_data_retention (
        user_id TEXT PRIMARY KEY,
        retention_period TEXT DEFAULT '365',
  ...
  `CREATE INDEX IF NOT EXISTS idx_data_export_requests_user_time ON data_export_requests(user_id, requested_at DESC)`,
  ...
  `CREATE INDEX IF NOT EXISTS idx_account_deletion_requests_user_time ON account_deletion_requests(user_id, requested_at DESC)`,
  ...
  `CREATE INDEX IF NOT EXISTS idx_security_policies_org ON security_policies(organization_id, category, name)`,
  ...
  `CREATE INDEX IF NOT EXISTS idx_trusted_devices_user_time ON trusted_devices(user_id, trusted_at DESC)`,
  ...
  `CREATE INDEX IF NOT EXISTS idx_user_settings_history_user_time ON user_settings_history(user_id, changed_at DESC)`,
  ...
  `CREATE INDEX IF NOT EXISTS idx_user_settings_templates_user_name ON user_settings_templates(user_id, name)`,
  ...
  `CREATE TABLE IF NOT EXISTS interview_assignments (
        ...
        FOREIGN KEY(organization_id) REFERENCES organizations(id) ON DELETE CASCADE,
        FOREIGN KEY(project_id) REFERENCES projects(id) ON DELETE SET NULL,
        FOREIGN KEY(template_id) REFERENCES interview_library_templates(id) ON DELETE SET NULL,
  ...
  `INSERT OR IGNORE INTO interview_question_templates (id, category, question_text, sort_order)
        VALUES
        ('tpl_strategy_1', 'strategy', 'What is the current strategy?', 1),
        ('tpl_operations_1', 'operations', 'How do operations run today?', 1),
        ('tpl_digital_1', 'digital', 'What systems support delivery?', 1),
        ('tpl_people_1', 'people', 'How is the team structured?', 1),
        ('tpl_finance_1', 'finance', 'How do you track cost/ROI?', 1)`,
  `INSERT OR IGNORE INTO interview_library_templates (id, organization_id, name, description, category, version, status)
        VALUES ('lib_tpl_1', NULL, 'Discovery Basic', 'Seed template for smoke', 'strategy', 1, 'active')`,
  `INSERT OR IGNORE INTO interview_library_template_questions (id, template_id, category, question_text, sort_order)
        VALUES
        ('lib_tpl_1_q1', 'lib_tpl_1', 'strategy', 'What is your north star metric?', 1),
        ('lib_tpl_1_q2', 'lib_tpl_1', 'strategy', 'What are top 3 risks?', 2)`,
  ...
  `CREATE INDEX IF NOT EXISTS idx_webhook_subscriptions_org_time ON webhook_subscriptions(organization_id, created_at DESC)`,
  ...
  `CREATE INDEX IF NOT EXISTS idx_sso_configs_domain_active ON sso_configs(domain, is_active)`,
  ...
  `CREATE TABLE IF NOT EXISTS imported_reports (
        ...
        mapped_data_json TEXT DEFAULT '{}',
        extraction_details_json TEXT DEFAULT '{}',
        document_metadata_json TEXT DEFAULT '{}',
        target_type TEXT,
        target_id TEXT,
        status TEXT DEFAULT 'pending',
