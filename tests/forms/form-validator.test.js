...
describe('Form Validator Tests', () => {
  ...
  describe('Length Rules', () => {
    ...
    beforeEach(() => {
      validator = createFormValidator({
        password: [rules.minLength(8), rules.maxLength(20)],
      });
    });
  ...
  describe('Number Range Rules', () => {
    ...
    beforeEach(() => {
      validator = createFormValidator({
        age: [rules.min(18, 'Must be 18 or older'), rules.max(120, 'Invalid age')],
      });
    });
  ...
  describe('Custom Rule', () => {
    it('should use custom validation function', () => {
      const validator = createFormValidator({
        username: [rules.custom((value) => !value.includes(' '), 'Username cannot contain spaces')],
      });
