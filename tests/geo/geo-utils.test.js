...
describe('Geo Calculator Tests', () => {
  ...
  it('should calculate distance', () => {
    ...
    const distance = geo.distance(40.7128, -74.006, 34.0522, -118.2437);
    expect(distance).toBeGreaterThan(3900);
    expect(distance).toBeLessThan(4000);
  });

  it('should calculate bearing', () => {
    const bearing = geo.bearing(40.7128, -74.006, 34.0522, -118.2437);
  ...
  it('should calculate bounding box', () => {
    const box = geo.boundingBox(40.7128, -74.006, 10);
...
describe('Geocoder Tests', () => {
  ...
  it('should reverse geocode', async () => {
    const result = await geocoder.reverse(40.7128, -74.006);
...
describe('Location Search Tests', () => {
  ...
  beforeEach(() => {
    ...
    search.add('store-1', 40.7128, -74.006, { name: 'NYC Store' });
    search.add('store-2', 40.758, -73.9855, { name: 'Times Square' });
    search.add('store-3', 34.0522, -118.2437, { name: 'LA Store' });
  });

  it('should find nearby locations', () => {
    const nearby = search.findNearby(40.7128, -74.006, 10);
  ...
  it('should find nearest locations', () => {
    const nearest = search.findNearest(40.7128, -74.006, 2);
  ...
  it('should include distance in results', () => {
    const nearby = search.findNearby(40.7128, -74.006, 100);
