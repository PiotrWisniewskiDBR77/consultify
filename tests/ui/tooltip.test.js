    ...
    getBestPosition: (targetRect, tooltipRect, viewportWidth, viewportHeight, offset = 8) => {
      ...
      for (const pos of positions) {
        ...
        const fitsHorizontally =
          calculated.x >= 0 && calculated.x + tooltipRect.width <= viewportWidth;
        const fitsVertically =
          calculated.y >= 0 && calculated.y + tooltipRect.height <= viewportHeight;
...
describe('Position Calculator Tests', () => {
  ...
  it('should find best position', () => {
    const result = calculator.getBestPosition(targetRect, tooltipRect, 800, 600);
