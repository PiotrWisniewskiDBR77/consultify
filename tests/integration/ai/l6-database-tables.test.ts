...
describe('L6.14: AI Database Tables', () => {
    ...
    describe('Embedding Tables Schema', () => {
        it('should define ai_knowledge_embeddings table schema', () => {
            const schema = {
                ...
                requiredColumns: ['id', 'embedding', 'chunk_text', 'metadata', 'source_type', 'organization_id'],
    ...
    describe('Memory Tables Schema', () => {
        it('should define ai_user_memory table schema', () => {
            const schema = {
                ...
                requiredColumns: ['id', 'user_id', 'preferences', 'expertise', 'recent_topics',
    ...
    describe('Learning Tables Schema', () => {
        ...
        it('should define ai_learning_patterns table schema', () => {
            const schema = {
                ...
                requiredColumns: ['id', 'pattern_type', 'pattern_data', 'confidence_score',
        ...
        it('should define ai_instruction_suggestions table schema', () => {
            const schema = {
                ...
                requiredColumns: ['id', 'suggested_instruction', 'category', 'reason',
    ...
    describe('LLM Provider Tables Schema', () => {
        ...
        it('should define llm_usage_logs table schema', () => {
            const schema = {
                ...
                requiredColumns: ['id', 'user_id', 'organization_id', 'model', 'input_tokens',
    ...
    describe('Table Count Summary', () => {
        ...
        it('should verify database tables if available', async () => {
            ...
            const aiTables = [
                'conversations', 'conversation_messages', 'ai_knowledge_embeddings',
                'ai_user_memory', 'organization_memory', 'ai_feedback',
                'ai_learning_patterns', 'ai_instruction_suggestions',
                'ai_user_style_profiles', 'ai_style_learning_patterns',
                'llm_providers', 'llm_usage_logs',
            ];
