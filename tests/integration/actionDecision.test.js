...
describe('Action Decisions API Integration', () => {
    ...
    beforeAll(async () => {
        ...
        const proposals = new Map([
            ['proposal-1', { id: 'proposal-1', status: 'PENDING', organizationId: 'org-1', action: 'TASK_CREATE' }],
            ['proposal-2', { id: 'proposal-2', status: 'APPROVED', organizationId: 'org-2', action: 'MEETING_SCHEDULE' }]
        ]);
        ...
        app.get('/api/ai/actions/audit', requireAuth, (req, res) => {
            ...
            const orgDecisions = Array.from(decisions.values())
                .filter(d => {
