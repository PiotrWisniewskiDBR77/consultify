...
describe('SuperAdmin API Endpoints', () => {
    ...
    beforeAll(async () => {
        ...
        app.post('/api/superadmin/impersonate', requireAuth, requireSuperadmin, (req: any, res: any) => {
        ...
        app.get('/api/superadmin/organizations/:id', requireAuth, requireSuperadmin, (req: any, res: any) => {
