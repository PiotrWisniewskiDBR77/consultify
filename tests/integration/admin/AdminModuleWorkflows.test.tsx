...
describe('Admin Module Integration', () => {
  ...
  describe('User Management Workflow', () => {
    ...
    it('should display users in data table', () => {
      renderWithProviders(<EnhancedDataTable data={mockUsers} columns={columns} />);
  ...
  describe('Data Table Operations', () => {
    ...
    it('should render table with all data', () => {
      renderWithProviders(<EnhancedDataTable data={mockData} columns={columns} />);
    ...
    it('should handle empty data gracefully', () => {
      renderWithProviders(<EnhancedDataTable data={[]} columns={columns} />);
  ...
  describe('AdminSidebar Integration', () => {
    ...
    it('should show pending invites badge', () => {
      renderWithProviders(
        <AdminSidebar activeSection="overview" onSectionChange={vi.fn()} pendingInvites={5} />
      );
  ...
  describe('Error Handling', () => {
    it('should render table even with missing data fields', () => {
      ...
      renderWithProviders(<EnhancedDataTable data={incompleteData} columns={columns} />);
