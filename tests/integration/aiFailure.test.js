...
describe('AI Failure Resilience', () => {
    ...
    beforeAll(async () => {
        ...
        const mockAiService = {
            ...
            setAvailable: (val) => { aiServiceAvailable = val; }
        };
        ...
        const tasks = [
            { id: 't1', title: 'Task 1', status: 'TODO', organizationId: 'org-1' }
        ];
        ...
        app.get('/api/initiatives', requireAuth, async (req, res) => {
            ...
            const orgInitiatives = initiatives.filter(i => i.organizationId === req.user.organizationId);
