...
describe('Project Endpoints Integration', () => {
    ...
    beforeAll(() => {
        ...
        app.get('/api/projects', authMiddleware, (req, res) => {
            const orgProjects = Array.from(projects.values()).filter(p => p.organizationId === req.user.orgId);
        ...
        app.post('/api/projects', authMiddleware, (req, res) => {
            ...
            const project = { id, name, description, status: status || 'active', organizationId: req.user.orgId };
