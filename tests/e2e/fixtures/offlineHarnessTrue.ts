...
// ★ FORKED for the 2026-08-13 "true E2E" run — this agent's own server/
// dev-render/Postgres (never another session's `mac-pg-s1b`/55500 or ports
// 42750/42820, which belong to a different concurrent worktree).
export const FRONTEND_URL = process.env.E2E_OFFLINE_FRONTEND_URL ?? 'http://localhost:42802';
export const DATABASE_URL =
  process.env.E2E_OFFLINE_DATABASE_URL ?? 'postgresql://t:t@localhost:55540/t_test';

export const ORG_ID = 'test-org-id';
export const USER_ID = 'test-user-id';

export const SCREENSHOT_DIR = path.resolve(process.cwd(), 'docs/qa/e2e-true-2026-08-13/offline-and-two-tabs');
export const HAR_DIR = path.resolve(process.cwd(), 'docs/qa/e2e-true-2026-08-13/offline-and-two-tabs/har');
