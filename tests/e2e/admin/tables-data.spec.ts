...
test.describe('Admin Panel Tables and Data', () => {
  ...
  test.describe('Team Module - Users Table', () => {
    test.beforeEach(async ({ page }) => {
      ...
      // Switch to users tab
      const usersTab = page
        .locator('button:has-text("Users"), [role="tab"]:has-text("Users"), [data-value="users"]')
        .first();
  ...
  test.describe('Team Module - Groups Table', () => {
    test.beforeEach(async ({ page }) => {
      ...
      const groupsTab = page
        .locator(
          'button:has-text("Groups"), [role="tab"]:has-text("Groups"), [data-value="groups"]'
        )
        .first();
  ...
  test.describe('Team Module - Invitations Table', () => {
    test.beforeEach(async ({ page }) => {
      ...
      const invitationsTab = page
        .locator(
          'button:has-text("Invitations"), [role="tab"]:has-text("Invitations"), [data-value="invitations"]'
        )
        .first();
  ...
  test.describe('Workspace Module - Projects Table', () => {
    test.beforeEach(async ({ page }) => {
      ...
      const projectsTab = page
        .locator(
          'button:has-text("Projects"), [role="tab"]:has-text("Projects"), [data-value="projects"]'
        )
        .first();
  ...
  test.describe('AI Module - Models & Providers Table', () => {
    test.beforeEach(async ({ page }) => {
      ...
      const modelsTab = page
        .locator(
          'button:has-text("Models"), [role="tab"]:has-text("Models"), [data-value="models"]'
        )
        .first();
  ...
  test.describe('Billing Module - Payment Methods Table', () => {
    test.beforeEach(async ({ page }) => {
      ...
      const paymentTab = page
        .locator(
          'button:has-text("Payment"), [role="tab"]:has-text("Payment"), [data-value="payment"]'
        )
        .first();
  ...
  test.describe('Billing Module - Invoices Table', () => {
    test.beforeEach(async ({ page }) => {
      ...
      const invoicesTab = page
        .locator(
          'button:has-text("Invoices"), [role="tab"]:has-text("Invoices"), [data-value="invoices"]'
        )
        .first();
  ...
  test.describe('Security Module - API Keys Table', () => {
    test.beforeEach(async ({ page }) => {
      ...
      const accessTab = page
        .locator(
          'button:has-text("API Keys"), [role="tab"]:has-text("API Keys"), [data-value="access"]'
        )
        .first();
  ...
  test.describe('Security Module - Audit Log Table', () => {
    test.beforeEach(async ({ page }) => {
      ...
      const auditTab = page
        .locator('button:has-text("Audit"), [role="tab"]:has-text("Audit"), [data-value="audit"]')
        .first();
  ...
  test('should verify table structure for all tables', async ({ page }) => {
    ...
    for (const { module, tab, name } of tablesToTest) {
      ...
      const tabButton = page
        .locator(
          `button:has-text("${tab}"), [role="tab"]:has-text("${tab}"), [data-value="${tab}"]`
        )
        .first();
