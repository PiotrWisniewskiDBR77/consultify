...
test.describe('Admin Panel Navigation', () => {
    ...
    const adminModules = [
        { name: 'Overview', route: '/admin/overview', selector: '[data-testid="overview-module"], .overview-module, [class*="Overview"]' },
        { name: 'Organization', route: '/admin/organization', selector: '[data-testid="organization-module"], .organization-module, [class*="Organization"]' },
        { name: 'Team', route: '/admin/team', selector: '[data-testid="team-module"], .team-module, [class*="Team"]' },
        { name: 'Workspace', route: '/admin/workspace', selector: '[data-testid="workspace-module"], .workspace-module, [class*="Workspace"]' },
        { name: 'AI', route: '/admin/ai', selector: '[data-testid="ai-module"], .ai-module, [class*="AI"]' },
        { name: 'Billing', route: '/admin/billing', selector: '[data-testid="billing-module"], .billing-module, [class*="Billing"]' },
        { name: 'Security', route: '/admin/security', selector: '[data-testid="security-module"], .security-module, [class*="Security"]' },
        { name: 'Feedback', route: '/admin/feedback', selector: '[data-testid="feedback-module"], .feedback-module, [class*="Feedback"]' },
    ];
    ...
    for (const module of adminModules) {
        test(`should navigate to ${module.name} module via sidebar`, async ({ page }) => {
            ...
            const sidebarButton = page.locator(`button:has-text("${module.name}"), a:has-text("${module.name}"), [aria-label*="${module.name}"]`).first();
    ...
    test('should synchronize URL when clicking sidebar buttons', async ({ page }) => {
        ...
        const teamButton = page.locator('button:has-text("Team"), a:has-text("Team"), [aria-label*="Team"]').first();
