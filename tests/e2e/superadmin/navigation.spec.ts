...
test.describe('SuperAdmin Navigation', () => {
    ...
    test('should navigate to Overview module', async ({ page }) => {
        ...
        const overviewContent = page.locator('[data-testid="overview-module"], .overview-module, [class*="Overview"]').first();
    ...
    test('should navigate to Customers module', async ({ page }) => {
        ...
        const customersContent = page.locator('[data-testid="customers-module"], .customers-module, [class*="Customers"]').first();
    ...
    test('should navigate to AI Infrastructure module', async ({ page }) => {
        ...
        const aiInfraContent = page.locator('[data-testid="ai-infrastructure-module"], .ai-infrastructure-module, [class*="Infrastructure"]').first();
    ...
    test('should navigate to AI Development module', async ({ page }) => {
        ...
        const aiDevContent = page.locator('[data-testid="ai-development-module"], .ai-development-module, [class*="Development"]').first();
    ...
    test('should navigate to AI Operations module', async ({ page }) => {
        ...
        const aiOpsContent = page.locator('[data-testid="ai-operations-module"], .ai-operations-module, [class*="Operations"]').first();
    ...
    test('should navigate to System module', async ({ page }) => {
        ...
        const systemContent = page.locator('[data-testid="system-module"], .system-module, [class*="System"]').first();
    ...
    test('should navigate to Content module', async ({ page }) => {
        ...
        const contentModule = page.locator('[data-testid="content-module"], .content-module, [class*="Content"]').first();
    ...
    test('should navigate to Revenue module', async ({ page }) => {
        ...
        const revenueContent = page.locator('[data-testid="revenue-module"], .revenue-module, [class*="Revenue"]').first();
    ...
    test('should navigate to Security module', async ({ page }) => {
        ...
        const securityContent = page.locator('[data-testid="security-module"], .security-module, [class*="Security"]').first();
    ...
    test('should navigate to Analytics module', async ({ page }) => {
        ...
        const analyticsContent = page.locator('[data-testid="analytics-module"], .analytics-module, [class*="Analytics"]').first();
    ...
    test('should navigate to Configuration module', async ({ page }) => {
        ...
        const configContent = page.locator('[data-testid="configuration-module"], .configuration-module, [class*="Configuration"]').first();
        await expect(configContent).toBeVisible({ timeout: 5000 });
    });

    test('should redirect legacy /superadmin/ai-platform to /superadmin/ai-infrastructure', async ({ page }) => {
    ...
    test('should update URL when clicking sidebar navigation', async ({ page }) => {
        ...
        const customersLink = page.locator('a[href*="/superadmin/customers"], button:has-text("Customers"), [data-section="customers"]').first();
