...
const CREDS = {
  email: process.env.M14_EMAIL || process.env.TEST_USER_EMAIL || 'test@localhost',
  password: process.env.M14_PASSWORD || process.env.TEST_USER_PASSWORD || 'testpassword123',
};
