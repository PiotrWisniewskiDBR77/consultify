...
test.describe('AI Playbooks Flow', () => {
    ...
    test.describe('SuperAdmin - Playbook Templates', () => {
        test.beforeEach(async ({ page }) => {
            ...
            const playbookLink = page.locator('text=Playbook Templates').or(page.locator('a[href*="playbook"]')).first();
        ...
        test('should display playbook templates list', async ({ page }) => {
            ...
            const templatesContainer = page.locator('div.grid, [data-testid="templates-list"], main').first();
    ...
    test.describe('Admin - Playbook Runs', () => {
        test.beforeEach(async ({ page }) => {
            ...
            const playbookRunsLink = page.locator('text=Playbook Runs').or(page.locator('a[href*="playbook-runs"]')).first();
        ...
        test('should show available templates to start a run', async ({ page }) => {
            ...
            const startRunButton = page.locator('button:has-text("Start New Playbook")').or(page.locator('button:has-text("New Run")'));
