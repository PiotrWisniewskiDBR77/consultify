...
describe('Latency Performance Tests', () => {
    ...
    it('should maintain acceptable latency distribution under normal load', async () => {
        ...
        const p50Index = Math.floor(requestCount * 0.50);
        ...
        console.log(`Latency Stats: P50=${p50.toFixed(2)}ms, P95=${p95.toFixed(2)}ms, P99=${p99.toFixed(2)}ms`);
    ...
    it('should not degrade significantly under simulated high latency', async () => {
        ...
        const duration = await fetchWithSimulatedLatency(`${BASE_URL}/api/health`, simulatedNetworkDelay);
