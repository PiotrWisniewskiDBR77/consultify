...
describe('Basic Selector Tests', () => {
    ...
    it('should compute derived state', () => {
        const getFilteredUsers = createSelector(
            [getUsers, getFilter],
            (users, filter) => users.filter(u => u.active === filter.active)
        );
...
describe('Parameterized Selector Tests', () => {
    it('should handle parameters', () => {
        ...
        const getItemById = createParameterizedSelector(
            [getItems],
...
describe('Custom Equality Selector Tests', () => {
    it('should use custom equality check', () => {
        ...
        const getProcessedConfig = createSelectorWithEquality(
            [getConfig],
            computeFn,
            deepEqual
        );
...
describe('Selector Composition Tests', () => {
    it('should compose selectors', () => {
        ...
        const getSortedActiveUsers = createSelector(
            [getActiveUsers],
