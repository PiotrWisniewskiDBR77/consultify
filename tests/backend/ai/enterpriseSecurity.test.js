...
import { EnterpriseSecurityService, PII_PATTERNS, RISK_RULES } from '../../../server/services/ai/enterpriseSecurity.js';
    ...
    describe('Risk Assessment', () => {
        describe('assessRisk()', () => {
            ...
            it('should return risk assessment for PII presence', () => {
                // Test that assessRisk returns a valid result
    ...
    describe('Rate Limiting', () => {
        ...
        describe('checkRateLimit()', () => {
            it('should return a result object', async () => {
                // This test requires DB, so just ensure it doesn't crash
                try {
                    const result = await security.checkRateLimit('org-1', 'chat');
                    expect(result).toBeDefined();
                    expect(result.allowed).toBeDefined();
                } catch {
                    // Expected if DB mock doesn't return proper format
