...
const createWorkflowExecutor = () => {
    ...
    return {
        ...
        getRunningWorkflows: () => {
            return [...runningWorkflows.values()]
    ...
    return {
        ...
        getDueSchedules: () => {
            ...
            return [...schedules.values()]
                .filter(s => s.enabled && s.nextRun <= now);
        },
...
describe('Workflow Executor Tests', () => {
    ...
    it('should handle errors', async () => {
        const steps = [{
            id: '1',
            type: 'action',
            handler: () => { throw new Error('Step failed'); },
        }];
...
describe('State Machine Tests', () => {
    ...
    it('should notify on transition', () => {
        ...
        expect(handler).toHaveBeenCalledWith('transition', expect.objectContaining({
            from: 'idle',
            to: 'running',
        }));
    });
