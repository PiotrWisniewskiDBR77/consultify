...
import { calculateAnalytics, generateBurnDownData, generateVelocityData } from '../../src/services/analytics';
import { FullInitiative, Task, TaskStatus, InitiativeStatus } from '../../src/types';
...
describe('Service Test: Analytics', () => {
    describe('calculateAnalytics', () => {
        ...
        it('calculates initiative statistics', () => {
            const initiatives: FullInitiative[] = [
                { id: '1', title: 'Initiative 1', status: InitiativeStatus.DONE, roi: 50 } as unknown as FullInitiative,
                { id: '2', title: 'Initiative 2', status: InitiativeStatus.EXECUTING, roi: 30 } as unknown as FullInitiative,
        ...
        it('calculates total cost and benefit', () => {
            const initiatives: FullInitiative[] = [
                { id: '1', title: 'I1', capex: 10000, firstYearOpex: 5000, annualBenefit: 20000 } as unknown as FullInitiative,
                { id: '2', title: 'I2', capex: 15000, firstYearOpex: 3000, annualBenefit: 25000 } as unknown as FullInitiative,
            ];
    ...
    describe('generateVelocityData', () => {
        ...
        it('uses default 8 weeks when not specified', () => {
            const tasks: Task[] = [{ id: '1', title: 'Task 1' } as unknown as Task];
