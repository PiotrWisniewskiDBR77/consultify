...
const MockPopover: React.FC<{
  ...
  return (
    <div data-testid="popover-container">
      <div data-testid="popover-trigger" onClick={() => setIsOpen(!isOpen)}>
        {trigger}
      </div>
      {isOpen && (
        <div data-testid="popover-content" data-position={position} role="dialog">
          {content}
          <button data-testid="popover-close" onClick={() => setIsOpen(false)}>
            Close
          </button>
        </div>
      )}
