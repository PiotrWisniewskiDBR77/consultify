...
const MockTimeline: React.FC<{
    items?: Array<{ id: string; title: string; description?: string; date: string; icon?: React.ReactNode; status?: 'completed' | 'active' | 'pending' }>;
                ...
                {items.map((item, index) => (
                    ...
                    >
                        ...
                        {index < items.length - 1 && (
                            <div data-testid={`timeline-connector-${index}`} />
                        )}
                    </div>
                ))}
            </div>
...
describe('Timeline Component', () => {
    ...
    describe('Description', () => {
        it('should render description when provided', () => {
            const items = [
                { id: '1', title: 'Event', description: 'Details here', date: '2026-01-01' }
            ];
