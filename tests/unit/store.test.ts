...
describe('Store Test: useAppStore', () => {
    ...
    it('sets chat messages', () => {
        ...
        const messages = [
            ...
            { id: '2', role: 'ai' as const, content: 'Hi there' },
        ];
    ...
    it('clears chat', () => {
        const store = useAppStore.getState();
        store.addChatMessage({ id: '1', role: 'user' as const, content: 'Hello' });
        store.clearChat();
    ...
    it('updates last chat message', () => {
        const store = useAppStore.getState();
        store.addChatMessage({ id: '1', role: 'ai' as const, content: 'Initial' });
