...
describe('SCIM Service', () => {
  ...
  describe('SCIM User Schema', () => {
    ...
    it('should support enterprise user extension', () => {
      ...
      const scimUser = {
        schemas: ['urn:ietf:params:scim:schemas:core:2.0:User', enterpriseSchema],
        [enterpriseSchema]: {
  ...
  describe('Service Provider Configuration', () => {
    it('should expose service provider config endpoint', () => {
      const config = {
        ...
        documentationUri: 'https://docs.consultify.app/scim',
  ...
  describe('Group to Role Mapping', () => {
    it('should map IdP groups to Consultify roles', () => {
      const groupMappings = {
