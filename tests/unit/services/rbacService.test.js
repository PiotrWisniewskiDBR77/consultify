...
describe('RBAC Service', () => {
  ...
  describe('Permission Categories', () => {
    ...
    it('should define team permissions', () => {
      const teamPermissions = ['team:view', 'team:manage', 'team:invite', 'team:remove'];
    ...
    it('should define AI feature permissions', () => {
      const aiPermissions = ['ai:use', 'ai:configure', 'ai:budget:view', 'ai:budget:manage'];
    ...
    it('should define billing permissions', () => {
      const billingPermissions = ['billing:view', 'billing:manage', 'billing:invoices'];
  ...
  describe('System Roles', () => {
    ...
    it('should have Project Manager role', () => {
      const pmRole = {
        ...
        isSystem: true,
        permissions: ['project:*', 'team:view', 'team:invite', 'ai:use'],
      };
    ...
    it('should have Member role', () => {
      const memberRole = {
        name: 'Member',
        isSystem: true,
        permissions: ['project:read', 'project:update', 'team:view', 'ai:use'],
      };
    ...
    it('should have Viewer role with read-only permissions', () => {
      const viewerRole = {
        name: 'Viewer',
        isSystem: true,
        permissions: ['organization:read', 'project:read', 'team:view'],
      };
