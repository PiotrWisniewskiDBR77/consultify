...
const createValueRealizationService = () => {
    ...
    return {
        ...
        getRealizationRate: async (planId) => {
            ...
            const rate = plan.expectedValue > 0
                ? (totalRealized / plan.expectedValue) * 100
                : 0;
...
describe('ValueRealizationService', () => {
    ...
    describe('Plan Creation', () => {
        ...
        it('should require initiative ID', async () => {
            await expect(valueService.createPlan({}))
                .rejects.toThrow('Initiative ID required');
        });
    });
    ...
    describe('Summary', () => {
        it('should calculate summary across all plans', async () => {
            const plan1 = await valueService.createPlan({ initiativeId: 'init-1', expectedValue: 100000 });
            const plan2 = await valueService.createPlan({ initiativeId: 'init-2', expectedValue: 200000 });
