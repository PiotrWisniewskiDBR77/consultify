...
// NOTE: Keeping this suite as TODO until the service is refactored to DI-friendly seams.
describe('AssessmentReportService (TODO - CJS mock limitation)', () => {
    it.todo('covers PDF + Excel report generation once DI seams exist');
    return;
