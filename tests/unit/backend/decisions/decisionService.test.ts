...
describe('DecisionService - Real Production Tests', () => {
    ...
    describe('escalateDecision', () => {
        it('should throw error for non-existent decision', async () => {
            ...
            await expect(
                escalateDecision('non-existent', 'user-123', 'Urgent')
        ...
        it('should throw error for non-pending decision', async () => {
            ...
            await expect(
                escalateDecision('decision-123', 'user-123', 'Urgent')
            ).rejects.toThrow('Cannot escalate decision in status');
        });
    ...
    describe('cancelDecision', () => {
        it('should throw error for made decision', async () => {
            ...
            await expect(
                cancelDecision('decision-123', 'user-123', 'Changed mind')
            ).rejects.toThrow('Cannot cancel a made decision');
        });
