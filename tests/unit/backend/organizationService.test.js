...
describe('OrganizationService', () => {
    ...
    beforeAll(async () => {
        ...
        // Import service
        OrganizationService = (await import('../../../server/src/services/organizationService.js')).default;
    ...
    afterAll(async () => {
        ...
        for (const orgId of createdOrgIds) {
            await new Promise(r => db.run(`DELETE FROM organization_members WHERE organization_id = ?`, [orgId], () => r()));
            await new Promise(r => db.run(`DELETE FROM organizations WHERE id = ?`, [orgId], () => r()));
        }
    ...
    describe('getOrganization', () => {
        ...
        it('should throw for non-existent ID', async () => {
            await expect(OrganizationService.getOrganization('non-existent-id'))
