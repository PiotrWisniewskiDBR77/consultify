...
const createRecommendationEngine = () => {
  ...
  return {
    ...
    getSimilar: async (itemId, limit = 5) => {
      ...
      return scoredItems.sort((a, b) => b.similarityScore - a.similarityScore).slice(0, limit);
    },
    ...
    getTrending: async (options = {}) => {
      ...
      return trending.sort((a, b) => b.trendingScore - a.trendingScore).slice(0, limit);
    },
...
describe('RecommendationEngine', () => {
  ...
  describe('Popularity Tracking', () => {
    it('should increase popularity on completion', async () => {
      ...
      const recommendations = await engine.getRecommendations('user-3', {
        limit: 10,
        excludeViewed: false,
      });
