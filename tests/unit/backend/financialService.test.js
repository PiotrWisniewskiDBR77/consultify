...
describe('FinancialService', () => {
    ...
    describe('Category Analysis', () => {
        it('should group revenue by category', () => {
            financialService.recordTransaction({ type: 'revenue', amount: 5000, category: 'subscription' });
            financialService.recordTransaction({ type: 'revenue', amount: 3000, category: 'subscription' });
