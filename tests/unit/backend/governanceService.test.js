...
describe('GovernanceService', () => {
    ...
    describe('Policy Management', () => {
        it('should create a policy', async () => {
            const policy = await governanceService.createPolicy({
                ...
                type: 'financial',
                rules: [
                    { id: 'r1', name: 'Budget limit', condition: 'budget_under', value: 100000, severity: 'critical' }
                ]
            });
        ...
        it('should list policies by type', async () => {
            await governanceService.createPolicy({ name: 'P1', organizationId: 'org-1', type: 'financial' });
            await governanceService.createPolicy({ name: 'P2', organizationId: 'org-1', type: 'security' });
            await governanceService.createPolicy({ name: 'P3', organizationId: 'org-1', type: 'financial' });
    ...
    describe('Approvals', () => {
        ...
        it('should approve request', async () => {
            ...
            const approved = await governanceService.decide(request.id, 'manager-1', 'approved', 'Looks good');
        ...
        it('should reject request', async () => {
            ...
            const rejected = await governanceService.decide(request.id, 'manager-1', 'rejected', 'Over budget');
        ...
        it('should not allow double decision', async () => {
            ...
            await expect(governanceService.decide(request.id, 'manager-2', 'rejected'))
