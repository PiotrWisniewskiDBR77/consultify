...
const createOnboardingService = () => {
    ...
    const getProgressInternal = (userId) => {
        ...
        return {
            ...
            nextStep: onboardingSteps.find(s => !progress.completedSteps.includes(s.id) && !progress.skippedSteps.includes(s.id))
        };
    };
    ...
    return {
        ...
        completeStep: async (userId, stepId) => {
            ...
            if (progress.completedSteps.length + progress.skippedSteps.length === onboardingSteps.length) {
...
describe('OnboardingService', () => {
    ...
    describe('Starting Onboarding', () => {
        ...
        it('should prevent starting twice', async () => {
            ...
            await expect(onboardingService.start('user-1'))
                .rejects.toThrow('Onboarding already started');
        });
    });
    ...
    describe('Progress Tracking', () => {
        ...
        it('should not allow completing same step twice', async () => {
            ...
            await expect(onboardingService.completeStep('user-1', 'welcome'))
