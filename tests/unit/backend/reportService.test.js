...
const createReportService = () => {
    ...
    const templates = new Map([
        ['executive_summary', { id: 'executive_summary', name: 'Executive Summary', sections: ['overview', 'metrics', 'recommendations'] }],
        ['project_status', { id: 'project_status', name: 'Project Status', sections: ['progress', 'risks', 'timeline'] }],
        ['financial', { id: 'financial', name: 'Financial Report', sections: ['budget', 'spending', 'forecast'] }]
    ]);
...
describe('ReportService', () => {
    ...
    describe('Report Generation', () => {
        ...
        it('should require template and project', async () => {
            await expect(reportService.generate({}))
                .rejects.toThrow('Template ID and Project ID required');
        });
