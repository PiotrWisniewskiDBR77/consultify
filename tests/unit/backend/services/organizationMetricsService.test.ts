...
describe('OrganizationMetricsService', () => {
  ...
  beforeEach(async () => {
    ...
    const { getOrganizationMetricsService } =
      await import('../../../../server/src/services/organizationMetricsService.js');
    ...
    it('should return organization overview with active users', async () => {
      ...
      mockDb.query
        ...
        .mockResolvedValueOnce({
          rows: [{ status: 'active', plan: 'enterprise', trial_ends_at: null }],
        }) // org status
