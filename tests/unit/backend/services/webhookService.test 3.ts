...
describe('WebhookService', () => {
    ...
    describe('Webhook CRUD', () => {
        it('should create webhook', async () => {
            ...
            await new Promise<void>((resolve, reject) => {
                db.run(
                    ...
                    [webhookId, 'org-123', 'https://api.example.com/webhook', JSON.stringify(events), 'secret123'],
        ...
        it('should deactivate webhook after failures', async () => {
            ...
            await new Promise<void>((resolve, reject) => {
                db.run('UPDATE webhooks SET is_active = 0 WHERE id = ? AND failure_count >= 5', [webhookId], (err) => err ? reject(err) : resolve());
            });
    ...
    describe('Webhook Logs', () => {
        it('should log webhook execution', async () => {
            ...
            await new Promise<void>((resolve, reject) => {
                db.run('INSERT INTO webhooks (id, organization_id, url, events) VALUES (?, ?, ?, ?)',
