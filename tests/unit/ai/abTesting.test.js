...
const createABTestingService = () => {
    ...
    return {
        ...
        getVariant: async (promptId, userId) => {
            ...
            const running = Array.from(experiments.values())
                .find(e => e.status === 'running' && e.promptId === promptId);
        ...
        getExperimentStats: async (id) => {
            ...
            const expOutcomes = Array.from(outcomes.values())
                .filter(o => o.experimentId === id);
