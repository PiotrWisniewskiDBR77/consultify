    ...
    return {
        ...
        getStats: () => {
            return {
                ...
                successRate: storage.length > 0
                    ? storage.filter(e => e.success).length / storage.length
                    : 1,
            };
        },
...
describe('Audit Logger Tests', () => {
    ...
    describe('logAuthentication', () => {
        it('should log successful auth', () => {
            const entry = auditLogger.logAuthentication('user@example.com', 'password', true, { ip: '127.0.0.1' });
