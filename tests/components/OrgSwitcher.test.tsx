...
describe('OrgSwitcher Component', () => {
  ...
  describe('Single Organization', () => {
    it('should support single organization state', () => {
      // When user has only one org, component still shows it
      mockOrgContext.availableOrgs = [
      ...
      // Only one org - may or may not have dropdown trigger
      // Just verify the component renders without error
    });

    it('should render minimal UI in compact mode with single org', () => {
      mockOrgContext.availableOrgs = [
        { id: 'org-1', name: 'Only Org', role: 'OWNER', access_type: 'DIRECT' },
      ];
      ...
      // In compact mode with single org, may render null or minimal
