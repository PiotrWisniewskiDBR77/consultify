    ...
    useTranslation: () => ({
        t: (key: string, options?: any) => {
            if (options?.returnObjects) {
                return {}; // Return empty object so properties are undefined and fallbacks are used
            }
            return key;
        },
        i18n: {
...
import { LevelNavigator } from '../../src/components/assessment/LevelNavigator';
import { LevelDetailCard } from '../../src/components/assessment/LevelDetailCard';
