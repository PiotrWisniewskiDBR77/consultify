...
function makeEditor(opts: { canUndo?: boolean; canRedo?: boolean; active?: string } = {}) {
  const chain: any = {};
  const methods = [
    'focus', 'undo', 'redo', 'toggleBold', 'toggleItalic', 'toggleUnderline',
    'toggleStrike', 'toggleHighlight', 'toggleCode', 'extendMarkRange', 'setLink',
    'unsetLink', 'setTextAlign', 'toggleHeading', 'toggleBulletList', 'toggleOrderedList',
    'toggleTaskList', 'toggleBlockquote', 'clearNodes', 'unsetAllMarks',
  ];
