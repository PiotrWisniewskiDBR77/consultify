...
// D-6 flipped ff_myWorkCalendarV2 to default ON, but this suite specifically
// exercises the pre-V2 task-backed creation flow (implicit entryType, no
// attendees/time fields) — coverage the V2-specific suites
// (CalendarCreateEventModal.v2.test.tsx, .attendees.test.tsx) don't duplicate.
// Pin it to the legacy path explicitly rather than letting it silently ride the
// new default.
