...
import EvidencePanel from '../../../src/components/ai/EvidencePanel';
  ...
  reasoning: [
    {
      ...
      assumptions: ['Current team velocity remains stable', 'No major blockers are introduced'],
      confidence: 0.85,
  ...
  describe('Reasoning Section', () => {
    it('displays reasoning summary', async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByText('Based on the analysis of project metrics and historical data')
        ).toBeInTheDocument();
      });
    });
