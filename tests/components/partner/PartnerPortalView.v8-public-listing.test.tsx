...
function renderView() {
  return render(
    <MemoryRouter initialEntries={['/partner?tab=public-listing']}>
...
describe('PartnerPortalView public listing V8 seam', () => {
  ...
  it('uses the V8 route first for public-listing updates', async () => {
    vi.mocked(V8PartnerApi.updateOrganizationListing).mockResolvedValue({
      success: true,
