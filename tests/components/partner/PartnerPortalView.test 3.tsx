    ...
    describe('Certification Section', () => {
        ...
        it('should show progress bars for in-progress courses', async () => {
            const mockData = {
                success: true,
                data: [
                    { id: '1', name: 'Test Course', status: 'in_progress', progress: 50 },
                ],
            };
    ...
    describe('Resources Section', () => {
        it('should fetch and display resources by category', async () => {
            const mockResourcesData = {
                ...
                data: {
                    documentation: [
                        { id: '1', title: 'Partner Guide', type: 'PDF', size: '2.4 MB' },
                    ],
                    marketing: [
                        { id: '2', title: 'Logo Kit', type: 'ZIP', size: '12 MB' },
                    ],
                    caseStudies: [
                        { id: '3', title: 'Success Story', type: 'PDF', size: '3.2 MB' },
                    ],
                    templates: [
                        { id: '4', title: 'PMO Checklist', type: 'XLSX', size: '450 KB' },
                    ],
                },
            };
