...
const createAriaValidator = () => {
    const validRoles = [
        ...
        'radio', 'radiogroup', 'scrollbar', 'searchbox', 'slider',
        ...
        'form', 'region', 'article', 'document', 'application', 'img',
        'heading', 'list', 'listitem', 'row', 'rowgroup', 'table',
    ...
    return {
        ...
        validateAriaValue: (attribute, value) => {
            const booleanAttrs = ['aria-checked', 'aria-disabled', 'aria-expanded',
                'aria-hidden', 'aria-pressed', 'aria-selected', 'aria-required'];
            const numberAttrs = ['aria-valuenow', 'aria-valuemin', 'aria-valuemax',
