    ...
    describe('File Validator', () => {
        ...
        describe('allowTypes', () => {
            it('should validate file type', () => {
                ...
                expect(validator.validate({ type: 'image/jpeg', name: 'test.jpg', size: 100 }).valid).toBe(true);
                expect(validator.validate({ type: 'application/pdf', name: 'test.pdf', size: 100 }).valid).toBe(false);
            });
        });
