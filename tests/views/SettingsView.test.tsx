    ...
    return (
        <div data-testid="settings-view">
            ...
            <main data-testid="settings-content">
                ...
                {activeTab === 'notifications' && <div data-testid="notifications-section">Notification Settings</div>}
                {activeTab === 'preferences' && <div data-testid="preferences-section">Preference Settings</div>}
            </main>
        </div>
    );
};
