...
const createRequestQueue = () => {
    ...
    return {
        ...
        pause: () => { isPaused = true; },
        resume: () => { isPaused = false; processQueue(); },
        isPaused: () => isPaused,

        setConcurrency: (limit) => { concurrencyLimit = limit; },
...
describe('Network Request & Retry Logic Tests', () => {
    ...
    describe('Fetch with Retry', () => {
        ...
        it('should throw after max retries exceeded', async () => {
            ...
            let error = null;
            const fetchPromise = fetchWithRetry.fetch('/api/fail',
        ...
        it('should use exponential backoff', async () => {
            ...
            let error = null;
            const fetchPromise = fetchWithRetry.fetch('/api/test',
                { _mockFetch: mockFetch },
    ...
    describe('Request Queue', () => {
        it('should process requests in order', async () => {
            ...
            requestQueue.add(async () => { results.push(1); return 1; });
            requestQueue.add(async () => { results.push(2); return 2; });
            requestQueue.add(async () => { results.push(3); return 3; });
        ...
        it('should respect priority ordering', async () => {
            ...
            requestQueue.add(async () => { results.push('high'); }, 10);
            requestQueue.add(async () => { results.push('medium'); }, 5);
        ...
        it('should pause and resume queue', async () => {
            ...
            requestQueue.pause();
            requestQueue.add(async () => { results.push(1); });
