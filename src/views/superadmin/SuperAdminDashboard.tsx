...
const QuickAction: React.FC<{
  ...
  >
    ...
    <div className="flex items-center gap-3 mb-1.5">
      <Icon
        size={18}
        className="text-slate-400 group-hover:text-slate-600 dark:text-slate-400 dark:group-hover:text-slate-300 transition-colors"
      />
...
const ActivityRow: React.FC<{ activity: ActivityItem }> = ({ activity }) => {
  ...
  return (
    <div className="flex items-center gap-3 py-2.5 border-b border-slate-100 dark:border-white/[0.04] last:border-b-0">
      ...
      <span className="text-xs text-slate-500 dark:text-slate-400 truncate px-1.5 py-0.5 rounded bg-slate-100 dark:bg-slate-800/50 font-medium">
        {activity.action}
      </span>
