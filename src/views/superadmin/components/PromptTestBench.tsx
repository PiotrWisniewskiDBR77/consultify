      ...
      <div className="p-4 space-y-4 border-b border-slate-200 dark:border-navy-700">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-3 py-2 rounded-lg border border-slate-200 dark:border-navy-700 bg-slate-50 dark:bg-navy-800 text-slate-900 dark:text-white text-sm resize-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-c-focus"
            rows={2}
          />
