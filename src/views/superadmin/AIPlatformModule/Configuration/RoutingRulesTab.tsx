                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="p-2 rounded-lg bg-slate-200 dark:bg-navy-700 text-slate-600 dark:text-slate-200 hover:bg-danger-500/20 hover:text-danger-500 transition-colors"
                        title="Delete"
                      >
                        <Trash2 size={16} />
                      </button>
