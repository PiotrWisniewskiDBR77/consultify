      ...
      <div className="flex flex-wrap items-center gap-2">
        <div className="relative">
          ...
          <input
            ...
            className="pl-9 pr-3 py-2 rounded-xl border border-slate-200 dark:border-navy-700 bg-white dark:bg-navy-900 text-sm text-slate-800 dark:text-slate-200 outline-none focus:ring-2 focus:ring-c-focus"
          />
        </div>
        ...
        <select
          ...
          className="px-3 py-2 rounded-xl border border-slate-200 dark:border-navy-700 bg-white dark:bg-navy-900 text-sm text-slate-800 dark:text-slate-200 outline-none focus:ring-2 focus:ring-c-focus"
        >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-2 rounded-xl border border-slate-200 dark:border-navy-700 bg-white dark:bg-navy-900 p-3">
                          <label className="space-y-1">
                            ...
                            <select
                              ...
                              className="w-full px-2 py-1.5 rounded-lg border border-slate-200 dark:border-navy-700 bg-white dark:bg-navy-950 text-xs text-slate-800 dark:text-slate-200 outline-none focus:ring-2 focus:ring-c-focus"
                            >
