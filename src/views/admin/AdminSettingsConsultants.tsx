                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <button
                          ...
                          className="text-slate-500 dark:text-slate-400 hover:text-red-400 transition-colors p-2 hover:bg-red-500/10 rounded-lg"
                            ...
                            >
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <button
                                  ...
                                  className="text-slate-500 dark:text-slate-400 hover:text-red-400 transition-colors p-1.5 hover:bg-red-500/10 rounded"
                                  title="Revoke access"
                                >
                                  <X size={14} />
                                </button>
