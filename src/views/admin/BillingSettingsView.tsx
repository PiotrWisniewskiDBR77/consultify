...
export const BillingSettingsView: React.FC<BillingSettingsViewProps> = ({ className = '' }) => {
    ...
    const handleExport = async (type: 'invoices' | 'usage') => {
        ...
        try {
            const response = await fetch(`/api/billing/export?type=${type}&format=${exportFormat}&year=${exportYear}`, {
                headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
            });
                    ...
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                        ...
                        >
                            ...
                            <div className="p-6 border-t border-white/[0.05] flex justify-end gap-3 bg-white/[0.02]">
                                <button onClick={() => setShowAddContact(false)} className="admin-btn admin-btn-subtle">
                                    Cancel
                                </button>
