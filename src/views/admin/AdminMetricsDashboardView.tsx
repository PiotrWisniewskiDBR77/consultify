...
export const AdminMetricsDashboardView: React.FC = () => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 relative">
      ...
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white dark:bg-navy-900 p-6 rounded-xl border border-slate-200 dark:border-navy-700 shadow-sm dark:shadow-none">
        <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {helpMetrics?.byPlaybook?.length > 0 ? (
                helpMetrics.byPlaybook.map((playbook: any, idx: number) => (
                  <div
                    key={idx}
                    className="bg-slate-50 dark:bg-navy-950/50 border border-slate-200 dark:border-navy-700 rounded-xl p-4 hover:border-secondary-500/30 transition-all group"
                  >
                ...
                <div className="col-span-2 text-center py-12 text-slate-500 dark:text-slate-400 italic">
        ...
        <div className="space-y-8">
          <div className="bg-white dark:bg-gradient-to-br dark:from-blue-900/40 dark:to-navy-900 border border-slate-200 dark:border-blue-500/20 rounded-xl p-6 shadow-sm dark:shadow-xl relative overflow-hidden group">
            <div className="absolute -top-12 -right-12 w-32 h-32 bg-slate-100 dark:bg-blue-500/10 rounded-full blur-3xl group-hover:bg-slate-200 dark:group-hover:bg-blue-500/20 transition-all duration-700" />

            <div className="relative z-10">
              <div className="flex items-center gap-2 text-slate-600 dark:text-blue-400 mb-4 font-bold text-xs uppercase tracking-widest">
              ...
              <div className="flex items-center gap-4 pt-4 border-t border-white/20 dark:border-navy-700">
                <div className="flex-1">
                  <div className="flex justify-between text-[10px] font-bold text-slate-600 dark:text-slate-500 mb-1 uppercase">
          ...
          <div className="bg-white dark:bg-navy-900 border border-slate-200 dark:border-navy-700 rounded-xl overflow-hidden shadow-sm dark:shadow-xl">
            ...
            <div className="divide-y divide-slate-200 dark:divide-white/5 max-h-[500px] overflow-y-auto">
              {recentEvents.length > 0 ? (
                ...
                <div className="p-12 text-center text-slate-500 dark:text-slate-400 text-xs italic">
...
const MetricCard: React.FC<MetricCardProps> = ({ title, value, subtitle, icon, trend, color }) => {
  ...
  return (
    <div className="bg-white dark:bg-navy-900/80 border border-slate-200 dark:border-navy-700 rounded-xl p-6 shadow-sm dark:shadow-lg backdrop-blur-sm group hover:border-primary-500/30 dark:hover:border-white/20 transition-all hover:translate-y-[-2px]">
      <div className="flex justify-between items-start mb-4">
        ...
        <div className="flex flex-col items-end">
          ...
          <span className="text-[9px] text-slate-500 dark:text-slate-400 mt-1 uppercase font-bold tracking-tighter">
            v. Prev Month
          </span>
        </div>
      </div>
  ...
  <div className="group">
    <div className="flex items-center gap-4 mb-2 px-2">
      ...
      <div className="flex-1 h-12 relative flex items-center">
        <div className="absolute inset-0 bg-slate-100 dark:bg-white/5 rounded-xl border border-slate-200 dark:border-navy-700" />
        <div
...
const EventRow: React.FC<{ event: any }> = ({ event }) => {
  ...
  return (
    <div className="p-4 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors flex items-center gap-4 group">
      <div className="w-8 h-8 rounded-lg bg-slate-100 dark:bg-navy-950 border border-slate-200 dark:border-navy-700 flex items-center justify-center shrink-0 group-hover:border-primary-500/30 dark:group-hover:border-white/20 transition-all">
        {getIcon()}
      </div>
      <div className="flex-1 min-w-0">
