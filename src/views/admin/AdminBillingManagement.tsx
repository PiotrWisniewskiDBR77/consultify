        ...
        <div className={`space-y-6 ${className}`}>
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    <button onClick={openAddonsModal} className="admin-btn admin-btn-subtle flex items-center gap-2">
                        <Package size={14} />
                        {t('admin.billing.addons', 'Add-ons')}
                    </button>
                    <button onClick={openPlanModal} className="admin-btn admin-btn-accent flex items-center gap-2">
                        <Crown size={14} />
            ...
            <div className="admin-card p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-xs text-slate-500 font-medium uppercase tracking-wider">Billing Email</p>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-xs text-slate-500 font-medium uppercase tracking-wider">Billing Name</p>
                            <p className="text-sm font-medium text-navy-900 dark:text-white">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-xs text-slate-500 font-medium uppercase tracking-wider">Tax ID / VAT</p>
                            <p className="text-sm font-medium text-navy-900 dark:text-white">
            ...
            <div className="admin-card p-6">
                ...
                <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/5 rounded-xl">
                    ...
                    <button className="admin-btn admin-btn-subtle">{t('admin.billing.manage', 'Manage')}</button>
                </div>
            </div>
                ...
                {showPlanModal && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                        <motion.div
                            ...
                            className="bg-white dark:bg-navy-800 border border-slate-200 dark:border-white/10 rounded-2xl shadow-2xl max-w-4xl w-full overflow-hidden flex flex-col max-h-[90vh]"
                        >
                            ...
                            <div className="p-6 overflow-y-auto">
                                ...
                                {planComparison && selectedPlanId && selectedPlanId !== billing?.plan && (
                                    <div className="mt-6 p-4 bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/10 rounded-xl">
                                        ...
                                        <div className="grid grid-cols-2 gap-4 text-sm">
                                            ...
                                            {planComparison.comparison.isUpgrade ? (
                                                <div>
                                                    <p className="text-slate-500">Prorated charge today</p>
                                                ...
                                                <div>
                                                    <p className="text-slate-500">Credit to account</p>
                            ...
                            <div className="p-6 border-t border-slate-200 dark:border-white/5 flex justify-end gap-3 bg-slate-50 dark:bg-white/[0.02]">
                                <button onClick={() => setShowPlanModal(false)} className="admin-btn admin-btn-subtle">
                                    Cancel
                                </button>
                                <button
                ...
                {showAddonsModal && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                        <motion.div
                            ...
                            animate={{ opacity: 1, scale: 1, y: 0 }}
                            exit={{ opacity: 0, scale: 0.95, y: 20 }}
                            className="bg-white dark:bg-navy-800 border border-slate-200 dark:border-white/10 rounded-2xl shadow-2xl max-w-2xl w-full overflow-hidden flex flex-col max-h-[90vh]"
                        >
                            <div className="p-6 border-b border-slate-200 dark:border-white/5 flex items-center justify-between">
                                <h3 className="text-xl font-semibold text-navy-900 dark:text-white flex items-center gap-2">
                                    ...
                                    <div className="space-y-3">
                                        {addons.map((addon) => (
                                            ...
                                            >
                                                ...
                                                <ChevronRight
                                                    size={16}
                                                    className="text-slate-400 group-hover:text-[var(--admin-accent)] transition-colors"
                                                />
                                            </div>
                                        ))}
                                        {addons.length === 0 && (
                                            <p className="text-center py-8 text-slate-500">No add-ons available</p>
                                        )}
                                    </div>
                                ) : (
                                            ...
                                            <div className="mt-4 flex items-center gap-4">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <button
                                                        ...
                                                        className="w-8 h-8 rounded-lg border border-slate-200 dark:border-white/10 flex items-center justify-center text-slate-500 hover:text-white hover:border-white/30"
                                                    >
                                                        -
                                                    </button>
                                                    ...
                                                    <button
                                                        onClick={() =>
                                                            setAddonQuantity(Math.min(10, addonQuantity + 1))
                                                        }
                                                        className="w-8 h-8 rounded-lg border border-slate-200 dark:border-white/10 flex items-center justify-center text-slate-500 hover:text-white hover:border-white/30"
                                                    >
                                                        +
                                        ...
                                        {selectedAddon.type === 'tokens' && (
                                            <div className="flex items-start gap-3 p-3 bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-500/20 rounded-lg">
                                                ...
                                                <p className="text-sm text-amber-700 dark:text-amber-300">
                                                    Token packages are added to your monthly limit immediately and do
                                                    not roll over.
                                                </p>
                                            </div>
                                        )}
                ...
                {showBillingModal && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm shadow-2xl">
                        <motion.div
                            ...
                            animate={{ opacity: 1, scale: 1, y: 0 }}
                            exit={{ opacity: 0, scale: 0.95, y: 20 }}
                            className="bg-white dark:bg-navy-800 border border-slate-200 dark:border-white/10 rounded-2xl shadow-2xl max-w-lg w-full overflow-hidden flex flex-col max-h-[90vh]"
                        >
                            <div className="p-6 border-b border-slate-200 dark:border-white/5 flex items-center justify-between">
                                <h3 className="text-xl font-semibold text-navy-900 dark:text-white flex items-center gap-2">
