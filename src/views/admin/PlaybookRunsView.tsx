    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-1">
          View published playbooks and start runs
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {templates.map((template) => (
            <div
              key={template.id}
              className="bg-white dark:bg-navy-900 rounded-lg border border-gray-200 p-4 hover:shadow-md transition"
            >
      ...
      <div className="mt-8">
        ...
        <div className="bg-white dark:bg-navy-900 rounded-lg border border-gray-200 p-6 text-center text-gray-500">
