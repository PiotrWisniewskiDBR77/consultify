    ...
    <div id="org-report" className="max-w-5xl mx-auto p-6 space-y-8 bg-white dark:bg-gray-900">
        ...
        {!isPublic && (
          <div className="flex gap-2">
            ...
            {onShare && (
              <button
                onClick={onShare}
                className="flex items-center gap-2 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:bg-navy-800 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300 transition-colors"
              >
      ...
      {report.transformationContext?.goals && (
        <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
          ...
          <p className="text-gray-700 dark:text-gray-300">{report.transformationContext.goals}</p>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span
                      className={`px-2 py-0.5 text-xs rounded-full ${statusColors[initiative.status] || statusColors.draft}`}
                    >
                      {initiative.status}
                    </span>
                  </div>
            ...
            {report.upcomingTasks.map((task, idx) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-gray-500 dark:text-gray-400">{task.initiative}</div>
                </div>
                {task.due_date && (
                  <div className="text-sm text-gray-500 dark:text-gray-400">
