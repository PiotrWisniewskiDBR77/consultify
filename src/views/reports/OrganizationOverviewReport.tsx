            ...
            <div className="flex items-start justify-between">
                <div>
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">{report.organization.name}</h1>
                    </div>
                        ...
                        {report.activeBlockers.map((blocker, idx) => (
                            <div key={idx} className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm text-gray-500 dark:text-gray-400">{blocker.initiative}</div>
                                </div>
                            </div>
                        ))}
                    </div>
