    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        {safeItems.length === 0 && !isAdding && (
          <div className="p-8 text-center border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-lg text-slate-400 dark:text-slate-500">
            {emptyStateMessage}
          </div>
        )}
              ...
              >
                ...
                <div className="md:w-20 flex items-center justify-end gap-2 pt-2 md:pt-0">
                  ...
                  <button
                    ...
                    className="p-2 text-slate-400 dark:text-slate-500 hover:bg-slate-100 dark:hover:bg-navy-800/30 rounded"
                  >
                    <X size={18} />
                  </button>
                </div>
            ...
            >
              {columns.map((col) => (
                <div key={col.key} className={`${col.width || 'flex-1'} flex items-center`}>
                  <span className="md:hidden text-xs font-bold text-slate-400 dark:text-slate-500 mr-2 min-w-[80px]">
                    {col.label}:
                  </span>
                  {col.render ? (
                    col.render(item)
              ...
              <div className="md:w-20 flex items-center justify-end gap-2 opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity">
                <button
                  ...
                  className="p-1.5 text-slate-400 dark:text-slate-500 hover:text-blue-500 hover:bg-blue-50 rounded"
                >
                  <Edit2 size={16} />
                </button>
                <button
