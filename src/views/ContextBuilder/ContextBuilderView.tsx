  ...
  return (
    <div className="flex h-full w-full bg-slate-50 dark:bg-navy-950 overflow-hidden relative">
      <SplitLayout>
        ...
        <div
          className={`absolute top-0 right-0 h-full bg-white dark:bg-navy-900 border-l border-slate-200 dark:border-navy-700 shadow-xl transition-all duration-300 z-20 ${isSidebarOpen ? 'w-80 translate-x-0' : 'w-0 translate-x-full'}`}
        >
          <div className="h-full flex flex-col">
            <div className="h-14 border-b border-slate-200 dark:border-navy-700 flex items-center justify-between px-4">
              ...
              <button
                ...
                className="text-slate-400 dark:text-slate-500 hover:text-navy-900"
              >
                {/* Close Icon */}
            ...
            <div className="flex-1 p-4 overflow-y-auto">
              ...
              <div className="mt-6">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-3 p-2 rounded-lg bg-slate-50 dark:bg-navy-800 border border-slate-100 dark:border-navy-700">
        ...
        {!isSidebarOpen && (
          <button
            ...
            className="absolute right-0 top-20 bg-white dark:bg-navy-800 border-l border-t border-b border-slate-200 dark:border-navy-700 p-2 rounded-l-lg shadow-md z-10 text-slate-500 dark:text-slate-400 hover:text-blue-600"
          >
            <FileText size={20} />
          </button>
        )}
