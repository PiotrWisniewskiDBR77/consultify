              ...
              <div className="space-y-4">
                {[
                  ...
                  <label key={cadence.id} className="relative block cursor-pointer group">
                    ...
                    />
                    <div className="flex items-center gap-3 p-3 rounded-lg border border-slate-200 dark:border-navy-700 bg-slate-50/50 dark:bg-navy-950/50 hover:bg-white dark:hover:bg-navy-800 peer-checked:bg-blue-50 dark:peer-checked:bg-blue-900/20 peer-checked:border-blue-500 transition-all">
                      <div className="w-4 h-4 rounded-full border border-slate-300 dark:border-navy-700 peer-checked:border-blue-500 peer-checked:bg-blue-500 flex items-center justify-center shrink-0">
                        <div className="w-1.5 h-1.5 bg-white dark:bg-navy-900 rounded-full opacity-0 peer-checked:opacity-100" />
                      </div>
                      <div>
                        <div className="font-bold text-sm text-navy-900 dark:text-white peer-checked:text-blue-700 dark:peer-checked:text-blue-400">
                          {cadence.label}
                        </div>
