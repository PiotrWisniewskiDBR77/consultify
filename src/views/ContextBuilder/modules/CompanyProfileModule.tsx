...
export const CompanyProfileModule: React.FC = () => {
    ...
    const [activeTab, setActiveTab] = useState<'snapshot' | 'operating' | 'org' | 'history' | 'constraints'>(
        'snapshot',
    );
        ...
        <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {options.map((opt) => (
                    <label
                        key={opt}
                        className="relative flex items-center p-3 rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-navy-900 cursor-pointer hover:border-purple-400 dark:hover:border-purple-500 hover:bg-purple-50/50 dark:hover:bg-purple-900/20 transition-all group"
                    >
                        <input
                            type="radio"
                            name={name}
                ...
                <div className="bg-gradient-to-r from-purple-50 to-white dark:from-purple-900/20 dark:to-navy-900 border border-purple-100 dark:border-purple-800/50 rounded-xl p-4 flex items-start gap-4 shadow-sm relative overflow-hidden animate-in fade-in slide-in-from-top-2">
                    ...
                    <div className="flex-1 z-10 min-w-0">
                        ...
                        <p className="text-xs text-slate-600 dark:text-slate-300 mt-1 leading-relaxed">
                            Based on analysis of <strong>Annual Report 2024.pdf</strong>, the Industry classification
                            seems more specific.
                            <br />
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        <MapPin
                                            className="absolute top-3 left-3 text-slate-400 group-focus-within:text-purple-500 transition-colors z-10"
                                            size={16}
                                        />
                                        <AITextArea
                            ...
                            {[
                                ...
                                <label key={constraint.id} className="relative group cursor-pointer">
                                    ...
                                    <div className="h-full p-5 rounded-2xl border border-slate-200 dark:border-white/5 bg-white dark:bg-navy-900 hover:border-purple-300 dark:hover:border-purple-500/50 transition-all peer-checked:border-purple-500 peer-checked:ring-1 peer-checked:ring-purple-500/50 peer-checked:bg-purple-50/30 dark:peer-checked:bg-purple-900/10 shadow-sm">
                                        ...
                                        <div
                                            className={`grid transition-all duration-300 ease-in-out ${companyProfile.activeConstraints.includes(constraint.id) ? 'grid-rows-[1fr] pt-4 mt-2 border-t border-slate-100 dark:border-white/5' : 'grid-rows-[0fr]'}`}
                                        >
