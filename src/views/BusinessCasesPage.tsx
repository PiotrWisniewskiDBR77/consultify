        ...
        <motion.div {...fade} className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-3">
            {[
              ...
              <div
                key={w.num}
                className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-slate-800/50"
              >
            ...
            <div className="rounded-3xl border border-emerald-200 bg-emerald-50 p-6 dark:border-emerald-500/20 dark:bg-emerald-500/5">
              ...
              <div className="mt-6 space-y-3">
                {[
                  ...
                  <div
                    key={r.label}
                    className="flex items-center justify-between gap-3 rounded-2xl bg-white/70 px-4 py-3 dark:bg-black/10"
                  >
            ...
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6 dark:border-white/10 dark:bg-white/[0.03]">
              ...
              <div className="mt-6 space-y-3">
                {[
                  ...
                  <div
                    key={r.label}
                    className="flex items-center justify-between gap-3 rounded-2xl bg-white px-4 py-3 dark:bg-black/10"
                  >
                    <span className="text-sm text-slate-600 dark:text-slate-300">{r.label}</span>
                    <span className="shrink-0 text-sm font-black text-slate-900 dark:text-white">
                      {r.value}
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-3">
                {[
                  ...
                  <div
                    key={k.label}
                    className="rounded-2xl border border-slate-200 bg-white px-4 py-4 text-center dark:border-white/10 dark:bg-black/10"
                  >
          ...
          <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              return (
                <div
                  key={item.title}
                  className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-slate-800/50"
                >
                  <div
