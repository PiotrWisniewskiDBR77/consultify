            ...
            <form onSubmit={handleSearch} className="max-w-xl mx-auto">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 rounded-xl bg-c-surface border border-c-border-subtle text-lg shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-c-focus focus:border-transparent transition-all"
                />
                <button
                  type="submit"
