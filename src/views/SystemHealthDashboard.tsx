...
export default function SystemHealthDashboard() {
    ...
    const hasAutoFixableIssues = health?.checks.some(c =>
        (c.status === 'error' || c.status === 'warning') && c.autoFixAvailable
    );
            ...
            <div className="max-w-6xl mx-auto">
                <div className="flex items-center justify-between mb-8">
                    <div className="flex items-center gap-4">
                        <div className={`w-3 h-3 rounded-full ${health ? getOverallStatusColor(health.overall) : 'bg-gray-500'} animate-pulse`} />
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">
                                        {health.checks.filter(c => c.status === 'healthy').length} / {health.checks.length} checks passed
                                    </p>
                                </div>
                            </div>
                ...
                {loading && !health ? (
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-400">Running health checks...</p>
                    </div>
                ) : health ? (
