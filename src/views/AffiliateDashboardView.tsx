...
export const AffiliateDashboardView: React.FC = () => {
  ...
  >([]);
  const [stats, setStats] = useState<{ totalReferrals: number; totalConversions: number } | null>(
    null
  );
  ...
  return (
    <div className="flex-1 flex flex-col bg-slate-50 dark:bg-navy-950 overflow-auto">
      {/* Header Section */}
      <div className="px-6 py-8 border-b border-slate-200 dark:border-navy-700 bg-white dark:bg-navy-900">
      ...
      <div className="px-6 py-8">
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="glass-card p-6 rounded-xl flex flex-col justify-between overflow-hidden relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              <div className="space-y-3">
                {referrals.map((ref) => (
                  <div
                    key={ref.id}
                    className="glass-card p-4 rounded-xl flex items-center justify-between group hover:border-brand-500/30 transition-all border-white/5"
                  >
            ...
            <div className="space-y-6">
              <div className="glass-panel p-6 rounded-xl space-y-6 border-white/5 shadow-xl">
              ...
              <div className="p-6 rounded-xl bg-brand-600 text-white space-y-4 shadow-xl shadow-brand-600/20">
