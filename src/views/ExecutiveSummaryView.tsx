    ...
    >
      ...
      <div className="border-b-4 border-blue-900 pb-4 mb-8 flex justify-between items-end">
        ...
        <div className="text-right">
          ...
          <div className="text-xs text-slate-400 dark:text-slate-500 uppercase font-bold">
            Maturity Score
          </div>
        </div>
      </div>
      ...
      {/* Footer / Disclaimers */}
      <div className="mt-auto border-t border-slate-200 dark:border-navy-700 pt-6 flex justify-between items-center text-xs text-slate-400 dark:text-slate-500">
        <p>Generated by Consultinity Enterprise • Confidential</p>
        <div className="flex gap-4">
          <span>consultinity.com</span>
