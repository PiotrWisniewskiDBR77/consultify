...
export const ActionProposalView: React.FC = () => {
  ...
  const handleConfirmDecision = async (reason: string) => {
    ...
    const loadingToast = toast.loading(
      `${decisionType === 'APPROVE' ? 'Executing' : 'Rejecting'} proposal...`
    );
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-slate-50 dark:bg-navy-950 overflow-hidden">
      ...
      <div className="bg-white dark:bg-navy-900 border-b border-slate-200 dark:border-navy-700 py-8 px-8 flex justify-between items-center shrink-0">
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 bg-indigo-600 rounded-xl flex items-center justify-center text-white shadow-xl shadow-indigo-500/20 rotate-3">
            <Brain size={28} />
          </div>
          <div>
      ...
      <div className="px-8 pt-4 shrink-0">
        <div className="flex gap-1 p-1 bg-slate-200/50 dark:bg-navy-900/50 rounded-xl w-fit border border-slate-200 dark:border-navy-700">
          <button
