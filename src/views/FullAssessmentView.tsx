...
export const FullAssessmentView: React.FC = () => {
        ...
        if (report && report.assessment_snapshot) {
          ...
          const snapshotSession: FullSession = {
            ...
            assessment: {
              ...
              completedAxes: Object.keys(report.assessment_snapshot).filter(
                (k) => k !== 'completedAxes'
              ),
            },
          };
  ...
  const axes: { id: AxisId; label: string; icon: React.ReactNode; desc: string }[] = [
    {
      id: 'processes',
      label: ts.fullStep1_proc,
      icon: <Settings size={22} />,
      desc: t.descriptions.processes,
    },
    {
      id: 'digitalProducts',
      label: ts.fullStep1_prod,
      icon: <Smartphone size={22} />,
      desc: t.descriptions.digitalProducts,
    },
    {
      id: 'businessModels',
      label: ts.fullStep1_model,
      icon: <Briefcase size={22} />,
      desc: t.descriptions.businessModels,
    },
    {
      id: 'culture',
      label: ts.fullStep1_cult,
      icon: <Users size={22} />,
      desc: t.descriptions.culture,
    },
    {
      id: 'dataManagement',
      label: ts.fullStep1_data,
      icon: <Database size={22} />,
      desc: t.descriptions.dataManagement,
    },
    {
      id: 'cybersecurity',
      label: ts.fullStep1_cyber,
      icon: <Lock size={22} />,
      desc: t.descriptions.cybersecurity,
    },
    {
      id: 'aiMaturity',
      label: ts.fullStep1_ai,
      icon: <BrainCircuit size={22} />,
      desc: t.descriptions.aiMaturity,
    },
  ];
  ...
  const handleWizardComplete = (
    recommendedLevel: MaturityLevel,
    ...
    return (
      <SplitLayout title={ta.header}>
        <div className="flex h-full">
          <div className="flex flex-col flex-1 bg-white dark:bg-navy-900 border-l border-slate-200 dark:border-navy-700">
            {/* Back Navigation Bar with AI Toggle */}
            <div className="h-12 border-b border-slate-200 dark:border-navy-700 flex items-center justify-between px-4 bg-slate-50 dark:bg-navy-950/30">
              <button
