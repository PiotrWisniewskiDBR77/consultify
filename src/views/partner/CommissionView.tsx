  ...
  return (
    <div className="h-full overflow-y-auto bg-slate-50 dark:bg-navy-950">
      <div className="space-y-6 px-6 py-4">
        ...
        <div className="rounded-xl border border-slate-200 bg-white/90 p-6 dark:border-navy-700 dark:bg-navy-900/60">
          ...
          <div className="space-y-3">
            {statements.map((statement) => (
              <div
                key={statement.id}
                className="flex items-center justify-between rounded-xl border border-slate-100 p-4 dark:border-navy-700"
              >
                <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <button className="rounded-xl border border-slate-200 px-3 py-1.5 text-xs font-medium text-slate-600 transition hover:border-brand/30 dark:border-navy-700 dark:text-slate-300">
                    View
                  </button>
                </div>
              </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <select
                ...
                className="w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm focus:border-brand focus:outline-none focus:ring-2 focus:ring-brand/20 dark:border-navy-700 dark:bg-navy-900 dark:text-white"
              >
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm focus:border-brand focus:outline-none focus:ring-2 focus:ring-brand/20 dark:border-navy-700 dark:bg-navy-900 dark:text-white"
        ...
        {/* FAQ Section */}
        <div className="rounded-xl border border-slate-200 bg-slate-50/80 p-6 dark:border-navy-700 dark:bg-navy-900/40">
...
const FaqItem: React.FC<FaqItemProps> = ({ question, answer }) => (
  <div className="rounded-xl bg-white p-4 dark:bg-navy-900/60">
