            ...
            <div className="space-y-6 overflow-y-auto px-6 py-4">
                ...
                <div className="rounded-3xl border border-slate-200 bg-white/90 p-4 dark:border-white/5 dark:bg-navy-900/60">
                    <div className="mb-3 flex items-center justify-between">
                        <div className="text-sm font-semibold text-navy-900 dark:text-white">Trust Progression</div>
                        <button
...
const QuickNavCard: React.FC<QuickNavCardProps> = ({ title, description, onClick }) => (
    <button
        onClick={onClick}
        className="flex flex-col rounded-2xl border border-slate-200 bg-white/90 p-4 text-left transition hover:border-brand/30 hover:shadow-md dark:border-white/5 dark:bg-navy-900/60"
    >
