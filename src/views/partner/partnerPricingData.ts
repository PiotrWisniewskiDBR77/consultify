...
export const PARTNER_FAQS: PartnerFAQ[] = [
  ...
  },
  {
    ...
    answer:
      'Od poziomu Silver otrzymujesz dostęp do leadów generowanych przez Consultinity. Leady są przydzielane na podstawie Twojej specjalizacji, regionu i historii współpracy. Na poziomie Gold i Platinum masz priorytetowy dostęp.',
  },
  {
