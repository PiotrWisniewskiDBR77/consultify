        ...
        <div className="relative">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-6 py-24">
            <div className="animate-pulse space-y-6">
              <div className="h-4 bg-slate-200 rounded w-1/3 dark:bg-c-surface/[0.06]" />
              <div className="h-10 bg-slate-200 rounded w-2/3 dark:bg-c-surface/[0.06]" />
              <div className="aspect-[16/9] bg-c-surface-raised rounded-2xl dark:bg-c-surface/[0.04]" />
              <div className="h-4 bg-c-surface-raised rounded w-full dark:bg-c-surface/[0.04]" />
              <div className="h-4 bg-c-surface-raised rounded w-4/5 dark:bg-c-surface/[0.04]" />
            </div>
          </div>
        </div>
      </MarketingLayout>
        ...
        <div className="relative">
          ...
          <div className="relative z-10 flex items-center justify-center min-h-[60vh]">
            <div className="text-center">
              <BookOpen size={48} className="mx-auto text-c-text-secondary mb-4 dark:text-white/20" />
              {redirectInfo?.redirectSlug ? (
                <>
                  <h2 className="text-xl font-bold text-c-text mb-2 dark:text-white">
  ...
  return (
    <MarketingLayout footerVariant="knowledge">
      ...
      <div className="relative">
        ...
        {/* Breadcrumb */}
        <div className="relative z-10 border-b border-c-border-subtle/80 dark:border-white/[0.06]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
            <nav className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm text-c-text-muted dark:text-white/40 overflow-hidden">
              <Link
                to="/knowledge-base"
              ...
              <span className="text-c-text-secondary font-medium truncate max-w-xs hidden sm:block dark:text-white/70">
                {article.title}
              </span>
            </nav>
          </div>
          ...
          {toc.length > 2 && (
            <div className="xl:hidden mb-8">
              <button
                ...
                className="w-full flex items-center justify-between px-4 py-3 rounded-xl border border-c-border-subtle/80 bg-c-surface/80 text-sm text-c-text-secondary hover:border-c-border transition-colors dark:border-white/[0.08] dark:bg-c-surface/[0.02] dark:text-white/50 dark:hover:border-white/[0.15]"
              >
                <span className="font-semibold">{t('kb.article.toc', 'On this page')}</span>
                {mobileTocOpen ? <ChevronUp size={16} /> : <ChevronDown size={16} />}
              </button>
              {mobileTocOpen && (
                <nav className="mt-2 px-4 py-3 rounded-xl border border-c-border-subtle/80 bg-c-surface/85 space-y-1 dark:border-white/[0.06] dark:bg-c-surface/[0.02]">
                  {toc.map((item) => (
                    <a
                      key={item.id}
                      href={`#${item.id}`}
                      ...
                      className={cn(
                        ...
                        activeHeading === item.id
                          ...
                          : 'text-c-text-muted hover:text-c-text-secondary dark:text-white/40 dark:hover:text-white/60'
                      )}
                    >
                      {item.text}
                    </a>
          ...
          <div className="flex gap-12">
            ...
            <article className="flex-1 min-w-0 max-w-3xl">
              ...
              >
                ...
                <h1 className="text-2xl sm:text-3xl md:text-4xl font-black text-c-text tracking-tight leading-[1.1] dark:text-white">
                  {article.title}
                </h1>

                {article.summary && (
                  <p className="mt-3 sm:mt-4 text-base sm:text-lg text-c-text-secondary leading-relaxed font-medium dark:text-white/45">
                    {article.summary}
                  </p>
                )}

                <div className="mt-4 sm:mt-6 flex flex-wrap items-center gap-3 sm:gap-5 text-xs sm:text-sm text-c-text-muted dark:text-white/30">
              ...
              <div
                ...
                className="
                  ...
                  prose-blockquote:border-l-4 prose-blockquote:border-primary-500 prose-blockquote:bg-primary-50 prose-blockquote:rounded-xl prose-blockquote:py-4 prose-blockquote:px-6 prose-blockquote:my-8 prose-blockquote:text-c-text-secondary prose-blockquote:not-italic prose-blockquote:text-[1.1rem] prose-blockquote:font-medium prose-blockquote:leading-relaxed prose-blockquote:shadow-[inset_0_1px_0_rgba(165,28,48,0.12)] dark:prose-blockquote:bg-primary-950/30 dark:prose-blockquote:text-white/70 dark:prose-blockquote:shadow-[inset_0_1px_0_rgba(165,28,48,0.15)]

                  prose-table:border-collapse
                  prose-th:bg-c-surface-raised prose-th:border-c-border-subtle prose-th:text-c-text-secondary prose-th:font-bold prose-th:text-sm dark:prose-th:bg-c-surface/[0.04] dark:prose-th:border-white/[0.08] dark:prose-th:text-white/70
                  ...
                  prose-pre:bg-slate-900 prose-pre:border prose-pre:border-c-border-subtle prose-pre:rounded-xl dark:prose-pre:bg-[#0B1220] dark:prose-pre:border-white/[0.06]
                    ...
                    img: ({ src, alt, ref: _ref, ...props }) => {
                      ...
                      return (
                        <figure className="my-6 sm:my-10">
                          ...
                          />
                          {caption && (
                            <figcaption className="mt-2 sm:mt-3 text-center text-xs sm:text-sm text-c-text-secondary italic dark:text-white/25">
                              {caption}
                            </figcaption>
                          )}
                        </figure>
              ...
              <div className="mt-8 sm:mt-12 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-primary-500/20 bg-gradient-to-r from-primary-50 to-white dark:from-primary-950/40 dark:to-primary-900/20">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="text-c-text font-bold text-base mb-1 dark:text-white">
                      {docsLanguage === 'pl'
                        ? 'Masz pytania?'
                        : docsLanguage === 'de'
                          ? 'Fragen?'
                    ...
                    <p className="text-c-text-secondary text-sm leading-relaxed mb-3 dark:text-white/50">
                      {docsLanguage === 'pl'
              ...
              <div className="mt-10 pt-8 border-t border-c-border-subtle dark:border-white/[0.06]">
                <p className="text-sm text-c-text-muted mb-3 dark:text-white/40">
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className={cn(
                      ...
                      feedback === 'up'
                        ...
                        : 'border-c-border bg-c-surface text-c-text-secondary hover:border-emerald-500/40 hover:text-emerald-600 dark:border-white/[0.08] dark:bg-transparent dark:text-white/40 dark:hover:text-emerald-400'
                    )}
                  >
                    <ThumbsUp size={14} />
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      feedback === 'down'
                        ...
                        : 'border-c-border bg-c-surface text-c-text-secondary hover:border-danger-500/40 hover:text-danger-600 dark:border-white/[0.08] dark:bg-transparent dark:text-white/40 dark:hover:text-danger-400'
                    )}
                  >
                    <ThumbsDown size={14} />
                    {t('kb.article.no', 'No')}
                  ...
                  {feedback && (
                    <span className="text-xs text-c-text-secondary ml-2 dark:text-white/25">
                ...
                >
                  {prevArticle ? (
                    <Link
                      ...
                      className="group p-5 rounded-2xl border border-c-border-subtle bg-c-surface hover:bg-c-bg hover:border-c-border transition-all duration-200 dark:border-white/[0.06] dark:bg-c-surface/[0.02] dark:hover:bg-c-surface/[0.04] dark:hover:border-white/[0.12]"
                    >
                      <div className="flex items-center gap-1 text-xs text-c-text-muted mb-2 dark:text-white/30">
                        <ChevronLeft size={12} />
                  ...
                  {nextArticle ? (
                    <Link
                      ...
                      className={cn(
                        'group p-5 rounded-2xl border border-c-border-subtle bg-c-surface hover:bg-c-bg hover:border-c-border transition-all duration-200 dark:border-white/[0.06] dark:bg-c-surface/[0.02] dark:hover:bg-c-surface/[0.04] dark:hover:border-white/[0.12]',
                        articleNavigationCount > 1 && 'text-right'
                      )}
                    >
                      <div
                        className={cn(
                          'flex items-center gap-1 text-xs text-c-text-muted mb-2 dark:text-white/30',
              ...
              {relatedArticles && relatedArticles.length > 0 && (
                <div className="mt-10 sm:mt-14">
                  <h3 className="text-base sm:text-lg font-black text-c-text mb-4 sm:mb-5 tracking-tight dark:text-white">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    {relatedArticles.map((related: any) => (
                      ...
                      >
                        ...
                        {related.summary && (
                          <p className="mt-2 text-xs text-c-text-muted line-clamp-2 leading-relaxed dark:text-white/35">
                            {related.summary}
                          </p>
                        )}
            ...
            {toc.length > 2 && (
              <aside className="hidden xl:block w-64 flex-shrink-0 self-start h-0">
                <div className="sticky top-20">
                  <h4 className="text-[10px] font-black text-c-text-muted uppercase tracking-[0.2em] mb-5 dark:text-white/30">
                      ...
                      <a
                        ...
                        className={cn(
                          ...
                          activeHeading === item.id
                            ...
                            : 'border-c-border-subtle text-c-text-muted hover:text-c-text-secondary hover:border-c-border dark:border-white/[0.06] dark:text-white/35 dark:hover:text-white/60 dark:hover:border-white/[0.15]'
                        )}
                      >
                        {item.text}
                      </a>
                  ...
                  <div className="mt-8 pt-6 border-t border-c-border-subtle dark:border-white/[0.06] space-y-3">
                    <Link
                      to={`/knowledge-base/${categorySlug}`}
                      className="flex items-center gap-2 text-sm text-c-text-secondary hover:text-primary-500 dark:text-white/35 dark:hover:text-primary-400 transition-colors font-medium"
                    >
                      <ArrowLeft size={14} />
                    ...
                    <Link
                      to="/knowledge-base"
                      className="flex items-center gap-2 text-sm text-c-text-muted hover:text-primary-500 dark:text-white/25 dark:hover:text-primary-400 transition-colors font-medium"
                    >
                      <Home size={14} />
      ...
      {showBackToTop && (
        <button
          ...
          className="fixed bottom-6 right-6 z-40 p-3 rounded-full bg-c-surface/90 border border-c-border-subtle text-c-text-muted hover:text-c-text hover:bg-c-surface transition-all shadow-lg backdrop-blur-sm dark:bg-c-surface/[0.06] dark:border-white/[0.1] dark:text-white/40 dark:hover:text-white dark:hover:bg-c-surface/[0.1]"
