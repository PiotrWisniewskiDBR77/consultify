 ...
 *
 * Full article view with dark glass aesthetic, reading progress bar,
 * next/prev navigation, and MarketingLayout wrapper.
 */
                    ...
                    img: ({ src, alt, ...props }) => (
                      <figure className="my-10">
                        <img
                          ...
                          {...props}
                        />
                        {alt && alt !== 'Article hero image' && alt !== 'Analytical illustration' && (
                          <figcaption className="mt-3 text-center text-sm text-white/30 italic">
                            {alt}
                          </figcaption>
                        )}
                      </figure>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {relatedArticles.map((related: any) => (
                      ...
                      >
                        ...
                        {related.summary && (
                          <p className="mt-2 text-xs text-white/35 line-clamp-2">{related.summary}</p>
                        )}
