        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          {invitation?.requireEmail ? (
            <div>
              ...
              <input
                ...
                autoComplete="email"
                required
                className="w-full px-4 py-2 border border-c-border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-c-surface text-c-text placeholder:text-c-text-muted"
              />
          ...
          <div className="flex items-start gap-2">
            <input
              ...
              className="mt-1 h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-c-border rounded"
            />
          ...
          <div className="flex gap-3 pt-2">
            <a
              href="/"
              className="flex-1 px-4 py-3 bg-c-surface-raised text-c-text-secondary rounded-lg hover:bg-gray-200 transition-colors font-medium text-center"
            >
              Decline
            </a>
            <button
