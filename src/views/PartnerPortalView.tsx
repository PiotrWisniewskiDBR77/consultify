...
const sections = [
  {
    ...
    title: 'Provider Home',
    description:
      'Przyspiesz onboarding partnerów: checklisty aktywacji, weryfikacja tax/bank i plan szkoleń.',
...
const collaborationSteps = [
  ...
  },
  {
    ...
    detail:
      'Audit trail dla decyzji, escalations, SLA payout + standards mapping w systemach CO-SELL/COMMISSION.',
  },
];
      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6 px-4 sm:px-6 lg:px-8">
        <div className="rounded-xl border border-slate-200/60 bg-white p-6 shadow-sm dark:border-navy-800 dark:bg-navy-900">
          ...
          <p className="mt-3 text-base text-slate-600 dark:text-slate-300">
            Umożliw partnerom zgłaszanie klientów, współdzielenie umów i dostęp do zasobów.
            Kopiujemy sprawdzony flow HubSpot: landing, dashboard, commision, katalog usług i
            community.
          </p>
        ...
        <section className="grid gap-4 md:grid-cols-3">
          {partnerBenefits.map((benefit) => (
            <article
              key={benefit.title}
              className="rounded-xl border border-slate-200/60 bg-white p-4 shadow-sm dark:border-navy-800 dark:bg-navy-900"
            >
        ...
        <section className="rounded-xl border border-slate-200/60 bg-white p-6 shadow-sm dark:border-navy-800 dark:bg-navy-900">
          ...
          <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
            Partnerzy pracują w oparciu o Meta-PMO Framework: każdy etap dealu ma przypisane domeny
            PMO i śledzimy mappingi ISO 21500 / PMBOK 7 / PRINCE2.
          </p>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <div className="space-y-4 rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-navy-700 dark:bg-navy-900">
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              {sharedSellingStats.map((item) => (
                ...
                >
                  ...
                  <div className="text-[10px] font-medium text-slate-400 dark:text-slate-500 mt-1 uppercase tracking-tighter">
                    {item.caption}
                  </div>
                </div>
              ))}
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-navy-700 dark:bg-navy-900 flex flex-col">
            <h3 className="text-lg font-semibold text-navy-900 dark:text-white">
        ...
        <div className="rounded-xl border border-violet-200 bg-violet-50 p-6 text-slate-800 dark:border-violet-700/50 dark:bg-violet-900/20 dark:text-white flex flex-col md:flex-row items-center gap-4">
          <div className="flex-1">
            ...
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-200 leading-relaxed">
              ...
              oferuje progresywne korzyści — od 10% do 20% prowizji, co-sell leads i dedykowane
              wsparcie.
            </p>
          </div>
