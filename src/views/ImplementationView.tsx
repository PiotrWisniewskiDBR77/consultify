...
export const ImplementationView: React.FC = () => {
  ...
  const renderTasksTab = () => {
    ...
    const renderColumn = (status: TaskStatus, label: string, color: string) => (
      <div className="flex-1 min-w-[280px] bg-slate-50 dark:bg-navy-950/50 rounded-xl border border-slate-200 dark:border-navy-700 flex flex-col h-full">
        <div
          className={`p-3 border-b border-slate-200 dark:border-navy-700 flex justify-between items-center ${color} rounded-t-xl`}
        >
        ...
        <div className="p-3 flex-1 overflow-y-auto space-y-3">
          {tasksByStatus[status].map((task) => (
            <div
              ...
              className="bg-white dark:bg-navy-900 border border-slate-200 dark:border-navy-700 p-3 rounded-lg hover:border-purple-400 dark:hover:border-purple-500/50 cursor-pointer shadow-sm group"
            >
          ...
          {tasksByStatus[status].length === 0 && (
            <div className="h-20 flex items-center justify-center border border-dashed border-slate-200 dark:border-navy-700 rounded text-xs text-slate-400 dark:text-slate-500">
              Empty
            </div>
          )}
        </div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <select
            ...
            className="px-3 py-2 rounded-lg border border-slate-200 dark:border-navy-700 bg-white dark:bg-navy-950 text-navy-900 dark:text-white text-sm"
          >
