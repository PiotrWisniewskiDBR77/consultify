...
export const KpiOkrView: React.FC = () => {
  ...
  return (
    <SplitLayout title="KPI/OKR Dashboard" currentView={AppView.KPI_OKR_DASHBOARD}>
          ...
          <div className="bg-white dark:bg-navy-800 rounded-xl shadow-xl border border-slate-200 dark:border-navy-700 overflow-hidden">
            <div className="p-12 text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                {/* Feature 1 */}
                <div className="p-6 bg-slate-50 dark:bg-navy-900/50 rounded-xl border border-slate-200 dark:border-navy-700">
