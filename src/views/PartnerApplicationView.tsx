    ...
    <MarketingLayout>
      <section className="relative overflow-hidden px-6 py-20">
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
          ...
          <div className="rounded-[28px] border border-white/10 bg-white p-8 shadow-2xl dark:bg-navy-900">
            {isSubmitted ? (
              <div className="text-center">
                <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-emerald-100 text-emerald-600 dark:bg-emerald-900/30 dark:text-emerald-300">
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="mt-8 grid gap-4">
                  ...
                  {error && (
                    <div className="rounded-2xl border border-danger-200 bg-danger-50 px-4 py-3 text-sm text-danger-700 dark:border-danger-500/20 dark:bg-danger-500/10 dark:text-danger-300">
                      {error}
                    </div>
                  )}
