...
export const FullRoadmapView: React.FC = () => {
  ...
  React.useEffect(() => {
    const fetchSummary = async () => {
      ...
      try {
        const result = await Api.post('/ai/roadmap-summary', {
  ...
  useEffect(() => {
    ...
    const needsGeneration =
      fullSession.initiatives?.length > 0 && fullSession.initiatives.some((i) => !i.quarter);
    ...
    <SplitLayout title="Module 3: Strategic Roadmap">
      <div className="w-full h-full relative">
        <div className="w-full h-full bg-slate-50 dark:bg-navy-950 flex flex-col p-6 overflow-y-auto gap-6 relative">
          ...
          {/* 2. Workload Chart */}
          <div className="bg-white dark:bg-navy-800 border border-slate-200 dark:border-navy-700 rounded-xl p-4 shadow-sm">
            <WorkloadChart
              initiatives={fullSession.initiatives}
                ...
                {fullSession.initiatives
                  ...
                  .map((init) => (
                    <div
                      ...
                      className="p-4 rounded-xl border border-slate-200 dark:border-navy-700 bg-slate-50 dark:bg-white/5 hover:bg-slate-100 dark:hover:bg-white/10 cursor-pointer transition-all hover:border-blue-500 group"
                    >
