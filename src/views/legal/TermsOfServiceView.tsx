  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <p>
          These Terms apply to all users, including trial users, subscribers, and enterprise
          customers.
        </p>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            <strong>"Content"</strong> - All data, text, documents, and materials you create or
            upload
          </li>
          <li>
          ...
          <li>
            <strong>"Organization"</strong> - A company or entity using the Platform with multiple
            users
          </li>
          <li>
      ...
      <section>
        ...
        <p>
          ...
          unauthorized access at <a href={`mailto:${COMPANY.email}`}>{COMPANY.email}</a>.
        </p>
      ...
      <section>
        ...
        <p>
          ...
          license to access and use the Platform for your internal business purposes.
        </p>
      ...
      <section>
        ...
        <p>
          ...
          us a limited license to process your Content solely to provide the Service.
        </p>

        <h3>7.3 AI-Generated Content</h3>
        <p>
          Outputs generated by AI features based on your inputs belong to you, subject to the terms
          of the underlying AI provider. You are responsible for reviewing and validating all
          AI-generated content before use.
        </p>

        <h3>7.4 Feedback</h3>
        <p>
          If you provide feedback or suggestions, we may use them without obligation to compensate
          you.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          solely responsible for reviewing, validating, and appropriately using any AI outputs. AI
          should not replace professional judgment or advice.
        </p>
      ...
      <section>
        ...
        <p>
          Your privacy is important to us. Our <a href="/privacy">Privacy Policy</a> explains how we
          collect, use, and protect your personal data. By using the Service, you consent to our
          data practices as described in the Privacy Policy.
        </p>
        <p>
          You are responsible for ensuring you have appropriate rights to upload any data to the
          Platform.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          We do not warrant that AI-generated insights are accurate, complete, or suitable for any
          particular purpose. Strategic decisions should be validated independently.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          TO THE MAXIMUM EXTENT PERMITTED BY LAW, {COMPANY.name.toUpperCase()} SHALL NOT BE LIABLE
          FOR:
        </p>
        <ul>
      ...
      <section>
        ...
        <h3>14.2 By Us</h3>
        <p>
          We may suspend or terminate your account if you violate these Terms, fail to pay, or if
          required by law. We may also discontinue the Service with 90 days' notice.
        </p>
      ...
      <section>
        ...
        <p>
          For EU consumers, nothing in these Terms affects your statutory rights or your right to
      ...
      <section>
        ...
        <p>
          ...
          email or through the Platform at least 30 days before they take effect. Your continued use
