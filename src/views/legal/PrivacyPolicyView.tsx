  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <div className="bg-slate-50 dark:bg-navy-900 p-6 rounded-xl border border-slate-200 dark:border-navy-700 my-6">
      ...
      <section>
        ...
        <p>
          When you use our AI-powered features, we process the prompts and data you provide to
          generate strategic insights. This data is processed in accordance with your selected AI
          provider's terms and our data protection measures.
        </p>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            <strong>Legitimate Interests (Art. 6(1)(f)):</strong> Platform improvement, fraud
            prevention, security
          </li>
          <li>
      ...
      <section>
        ...
        <p>
          In the event of a merger, acquisition, or sale, your data may be transferred as part of
          the business assets.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Your data is primarily stored on servers located in the European Union. When we transfer
          data outside the EU/EEA (e.g., to AI providers), we ensure appropriate safeguards are in
          place:
        </p>
        <ul>
      ...
      <section>
        ...
        <p>
          After account deletion, we anonymize or delete your data within 90 days, except where
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            <strong>Right to Data Portability (Art. 20):</strong> Receive your data in a portable
            format
          </li>
          <li>
        ...
        <p>
          ...
          <a href={`mailto:${COMPANY.dpo}`}>{COMPANY.dpo}</a>. We will respond within 30 days.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          information about the cookies we use and how to control them, please see our{' '}
