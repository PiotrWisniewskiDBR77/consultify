...
export const SecurityView: React.FC = () => {
  ...
  const securityFeatures = [
    ...
    },
    {
      ...
      description:
        'Your data is stored exclusively in EU-based data centers, ensuring GDPR compliance.',
    ...
    },
    {
      ...
      title: 'SOC2 Type II',
      description:
        'Our infrastructure follows SOC2 Type II security controls and undergoes regular audits.',
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <p>
              ...
              protected using TLS 1.3 with perfect forward secrecy. Encryption keys are managed
              using industry-standard key management practices with regular rotation.
            </p>

            <h3>Access Controls</h3>
            <p>
              We implement strict role-based access control (RBAC) throughout our platform. Access
              to production systems is limited to authorized personnel only, with all access logged
              and regularly audited. Multi-factor authentication (MFA) is mandatory for all
              administrative access.
            </p>

            <h3>Data Isolation</h3>
            <p>
              Each organization's data is logically isolated using tenant-level encryption keys.
              This ensures that your strategic data remains completely separate from other
              customers' data.
            </p>

            <h3>Backup & Recovery</h3>
            <p>
              We perform daily encrypted backups with point-in-time recovery capabilities. Backups
              are stored in geographically separate EU data centers to ensure business continuity.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-300 mb-4">
                  ...
                  please report it to us responsibly. We commit to:
                </p>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="/privacy"
              className="px-6 py-3 bg-white dark:bg-navy-900 border border-slate-200 dark:border-navy-700 text-navy-950 dark:text-white font-semibold rounded-lg hover:bg-slate-50 dark:hover:bg-white/5 transition-colors"
            >
              View Privacy Policy
            </a>
          </div>
