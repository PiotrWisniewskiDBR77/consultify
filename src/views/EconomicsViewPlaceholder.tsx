        ...
        <div className="flex flex-col h-full bg-slate-50 dark:bg-navy-950">
            ...
            <div className="flex-1 flex items-center justify-center p-8">
                <div className="max-w-2xl w-full">
                    <div className="bg-white dark:bg-navy-900 rounded-2xl shadow-xl border border-slate-200 dark:border-white/10 p-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
                            <div className="p-4 rounded-xl bg-slate-50 dark:bg-navy-800 border border-slate-200 dark:border-white/10">
