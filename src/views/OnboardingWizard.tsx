          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  className="w-full pl-10 p-3 rounded-lg border border-slate-200 dark:border-navy-700 bg-slate-50 dark:bg-navy-900 focus:ring-2 focus:ring-c-focus outline-none transition-all"
            ...
            <div>
              ...
              <select
                className="w-full p-3 rounded-lg border border-slate-200 dark:border-navy-700 bg-slate-50 dark:bg-navy-900 focus:ring-2 focus:ring-c-focus outline-none transition-all"
