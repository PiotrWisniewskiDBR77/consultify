...
Return JSON:
{
  ...
  "rationale": "why — anchored in the baseline capital and lever scores above",
  "tradeoffs": [{"chosen":"...","rejected":"...","why":"..."}],
  "moves": [{"title":"...","lever":"classify|service|replenish|deadstock","rationale":"...","tradeOff":"...","rejectedVariant":"...","expectedImpact":"high|medium|low","estimatedEffort":"high|medium|low","confidence":4,"firstStep":"..."}],
