...
export interface LadderRung {
  ...
  /** 1-4 depth level (surface..risk) — orders the staircase and drives the UI's
   *  depth affordance; available for depth scoring (not currently consumed by the
   *  synthesis engine, which scores facts, not how far the conversation reached). */
  depth: 1 | 2 | 3 | 4;
  label: Bilingual;
