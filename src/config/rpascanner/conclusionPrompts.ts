...
Return JSON:
{
  ...
  "rationale": "why — anchored in the automation portfolio minutes and gate scores above",
  "tradeoffs": [{"chosen":"...","rejected":"...","why":"..."}],
  "moves": [{"title":"...","gate":"identify|standardize|quantify|feasibility","rationale":"...","tradeOff":"...","rejectedVariant":"...","expectedImpact":"high|medium|low","estimatedEffort":"high|medium|low","confidence":4,"firstStep":"..."}],
