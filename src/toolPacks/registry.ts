...
const ENGINE_BACKED: Array<{
...
}> = [
  {
    ...
    name: bi('Siły rynkowe (Porter)', 'Market Forces (Porter)'),
    category: 'strategic',
  ...
  },
  {
    ...
    name: bi('Ścieżki wzrostu (Ansoff)', 'Growth Paths (Ansoff)'),
    category: 'strategic',
  ...
  },
  {
    ...
    name: bi('Analiza łańcucha wartości', 'Value Chain Analysis'),
    category: 'strategic',
    archetype: 'flow-value-stream',
    configDir: 'valuechain',
  },
  {
    toolType: 'portfolio-priority',
    name: bi('Priorytetyzacja portfela', 'Portfolio Prioritization'),
    category: 'strategic',
  ...
  },
  {
    ...
    name: bi('Ryzyko i niepewność', 'Risk & Uncertainty'),
    category: 'strategic',
    archetype: 'decision-matrix-portfolio',
    configDir: 'riskuncertainty',
  },
  {
    toolType: 'capability-mapper',
    name: bi('Mapa zdolności', 'Capability Mapper'),
    category: 'strategic',
    archetype: 'architecture-capability',
    configDir: 'capabilitymapper',
  },
  {
    toolType: 'ambition-decomposer',
    name: bi('Dekompozycja ambicji', 'Ambition Decomposer'),
    category: 'strategic',
    archetype: 'architecture-capability',
    configDir: 'ambitiondecomposer',
  },
  {
    toolType: 'focus-tradeoff',
    name: bi('Fokus i kompromisy', 'Focus & Trade-offs'),
    category: 'strategic',
    archetype: 'decision-matrix-portfolio',
    configDir: 'focustradeoffs',
  },
  {
    toolType: 'narrative-engine',
    name: bi('Narracja i spójność', 'Narrative & Alignment'),
    category: 'strategic',
    archetype: 'architecture-capability',
    configDir: 'narrativeengine',
  },
  {
    toolType: 'a3-problem-solving',
    name: bi('Rozwiązywanie problemów A3', 'A3 Problem Solving'),
    category: 'operational',
    archetype: 'causal-problem-solving',
    configDir: 'a3problemsolving',
  },
  {
    toolType: 'sop-builder',
    name: bi('Kreator SOP', 'SOP Builder'),
    category: 'operational',
    archetype: 'operating-model-standard',
    configDir: 'sopbuilder',
  },
  {
    toolType: 'smed-planner',
    name: bi('Planer SMED', 'SMED Planner'),
    category: 'operational',
    archetype: 'flow-value-stream',
    configDir: 'smedplanner',
  },
  {
    toolType: 'dms-builder',
    name: bi('System zarządzania dziennego', 'Daily Management System'),
    category: 'operational',
    archetype: 'operating-model-standard',
    configDir: 'dmsbuilder',
  },
  {
    toolType: 'inventory-autopilot',
    name: bi('Autopilot zapasów', 'Inventory Autopilot'),
    category: 'operational',
    archetype: 'decision-matrix-portfolio',
    configDir: 'inventoryautopilot',
  },
  // Trzy poniżej: silnik JEST, brakuje gałęzi w ToolCanvas (L4 — podłączenie UI).
  {
    toolType: 'rpa-scanner',
    name: bi('Skaner RPA', 'RPA Scanner'),
    category: 'digital',
    archetype: 'discovery-candidate-funnel',
    configDir: 'rpascanner',
  },
  {
    toolType: 'ai-discovery',
    name: bi('Odkrywanie zastosowań AI', 'AI Discovery'),
    category: 'digital',
    archetype: 'discovery-candidate-funnel',
    configDir: 'aidiscovery',
  },
  {
    toolType: 'pain-explorer',
    name: bi('Eksplorator problemów', 'Pain Explorer'),
    category: 'digital',
    archetype: 'causal-problem-solving',
    configDir: 'painexplorer',
  },
  {
    toolType: 'process-automation',
    name: bi('Automatyzacja procesu', 'Process Automation'),
    category: 'automation',
    archetype: 'flow-value-stream',
    configDir: 'processautomation',
  },
];
...
const NO_EVIDENCE: Array<{
...
}> = [
  {
    ...
    name: bi('Kreator VSM', 'VSM Builder'),
    category: 'operational',
    archetype: 'flow-value-stream',
  },
  {
    toolType: 'constraint-control',
    name: bi('Sterowanie ograniczeniem (TOC)', 'Constraint Control (TOC)'),
    category: 'operational',
    archetype: 'flow-value-stream',
  },
  {
    toolType: 'decision-engine',
    name: bi('Silnik decyzyjny', 'Decision Engine'),
    category: 'operational',
    archetype: 'decision-matrix-portfolio',
  },
  {
    toolType: 'control-tower',
    name: bi('Wieża kontrolna', 'Control Tower'),
    category: 'operational',
    archetype: 'operating-model-standard',
  },
  {
    toolType: 'automation-pipeline',
    name: bi('Pipeline automatyzacji', 'Automation Pipeline'),
    category: 'operational',
    archetype: 'discovery-candidate-funnel',
  },
  {
    toolType: 'robotics-feasibility',
    name: bi('Wykonalność robotyzacji', 'Robotics Feasibility'),
    category: 'digital',
    archetype: 'discovery-candidate-funnel',
  },
  {
    toolType: 'logistics-automation',
    name: bi('Automatyzacja logistyki', 'Logistics Automation'),
    category: 'digital',
    archetype: 'flow-value-stream',
  },
  {
    toolType: 'integration-diagnostic',
    name: bi('Diagnostyka integracji', 'Integration Diagnostic'),
    category: 'digital',
    archetype: 'architecture-capability',
  },
  {
    toolType: 'digital-value-pool',
    name: bi('Pula wartości cyfrowej', 'Digital Value Pool'),
    category: 'digital',
    archetype: 'decision-matrix-portfolio',
  },
  {
    toolType: 'legacy-analyzer',
    name: bi('Analizator legacy', 'Legacy Analyzer'),
    category: 'digital',
    archetype: 'architecture-capability',
  },
  {
    toolType: 'data-inventory',
    name: bi('Inwentaryzacja danych', 'Data Inventory'),
    category: 'digital',
    archetype: 'architecture-capability',
  },
  {
    toolType: 'pain-to-solution',
    name: bi('Od problemu do rozwiązania', 'Pain-to-Solution Mapper'),
    category: 'digital',
    archetype: 'causal-problem-solving',
  },
];
...
function notAuthoredPack(entry: (typeof ENGINE_BACKED)[number]): ToolPack {
  ...
  return {
    ...
    provenance: [
      {
        source: `src/config/${entry.configDir}/`,
        verifiableInRepo: true,
        note: 'Silnik metody istnieje; pack do spisania.',
      },
    ],
  };
}
