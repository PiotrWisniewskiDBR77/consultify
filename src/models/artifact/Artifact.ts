...
export const unsafeArtifactVersionId = (v: string): ArtifactVersionId =>
  v as ArtifactVersionId;
...
export const unsafeRetentionPolicyId = (v: string): RetentionPolicyId =>
  v as RetentionPolicyId;
