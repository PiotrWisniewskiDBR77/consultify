...
export const TERESA_NAVIGATION_MANIFEST = [
  ...
  { id: 'PROJECTS', route: ROUTES.PROJECTS, labelEn: 'Projects', labelPl: 'Projekty', clickPathEn: ['My Work', 'Projects'], clickPathPl: ['Moja praca', 'Projekty'], runtimeFlagKey: 'VITE_PMO_PROJECTS' },
...
export const APP_VIEW_TO_ROUTE: Record<AppView, string> = {
  ...
  [AppView.KPI_OKR_DASHBOARD]: ROUTES.RESULTS_KPI.ROOT,
  [AppView.PORTFOLIO_ROADMAP]: ROUTES.INITIATIVES,
  [AppView.INITIATIVE_MANAGEMENT]: ROUTES.INITIATIVES,
  [AppView.BENEFITS_REALIZATION]: ROUTES.RESULTS_KPI.ROOT,
