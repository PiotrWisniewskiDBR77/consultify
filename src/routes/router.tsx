...
const OrgSetupWizard = React.lazy(() => import('@/views/OrgSetupWizard').then((m) => ({ default: m.OrgSetupWizard })));
...
const AnimatedSuspenseWrapper: React.FC<{ children: React.ReactNode; variant?: 'fade' | 'slideUp' }> = ({
    children,
    variant = 'fade',
}) => (
