...
export const warnMissingTranslationKey = (
  languages: readonly string[],
  namespace: string,
  key: string
): void => {
  console.warn(
    `[i18n] Missing translation key: ${namespace}:${key} (${languages.join(', ') || 'unknown language'})`
  );
};
...
i18n
  ...
  .init({
    ...
    saveMissing: import.meta.env.VITE_I18N_DEBUG === 'true',
    missingKeyHandler:
      import.meta.env.VITE_I18N_DEBUG === 'true' ? warnMissingTranslationKey : undefined,
    returnNull: false,
