...
export const DBR77_PHASES: DBR77PhaseConfig[] = [
  {
    ...
    descriptionEN:
      'Current state analysis - processes and workstations. Collect data, measure metrics.',
    color: 'blue',
    icon: 'Ruler',
    outputs: [
      'Process Maps',
...
export const DBR77_WASTES: DBR77WasteConfig[] = [
  {
    ...
    examples: [
      'Przewożenie WIP między budynkami',
      'Wielokrotne przekazywanie dokumentów',
      'Zbędne maile w CC',
    ],
    color: 'orange',
  },
  ...
  },
  {
    ...
    examples: [
      ...
      'Tworzenie niepotrzebnych raportów',
      'Nadmiarowe funkcje',
    ],
    color: 'red',
  },
