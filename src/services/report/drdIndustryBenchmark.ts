/**
 * DRD Report — industry benchmark overlay (P3, prepared but not yet decided)
 *
...
import {
  ...
  type DRDDimensionId,
  type DRDIndustryId,
} from '../assessmentKnowledge/drdIndustryProfiles';
import type { DrdDimension } from './drdReportModel';
