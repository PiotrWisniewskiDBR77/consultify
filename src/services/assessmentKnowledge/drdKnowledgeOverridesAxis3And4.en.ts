/**
 * DRD_KNOWLEDGE_OVERRIDES (EN mirror) — Axis 3 (Digital Business Models, 5 areas × 5 levels)
 *                                       + Axis 4 (Data Management, 5 areas × 7 levels)
 *
 * Oxford O1 · batch 2 · 2026-07-02
 *
 * Question style: behavioural — we ask about behaviour, an artefact, or an
 * event, NOT self-assessment. Pattern from the canon §9.2:
 *   "When did you last do X? Show us that instance."
 *   "What did the system do when Y happened? What log/screenshot do you have?"
 *
 * The `example` field plays the role of `expectedEvidence` (the DRDLevelKnowledge
 * type has no separate evidence field; we embed it here as a hint for the consultant).
 *
 * This is the English mirror of drdKnowledgeOverridesAxis3And4.ts (PL is the
 * runtime source; this file is self-contained with identical keys/shape).
 */

import type { DRDAreaLevelKey, DRDLevelKnowledge } from './drdKnowledge';

export const DRD_OVERRIDES_AXIS_3_4_EN: Partial<
  Record<DRDAreaLevelKey, Partial<DRDLevelKnowledge>>
> = {
  // ================================================================
  // AXIS 3A — E-COMMERCE MODELS (5 levels)
  // ================================================================
  ...
  // ================================================================
  // AXIS 3B — PLATFORM SOLUTIONS (5 levels)
  // ================================================================
  ...
  // ================================================================
  // AXIS 3D — ASSET SHARING MODELS (5 levels)
  // ================================================================
  ...
  // ================================================================
  // AXIS 3E — DATA MONETIZATION MODELS (5 levels)
  // ================================================================
  ...
  // ================================================================
  // AXIS 4A — DATA COLLECTION (7 levels)
  // ================================================================
  ...
  // ================================================================
  // AXIS 4B — DATA STORAGE METHODOLOGY (7 levels)
  // ================================================================
  ...
  '4B#2': {
    ...
    suggestedTechnologies: ['Local Backup', 'NAS Storage', 'Automated Backup', 'Recovery Testing'],
  },
  ...
  // ================================================================
  // AXIS 4C — DATA COMMUNICATION (7 levels)
  // ================================================================
  ...
  '4C#2': {
    ...
    suggestedTechnologies: ['Email', 'Report Distribution', 'File Sharing', 'Automated Reporting'],
  },
  ...
  '4C#6': {
    ...
    suggestedTechnologies: ['SD-WAN', 'MPLS', 'VPN', 'Zero Trust Network Access', 'WAN Monitoring'],
  },
  ...
  // ================================================================
  // AXIS 4D — BIG DATA ANALYSIS (7 levels)
  // ================================================================
  ...
  '4E#3': {
    ...
    suggestedTechnologies: ['Clustering', 'Load Balancing', 'High Availability', 'Shared Storage'],
  },
