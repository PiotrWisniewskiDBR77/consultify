...
export const CMMI_MATURITY_LEVELS: CMMIMaturityLevel[] = [
  {
    ...
    description:
      'Processes unpredictable, poorly controlled and reactive. Success depends on individual heroics.',
    characteristics: [
      'Ad hoc and chaotic',
  ...
  },
  {
    ...
    description:
      'Processes characterized for projects and often reactive. Project-level discipline.',
    characteristics: [
  ...
  },
  {
    ...
    description:
      'Processes characterized for organization and proactive. Standard processes established.',
    characteristics: [
  ...
  },
  {
    ...
    description:
      'Processes measured and controlled. Statistical management and quantitative objectives.',
    characteristics: [
  ...
  },
  {
    ...
    description:
      'Focus on continuous improvement. Innovation and optimization are institutionalized.',
    characteristics: [
...
export const CMMI_PRACTICE_AREAS: CMMIPracticeArea[] = [
  ...
  // MANAGING - Manage Work
  {
    ...
    descriptionPL:
      'Identyfikacja przyczyn wyników i podejmowanie działań w celu poprawy wydajności',
    levels: PRACTICE_AREA_LEVELS,
  },
  {
    id: 'CM',
...
export function calculateOverallMaturityLevel(practiceAreaScores: Record<string, number>): number {
  const scores = Object.values(practiceAreaScores).filter(
