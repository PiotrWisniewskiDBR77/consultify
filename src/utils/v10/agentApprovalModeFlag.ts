...
const QUERY_KEY = 'ff_agent_approval_mode';
const ENV_KEY = 'VITE_AGENT_APPROVAL_MODE';
...
export function isAgentApprovalModeEnabled(): boolean {
...
export const AGENT_APPROVAL_MODE_FLAG_KEYS = {
  localStorage: LS_KEY,
  query: QUERY_KEY,
  env: ENV_KEY,
} as const;
