...
const QUERY_KEY = 'ff_agent_anti_patterns';
const ENV_KEY = 'VITE_AGENT_ANTI_PATTERNS';
...
export function isAgentAntiPatternsEnabled(): boolean {
...
export const AGENT_ANTI_PATTERNS_FLAG_KEYS = {
  localStorage: LS_KEY,
  query: QUERY_KEY,
  env: ENV_KEY,
} as const;
