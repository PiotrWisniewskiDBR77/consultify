...
export type RiskResponse = 'avoid' | 'mitigate' | 'transfer' | 'accept' | 'exploit' | 'enhance' | 'share';
...
export type ChangeRequestType = 'scope' | 'schedule' | 'cost' | 'resource' | 'quality' | 'requirements' | 'design';
