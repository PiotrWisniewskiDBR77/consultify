...
export type ShortcutCategory = 'navigation' | 'editing' | 'task_management' | 'search' | 'ai' | 'general';
...
/** Bulk action type */
export type ContentBulkActionType = 'PUBLISH' | 'DEPRECATE' | 'DELETE' | 'ADD_TAG' | 'REMOVE_TAG' | 'CHANGE_CATEGORY';
