...
export const useBreadcrumbs = () => {
  ...
  // Full Transformation Views
    ...
    currentView === AppView.FULL_STEP1_ASSESSMENT ||
    currentView.startsWith('FULL_STEP1_')
  ) {
    section = t('sidebar.fullProject');
  ...
  // Settings Views
    ...
    else if (currentView === AppView.SETTINGS_WORK_PREFERENCES)
      sub = t('settings.menu.workPreferences');
    else if (currentView === AppView.SETTINGS_DASHBOARD_PREFERENCES)
      sub = t('settings.menu.dashboardPreferences');
