...
export const DEFAULT_FLAGS: FeatureFlag[] = [
  ...
  },
  {
    ...
    description:
      'P0C (2026-08-13), retired by J2: `DrdMethodWorkspaceScreen` now always uses ' +
      '`DrdHttpSessionRuntime` (src/method-core/methods/drd/drdHttpSessionRuntime.ts). The ' +
      'server (`/api/method/...` via methodCoreApi.ts) is the ONLY product source of truth. ' +
      ...
      'backed the current paint. The stored flag remains for configuration compatibility, but ' +
      'its value no longer selects a local product writer.',
    defaultValue: false,
    category: 'experimental',
    allowLocalOverride: true,
  },
