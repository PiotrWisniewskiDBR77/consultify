...
import { Beaker, Brain, ChevronDown, ChevronUp, Eye, Flag, RefreshCw, Sparkles, Trash2, X, Zap } from 'lucide-react';
import React, { createContext, useCallback, useContext, useState } from 'react';

import { FeatureFlag, FeatureFlagsConfig, useFeatureFlags, UseFeatureFlagsReturn } from '../hooks/useFeatureFlags';
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between px-4 py-3 bg-navy-800 border-b border-white/10">
                ...
                <div className="flex items-center gap-1">
                    <button
                        onClick={refresh}
                        disabled={isLoading}
                        className="p-1.5 text-slate-400 hover:text-white hover:bg-white/5 rounded-lg transition-colors disabled:opacity-50"
                        title="Refresh flags"
                    >
                    ...
                    <button
                        ...
                        className="p-1.5 text-slate-400 hover:text-danger-400 hover:bg-danger-400/10 rounded-lg transition-colors"
                    ...
                    <div key={category}>
                        ...
                        >
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-xs text-slate-500">({categoryFlags.length})</span>
                            </div>
            ...
            <div className="px-4 py-2 bg-navy-800 border-t border-white/10">
                <div className="text-xs text-slate-500 text-center">Changes saved to localStorage</div>
            </div>
        </motion.div>
    );
};
