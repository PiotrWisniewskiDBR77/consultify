...
export const RAPID_LEAN_OBSERVATION_TEMPLATES: ObservationTemplate[] = [
    {
        ...
        descriptionPl: 'Systematyczna obserwacja w celu identyfikacji 8 typów marnotrawstwa w obszarze procesu',
        category: 'lean',
        icon: 'Footprints',
        checklist: [
        ...
        fields: [
            ...
            { id: 'waste_type', label: 'Primary Waste Type', labelPl: 'Główny typ marnotrawstwa', type: 'select', options: ['Overproduction', 'Waiting', 'Transport', 'Processing', 'Inventory', 'Motion', 'Defects', 'Skills'] },
    ...
    },
    {
        ...
        icon: 'CheckSquare',
        checklist: [
            { id: '5s1', text: 'Sort: Unnecessary items removed', textPl: 'Sortowanie: Usunięto niepotrzebne przedmioty' },
            { id: '5s2', text: 'Set in Order: Items properly organized', textPl: 'Systematyka: Przedmioty właściwie zorganizowane' },
            { id: '5s3', text: 'Shine: Area is clean', textPl: 'Sprzątanie: Obszar jest czysty' },
            { id: '5s4', text: 'Standardize: Standards are visible', textPl: 'Standaryzacja: Standardy są widoczne' },
            { id: '5s5', text: 'Sustain: Audits are regular', textPl: 'Samodyscyplina: Audyty są regularne' },
        ],
        fields: [
            ...
            { id: 'set_score', label: 'Set in Order Score', labelPl: 'Ocena systematyki', type: 'rating' },
            { id: 'shine_score', label: 'Shine Score', labelPl: 'Ocena sprzątania', type: 'rating' },
            { id: 'standardize_score', label: 'Standardize Score', labelPl: 'Ocena standaryzacji', type: 'rating' },
            { id: 'sustain_score', label: 'Sustain Score', labelPl: 'Ocena samodyscypliny', type: 'rating' },
        ],
    },
    {
        id: 'gemba-walk',
        ...
        icon: 'Eye',
        checklist: [
            { id: 'gw1', text: 'Observed actual work processes', textPl: 'Zaobserwowano rzeczywiste procesy pracy' },
            { id: 'gw2', text: 'Spoke with workers', textPl: 'Rozmawiano z pracownikami' },
            { id: 'gw3', text: 'Identified improvement opportunities', textPl: 'Zidentyfikowano możliwości usprawnień' },
            { id: 'gw4', text: 'Noted safety concerns', textPl: 'Odnotowano obawy dotyczące bezpieczeństwa' },
        ],
        fields: [
            { id: 'area', label: 'Area Visited', labelPl: 'Odwiedzony obszar', type: 'text', required: true },
            { id: 'duration', label: 'Duration (minutes)', labelPl: 'Czas trwania (minuty)', type: 'number' },
            { id: 'observations', label: 'Key Observations', labelPl: 'Kluczowe obserwacje', type: 'text' },
        ],
    },
];

export const getObservationTemplates = () => RAPID_LEAN_OBSERVATION_TEMPLATES;
export const getTemplateById = (id: string) => RAPID_LEAN_OBSERVATION_TEMPLATES.find(t => t.id === id);
