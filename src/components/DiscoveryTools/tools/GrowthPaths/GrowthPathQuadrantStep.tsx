    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <input
          ...
          className="w-full px-4 py-3 rounded-lg border border-slate-200 dark:border-navy-700 bg-white dark:bg-navy-800 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-c-focus"
        />
        <textarea
          value={description}
