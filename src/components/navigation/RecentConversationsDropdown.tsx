  ...
  return (
    <div ref={containerRef} className={wrapperClass}>
      <button
        ...
        className="ml-0.5 inline-flex h-5 w-5 items-center justify-center rounded hover:bg-slate-100 dark:hover:bg-navy-800 focus:outline-none focus:ring-2 focus:ring-c-focus text-slate-500 dark:text-slate-400"
      >
