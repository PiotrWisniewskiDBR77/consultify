        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {stakeholders.map((s) => (
              <div
                key={s.id}
                className="bg-white dark:bg-navy-900 border border-slate-200 dark:border-navy-700 p-4 rounded-xl shadow-sm relative group hover:border-yellow-500/50 transition-colors"
              >
                <input
                  value={s.name}
                ...
                <input
                  ...
                  className="text-xs text-slate-500 dark:text-slate-400 bg-transparent outline-none w-full mb-3 uppercase tracking-wide"
                />

                <div className="flex gap-2 mb-3">
                  <div className="flex-1">
                    <label className="text-[10px] text-slate-400 dark:text-slate-500 font-bold block mb-1">
                      Influence (1-5)
                    </label>
                    <input
                      type="number"
                      ...
                      className="w-full bg-slate-50 dark:bg-navy-950 p-1 rounded border border-slate-200 dark:border-navy-700 text-center text-sm"
                    />
                  </div>
                  <div className="flex-1">
                    <label className="text-[10px] text-slate-400 dark:text-slate-500 font-bold block mb-1">
                ...
                <textarea
                  ...
                  className="w-full bg-slate-50 dark:bg-navy-950 p-2 rounded border border-slate-200 dark:border-navy-700 text-xs h-20 resize-none"
                />
              </div>
            ))}
          </div>
      ...
      {subTab === 'comms' && (
        <div className="bg-white dark:bg-navy-900 rounded-xl border border-slate-200 dark:border-navy-700 overflow-hidden">
          <table className="w-full text-left">
            <thead className="bg-slate-50 dark:bg-navy-950 text-xs uppercase text-slate-500 dark:text-slate-400 font-bold">
              <tr>
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-white/5">
              ...
              <tr className="hover:bg-slate-50 dark:hover:bg-white/5">
                ...
                <td className="p-4 text-sm text-slate-500 dark:text-slate-400">All Company</td>
                <td className="p-4">
                  <span className="flex items-center gap-1 text-xs text-blue-500 bg-blue-50 px-2 py-1 rounded">
                    <Mic size={12} /> Townhall
                  </span>
                </td>
                <td className="p-4 text-sm text-slate-500 dark:text-slate-400">Oct 15, 2025</td>
                <td className="p-4">
          ...
          <div className="p-4 text-center border-t border-slate-100 dark:border-navy-700">
