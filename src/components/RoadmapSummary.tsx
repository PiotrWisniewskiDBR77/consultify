...
export const RoadmapSummary: React.FC<RoadmapSummaryProps> = ({ summary, isLoading }) => {
  if (isLoading) {
    return (
      <div className="bg-white dark:bg-navy-800 border border-slate-200 dark:border-navy-700 rounded-xl p-6 shadow-sm animate-pulse">
  ...
  return (
    <div className="bg-gradient-to-br from-white to-slate-50 dark:from-navy-800 dark:to-navy-900 border border-slate-200 dark:border-navy-700 rounded-xl p-4 shadow-sm relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
        ...
        <div className="space-y-4 border-l border-slate-200 dark:border-navy-700 pl-6">
          {summary.riskText && (
            <div>
