...
export const FullReportDocument: React.FC<FullReportDocumentProps> = ({ report }) => {
  ...
  return (
    <div className="h-full bg-gray-50 dark:bg-navy-950 flex flex-col">
      ...
      <div
        className="flex-1 overflow-y-auto p-8 lg:p-12 print:p-0 print:overflow-visible"
      ...
      >
        <div className="max-w-4xl mx-auto bg-white dark:bg-navy-900/50 p-8 lg:p-16 rounded-xl border border-slate-200 dark:border-navy-700 shadow-xl dark:shadow-2xl print:shadow-none print:border-none print:max-w-none">
          ...
          <div className="text-center mb-16 border-b-2 border-primary-500 pb-8">
            <div className="text-sm font-bold tracking-[0.3em] text-slate-600 dark:text-slate-500 uppercase mb-4">
              CONFIDENTIAL
            </div>
            ...
            <p className="text-xl text-slate-500 dark:text-slate-400">
              Strategic Assessment & Execution Roadmap
            </p>
          </div>

          {/* 1. Executive Summary */}
          <SectionHeader title={t.sections.exec} />
          <div className="prose prose-slate dark:prose-invert prose-p:text-slate-600 dark:text-slate-400 dark:prose-p:text-slate-300 prose-p:leading-relaxed max-w-none mb-12">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                ...
                <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
                  ...
                  <div className="text-xl font-bold text-blue-700 dark:text-blue-300">
                    {report.financials.payback.toFixed(1)}{' '}
          ...
          {/* Footer */}
          <div className="mt-24 pt-8 border-t border-slate-200 dark:border-navy-700 text-center text-xs text-slate-600 dark:text-slate-500">
            <p>
              CONFIDENTIAL - Generated by CONSULTIFY AI for{' '}
