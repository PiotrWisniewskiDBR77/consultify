              ...
              >
                ...
                <div className="flex items-center gap-2 pt-1">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium text-danger-600 dark:text-danger-400 hover:bg-danger-500/10 transition-colors"
                  >
                    <X size={14} />
