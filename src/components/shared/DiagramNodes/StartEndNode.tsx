    ...
    return (
      <div
        className={`
                ...
                ${isStart ? 'border-green-500 bg-green-50 dark:bg-green-500/10' : 'border-rose-500 bg-rose-50 dark:bg-rose-500/10'}
      ...
      >
        ...
        <div className="flex items-center justify-center gap-2">
          ...
          <span
            className={`font-medium text-sm ${isStart ? 'text-green-600 dark:text-green-400' : 'text-rose-600 dark:text-rose-400'}`}
          >
