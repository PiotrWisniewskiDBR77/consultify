    ...
    return (
      <div
        className={`
                ...
                ${isStart ? 'border-green-500 bg-green-50 dark:bg-green-500/10' : 'border-danger-500 bg-danger-50 dark:bg-danger-500/10'}
      ...
      >
        ...
        <div className="flex items-center justify-center gap-2">
          {isStart ? (
            ...
            <Flag size={14} className="text-danger-600 dark:text-danger-400" />
          )}
          <span
            className={`font-medium text-sm ${isStart ? 'text-green-600 dark:text-green-400' : 'text-danger-600 dark:text-danger-400'}`}
          >
