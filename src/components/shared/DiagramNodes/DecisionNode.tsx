    ...
    return (
      <div className="relative">
        ...
        <Handle
          ...
          id="no"
          isConnectable={isConnectable}
          className="!w-3 !h-3 !bg-danger-500 !border-2 !border-white dark:!border-slate-800"
        />
        <span className="absolute bottom-[-20px] left-1/2 -translate-x-1/2 text-[10px] text-danger-600 dark:text-danger-400 font-medium">
          {noLabel}
        </span>
      </div>
    );
