          ...
          <div className="relative mx-4 w-full max-w-2xl rounded-2xl border border-slate-200 dark:border-navy-700 bg-white dark:bg-navy-900 shadow-2xl">
            ...
            <div className="space-y-4 p-6">
              ...
              <button
                ...
                className="inline-flex h-10 w-full items-center justify-center gap-2 rounded-full bg-c-text px-4 text-sm font-medium text-c-bg hover:bg-c-text-secondary disabled:opacity-50"
              >
                <Plus size={14} />
