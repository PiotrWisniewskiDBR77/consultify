/**
 * BEZPIECZNIK JĘZYKOWY MODUŁU 08 RESULTS (paczka J-DOG-C, DEC-453, 2026-09-09).
 *
 ...
 *
 * ZASIĘG: `src/components/Results/**`, `src/components/ResultsVNext/**`,
 * `src/components/Benefits/**`, `src/components/Conclusions/**`.
 *
...
const KATALOGI = [
  __dirname + '/..',
  __dirname + '/../../ResultsVNext',
  __dirname + '/../../Benefits',
  __dirname + '/../../Conclusions',
];

describe('J-DOG-C — moduł Results mówi po angielsku w kodzie (bez ogonków też)', () => {
