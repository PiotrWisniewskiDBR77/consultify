    ...
    <div className="p-4 space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="rounded-xl bg-white dark:bg-navy-900 border border-slate-200/70 dark:border-navy-700 p-4">
          ...
          <p className="text-lg font-semibold text-slate-900 dark:text-white">{formatCurrency(totalPlanned)}</p>
        </div>
        <div className="rounded-xl bg-white dark:bg-navy-900 border border-slate-200/70 dark:border-navy-700 p-4">
          <div className="flex items-center gap-2 mb-1">
          ...
          <p className="text-lg font-semibold text-slate-900 dark:text-white">{formatCurrency(totalRealized)}</p>
        </div>
        <div className="rounded-xl bg-white dark:bg-navy-900 border border-slate-200/70 dark:border-navy-700 p-4">
          <div className="flex items-center gap-2 mb-1">
            {totalVariance >= 0 ? (
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-slate-50/80 dark:bg-navy-900/50 border-b border-slate-200/60 dark:border-navy-700/50">
                ...
                <th className="px-4 py-3 text-right text-xs font-medium text-slate-500 uppercase tracking-wider w-16" aria-label="Row actions">
                      ...
                      <td className="px-4 py-3 text-right">
                        <div className="relative">
                          <button
                            ...
                            className="p-1.5 rounded hover:bg-slate-100 dark:hover:bg-navy-700 text-slate-500 hover:text-slate-900 dark:hover:text-white transition-colors h-8 w-8 flex items-center justify-center"
                          >
