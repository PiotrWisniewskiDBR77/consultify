  ...
  return (
    <div className="p-4 space-y-4">
      ...
      {filteredItems.length > 0 && (
        <div className="rounded-xl bg-white dark:bg-c-surface border border-c-border/70 dark:border-c-border p-4">
          <h3 className="text-sm font-medium text-c-text-secondary dark:text-c-text-secondary mb-3">
              ...
              .map((item, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    />
                    <span className="text-[10px] text-c-text-muted truncate max-w-full mt-1 opacity-0 group-hover:opacity-100">
