...
const USAGE_TYPE_CONFIG: Record<string, { icon: React.ReactNode; color: string; label: string }> = {
  ...
  other: {
    ...
    color: 'bg-slate-50 dark:bg-navy-800/300',
    label: 'Other',
  },
};
      ...
      <div className={`grid ${compact ? 'grid-cols-2' : 'grid-cols-4'} gap-4`}>
        ...
        <div className="bg-white dark:bg-navy-900 rounded-xl border border-slate-200 dark:border-navy-700 p-4">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
            {t('analytics.tokensUsed', 'Tokens Used')}
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-navy-900 rounded-xl border border-slate-200 dark:border-navy-700 p-4">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
            {t('analytics.avgDaily', 'Avg Daily Usage')}
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-navy-900 rounded-xl border border-slate-200 dark:border-navy-700 p-4">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
            {t('analytics.daysRemaining', 'Est. Days Left')}
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-navy-900 rounded-xl border border-slate-200 dark:border-navy-700 p-4">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
            {t('analytics.costThisMonth', 'Cost This Month')}
          </p>
        </div>
      </div>
