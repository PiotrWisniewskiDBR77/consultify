...
const HelpButton: React.FC<HelpButtonProps> = ({ onClick }) => {
  ...
  return (
    <>
      ...
      <button
        onClick={onClick}
        className="fixed bottom-6 right-6 z-30 flex items-center justify-center w-14 h-14 text-white rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:scale-105 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-c-focus"
        style={{
