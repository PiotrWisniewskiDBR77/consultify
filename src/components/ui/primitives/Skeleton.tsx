...
export const CardSkeleton: React.FC<CardSkeletonProps> = ({
  ...
  return (
    <div className="p-4 rounded-xl bg-white dark:bg-navy-800 shadow-hig-md">
      {/* Header */}
      ...
      {/* Actions */}
      {actions && (
        <div className="flex gap-2 mt-4 pt-4 border-t border-slate-200 dark:border-navy-700">
...
export const AvatarGroupSkeleton: React.FC<AvatarGroupSkeletonProps> = ({
  count = 4,
  size = 32,
}) => {
  return (
