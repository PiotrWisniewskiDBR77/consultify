        ...
        className={`
          ...
          ${
            isPills
              ...
              : 'gap-0 border-b border-slate-200 dark:border-navy-700'
          }
          ${className}
        `}
        {...props}
          ...
          {React.Children.map(children, (child) => {
            if (React.isValidElement(child)) {
              return React.cloneElement(
                child as React.ReactElement<{ setIndicatorStyle?: typeof setIndicatorStyle }>,
                {
                  setIndicatorStyle,
                }
              );
...
export const TabsTrigger = React.forwardRef<HTMLButtonElement, TabsTriggerProps>(
  (
    { value: tabValue, disabled, icon, children, setIndicatorStyle, className = '', ...props },
    ref
  ) => {
