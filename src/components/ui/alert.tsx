...
const variantStyles: Record<AlertVariant, string> = {
    ...
    success: 'border-green-500/50 text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/20',
    warning: 'border-yellow-500/50 text-yellow-600 dark:text-yellow-400 bg-yellow-50 dark:bg-yellow-900/20',
};
