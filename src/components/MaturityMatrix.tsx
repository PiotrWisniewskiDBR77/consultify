...
export const MaturityMatrix: React.FC<MaturityMatrixProps> = ({
    ...
    return (
        <div className="flex flex-col h-full bg-slate-50 dark:bg-navy-950 text-navy-900 dark:text-slate-100 font-sans selection:bg-blue-500/30 transition-colors duration-300">
            {/* 1. Top Bar: Progress & Context */}
            <div className="shrink-0 h-14 border-b border-slate-200 dark:border-white/5 flex items-center px-6 justify-between bg-white dark:bg-navy-950 transition-colors duration-300">
            ...
            <div className="flex-1 flex overflow-hidden">
                ...
                <div className="w-64 border-r border-slate-200 dark:border-white/5 bg-slate-50 dark:bg-navy-900 overflow-y-auto custom-scrollbar transition-colors duration-300">
                    <div className="p-4">
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-full text-left px-3 py-2.5 rounded-lg flex items-center justify-between transition-all duration-200 group ${
                                            isSelected
                                                ? 'bg-blue-50 dark:bg-blue-600/10 text-blue-600 dark:text-white shadow-sm ring-1 ring-blue-500/20'
                                                : 'text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-white/5 hover:text-navy-900 dark:hover:text-slate-200'
                                        }`}
                                    >
                ...
                <div className="flex-1 overflow-y-auto bg-gradient-to-br from-white to-slate-50 dark:from-navy-950 dark:to-navy-900 p-6 relative transition-colors duration-300">
                                                        ...
                                                        {!aiResult ? (
                                                            <>
                                                                <p className="text-[10px] text-purple-600/70 dark:text-purple-200/70 mb-2">
                                                                    Describe your current processes, tools, and
                                                                    challenges regarding {currentArea.name}.
                                                                </p>
                                                                <textarea
                                                                    value={aiInput}
                                    ...
                                    {currentArea.levels.map((level) => {
                                        ...
                                        return (
                                            <motion.button
                                                ...
                                                className={`group relative text-left p-4 rounded-xl border transition-all duration-300 w-full ${
                                                    isSelected
                                                        ? 'bg-blue-50 dark:bg-blue-600/10 border-blue-500 shadow-md shadow-blue-500/10 z-10'
                                                        : 'bg-white dark:bg-navy-900 border-slate-200 dark:border-white/5 hover:border-blue-400/30 hover:bg-slate-50 dark:hover:bg-navy-800'
                                                }`}
                                            >
                                                        ...
                                                        <h4
                                                            className={`text-sm font-bold mb-1 transition-colors ${
                                                                isSelected
                                                                    ...
                                                                    : 'text-navy-900 dark:text-slate-200 group-hover:text-blue-600 dark:group-hover:text-white'
                                                            }`}
                                                        >
                                                            {level.title}
                                                        </h4>
                                                        <p
                                                            className={`text-xs leading-relaxed transition-colors ${
                                                                isSelected
                                                                    ...
                                                                    : 'text-slate-500 dark:text-slate-400 group-hover:text-navy-700 dark:group-hover:text-slate-300'
                                                            }`}
                                                        >
                                                            {level.description}
                                                        </p>
