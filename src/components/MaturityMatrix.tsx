...
export const MaturityMatrix: React.FC<MaturityMatrixProps> = ({
  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 dark:bg-navy-950 text-navy-900 dark:text-slate-100 font-sans selection:bg-blue-500/30 transition-colors duration-300">
      ...
      <div className="shrink-0 h-14 border-b border-slate-200 dark:border-navy-700 flex items-center px-6 justify-between bg-white dark:bg-navy-950 transition-colors duration-300">
                      ...
                      <motion.button
                        ...
                        className={`group relative text-left p-4 rounded-xl border transition-all duration-300 w-full ${
                          isSelected
                            ...
                            : 'bg-white dark:bg-navy-900 border-slate-200 dark:border-navy-700 hover:border-blue-400/30 hover:bg-slate-50 dark:hover:bg-navy-800'
                        }`}
                      >
