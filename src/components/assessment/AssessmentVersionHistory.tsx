...
export const AssessmentVersionHistory: React.FC<AssessmentVersionHistoryProps> = ({
  ...
  const { versions, fetchVersions, restoreVersion, isLoading, error } =
      ...
      <div className="p-4 border-b border-slate-200 dark:border-navy-700 flex items-center justify-between">
        ...
        {selectedForCompare.length === 2 && onCompareVersions && (
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-navy-900 dark:bg-[#F4F7FB] hover:bg-navy-800 dark:hover:bg-[#DDE5EF] text-white dark:text-navy-950 text-sm font-medium rounded-lg transition-colors"
          >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                      {version.data.axes &&
                        Object.entries(version.data.axes).map(([axis, data]: [string, any]) => (
                          <div
                            key={axis}
                            className="bg-white dark:bg-navy-900 rounded-lg p-3 border border-slate-200 dark:border-navy-700"
                          >
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-amber-700 dark:text-amber-300 mt-1">
                          Czy na pewno chcesz przywrócić tę wersję? Obecna wersja zostanie zapisana
                          w historii.
                        </p>
