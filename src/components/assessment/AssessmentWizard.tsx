  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 dark:bg-navy-900 text-navy-900 dark:text-white relative overflow-hidden transition-colors">
      ...
      <div className="relative z-10 flex-1 flex flex-col max-w-4xl mx-auto w-full p-8 justify-center min-h-[500px]">
        ...
        <button
          onClick={onCancel}
          className="absolute top-8 left-8 text-slate-500 dark:text-slate-400 hover:text-navy-900 dark:hover:text-white transition-colors flex items-center gap-2 text-sm"
        >
          <ArrowLeft size={16} />
          {wizT.cancel || 'Cancel'}
        </button>
        ...
        {step === 'result' && (
          <div className="text-center max-w-xl mx-auto animate-in fade-in slide-in-from-bottom-8 duration-700">
            ...
            <div className="space-y-4">
              ...
              <button
                onClick={onCancel}
                className="w-full bg-slate-100 dark:bg-white/5 hover:bg-slate-200 dark:hover:bg-navy-700 dark:hover:bg-white/10 text-slate-600 dark:text-slate-300 px-8 py-4 rounded-xl font-semibold transition-colors"
              >
                {wizT.adjustManually}
              </button>
            </div>
