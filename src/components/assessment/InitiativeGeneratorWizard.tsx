...
export const InitiativeGeneratorWizard: React.FC<InitiativeGeneratorWizardProps> = ({
      ...
      return (
        <div className="flex flex-col items-center justify-center py-16">
          <div className="relative">
            <div className="w-20 h-20 rounded-full border-4 border-primary-200 dark:border-primary-800" />
            <div className="absolute inset-0 w-20 h-20 rounded-full border-4 border-primary-500 border-t-transparent animate-spin" />
            <Brain size={32} className="absolute inset-0 m-auto text-primary-500" />
          </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          <select
            ...
            onChange={(e) =>
              setConstraints((prev: any) => ({ ...prev, maxTimeline: e.target.value }))
            }
            className="w-full px-4 py-2.5 rounded-lg border border-slate-200 dark:border-navy-700 bg-white dark:bg-navy-950 text-navy-900 dark:text-white"
          >
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-slate-100 dark:bg-navy-800/40 dark:bg-white/10 hover:bg-slate-200 dark:hover:bg-white/20 text-slate-700 dark:text-slate-300 rounded-lg text-sm font-medium transition-colors"
        >
          <Plus size={16} />
          Add Custom
        </button>
        ...
        <>
          ...
          <div className="p-6 bg-gradient-to-r from-primary-600 to-crimson-600 rounded-xl text-white">
            ...
            <div className="grid grid-cols-3 gap-6">
              <div>
                <p className="text-primary-200 text-sm">Initiatives</p>
              ...
              <div>
                <p className="text-primary-200 text-sm">Expected ROI</p>
          ...
          {/* Initiative List */}
          <div className="divide-y divide-slate-200 dark:divide-white/10 border border-slate-200 dark:border-navy-700 rounded-xl overflow-hidden">
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-navy-900">
      ...
      {/* Progress Steps */}
      <div className="shrink-0 px-6 py-4 border-b border-slate-200 dark:border-navy-700 bg-slate-50 dark:bg-navy-950">
          ...
          <div className="flex items-center gap-3">
            {stepIndex > 0 && !transferResult && (
              <button
                ...
                className="flex items-center gap-2 px-4 py-2.5 border border-slate-200 dark:border-navy-700 hover:bg-slate-100 dark:hover:bg-white/5 text-slate-700 dark:text-slate-300 rounded-lg font-medium transition-colors disabled:opacity-50"
              >
                <ArrowLeft size={18} />
                Back
              </button>
            ...
            {currentStep !== 'approve' ? (
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-2.5 bg-navy-900 hover:bg-navy-800 text-white dark:bg-[#F4F7FB] dark:text-navy-950 dark:hover:bg-[#DDE5EF] rounded-lg font-medium transition-colors"
              >
