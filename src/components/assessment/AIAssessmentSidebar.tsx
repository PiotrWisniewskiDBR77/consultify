...
export const AIAssessmentSidebar: React.FC<AIAssessmentSidebarProps> = ({
  ...
  return (
    <div className="w-80 h-full bg-white dark:bg-navy-900 border-l border-slate-200 dark:border-navy-700 flex flex-col shadow-xl">
      {/* Header */}
      <div className="p-4 border-b border-slate-200 dark:border-navy-700 flex items-center justify-between">
        ...
        >
          <X size={16} className="text-slate-500 dark:text-slate-400 dark:text-slate-500" />
        </button>
      </div>
            ...
            {isLoadingInsights ? (
              ...
              insights.map((insight, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className={`rounded-xl border border-slate-200 dark:border-navy-700 overflow-hidden ${config.bgColor}`}
                  >
                    <button
                    ...
                    >
                      ...
                      {isExpanded ? (
                        <ChevronDown
                          size={14}
                          className="text-slate-500 dark:text-slate-400 dark:text-slate-500 shrink-0"
                        />
                      ) : (
                        <ChevronRight
                          size={14}
