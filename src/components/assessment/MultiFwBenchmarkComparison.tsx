...
export const MultiFwBenchmarkComparison: React.FC<MultiFwBenchmarkComparisonProps> = ({
    ...
    const generateMockBenchmarkData = (): BenchmarkData => {
        ...
        const percentile = Math.round(((scoreResult.overall - 1) / 4) * 100 * (0.8 + Math.random() * 0.4));
        ...
        return {
            industry: selectedIndustry,
            industryName: INDUSTRY_OPTIONS[framework]?.find((i) => i.id === selectedIndustry)?.name || selectedIndustry,
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-white dark:bg-navy-800 rounded-xl p-6 border border-gray-200 dark:border-navy-700">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-xs text-gray-500">vs Industry Average</span>
                    </div>
                ...
                <div className="bg-white dark:bg-navy-800 rounded-xl p-6 border border-gray-200 dark:border-navy-700">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-xs text-gray-500">Benchmark Data</span>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                {/* Gap Chart */}
                <div className="bg-white dark:bg-navy-800 rounded-xl p-6 border border-gray-200 dark:border-navy-700">
                    <h3 className="font-semibold text-gray-900 dark:text-white mb-4">Gap to Industry Average</h3>
                    <div className="h-[300px]">
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={barData} layout="vertical">
                                ...
                                />
                                <Tooltip formatter={(value: any) => [value > 0 ? `+${value}` : value, 'Gap'] as any} />
            ...
            <div className="flex items-start gap-3 p-4 bg-gray-50 dark:bg-navy-900 rounded-lg">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">
                    Benchmark data is based on aggregated industry assessments and may not reflect the most recent
                    market conditions. Sample sizes vary by industry and region. Use these comparisons as guidance
