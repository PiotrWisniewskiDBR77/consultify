...
export const AssessmentVersionDiff: React.FC<AssessmentVersionDiffProps> = ({
  ...
  const axisDiffs: AxisDiff[] = Object.keys(AXIS_NAMES).map((axisId) => {
    ...
    const hasChanges =
      actualChange !== 0 || targetChange !== 0 || v1Justification !== v2Justification;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-white dark:bg-navy-900 rounded-xl w-full max-w-5xl max-h-[90vh] overflow-hidden flex flex-col shadow-2xl">
        {/* Header */}
        ...
        {/* Version Info */}
        <div className="grid grid-cols-2 gap-4 p-4 bg-slate-50 dark:bg-navy-950/50 border-b border-slate-200 dark:border-navy-700 shrink-0">
          {/* Older Version */}
          <div className="p-4 bg-white dark:bg-navy-900 rounded-xl border border-slate-200 dark:border-navy-700">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-slate-500 dark:text-slate-400">Starsza</span>
            </div>
        ...
        {/* Summary */}
        <div className="p-4 bg-slate-50 dark:bg-navy-950/50 border-b border-slate-200 dark:border-navy-700 shrink-0">
            ...
            <div>
              ...
              <div className="space-y-3">
                {changedAxes.map((diff) => (
                  <div
                    key={diff.axisId}
                    className="bg-white dark:bg-navy-950/50 rounded-xl border border-slate-200 dark:border-navy-700 overflow-hidden"
                  >
                    {/* Axis Header */}
                    <button
                      onClick={() =>
                    ...
                    {/* Justification Diff */}
                    {expandedAxis === diff.axisId && (
                      <div className="p-4 border-t border-slate-200 dark:border-navy-700 bg-slate-50 dark:bg-navy-950/30">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {unchangedAxes.map((diff) => (
                  <div
                    key={diff.axisId}
                    className="p-3 bg-slate-50 dark:bg-navy-950/50 rounded-lg border border-slate-200 dark:border-navy-700"
                  >
        ...
        {/* Footer */}
        <div className="p-4 border-t border-slate-200 dark:border-navy-700 shrink-0">
          <button
            onClick={onClose}
