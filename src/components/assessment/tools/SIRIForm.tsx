        ...
        {isExpanded && (
          <div className="px-4 pb-4 border-t border-slate-200 dark:border-navy-700 pt-4 space-y-4">
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <ChevronRight
                            size={16}
                            className={`text-slate-400 transition-transform ${isAreaExpanded ? 'rotate-90' : ''}`}
                          />
                        </div>
                      </button>
                      {isAreaExpanded && (
            ...
            <details className="text-sm">
              <summary className="text-slate-600 dark:text-slate-400 cursor-pointer hover:text-purple-600">
