...
export const AxisCommentsPanel: React.FC<Props> = ({
  ...
  return (
    <div className="bg-white dark:bg-navy-900 rounded-lg border border-slate-200 dark:border-navy-700 overflow-hidden">
      {/* Header */}
      <div
        className={`px-4 py-3 ${axisColors.bg} dark:bg-navy-800 border-b ${axisColors.border} dark:border-navy-700`}
      >
...
const CommentThread: React.FC<CommentThreadProps> = ({
  ...
  return (
    <div
      className={`${depth > 0 ? 'ml-8 pt-3 border-l-2 border-slate-200 dark:border-navy-700 pl-4' : ''}`}
    >
              ...
              <div className="mt-3 flex gap-2">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <button
                    ...
                    className="p-2 text-slate-500 hover:text-slate-700 dark:text-slate-300 dark:hover:text-slate-300"
                  >
                    ✕
                  </button>
                </div>
