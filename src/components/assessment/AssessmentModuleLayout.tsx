...
export const AssessmentModuleLayout: React.FC<AssessmentModuleLayoutProps> = ({
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-navy-900">
      ...
      <div className="shrink-0 border-b border-slate-200 dark:border-navy-800 bg-white dark:bg-navy-900">
        <div className="flex items-center justify-between px-6">
              ...
              return (
                <button
                  ...
                  className={`
                                        ...
                                        ${
                                          isActive
                                            ? 'border-navy-900 dark:border-white/70 text-slate-900 dark:text-white'
          ...
          {showGenerateButton && onGenerateClick && (
            <button
              ...
              className="flex items-center gap-2 p-4 py-2.5 bg-gradient-to-r from-green-600 to-emerald-500 hover:from-green-500 hover:to-emerald-400 text-white rounded-lg text-sm font-semibold shadow-lg shadow-green-900/20 transition-all"
            >
              <Sparkles size={16} />
