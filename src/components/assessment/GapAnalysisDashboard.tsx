        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-green-100 mt-2 max-w-xl">
              Transform assessment gaps into actionable transformation initiatives. Our AI will
              analyze your maturity gaps and generate prioritized initiatives with estimated ROI,
          ...
          <div className="flex flex-col gap-2">
            {onNavigateToGenerator && (
              <button
                ...
                className="px-6 py-3 bg-white dark:bg-navy-900 text-green-600 rounded-lg hover:bg-green-50 flex items-center gap-2 font-semibold shadow-lg transition-all hover:scale-105"
              >
