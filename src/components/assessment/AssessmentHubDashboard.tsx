...
export const AssessmentHubDashboard: React.FC<AssessmentHubProps> = ({
    ...
    return (
      ...
      >
        <div className="flex items-center justify-center h-64">
          <div className="text-slate-500 dark:text-slate-400">Loading assessment overview...</div>
        </div>
      </SplitLayout>
    );
  }
  ...
  if (!overview) {
    return (
      ...
      >
        <div className="flex items-center justify-center h-64">
          <div className="text-slate-500 dark:text-slate-400">No assessment data available</div>
        </div>
      </SplitLayout>
    );
  }
