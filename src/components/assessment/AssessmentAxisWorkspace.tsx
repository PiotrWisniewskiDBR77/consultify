...
export const AssessmentAxisWorkspace: React.FC<AssessmentAxisWorkspaceProps> = ({
    ...
    return (
        ...
        >
            ...
            {/* Header - Responsive */}
            <div
                className={`border-b border-slate-200 dark:border-white/5 bg-white dark:bg-navy-900 shrink-0 z-20 relative ${isCompact ? 'px-4 py-3' : 'h-20 px-6 flex items-center justify-between'}`}
            >
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <div className="flex flex-col">
                                ...
                                <h2 className="text-xl font-bold text-navy-900 dark:text-white flex items-center gap-2">
                                    ...
                                    <Info
                                        size={14}
                                        className="text-slate-500 cursor-pointer hover:text-navy-900 dark:hover:text-white transition-colors"
                                    />
                                </h2>
                            </div>
                            ...
                            {hasSubAreas && (
                                <div className="relative group ml-4 pl-4 border-l border-slate-200 dark:border-white/10">
                                    <span className="text-[10px] text-slate-500 font-bold uppercase tracking-widest mb-0.5 block">
                                        {workspaceT.functionalArea || 'FUNCTIONAL AREA'}
                                    </span>
            ...
            {isCompact && (
                <LevelNavigator
                    levels={
                        (hasSubAreas && activeArea ? activeArea.levels : mainLevelsRecord) as Record<string, string>
                    }
                        ...
                        <LevelDetailCard
                            ...
                            title={
                                (hasSubAreas && activeArea
                                    ...
                                    : mainLevelsRecord[currentLevelView]) || `${t('common.level')} ${currentLevelView}`
                            }
                            description={
