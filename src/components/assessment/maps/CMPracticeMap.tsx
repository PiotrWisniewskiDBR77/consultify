    ...
    return (
        ...
        >
            ...
            <button onClick={onToggleExpand} className="w-full p-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    <div className={`px-3 py-1 rounded-lg bg-${config.color}-100 dark:bg-${config.color}-900/30`}>
                            ...
                            return (
                                ...
                                >
                                    <div className="w-12 text-center">
                                        <span className="text-xs font-mono font-bold text-slate-500">{pa.code}</span>
                                    </div>
                                                ...
                                                <button
                                                    ...
                                                    className={`w-8 h-8 rounded text-xs font-bold transition-all ${
                                                        isSelected
                                                            ...
                                                            : 'bg-white dark:bg-navy-800 text-slate-500 hover:bg-slate-100 dark:hover:bg-navy-700'
...
const CMMILegalNotice: React.FC = () => (
    <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-500/30 rounded-lg p-4 flex items-start gap-3">
        ...
        <div className="text-sm text-amber-800 dark:text-amber-200">
            ...
            Implementacja w Consultinity służy <strong>celom edukacyjnym</strong>.
        </div>
    </div>
);
