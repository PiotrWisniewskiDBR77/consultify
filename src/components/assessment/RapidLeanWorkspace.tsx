      ...
      <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex items-start justify-between">
          ...
          <button
            ...
            className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:bg-navy-800 dark:hover:bg-gray-700 flex items-center gap-2"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs text-gray-500 dark:text-gray-400 ml-auto">15-20 min</span>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs text-gray-500 dark:text-gray-400 ml-auto">60-90 min</span>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                {assessmentHistory.map((item, index) => {
                  ...
                  return (
                    <tr
                      key={item.id}
                      className="hover:bg-gray-50 dark:bg-navy-800 dark:hover:bg-gray-700/50"
                    >
      ...
      <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
          <p className="text-gray-600 dark:text-gray-400">
            Report generated successfully. Download PDF to view full report.
          </p>
        </div>
      </div>
    );
