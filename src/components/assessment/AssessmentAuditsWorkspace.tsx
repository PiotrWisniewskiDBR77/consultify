...
export const AssessmentAuditsWorkspace: React.FC<AssessmentAuditsWorkspaceProps> = ({
  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 dark:bg-navy-900 text-navy-900 dark:text-white p-8">
      <div className="mb-8">
        ...
        {audits.map((audit) => (
          ...
          >
            ...
            <div className="flex items-start gap-3 mb-3">
              ...
              <div>
                <h3 className="font-semibold text-navy-900 dark:text-white">{audit.name}</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400">{audit.date}</p>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-navy-800 border border-primary-500/50 rounded-xl p-4 shadow-lg shadow-primary-900/20">
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                <input
                  type="date"
                  className="w-1/2 bg-slate-50 dark:bg-navy-900 border border-slate-200 dark:border-navy-700 rounded px-3 py-2 text-sm text-slate-600 dark:text-slate-300 focus:outline-none"
                  value={newAudit.date || ''}
                ...
                <input
                  type="text"
                  placeholder="Score"
                  className="w-1/2 bg-slate-50 dark:bg-navy-900 border border-slate-200 dark:border-navy-700 rounded px-3 py-2 text-sm text-navy-900 dark:text-white focus:outline-none"
              ...
              <div className="border border-dashed border-slate-300 dark:border-navy-700 bg-slate-50 dark:bg-navy-900/50 rounded h-16 flex items-center justify-center text-xs text-slate-500 dark:text-slate-400 cursor-pointer hover:bg-slate-100 dark:hover:bg-navy-900 transition-colors">
