    ...
    <div className="bg-navy-800 rounded-xl border border-white/10 p-6 space-y-6">
      ...
      <div className="space-y-4">
        {policies.map((policy, index) => (
          <div
            key={policy.dataType}
            className="bg-navy-900 rounded-lg p-4 flex items-center justify-between"
          >
            <div>
              <div className="text-white font-medium">{policy.dataType}</div>
              <div className="text-sm text-slate-600 dark:text-slate-500 flex items-center gap-2 mt-1">
            ...
            <div className="flex items-center gap-4">
              <label className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-500">
                <input
                  ...
                  className="rounded border-slate-600 bg-navy-800 text-primary-500 focus:ring-primary-500"
                />
                Auto-delete
              </label>
              <input
                ...
                className="w-20 px-2 py-1 bg-navy-800 border border-white/10 rounded text-white text-sm"
              />
            </div>
          </div>
        ))}
