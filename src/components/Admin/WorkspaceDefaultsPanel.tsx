...
export const WorkspaceDefaultsPanel: React.FC<WorkspaceDefaultsPanelProps> = ({ className = '' }) => {
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="manager">{t('admin.defaults.projectManager', 'Project Manager')}</option>
