    ...
    const handleQuickAction = async (action: string) => {
        ...
        switch (action) {
            ...
            case 'improve':
                ...
                break;
            case 'variables':
                message = 'What variables are available for language-independent prompts? Show me examples.';
                break;
            case 'best-practices':
                message = 'What are the top 5 best practices for creating effective, language-independent prompts?';
                break;
        }
        ...
        >
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-slate-200 dark:border-white/10">
                ...
                <button
                    ...
                    className="p-1.5 text-slate-400 hover:text-slate-600 dark:hover:text-white rounded-lg hover:bg-slate-100 dark:hover:bg-navy-800"
                    title="Clear history"
                >
                    <Trash2 size={16} />
                </button>
