                ...
                >
                    ...
                    {isEditing ? (
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          className="h-7 w-7 p-0 text-slate-500 dark:text-slate-400"
                        >
                          <X size={14} />
                        </Button>
                      </div>
                  ...
                  {!isEditing && (
                    <div className="flex items-center gap-1">
                      ...
                      {!bounceInfo.canRetry && (
                        <Tooltip
                          content={t('admin.team.bounced.editAndResend', 'Edit email and resend')}
                        >
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => {
                              setEditingEmail(invitation.id);
                              setCorrectedEmail(invitation.suggestedEmail || invitation.email);
                            }}
                            className="h-8 w-8 p-0"
                          >
                            <Mail size={14} />
