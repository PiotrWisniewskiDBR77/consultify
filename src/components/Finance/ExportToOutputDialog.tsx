        ...
        >
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full pl-3 pr-10 py-2.5 rounded-lg border border-slate-200 dark:border-navy-700 bg-white dark:bg-navy-800 text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-c-focus focus:border-transparent appearance-none"
                  >
                    {loadingTemplates ? (
          ...
          <div className="px-6 py-4 border-t border-slate-200 dark:border-navy-700 flex justify-end">
            <button
              ...
              className="px-4 py-2 rounded-full bg-c-text hover:bg-c-text-secondary text-c-bg text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {submitting ? (
                <>
