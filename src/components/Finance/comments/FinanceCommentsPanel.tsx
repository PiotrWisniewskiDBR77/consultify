...
import {
  ...
  type FinanceCommentDto,
  type FinanceReviewChecklistItemDto,
...
type LoadState =
  ...
  | {
      kind: 'loaded';
      comments: FinanceCommentDto[];
      checklist: FinanceReviewChecklistItemDto[];
...
export function FinanceCommentsPanel({
  artifactId,
  businessVersionId,
  className,
    ...
    Promise.all([
      ...
      .then(([comments, checklist, blocking]) => {
        setState({
          ...
          comments,
          checklist,
          hasUnresolvedBlocking: blocking.hasUnresolvedBlockingComments,
        });
      })
  ...
  async function handleAddChecklistItem() {
    ...
    try {
      await addFinanceReviewChecklistItem({
        businessVersionId,
  ...
  if (state.kind === 'loading') {
    ...
    content = (
      <div
        ...
        data-testid="comments-panel-error"
      >
    ...
    content = (
      <div
        ...
        data-testid="finance-comments-panel"
      >
