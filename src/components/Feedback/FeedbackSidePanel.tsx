...
export const FeedbackSidePanel: React.FC = () => {
    ...
    const handleFeatureSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                handleSuccess(
                    data.aiSuggestion 
                        ? t('feedback.success.featureWithAI', 'Feature request submitted! AI found similar requests.')
            ...
            {reportType === 'BUG' && (
                <div>
                    ...
                    <div className="grid grid-cols-4 gap-1">
                        {[
                            { value: 'LOW', label: 'Low', color: 'text-green-500 bg-green-50 dark:bg-green-900/20' },
                            { value: 'MEDIUM', label: 'Medium', color: 'text-yellow-500 bg-yellow-50 dark:bg-yellow-900/20' },
                            { value: 'HIGH', label: 'High', color: 'text-orange-500 bg-orange-50 dark:bg-orange-900/20' },
                            { value: 'CRITICAL', label: 'Critical', color: 'text-red-500 bg-red-50 dark:bg-red-900/20' },
                            ...
                            <button
                                ...
                                className={`py-1.5 px-2 rounded-lg text-xs font-medium transition-all border ${
                                    severity === value
                                        ...
                                        : 'border-slate-200 dark:border-navy-700 text-slate-500'
                                }`}
                            >
                                {label}
                            </button>
            ...
            {!showPulseComment ? (
                <>
                    ...
                    <div className="flex items-center gap-3">
                        {[
                            { rating: 1, icon: Frown, label: 'Terrible', color: 'text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20' },
                            { rating: 2, icon: ThumbsDown, label: 'Poor', color: 'text-orange-500 hover:bg-orange-50 dark:hover:bg-orange-900/20' },
                            { rating: 3, icon: Meh, label: 'Okay', color: 'text-yellow-500 hover:bg-yellow-50 dark:hover:bg-yellow-900/20' },
                            { rating: 4, icon: Smile, label: 'Good', color: 'text-green-500 hover:bg-green-50 dark:hover:bg-green-900/20' },
                            { rating: 5, icon: ThumbsUp, label: 'Excellent', color: 'text-emerald-500 hover:bg-emerald-50 dark:hover:bg-emerald-900/20' },
                    ...
                    <div className="flex items-center gap-2 text-xs text-slate-400">
                        <BarChart3 size={12} />
                        <span>{t('feedback.pulse.context', 'Feedback for:')} {currentContext}</span>
                    </div>
                </>
            ) : (
        ...
        <form onSubmit={handleFeatureSubmit} className="flex flex-col gap-4 h-full">
                        ...
                        {aiInsights.slice(0, 2).map((insight, idx) => (
                            <div key={idx} className="flex items-start gap-2 text-xs">
                                ...
                                <div>
                                    ...
                                    <span className="text-purple-600 dark:text-purple-400"> - {insight.description}</span>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <div className="flex-1 flex flex-col">
                ...
                <textarea
                    ...
                    placeholder={t('feedback.feature.descPlaceholder', 'Describe the feature and how it would help you...')}
    ...
    return (
        <>
            ...
            {/* Panel */}
            <div className="fixed right-0 top-0 h-full w-[380px] max-w-[90vw] bg-white dark:bg-navy-950 shadow-2xl z-50 flex flex-col animate-in slide-in-from-right duration-200 border-l border-slate-200 dark:border-white/10">
                {/* Header */}
                ...
                {/* Footer */}
                {!showSuccess && (
                    <div className="px-4 py-3 border-t border-slate-100 dark:border-white/5 bg-slate-50 dark:bg-navy-900">
