    ...
    <div className={`space-y-4 ${className}`}>
      ...
      <div className="flex items-center justify-between">
        ...
        {value && (
          <button
            ...
            className="text-xs text-slate-400 dark:text-slate-500 hover:text-white transition-colors"
          >
            Clear selection
          </button>
        )}
                  ...
                  <div className="flex flex-wrap gap-1">
                    {model.capabilities.slice(0, 3).map((cap) => {
                      ...
                      return (
                        <span
                          key={cap}
                          className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-xs bg-slate-700/50 text-slate-300"
                        >
                  ...
                  className={`
                                        ...
                                        ${
                                          isVisible
                                            ...
                                            : 'bg-slate-700/50 text-slate-500 dark:text-slate-400 hover:text-slate-300'
                                        }
                                    `}
      ...
      {models.length === 0 && !loading && (
        <div className="text-center py-8">
          ...
          <p className="text-slate-400 dark:text-slate-500">No models available</p>
