...
export const REJESTR_KART_N: Record<KartaNKey, KartaNWpis> = {
  ...
  presentation: { nazwa: 'Prezentacja', komponent: 'src/components/Presentations/DeckBuilder/DeckBuilder.tsx', klasa: 'L', paragraf: 'DEC-432 · DEC-433 · DEC-434', statusMigracji: 'zmigrowana' },
  ...
  'template-architect-doc': { nazwa: 'Architekt wzorca dokumentu', komponent: 'src/components/DocumentStudio/DocumentStudioTemplateArchitectView.tsx', klasa: 'L', paragraf: 'DEC-432 · DEC-433 · DEC-434', statusMigracji: 'zmigrowana' },
  'template-architect-deck': { nazwa: 'Architekt wzorca prezentacji', komponent: 'src/components/Presentations/PresentationTemplateArchitectView.tsx', klasa: 'L', paragraf: 'DEC-432 · DEC-433 · DEC-434', statusMigracji: 'zmigrowana' },
  ...
  'report-builder': { nazwa: 'Raport', komponent: 'src/components/ReportBuilder/ReportEditor/ReportEditor.tsx', klasa: 'L', paragraf: 'DEC-432 · DEC-433 · DEC-434', statusMigracji: 'zmigrowana' },
  ...
  'finance-statement-pack': { nazwa: 'Pakiet sprawozdań finansowych', komponent: 'src/components/Finance/statementPackWorkspaceV2/StatementPackWorkspaceV2.tsx', klasa: 'L', paragraf: 'DEC-432 · DEC-433 · DEC-434 · DEC-440', statusMigracji: 'zmigrowana' },
