          ...
          {bundleStep ? (
            ...
            <div className="flex flex-col gap-4">
              ...
              <textarea
                ...
                className="w-full px-3 py-2 text-sm rounded-lg border border-slate-200 dark:border-navy-700 bg-white dark:bg-navy-950 text-slate-900 dark:text-white placeholder:text-slate-400 focus-visible:outline-none focus-visible:ring-2 focus:ring-c-focus resize-none"
              />
                ...
                <>
                  ...
                  <div className="mb-4 flex gap-2">
                    <input
                      ...
                      maxLength={1000}
                      className="flex-1 min-w-0 px-3 py-1.5 text-sm rounded-lg border border-slate-200 dark:border-navy-700 bg-white dark:bg-navy-950 text-slate-900 dark:text-white placeholder:text-slate-400 focus-visible:outline-none focus-visible:ring-2 focus:ring-c-focus"
                    />
                    <button
                      type="button"
