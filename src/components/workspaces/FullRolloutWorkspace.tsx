  ...
  const renderReports = () => (
    <div className="p-6">
      <StatusReportBuilder
        projectId={projectId}
        {...({
          projectName: (fullSession.rollout as any)?.projectName || 'Digital Transformation',
        } as any)}
      />
    </div>
  );
    ...
    <div className="flex flex-col h-full bg-navy-950 text-white">
      ...
      <div className="h-16 border-b border-white/10 px-6 flex items-center justify-between bg-navy-900/50 backdrop-blur-sm sticky top-0 z-10">
        ...
        <div className="flex items-center gap-3">
          <span className="text-xs text-slate-400 dark:text-slate-500 bg-slate-800 px-2 py-1 rounded">
