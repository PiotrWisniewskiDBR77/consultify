...
export const FullStep1Workspace: React.FC<FullStep1WorkspaceProps> = ({
  ...
  const axes: { id: AxisId; label: string; icon: React.ReactNode; desc: string }[] = [
    ...
    },
    {
      ...
      label: 'Cybersecurity',
      icon: <Lock size={22} />,
      desc: 'Security and Risk Management',
    },
    {
      id: 'aiMaturity',
  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 dark:bg-navy-950 text-navy-900 dark:text-slate-100 font-sans transition-colors duration-300">
      {/* Header Section */}
      <div className="h-12 px-4 border-b border-slate-200 dark:border-navy-700 flex items-center justify-between shrink-0 bg-white dark:bg-navy-950 transition-colors duration-300">
        <div>
                ...
                return (
                  <button
                    ...
                    className={`
                                        ...
                                        ${
                                          isCompleted
                                            ? 'bg-slate-50 dark:bg-navy-900/50 border-slate-200 dark:border-navy-700 opacity-60'
                                            : 'bg-white dark:bg-navy-900 border-slate-200 dark:border-navy-700 hover:border-blue-500/50 hover:bg-slate-50 dark:hover:bg-navy-800 hover:shadow-lg'
                                        }
                                    `}
                  >
