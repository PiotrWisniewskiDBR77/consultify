  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 dark:bg-navy-900">
      ...
      <div className="h-14 border-b border-slate-200 dark:border-white/5 flex flex-col justify-center p-4 bg-white dark:bg-navy-900 shrink-0">
        ...
        <div className="w-full h-1 bg-slate-200 dark:bg-navy-800 rounded-full overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-slate-50 dark:bg-navy-950/50 border border-slate-200 dark:border-white/5 p-3 rounded-xl">
            ...
            <div
              className={`text-xl font-bold ${economics.overallROI > 100 ? 'text-purple-400' : 'text-slate-900 dark:text-white'}`}
            >
        ...
        <div className="flex justify-end">
          <div className="bg-navy-950 p-1 rounded-lg border border-white/10 flex gap-1">
            <button
              ...
              className={`px-3 py-1.5 rounded text-xs font-medium flex items-center gap-2 transition-colors ${inputMode === 'range' ? 'bg-purple-600 text-white' : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white'}`}
            >
              <Sliders size={14} /> Estimate Ranges
            </button>
            <button
              onClick={() => setInputMode('precise')}
              className={`px-3 py-1.5 rounded text-xs font-medium flex items-center gap-2 transition-colors ${inputMode === 'precise' ? 'bg-purple-600 text-white' : 'text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white'}`}
            >
