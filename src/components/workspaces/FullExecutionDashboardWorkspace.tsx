...
import {
  Activity, AlertTriangle, ArrowRight, BarChart3, Bot, CheckCircle2, Clock, Download, FileText, LayoutDashboard, ListChecks, Shield, TrendingUp, Zap } from 'lucide-react';
...
export const FullExecutionDashboardWorkspace: React.FC<FullExecutionDashboardWorkspaceProps> = ({
          ...
          <div className="flex-1 glass-card p-6 relative flex flex-col">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="flex gap-2">
                <span className="px-2 py-1 rounded bg-slate-100 dark:bg-white/5 text-[10px] uppercase font-bold text-slate-500 dark:text-slate-400">
                  Milestone 1
                </span>
  ...
  const renderProgress = () => (
    <div className="glass-panel rounded-xl overflow-hidden animate-slide-up">
      <div className="p-6 border-b border-slate-200 dark:border-navy-700 flex justify-between items-center bg-slate-50/50 dark:bg-transparent">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left text-sm">
          <thead className="bg-slate-50 dark:bg-white/5 text-slate-500 dark:text-slate-400 uppercase text-[10px] font-bold tracking-wider">
            <tr>
                                        ...
                                        ${
                                          ...
                                          init.status === 'DONE'
                                            ...
                                            : (init.status as string) === 'In Progress' ||
                                              ...
                                              : 'bg-slate-100 dark:bg-white/5 text-slate-500 dark:text-slate-400 border-slate-200 dark:border-navy-700'
                                        }`}
                  >
  ...
  const renderAI = () => (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 h-full">
      <div className="glass-panel p-6 rounded-xl border-brand/20 relative overflow-hidden animate-fade-in">
      ...
      <div className="glass-card p-10 flex flex-col items-center justify-center text-center animate-fade-in delay-100">
        ...
        <p className="text-slate-500 dark:text-slate-400 mb-8 max-w-sm leading-relaxed">
          Ask complex questions about your transformation data. The AI has access to your KPIs,
          Risks, and Roadmap.
        </p>
        ...
        <div className="w-full max-w-md relative group">
          <input
            ...
            className="w-full bg-white dark:bg-navy-950 border border-slate-200 dark:border-navy-700 p-4 pl-6 rounded-xl text-sm focus:border-brand focus:ring-4 focus:ring-brand/10 outline-none transition-all shadow-lg dark:text-white group-hover:shadow-glow-lg/20"
          />
  ...
  const renderReport = () => (
    <div className="flex flex-col items-center justify-center min-h-[500px] text-center max-w-3xl mx-auto space-y-10 animate-fade-in">
      <div className="space-y-4 relative">
        ...
        <p className="text-slate-500 dark:text-slate-400 text-lg max-w-xl mx-auto relative z-10">
          Generate a comprehensive, board-ready PDF report encapsulating your entire Digital
        ...
        <div className="glass-card p-6">
          ...
          <ul className="text-sm text-slate-500 dark:text-slate-400 space-y-3">
            ...
            <li className="flex items-center justify-between opacity-60">
              ...
              <span className="text-[10px] bg-slate-100 dark:bg-white/10 text-slate-500 dark:text-slate-400 px-2 py-0.5 rounded font-bold">
                SOON
              </span>
            </li>
          </ul>
    ...
    <div className="flex flex-col h-full bg-gray-50 dark:bg-navy-950 text-navy-900 dark:text-white transition-colors">
      ...
      <div className="h-20 px-8 flex items-center justify-between shrink-0">
        ...
        <div className="flex items-center gap-4">
          <div className="hidden md:flex items-center gap-2 px-4 py-2 bg-white dark:bg-navy-900 rounded-full border border-slate-200 dark:border-navy-700 shadow-sm text-xs font-medium text-slate-500 dark:text-slate-400">
      ...
      <div className="px-8 pb-6">
        <div className="flex gap-1 p-1 bg-white/60 dark:bg-navy-900/60 backdrop-blur-md rounded-xl border border-slate-200 dark:border-navy-700 w-fit shadow-sm">
          {[
              ...
              className={`
                                ...
                                ${
                                  activeTab === tab.id
                                    ...
                                    : 'text-slate-500 dark:text-slate-400 hover:text-navy-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/5'
                                }
                            `}
            >
