    ...
    <div className="h-full flex flex-col bg-slate-50 dark:bg-navy-900 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Candidates List */}
          <div className="bg-white dark:bg-navy-950 rounded-xl border border-slate-200 dark:border-navy-700 p-4 shadow-sm">
            ...
            <div className="bg-blue-600/5 border border-blue-600/10 rounded-xl p-4 flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 dark:text-slate-300">
                  ...
                  <strong>{candidates[0]?.name || 'the top candidate'}</strong> is the optimal
                  pilot. It offers high visibility with manageable risk.
                </p>
              </div>
            </div>
              ...
              >
                ...
                <tbody className="divide-y divide-slate-200 dark:divide-white/5">
                  <tr>
                    ...
                    <td className="p-4 text-slate-500 dark:text-slate-400">Slow (6-12 months)</td>
                  </tr>
                  <tr>
