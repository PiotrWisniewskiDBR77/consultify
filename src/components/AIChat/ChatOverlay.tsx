  ...
  if (!isChatOpen) {
    ...
    return (
      <button
        data-tour="ai-panel"
        onClick={toggleChat}
        className="fixed bottom-6 right-6 w-14 h-14 bg-gradient-to-r from-c-surface-raised to-indigo-600 hover:from-c-surface-hover hover:to-indigo-500 text-white rounded-full shadow-lg flex items-center justify-center transition-transform hover:scale-105 z-50 group"
      >
      ...
      <div className="bg-navy-950 shrink-0 border-b border-white/5">
        <div className="h-14 flex items-center justify-between px-4">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-c-surface-raised to-indigo-600 flex items-center justify-center text-white font-bold">
              <Cpu size={18} />
            </div>
            <div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`w-7 h-7 flex items-center justify-center rounded-full transition-colors ${
                showThinking
                  ? 'bg-c-surface-raised text-c-text-secondary ring-1 ring-c-border'
