  ...
  return (
    <div className="relative group">
      ...
      <input
        ...
        className="w-full bg-slate-100/60 dark:bg-navy-950/60 border border-slate-200/50 dark:border-navy-700/50 rounded-lg py-1.5 pl-8 pr-7 text-[13px] focus:outline-none focus:ring-2 focus:ring-c-focus focus:border-c-focus-solid transition-all placeholder:text-slate-400 dark:placeholder:text-slate-600"
      />
      {value && (
        <button
          onClick={() => onChange('')}
