...
export const ChatExportModal: React.FC<ChatExportModalProps> = ({ isOpen, onClose, onExport, title }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div className="bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-2xl w-full max-w-sm shadow-2xl animate-in zoom-in-95 duration-200">
                ...
                <div className="p-4 space-y-3">
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-between p-3 rounded-xl border border-slate-200 dark:border-white/5 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors group"
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div className="text-left">
                                ...
                                <div className="text-xs text-slate-500">Professional strategy report</div>
                            </div>
                        </div>
                    </button>
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div className="text-left">
                                <div className="text-sm font-semibold text-slate-900 dark:text-white">JSON Data</div>
                                <div className="text-xs text-slate-500">Raw raw data for developers</div>
                            </div>
                        </div>
                    </button>
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div className="text-left">
                                <div className="text-sm font-semibold text-slate-900 dark:text-white">Text File</div>
                                <div className="text-xs text-slate-500">Plain text transcript</div>
                            </div>
                        </div>
                    </button>
                </div>
