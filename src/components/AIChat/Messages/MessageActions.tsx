    ...
    <div className={`flex items-center gap-0.5 ${className}`}>
      ...
      {showReportModal && (
        <>
          ...
          />
          <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-full max-w-md p-6 bg-white dark:bg-navy-900 rounded-xl shadow-2xl">
            <div className="flex items-center gap-2 mb-4 text-danger-600 dark:text-danger-400">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-2 rounded-lg bg-danger-600 text-white hover:bg-danger-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
...
const ActionButton: React.FC<ActionButtonProps> = ({
  ...
  const variantClasses = {
    ...
    danger:
      'text-slate-500 hover:text-danger-600 dark:text-slate-400 dark:hover:text-danger-400 hover:bg-danger-50 dark:hover:bg-danger-900/20',
  };
