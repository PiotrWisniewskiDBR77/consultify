...
export const MessageBubble: React.FC<MessageBubbleProps> = ({
    ...
    const displayContent =
        isLongMessage && !showFullContent ? message.content.slice(0, MAX_PREVIEW_LENGTH) + '...' : message.content;
      ...
      `}
            ...
            <div className={`flex-1 max-w-[85%] ${isUser ? 'items-end' : 'items-start'}`}>
                ...
                {isAI && hasThinkingSteps && showThinkingSteps && (
                    <ThinkingBlock steps={message.thinkingSteps!} isStreaming={isStreaming && message.isThinking} />
                )}
