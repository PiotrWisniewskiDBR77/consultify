        ...
        <div className="px-4 py-2 border-b border-slate-200 dark:border-navy-700">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 text-sm bg-slate-100 dark:bg-navy-700 border-0 rounded-lg focus:ring-2 focus:ring-c-focus text-slate-800 dark:text-slate-200 placeholder-slate-400"
            />
          </div>
        </div>
