        ...
        <div className="px-4 py-2 border-b border-slate-200 dark:border-navy-700">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 text-sm bg-slate-100 dark:bg-navy-700 border-0 rounded-lg focus:ring-2 focus:ring-primary-500 text-slate-800 dark:text-slate-200 placeholder-slate-400"
            />
          </div>
        </div>
        ...
        <div className="flex items-center justify-between px-4 py-3 border-t border-slate-200 dark:border-navy-700 bg-slate-50 dark:bg-navy-900">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-white bg-primary-500 hover:bg-primary-600 disabled:bg-slate-300 disabled:cursor-not-allowed rounded-lg transition-colors"
            >
