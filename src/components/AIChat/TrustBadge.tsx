                    ...
                    >
                      ...
                      {safeLink ? (
                        <a
                          ...
                          className="underline decoration-slate-400/50 underline-offset-2 hover:text-primary-700 hover:decoration-primary-500 dark:hover:text-primary-300 focus:outline-none focus:ring-2 focus:ring-primary-400/40 rounded-sm"
                          aria-label={t(
