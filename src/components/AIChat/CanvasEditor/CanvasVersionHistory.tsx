    ...
    >
      <div className="flex shrink-0 items-center justify-between border-b border-slate-200 px-3 py-2 dark:border-white/10">
        ...
        <button
          type="button"
          onClick={onClose}
          aria-label="Zamknij historię wersji"
          title="Zamknij"
      ...
      <div className="min-h-0 flex-1 space-y-1.5 overflow-auto p-2">
        {isLoading ? (
          ...
          <div className="px-2 py-3 text-slate-500 dark:text-slate-400">Brak wersji.</div>
        ) : (
                  ...
                  {isConfirming ? (
                    <>
                      ...
                      >
                        ...
                        {isRestoring ? 'Przywracanie...' : 'Tak, przywróć'}
                      </button>
                      <button
                        type="button"
                        disabled={isRestoring}
      ...
      {previewVersion ? (
        ...
        >
          <div className="mb-2 text-[10px] font-semibold uppercase tracking-[0.16em] text-slate-500 dark:text-slate-400">
            Podgląd · {formatRelativeTime(previewVersion.createdAt)}
          </div>
