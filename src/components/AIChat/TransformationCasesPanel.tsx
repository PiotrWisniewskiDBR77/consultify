            ...
            <div className="space-y-4" data-testid="transformation-case-preview">
              ...
              {finalOutputRun ? (
                <div className="rounded-lg border border-c-border bg-c-surface p-3">
                  ...
                  <div className="mt-2 flex gap-3 text-xs font-semibold text-c-accent">
                    <a
                ...
                <div className="space-y-2 rounded-lg border border-c-border bg-c-surface p-3">
                  ...
                  {drdProposal.assessmentId ? (
                    <a
                      ...
                      className="inline-flex text-xs font-semibold text-primary-600 hover:underline"
                    >
              ...
              {editableSteps ? (
                <div className="grid gap-2 sm:grid-cols-2">
                  ...
                  <button
                    ...
                    disabled={Boolean(stageAction)}
                    className="w-full rounded-lg border border-c-accent bg-c-accent/10 px-3 py-2 text-xs font-semibold text-c-accent disabled:opacity-50"
                  >
