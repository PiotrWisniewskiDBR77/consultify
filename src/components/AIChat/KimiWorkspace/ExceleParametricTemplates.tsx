...
export const ExceleParametricTemplates: React.FC<Props> = ({
  ...
  // A template build is a canonical generated_workbooks object, not transient
  // component state. Rehydrate it from the id retained in the page URL so a
  // reload preserves the exact workbook, its sheet preview and XLSX export.
