...
export const RESULTS_VNEXT_SAMPLE_SCORECARD: KpiScorecardDto = {
  ...
  editionLabel: 'edycja 02',
  revisionDate: '2026-09-01',
  preparedByUserId: 'Anna Kowalska',
  preparedByName: 'Anna Kowalska',
  rowVersion: 2,
  createdBy: 'Anna Kowalska',
  createdAt: '2026-05-20T08:00:00.000Z',
  updatedAt: now,
...
export const RESULTS_VNEXT_SAMPLE_SCORECARD_ITEMS: KpiScorecardItemDto[] = [
  {
    ...
    ownerUserId: 'Anna Kowalska',
    ownerName: 'Anna Kowalska',
    description: 'Udział dostaw zrealizowanych w umówionym terminie.',
    formulaText: 'dostawy na czas / dostawy ogółem × 100',
  ...
  },
  {
    ...
    targetGeometry: 'threshold_min',
    measurementFrequencyDays: 30,
    ownerUserId: 'Joanna Lis',
    ownerName: 'Joanna Lis',
    description: 'Udział wyrobów zgodnych w pierwszym przejściu.',
    formulaText: 'wyroby zgodne / wyroby ogółem × 100',
    addedBy: 'Anna Kowalska',
    addedByName: 'Anna Kowalska',
  ...
  },
  {
    ...
    description: 'Zużycie energii na wyprodukowaną sztukę.',
    formulaText: 'kWh / sztuki',
    addedBy: 'Marek Nowak',
