...
export const InvoiceTemplateEditor: React.FC<InvoiceTemplateEditorProps> = ({ organizationId }) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full">
      {/* Templates List */}
      <div className="lg:col-span-1 bg-white dark:bg-navy-800 rounded-xl border border-slate-200 dark:border-navy-700 overflow-hidden">
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {tpl.is_system && (
                      <span className="px-1.5 py-0.5 text-xs bg-slate-100 dark:bg-navy-800/40 text-slate-600 dark:text-slate-400 rounded">
                        System
                      </span>
                    )}
                  </div>
      ...
      {/* Editor / Details */}
      <div className="lg:col-span-2 bg-white dark:bg-navy-800 rounded-xl border border-slate-200 dark:border-navy-700 overflow-hidden">
        {!selectedTemplate ? (
                  ...
                  <>
                    {editMode ? (
                      ...
                      <button
                        ...
                        className="flex items-center gap-1 px-3 py-1.5 rounded-lg border border-slate-200 dark:border-navy-700 text-sm hover:bg-slate-50 dark:hover:bg-white/5"
                      >
