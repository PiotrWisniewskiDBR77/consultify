            ...
            {isTrialing && trialEndsAt && (
              <div className="mt-4 pt-4 border-t border-white/20">
                <p className="text-sm text-white/80">
                  ...
                  {new Date(trialEndsAt).toLocaleDateString('pl-PL')}
                </p>
              </div>
            )}
          </div>
                ...
                <div className="flex gap-2">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-slate-200 dark:border-navy-700 bg-white dark:bg-navy-950 text-slate-900 dark:text-white placeholder-slate-400 focus-visible:ring-2 focus-visible:ring-c-focus"
                    />
                  </div>
                  <button
