        ...
        <div className="space-y-6">
            ...
            {stats && (
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="bg-white dark:bg-navy-800 rounded-xl p-4 border border-slate-200 dark:border-white/10">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                <div className="relative flex-1">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 rounded-lg border border-slate-200 dark:border-white/10 bg-white dark:bg-navy-800 text-slate-900 dark:text-white placeholder-slate-400"
                    />
                </div>
                ...
                <button
                    onClick={fetchData}
                    className="px-4 py-2 rounded-lg border border-slate-200 dark:border-white/10 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors"
                >
...
const ApplyCreditModal: React.FC<ApplyCreditModalProps> = ({ creditNote, onApply, onClose, formatCurrency }) => {
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => setAmount(e.target.value ? parseFloat(e.target.value) * 100 : undefined)}
                    ...
                    <div className="flex gap-3">
                        <button
                            type="button"
                            onClick={onClose}
                            className="flex-1 px-4 py-2 rounded-lg border border-slate-200 dark:border-white/10 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors"
                        >
                            Cancel
                        </button>
                        <button
                            ...
                            {formData.items.map((item, index) => (
                                <div key={index} className="flex gap-2">
                                    <input
                                        ...
                                        required
                                        className="flex-1 px-3 py-2 rounded-lg border border-slate-200 dark:border-white/10 bg-white dark:bg-navy-800 text-slate-900 dark:text-white text-sm"
                                    />
                                    <input
                                        type="number"
                                        placeholder="Qty"
                                        ...
                                        min="1"
                                        className="w-20 px-3 py-2 rounded-lg border border-slate-200 dark:border-white/10 bg-white dark:bg-navy-800 text-slate-900 dark:text-white text-sm"
                                    />
                                    <input
                                        type="number"
                                        placeholder="Price"
