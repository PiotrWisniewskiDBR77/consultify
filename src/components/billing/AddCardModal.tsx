...
export const AddCardModal: React.FC<AddCardModalProps> = ({ onClose, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-navy-900 rounded-xl shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="p-3 rounded-lg bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20">
            <p className="text-xs text-amber-700 dark:text-amber-300">
              <strong>Development Mode:</strong> Use test card 4242 4242 4242 4242, any future
