        ...
        >
          ...
          >
            ...
            <div className="p-8 md:p-10">
              {/* Icon */}
              <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-xl flex items-center justify-center mb-6 mx-auto shadow-lg shadow-purple-500/30">
