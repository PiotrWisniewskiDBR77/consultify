...
export const SnapshotLabel: React.FC<SnapshotLabelProps> = ({ timestamp, version, className = '' }) => {
        ...
        >
            ...
            {formattedDate && (
                <>
                    ...
                    <span className="text-xs text-amber-600 dark:text-amber-400">{formattedDate}</span>
                </>
            )}
        </div>
    );
            ...
            <div className="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400 mb-2">
                        Ten widok przedstawia stan Twojego myślenia w momencie jego zapisania. To nie jest ostateczna
                        rekomendacja ani werdykt.
                    </p>
