...
const QUESTION_EXPLANATIONS = {
  ...
  challenges: {
    ...
    impact:
      'Ignorowanie barier prowadzi do planów, które wyglądają dobrze, ale są nierealistyczne.',
  ...
  stakeholders: {
    ...
    impact:
      'Pominięcie kluczowego interesariusza może zablokować realizację nawet najlepszego planu.',
