          ...
          <div className="flex items-center gap-2">
            ...
            {onUnlink && (
              <button
                ...
                disabled={isLinking}
                className="px-3 py-1.5 text-sm text-danger-600 dark:text-danger-400 hover:bg-danger-50 dark:hover:bg-danger-500/10 rounded-lg transition-colors disabled:opacity-50"
              >
                Delete Link
              </button>
            )}
