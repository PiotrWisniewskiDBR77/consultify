                    ...
                    <div className="space-y-4">
                            ...
                            <div className="bg-blue-50 dark:bg-blue-500/10 rounded-xl p-4 border border-blue-200 dark:border-blue-500/20">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <textarea
                                        ...
                                        rows={2}
                                        className="w-full px-3 py-2 bg-white dark:bg-navy-800 border border-slate-200 dark:border-white/10 rounded-lg text-sm resize-none"
                                    />
                                </div>
                        ...
                        {versions.length === 0 ? (
                            <div className="text-center py-8">
                                ...
                                <p className="text-sm text-slate-500 mb-2">Brak zapisanych wersji</p>
                                <p className="text-xs text-slate-400">Utwórz pierwszą wersję, aby śledzić zmiany</p>
                            </div>
                        ) : (
