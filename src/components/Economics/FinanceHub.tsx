    ...
    const _baseView =
      viewMode === 'grid'
        ...
        : activeTab === 'statements'
          ...
          : tableWithPreview;
    // List surfaces are navigation surfaces only. Domain tools, charts, simulations,
    // and planners belong to the selected record's full workspace, never below a table.
    return _baseView;
  }, [
    loadingTab,
    loadError,
