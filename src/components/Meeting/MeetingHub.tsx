...
export const MeetingHub: React.FC = () => {
  ...
  const commandRowContent = useMemo(() => {
    ...
    // Canonical Menu 3 layout: left chips + right AI action in one justify-between row.
    // commandRowRightContent is VOIDED by ModuleNavBar, so we embed both sides here.
    return (
