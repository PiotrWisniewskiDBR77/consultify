...
export const BurnDownChart: React.FC<BurnDownChartProps> = ({ data }) => {
    return (
        <div className="bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-xl p-6">
            <h3 className="text-lg font-bold text-navy-900 dark:text-white mb-4">Burn-Down Chart</h3>
            <p className="text-sm text-slate-600 dark:text-slate-400 mb-6">Track progress against planned timeline</p>
...
export const VelocityChart: React.FC<VelocityChartProps> = ({ data }) => {
    return (
        <div className="bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-xl p-6">
            <h3 className="text-lg font-bold text-navy-900 dark:text-white mb-4">Team Velocity</h3>
            <p className="text-sm text-slate-600 dark:text-slate-400 mb-6">Weekly task completion rate</p>
...
export const MetricCard: React.FC<MetricCardProps> = ({ title, value, change, icon, trend = 'neutral' }) => {
