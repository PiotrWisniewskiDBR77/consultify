    ...
    <div className="min-h-screen bg-white dark:bg-navy-950 flex flex-col">
      ...
      <main className="flex-1 pt-20">
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <button
            onClick={handleBack}
            className="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 hover:text-navy-900 dark:hover:text-white mb-8 transition-colors"
          >
            <ArrowLeft size={16} />
          ...
          {/* Title Section */}
          <div className="mb-12 pb-8 border-b border-slate-200 dark:border-navy-700">
