...
export const UserProfileMenu: React.FC<UserProfileMenuProps> = ({
  ...
  useEffect(() => {
    if (!currentUser || !isOpen || !shouldShowOrgSwitcher || orgsLoading || orgs.length > 0) return;
    void fetchOrgs();
  }, [currentUser, fetchOrgs, isOpen, orgs.length, orgsLoading, shouldShowOrgSwitcher]);
