      ...
      <div className="fixed right-0 top-0 h-full w-96 bg-white dark:bg-gray-900 z-overlay shadow-2xl transform transition-transform duration-300 ease-out flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <button
            ...
            className="p-1 rounded-lg hover:bg-gray-100 dark:bg-navy-800 dark:hover:bg-gray-800 transition-colors"
          >
                ...
                <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                  ...
                  <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-200 dark:border-gray-700">
                    <button
                      ...
                      className="text-sm text-gray-500 hover:text-gray-700 dark:text-gray-300 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
  ...
  return (
    ...
    >
      ...
      {onDismiss && !completed && (
        ...
        >
          <XCircle className="w-4 h-4 text-gray-600 dark:text-gray-500 dark:text-gray-400 hover:text-danger-500" />
        </button>
      )}
    </div>
  );
