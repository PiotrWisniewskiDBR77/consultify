      ...
      >
        ...
        <div className="p-3">
          <div className="flex items-start gap-2">
            {/* Status Indicator */}
            <div
              className={`w-2 h-2 rounded-full mt-1.5 shrink-0 ${(statusIndicator as any)[status]}`}
            />
            ...
            <div className="flex-1 min-w-0">
              ...
              {/* Description */}
              {description && (
                <div className="text-xs text-slate-600 dark:text-slate-500 mt-1 line-clamp-2">
                  {description}
                </div>
              )}
            </div>
