...
export const SwimLaneNode: React.FC<NodeProps<SwimLaneData>> = memo(
  ({ data, selected, isConnectable }: any) => {
    ...
    const colorClasses = {
      ...
      red: 'bg-danger-500/5 border-danger-500/30',
    ...
    const headerColors = {
      ...
      red: 'bg-danger-500/20 border-danger-500/50 text-danger-300',
    ...
    return (
      <>
        ...
        <Handle
          ...
          className="!w-3 !h-3 !bg-slate-50 dark:bg-navy-800/300 !border-2 !border-slate-800 !left-[-8px]"
          style={{ top: '50%' }}
        />
        <Handle
          type="source"
          ...
          isConnectable={isConnectable}
          className="!w-3 !h-3 !bg-slate-50 dark:bg-navy-800/300 !border-2 !border-slate-800 !right-[-8px]"
          style={{ top: '50%' }}
        />
      </>
    );
