  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-lg bg-slate-900 border border-white/10 rounded-xl shadow-2xl">
              ...
              className={`
                                ...
                                ${
                                  activeTab === tab.id
                                    ...
                                    : 'text-slate-500 dark:text-slate-400 hover:text-white hover:bg-slate-50 dark:hover:bg-navy-800/20'
                                }
                            `}
            >
              {tab.icon}
        ...
        <div className="px-4 py-3 bg-slate-50/30 dark:bg-navy-950/20 border-t border-white/10">
          <div className="text-xs text-slate-500 dark:text-slate-400">
            ...
            {selectedTaskId || selectedProjectId || selectedInitiativeId ? (
              ...
              <span className="text-slate-500 dark:text-slate-400">Nothing</span>
            )}
          </div>
        </div>
