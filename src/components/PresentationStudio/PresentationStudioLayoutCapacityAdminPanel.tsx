      ...
      <div className="border-t border-slate-200 px-5 py-4 dark:border-slate-800">
        ...
        <label className="mt-3 block text-xs font-medium text-slate-700 dark:text-slate-300">
          ...
          <textarea
            ...
            className="mt-1 block w-full rounded-md border border-slate-300 bg-white px-3 py-2 font-mono text-xs text-slate-800 shadow-sm focus:border-c-focus-solid focus:outline-none focus:ring-1 focus:ring-c-focus disabled:cursor-not-allowed disabled:bg-slate-100 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-200 dark:disabled:bg-slate-800"
