        ...
        <>
            <div ref={dropdownRef} className={`relative inline-block ${className}`}>
                ...
                {isOpen && allowedTransitions.length > 0 && (
                    <div className="absolute z-50 mt-1 w-48 rounded-lg bg-white dark:bg-navy-800 border border-slate-200 dark:border-white/10 shadow-lg overflow-hidden">
                        <div className="py-1">
                        ...
                        {charterCompleteness !== undefined && charterCompleteness < 60 && (
                            <div className="px-3 py-2 border-t border-slate-200 dark:border-white/10 bg-amber-50 dark:bg-amber-900/20">
