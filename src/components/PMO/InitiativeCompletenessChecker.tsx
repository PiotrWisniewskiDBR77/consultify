...
const calculateFieldStatuses = (initiative: InitiativeCompletenessCheckerProps['initiative']): FieldStatus[] => {
...
export const getInitiativeCompleteness = (initiative: InitiativeCompletenessCheckerProps['initiative']): number => {
    const fields = calculateFieldStatuses(initiative);
