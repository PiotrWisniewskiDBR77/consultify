...
export const PMOStatusBanner: React.FC<PMOStatusBannerProps> = ({
  ...
  const phaseColors: Record<string, string> = {
    ...
    Initiatives: 'from-primary-500 to-primary-600',
    Roadmap: 'from-primary-500 to-primary-600',
    Execution: 'from-emerald-500 to-emerald-600',
    Stabilization: 'from-blue-500 to-blue-600',
  };
  ...
  return (
    <div className="space-y-2">
      {/* Phase Header */}
      <div className="flex items-center justify-between bg-white dark:bg-navy-900 rounded-lg border border-slate-200 dark:border-navy-700 p-3">
