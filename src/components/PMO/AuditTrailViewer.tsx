      ...
      <div className="flex flex-wrap gap-4 bg-white dark:bg-navy-800 rounded-xl p-4 border border-slate-200 dark:border-navy-700">
        ...
        <div className="flex-1 min-w-[200px] relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-slate-50 dark:bg-navy-900 border border-slate-200 dark:border-navy-700 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-c-focus"
          />
        </div>
        ...
        <select
          ...
          className="px-4 py-2 bg-slate-50 dark:bg-navy-900 border border-slate-200 dark:border-navy-700 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-c-focus"
        >
