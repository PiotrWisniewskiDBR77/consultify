  ...
  const stages: LifecycleGateStage[] = useMemo(() => {
    ...
    const defs: LifecycleGateStage[] = [
      ...
      },
      {
        ...
        ...mk(InitiativeStatus.PENDING_REVIEW),
