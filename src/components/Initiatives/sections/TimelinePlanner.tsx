  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full max-w-2xl rounded-2xl border border-slate-200/60 dark:border-white/[0.03] bg-c-surface shadow-xl overflow-hidden"
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-1.5 rounded-lg bg-c-surface border border-slate-200/60 dark:border-white/[0.03] text-sm placeholder:text-c-text-muted focus:border-blue-500 focus:ring-1 focus:ring-blue-500/20 focus:outline-none"
                  autoFocus
                />
              </div>
              ...
              {selectedType === 'task' && (
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-1.5 rounded-lg bg-c-surface border border-slate-200/60 dark:border-white/[0.03] text-sm text-c-text-muted focus:border-blue-500 focus:outline-none"
                  >
              ...
              {startTriggerType === 'date' && (
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-1.5 rounded-lg bg-c-surface border border-slate-200/60 dark:border-white/[0.03] text-sm focus:border-blue-500 focus:outline-none"
                  />
                </div>
              )}
              {startTriggerType === 'event' && (
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-1.5 rounded-lg bg-c-surface border border-slate-200/60 dark:border-white/[0.03] text-sm placeholder:text-c-text-muted focus:border-blue-500 focus:outline-none"
                  />
                </div>
              )}
      ...
      <div className="bg-c-surface p-4 space-y-3">
        ...
        <div>
          ...
          <input
            ...
            value={name}
            onChange={(e) => setName(e.target.value)}
            className="w-full px-3 py-1.5 rounded-lg bg-c-surface border border-slate-200/60 dark:border-white/[0.03] text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500/20 focus:outline-none"
            autoFocus
          />
        </div>
          ...
          >
            ...
            >
              ...
              {canEdit && startMenuOpenId === row.id && (
                <div className="absolute left-1 top-6 z-20 w-[200px] rounded-lg border border-slate-200/60 dark:border-white/[0.03] bg-c-surface shadow-lg p-2 space-y-2 text-left">
            ...
            >
              {canEdit ? (
                <>
                  ...
                  {menuOpenId === row.id && (
                    <div className="absolute right-1 top-8 z-20 min-w-[126px] rounded-lg border border-slate-200/60 dark:border-white/[0.03] bg-c-surface shadow-lg overflow-hidden">
                      <button
                        onClick={() => {
      ...
      <AnimatePresence>
        {editingRow && (
          <motion.div
            ...
            className="fixed inset-0 z-[80] bg-black/40 backdrop-blur-[1px] flex items-center justify-center p-4"
          >
            <div className="w-full max-w-xl rounded-2xl border border-slate-200/60 dark:border-white/[0.03] bg-c-surface shadow-xl overflow-hidden">
              <EditRowPanel
                row={editingRow}
                rows={rows}
                tasks={tasks}
