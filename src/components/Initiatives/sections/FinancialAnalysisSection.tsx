...
export const FinancialAnalysisSection: React.FC<InitiativeSectionProps> = ({ sectionType, expanded, onToggle }) => {
    ...
    <CollapsibleSection
      ...
      actions={
        <motion.button
          ...
          onClick={(e) => { e.stopPropagation(); handleGenerateAI('financial'); }}
        ...
        >
          {isGeneratingAI === 'financial' ? <Loader2 size={14} className="animate-spin" /> : <Sparkles size={14} />}
          <span>AI</span>
        </motion.button>
      }
    >
