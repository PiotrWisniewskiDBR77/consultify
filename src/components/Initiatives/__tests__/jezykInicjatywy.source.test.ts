/**
 * BEZPIECZNIK JĘZYKOWY MODUŁU 06 INITIATIVES (paczka J-DOG-C, DEC-453, 2026-09-09).
 *
 ...
 *
 * ZASIĘG: `src/components/Initiatives/**`, `src/components/Portfolio/**`,
 * `src/components/Strategy/**` (bez `src/components/Execution/**` — inny
 * moduł zamrożenia).
 *
...
describe('J-DOG-C — moduł Initiatives mówi po angielsku w kodzie (bez ogonków też)', () => {
