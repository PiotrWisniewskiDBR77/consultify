      ...
      <div className="relative">
        ...
        {isOpen && (
          <>
            ...
            <div className="absolute right-0 mt-1 w-48 bg-white dark:bg-navy-900 rounded-lg shadow-lg border border-slate-200 dark:border-navy-700 py-1 z-50">
              {options.map((option) => (
                <button
                  key={option.format}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20">
          <div className="bg-white dark:bg-navy-900 rounded-xl p-6 shadow-xl w-72">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-sm text-slate-500 dark:text-slate-400">{exportProgress}%</span>
            </div>
