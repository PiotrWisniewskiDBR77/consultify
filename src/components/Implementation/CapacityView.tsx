        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-4 gap-4">
                <div className="bg-white dark:bg-navy-900 rounded-xl p-4 border border-slate-200 dark:border-white/10">
                    ...
                    <div className="text-xs text-slate-400 mt-1">per week</div>
                </div>
                <div className="bg-white dark:bg-navy-900 rounded-xl p-4 border border-slate-200 dark:border-white/10">
                    <div className="text-sm text-slate-500 dark:text-slate-400 mb-1">Allocated</div>
                    <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">{totalAllocated}h</div>
                    <div className="text-xs text-slate-400 mt-1">committed</div>
                </div>
                <div className="bg-white dark:bg-navy-900 rounded-xl p-4 border border-slate-200 dark:border-white/10">
                ...
                <div className="bg-white dark:bg-navy-900 rounded-xl p-4 border border-slate-200 dark:border-white/10">
                    ...
                    <div className={`text-2xl font-bold ${overallocatedCount > 0 ? 'text-red-600' : 'text-green-600'}`}>
                        {overallocatedCount}
                    </div>
                ...
                <div className="flex items-start gap-3 p-4 bg-red-50 dark:bg-red-900/10 border border-red-200 dark:border-red-500/20 rounded-xl">
                    ...
                    <div>
                        <p className="text-sm font-medium text-red-700 dark:text-red-300">
                            {overallocatedCount} team member{overallocatedCount > 1 ? 's are' : ' is'} overallocated
                        </p>
