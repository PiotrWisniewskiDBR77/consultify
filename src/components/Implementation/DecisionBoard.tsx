    ...
    return (
      <div
        ...
        className={`bg-white dark:bg-navy-900 rounded-lg border p-4 transition-all ${
          isOverdue
            ? 'border-danger-300 dark:border-danger-500/50 shadow-danger-100 dark:shadow-danger-900/20 shadow-md'
            : decision.isBlocking
        ...
        <div className="flex items-start justify-between mb-3">
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-1">
              ...
              {decision.isBlocking && (
                <span className="text-xs font-medium px-2 py-0.5 rounded bg-danger-100 dark:bg-danger-900/30 text-danger-700 dark:text-danger-400 animate-pulse">
                  BLOCKING
                </span>
              )}
            </div>
          ...
          {decision.status === 'PENDING' && (
            <div className="flex items-center gap-1">
              ...
              <button
                ...
                className="p-1.5 bg-danger-100 dark:bg-danger-900/30 text-danger-600 dark:text-danger-400 rounded hover:bg-danger-200 dark:hover:bg-danger-900/50"
                title="Reject"
              >
                <ThumbsDown size={14} />
              </button>
      ...
      <div className="flex items-center gap-4 p-4 bg-white dark:bg-navy-900 rounded-xl border border-slate-200 dark:border-navy-700">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <AlertTriangle
              size={20}
              className={blockingCount > 0 ? 'text-danger-600 dark:text-danger-400' : 'text-slate-600'}
            />
          </div>
          <div>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <Clock
              size={20}
              className={overdueCount > 0 ? 'text-danger-600 dark:text-danger-400' : 'text-slate-600'}
            />
          </div>
          <div>
            <p className="text-xs text-slate-500 dark:text-slate-400">Overdue</p>
            <p className="text-lg font-bold text-danger-600 dark:text-danger-400">{overdueCount}</p>
          </div>
        </div>
          ...
          <div className="bg-white dark:bg-navy-900 rounded-xl w-full max-w-lg p-6 m-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-danger-600 text-white rounded-lg hover:bg-danger-500"
              >
                Reject
              </button>
              <button
