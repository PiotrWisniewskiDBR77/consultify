...
export const PlaybookNode: React.FC<PlaybookNodeProps> = ({
  ...
  const getNodeStyles = () => {
    const base =
      'absolute rounded-lg shadow-md border-2 cursor-pointer transition-all duration-150';
    ...
    switch (node.type) {
      ...
      case NodeType.ACTION:
      default:
        return `${base} ${selected} bg-white dark:bg-navy-900 border-gray-300 text-gray-800`;
    }
  };
