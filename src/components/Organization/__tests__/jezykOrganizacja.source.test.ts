/**
 * BEZPIECZNIK JĘZYKOWY MODUŁU 13 ORGANIZATION (paczka J-DOG-C, DEC-453, 2026-09-09).
 *
 ...
 *
 * ZASIĘG: `src/components/Organization/**`, `src/components/governance/**`.
 *
...
describe('J-DOG-C — moduł Organization mówi po angielsku w kodzie (bez ogonków też)', () => {
