...
export const TrustStrip: React.FC = () => {
  ...
  return (
    <section className="py-10 bg-gradient-to-r from-slate-50 via-white to-slate-50 dark:from-navy-900/50 dark:via-navy-950 dark:to-navy-900/50 border-y border-slate-200 dark:border-navy-700">
          ...
          {badges.map((badge, idx) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                className={`
                                    flex items-center gap-3 p-4 py-3 
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            {regions.map((region, idx) => (
              <div
                key={idx}
                className="flex items-center gap-2 px-3 py-1.5 bg-white/50 dark:bg-white/5 rounded-full border border-slate-200 dark:border-navy-700 text-xs"
              >
