          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="space-y-8">
              ...
              <div className="pt-4">
                <a
                  href="/security"
                  className="inline-block px-8 py-4 bg-white dark:bg-navy-900 text-navy-950 rounded-full text-sm font-black uppercase tracking-widest hover:bg-slate-100 dark:hover:bg-navy-800/30 transition-all shadow-xl shadow-white/5 active:scale-95"
                >
