      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg bg-white dark:bg-navy-900 rounded-xl shadow-2xl border border-slate-200 dark:border-navy-700 overflow-hidden"
          ...
          >
            ...
            <div className="p-8 -mt-6">
              {/* Info Card */}
              <div className="bg-slate-50 dark:bg-navy-800/50 rounded-xl p-6 border border-slate-200 dark:border-navy-700 mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <a
                  ...
                  className="flex-1 py-3 px-6 bg-white dark:bg-navy-800 border-2 border-slate-200 dark:border-navy-700 text-navy-900 dark:text-white font-semibold rounded-xl hover:border-purple-300 dark:hover:border-purple-500/30 transition-all text-center"
                >
