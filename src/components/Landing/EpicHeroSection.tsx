...
import { ArrowRight, CheckCircle2, Handshake, Play, Sparkles } from 'lucide-react';
          ...
          <div className="max-w-2xl space-y-6 md:space-y-7">
            ...
            >
              <button
                ...
                className="group relative inline-flex items-center justify-center gap-2 px-7 py-3 rounded-full text-white font-semibold text-sm overflow-hidden transition-all duration-300 active:scale-[0.98]"
                style={{
