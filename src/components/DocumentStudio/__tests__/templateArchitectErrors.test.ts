...
describe('Document Template Architect save errors', () => {
  it('turns business-case domain codes into author instructions', () => {
    expect(
      getTemplateStructureSaveErrorMessage(new Error('business_case_scope_or_approach_required'))
    ...
    ).toBe('Add an Assumptions, Scenario, Sensitivity or Economic Analysis section before saving.');
  });
