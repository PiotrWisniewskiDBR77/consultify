    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6 animate-in fade-in relative">
            ...
            <div>
                ...
                <p className="text-slate-500 text-sm mt-1">Backup and restore your settings configuration</p>
            </div>
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-500">Download your settings as JSON file</p>
                        </div>
                    </div>
                    <button
            ...
            <div className="bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-xl p-6">
                ...
                {!importFile ? (
                    <label className="flex flex-col items-center justify-center p-8 border-2 border-dashed border-slate-300 dark:border-white/20 rounded-xl cursor-pointer hover:border-blue-400 dark:hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-blue-500/5 transition-colors">
                        ...
                        <p className="text-sm text-slate-500 mt-1">Accepts .json files exported from Consultinity</p>
            ...
            {/* Info */}
            <div className="bg-slate-50 dark:bg-navy-950 border border-slate-200 dark:border-white/10 rounded-xl p-4">
