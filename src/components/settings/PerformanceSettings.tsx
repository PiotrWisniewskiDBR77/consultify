...
export const PerformanceSettings: React.FC<PerformanceSettingsProps> = ({ currentUser, onUpdate }) => {
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">
                        {t('settings.performance.description', 'Optimize app performance and manage data usage')}
                    </p>
                </div>
                <button
                    onClick={handleSave}
                                ...
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${
                                        performance.cacheSizeMb === option.value
                                            ...
                                            : 'bg-slate-100 dark:bg-white/10 text-slate-600 dark:text-slate-300 border-2 border-transparent hover:border-slate-300'
                                    }`}
                                >
                                    {option.label}
                                </button>
            ...
            {/* Info */}
            <div className="bg-slate-50 dark:bg-navy-950/50 border border-slate-200 dark:border-white/10 rounded-lg p-4">
                <div className="flex items-start gap-3">
