        ...
        <div className="max-w-4xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 relative">
                        ...
                        <button
                            ...
                            className={`p-4 rounded-xl border-2 text-center transition-all ${
                                settings.contextWindowSize === size.id
                                    ...
                                    : 'border-slate-200 dark:border-white/10 hover:border-cyan-300'
                            }`}
                        >
                    ...
                    <div className="space-y-3">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2 bg-slate-50 dark:bg-navy-950 border border-slate-200 dark:border-white/10 rounded-lg"
                            />
                        </div>
            ...
            <div className="bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-xl p-6 space-y-4">
                ...
                <div className="pt-4 border-t border-slate-200 dark:border-white/10">
                    <p className="font-medium text-slate-900 dark:text-white mb-3">Custom Knowledge Sources</p>
                    <div className="flex gap-2 mb-3">
                        <input
                            ...
                            className="flex-1 px-3 py-2 bg-slate-50 dark:bg-navy-950 border border-slate-200 dark:border-white/10 rounded-lg"
                    ...
                    <div className="flex flex-wrap gap-2">
                        {settings.knowledgeBases.customSources.map((source) => (
                            ...
                            >
                                {source}
                                <button onClick={() => removeCustomSource(source)} className="hover:text-purple-900">
                                    <X size={14} />
                                </button>
                            </span>
                        ))}
