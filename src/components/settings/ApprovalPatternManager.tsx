                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      className="p-2 text-c-text-secondary hover:text-danger-500 hover:bg-danger-50 dark:hover:bg-danger-900/20 rounded-lg transition-colors disabled:opacity-50"
                    >
