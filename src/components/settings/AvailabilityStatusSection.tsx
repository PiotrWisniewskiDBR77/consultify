        ...
        <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 relative">
            ...
            <div className="bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-xl p-6">
                ...
                <input
                    ...
                    placeholder={t('settings.availability.statusPlaceholder', 'e.g., 🎉 On vacation until Jan 15')}
                    maxLength={100}
                    className="w-full px-4 py-3 bg-slate-50 dark:bg-navy-950/50 border border-slate-200 dark:border-white/10 rounded-lg text-slate-900 dark:text-white focus:ring-2 focus:ring-purple-500/50 outline-none"
                />
            ...
            <div className="bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-xl p-6">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">
                    {t('settings.availability.workingHoursDesc', 'Set your availability for each day of the week')}
                </p>
                                ...
                                {dayHours.enabled && (
                                    <div className="flex items-center gap-2 flex-1">
                                        <input
                                            ...
                                            className="px-3 py-2 bg-slate-50 dark:bg-navy-950 border border-slate-200 dark:border-white/10 rounded-lg"
                                        />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <input
                            ...
                            placeholder={t('settings.availability.reasonPlaceholder', 'e.g., Vacation, Conference')}
                            className="w-full px-3 py-2 bg-white dark:bg-navy-950 border border-slate-200 dark:border-white/10 rounded-lg"
                        />
                    </div>
