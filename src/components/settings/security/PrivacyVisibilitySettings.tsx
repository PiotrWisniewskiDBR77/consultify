...
export const PrivacyVisibilitySettings: React.FC<PrivacyVisibilitySettingsProps> = ({ currentUser, onUpdateUser }) => {
    ...
    const VisibilitySelector: React.FC<{
        ...
        const options: { value: VisibilityLevel; label: string; icon: React.ElementType; color: string }[] = [
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        <label className="flex items-center gap-2 p-3 bg-slate-50 dark:bg-navy-950 rounded-lg cursor-pointer">
                            <input
                                ...
                                onChange={(e) => setSettings({ ...settings, showProjectActivity: e.target.checked })}
                                className="rounded"
                            />
                        ...
                        <label className="flex items-center gap-2 p-3 bg-slate-50 dark:bg-navy-950 rounded-lg cursor-pointer">
                            <input
                                ...
                                onChange={(e) => setSettings({ ...settings, showCommentActivity: e.target.checked })}
                                className="rounded"
                            />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 bg-slate-50 dark:bg-navy-950 rounded-lg space-y-2">
                        ...
                        <select
                            ...
                            onChange={(e) => setSettings({ ...settings, allowMentionsFrom: e.target.value as any })}
