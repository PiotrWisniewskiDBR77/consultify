            ...
            <div>
                {(category !== 'all' || search || showConnectedOnly) && (
                    <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">
                        ...
                        <span className="text-sm font-normal text-slate-500 ml-2">({filteredIntegrations.length})</span>
                    </h3>
                )}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
    ...
    >
        ...
        {integration.connected ? (
            <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                    <button
                        className="p-2 text-slate-500 hover:bg-slate-100 dark:hover:bg-navy-800 rounded-lg"
                        title="Settings"
                    >
                        <Settings size={16} />
                    </button>
