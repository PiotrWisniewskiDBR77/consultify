...
export const AdvancedSettings: React.FC<AdvancedSettingsProps> = ({ currentUser, onUpdateUser }) => {
    ...
    const handleDeleteAPIKey = async (keyId: string) => {
        if (!confirm(t('settings.advanced.confirmDeleteKey', 'Are you sure you want to delete this API key?'))) {
            return;
        }
    ...
    const handleDisconnectAccount = async (provider: string) => {
        if (!confirm(t('settings.advanced.confirmDisconnect', 'Are you sure you want to disconnect this account?'))) {
            return;
        }
        ...
        <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 relative">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">
                        {t('settings.advanced.description', 'Developer tools, API access, and advanced options')}
                    </p>
                </div>
                <button
                    onClick={handleSave}
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-500 dark:text-slate-400">
                                {t('settings.advanced.apiKeysDescription', 'Create API keys for programmatic access')}
                            </p>
                        </div>
                    </div>
                    <button
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-slate-100 dark:border-white/5">
                        <div>
                            ...
                            <p className="text-sm text-slate-500 dark:text-slate-400">
                                {t('settings.advanced.includeAttachmentsDescription', 'Export files attached to tasks')}
                            </p>
                        </div>
                        <button
                            onClick={() => updatePreference('includeAttachments', !preferences.includeAttachments)}
            ...
            <div className="bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-xl p-6">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">
                    {t('settings.advanced.connectedAccountsDescription', 'Accounts linked for single sign-on')}
                </p>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-sm text-slate-500 dark:text-slate-400">
                                {t('settings.advanced.developerModeDescription', 'Enable advanced debugging features')}
                            </p>
                        </div>
                        <button
                            onClick={() => updatePreference('enableDeveloperMode', !preferences.enableDeveloperMode)}
                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    ...
                    {preferences.enableDeveloperMode && (
                        <>
                            {/* Show Debug Info */}
                            <div className="flex items-center justify-between pl-6 pt-4 border-t border-slate-100 dark:border-white/5">
                                <div>
                                    <label className="block font-medium text-slate-700 dark:text-slate-300">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-slate-100 dark:border-white/5">
                        ...
                        <button
                            onClick={() => updatePreference('enableBetaFeatures', !preferences.enableBetaFeatures)}
                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
