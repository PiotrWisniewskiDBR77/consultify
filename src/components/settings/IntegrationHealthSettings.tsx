                ...
                <>
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-2 mt-3">
                                        <button
                                            ...
                                            className="flex items-center gap-1 px-2 py-1 text-xs font-medium text-slate-600 dark:text-slate-400 hover:text-brand border border-slate-200 dark:border-white/10 rounded hover:bg-slate-100 dark:hover:bg-navy-700 transition-colors"
                                        >
                                            <RefreshCw size={12} />
                    ...
                    {selectedIntegration && (
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            {/* Health History */}
                            <div className="lg:col-span-2 bg-white dark:bg-navy-900 rounded-lg border border-slate-200 dark:border-white/10">
                                            ...
                                            {healthHistory[selectedIntegration].slice(0, 20).map((check) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="text-right">
                                                        ...
                                                        {check.error_message && (
                                                            <p className="text-xs text-red-600 dark:text-red-400 mt-1 truncate max-w-xs">
                                                                {check.error_message}
                                                            </p>
                                                        )}
                                                    </div>
