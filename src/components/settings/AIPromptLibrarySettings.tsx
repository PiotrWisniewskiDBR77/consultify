              ...
              <div className="space-y-2">
                {filteredPrompts.length === 0 ? (
                  ...
                  filteredPrompts.map((prompt) => (
                    <div
                      key={prompt.id}
                      className="p-3 bg-c-surface-raised border border-c-border-subtle rounded-lg hover:border-c-border-subtle dark:hover:border-white/10 transition-colors group"
                    >
