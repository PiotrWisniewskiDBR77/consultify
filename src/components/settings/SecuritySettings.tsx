...
export const SecuritySettings: React.FC<SecuritySettingsProps> = ({ currentUser }) => {
    ...
    const handleChangePassword = async () => {
        if (!isPasswordValid) {
            setPasswordError(t('settings.security.invalidPassword', 'Please meet all password requirements'));
            return;
        }
    ...
    const handleRevokeAllSessions = async () => {
        ...
        try {
            ...
            fetchSessions();
            toast.success(t('settings.security.allSessionsRevoked', 'All other sessions have been logged out'));
        } catch (error) {
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-11 pr-11 py-3 rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-navy-950 text-slate-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
                                placeholder="••••••••"
                            />
                            <button
                                type="button"
