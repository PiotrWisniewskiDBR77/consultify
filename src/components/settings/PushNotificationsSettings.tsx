      ...
      <div className="space-y-5">
        ...
        <div className="flex items-start justify-between gap-4 opacity-90">
          <div className="flex items-start gap-3 flex-1">
            <Smartphone size={18} className="text-slate-400 dark:text-slate-500 mt-0.5" />
            <div>
          ...
          <span className="inline-flex items-center rounded-full bg-white/5 px-2.5 py-1 text-xs font-medium text-slate-400 dark:text-slate-500 flex-shrink-0">
