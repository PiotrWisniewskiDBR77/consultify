        ...
        <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 relative p-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-slate-500 dark:text-slate-400">
                            {t('security.dashboard.subtitle', 'Monitor your account security and compliance status')}
                        </p>
                    </div>
                </div>
                <button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1">
                    <div className="bg-white dark:bg-navy-900 rounded-2xl border border-slate-200 dark:border-white/10 p-6 h-full">
...
const QuickActionCard: React.FC<QuickActionCardProps> = ({ icon, title, description, status, onClick }) => {
    ...
    return (
        <button
            onClick={onClick}
            className="bg-white dark:bg-navy-900 rounded-xl border border-slate-200 dark:border-white/10 p-4 text-left hover:shadow-lg hover:border-purple-300 dark:hover:border-purple-500/50 transition-all group"
        >
            <div className={`w-12 h-12 rounded-xl ${statusColors[status]} flex items-center justify-center mb-3`}>
                {icon}
            </div>
