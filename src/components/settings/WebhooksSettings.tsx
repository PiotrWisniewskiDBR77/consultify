        ...
        try {
            ...
            const formatted = (subscriptions || []).map((s: any) => ({
                ...
                retryConfig: s.retryConfig
                    ? typeof s.retryConfig === 'string'
                        ? JSON.parse(s.retryConfig)
                        : s.retryConfig
                    : undefined,
                filterRules: s.filterRules
                    ? typeof s.filterRules === 'string'
                        ? JSON.parse(s.filterRules)
                        : s.filterRules
                    : undefined,
                                                        ...
                                                        onChange={(e) =>
                                                            setWebhookSettings((prev) => ({
                                                                ...
                                                                [webhook.id]: {
                                                                    ...
                                                                    retryConfig: {
                                                                        ...prev[webhook.id].retryConfig,
                                                                        backoffStrategy: e.target.value as
                                                                            | 'linear'
                                                                            | 'exponential',
                                                                    },
                                                                },
                                                        ...
                                                        <div className="flex items-start justify-between">
                                                            ...
                                                            <div className="text-right">
                                                                ...
                                                                {delivery.status === 'failed' && (
                                                                    <button
                                                                        onClick={() =>
                                                                            retryDelivery(webhook.id, delivery.id)
                                                                        }
