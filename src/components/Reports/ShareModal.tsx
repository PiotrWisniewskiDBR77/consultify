    ...
    <div className="fixed inset-0 z-overlay flex items-center justify-center">
      ...
      <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-md w-full mx-4 overflow-hidden">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <button
            onClick={onClose}
            className="p-2 hover:bg-gray-100 dark:bg-navy-800 dark:hover:bg-gray-700 rounded-lg transition-colors"
          >
                    ...
                    <button
                      ...
                      className={`flex-1 py-2 px-3 rounded-lg border transition-colors ${
                        expiryDays === days
                          ...
                          : 'border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:bg-navy-800 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300'
                      }`}
                    >
