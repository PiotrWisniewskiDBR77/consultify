  ...
  return (
    <div className={`relative ${className}`}>
      <textarea
        ...
        autoFocus={autoFocus}
        className="w-full px-3 py-2 pr-12 border border-slate-200 dark:border-navy-700 rounded-lg bg-white dark:bg-navy-800 text-navy-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-c-focus resize-none"
        rows={2}
      />
