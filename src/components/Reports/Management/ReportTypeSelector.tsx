...
import { Briefcase, Building2, Calendar, Check, ChevronDown, FileText, Lock, Settings2, Users } from 'lucide-react';
...
export const ReportTypeSelector: React.FC<ReportTypeSelectorProps> = ({
    ...
    const enabledSections = useMemo(() => {
        return availableSections.filter((s) => !excludeSections.includes(s.id) || s.required).map((s) => s.id);
                                ...
                                {availableSections.map((section) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            {isRequired && <Lock size={12} className="text-slate-400 flex-shrink-0" />}
                                        </button>
                                    );
                                })}
                            </div>
