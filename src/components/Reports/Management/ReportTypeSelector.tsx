        ...
        <div>
          ...
          <div className="relative">
            <select
              ...
              className="w-full appearance-none px-4 py-3 pr-10 bg-white dark:bg-navy-800 border border-slate-200 dark:border-navy-700 rounded-lg text-navy-900 dark:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-c-focus"
            >
