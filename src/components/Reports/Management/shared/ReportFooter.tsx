...
export const ReportFooter: React.FC<ReportFooterProps> = ({
  ...
  return (
    <div
      className={`bg-slate-50 dark:bg-navy-800/50 rounded-xl border border-slate-200 dark:border-navy-700 p-4 ${className}`}
    >
      ...
      {dataSnapshot && (
        <div className="flex items-center gap-2 mb-3 pb-3 border-b border-slate-200 dark:border-navy-700">
          ...
          <span className="text-xs text-slate-500 dark:text-slate-400">
            ...
            initiatives, {dataSnapshot.decisionsAnalyzed || 0} decisions,{' '}
