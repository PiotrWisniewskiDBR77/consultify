...
oraz budowy kompetencji data science, co może przynieść szacowany ROI na poziomie 180% w ciągu 18 miesięcy.
  ...
  return (
    <NodeViewWrapper
      className={`premium-executive-summary ${selected ? 'ring-2 ring-blue-500' : ''}`}
    >
      {/* Header */}
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="p-2 bg-slate-50/50 dark:bg-navy-950/30 hover:bg-white/20 rounded-lg transition-colors disabled:opacity-50"
          >
            {isGenerating ? (
