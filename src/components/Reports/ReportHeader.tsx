...
export const ReportHeader: React.FC<ReportHeaderProps> = ({
  ...
  return (
    <header className="bg-white dark:bg-navy-900 border-b border-slate-200 dark:border-navy-700 sticky top-0 z-30">
      {/* Main header row */}
      <div className="px-4 sm:px-6 py-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 min-w-0">
            <button
              onClick={onBack}
              className="p-2 text-slate-700 hover:text-slate-900 dark:text-slate-300 dark:hover:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5 rounded-lg transition-colors flex-shrink-0 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500"
            ...
            <div className="min-w-0">
              ...
              <div className="flex items-center gap-3 mt-1 text-sm text-slate-600 dark:text-slate-400">
                ...
                {sourceLink && (
                  <a
                    href={sourceLink.url}
                    className="inline-flex items-center gap-1 text-primary-700 dark:text-primary-400 hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 rounded-sm"
                  >
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            {onFullscreen && (
              <button
                ...
                className="inline-flex items-center gap-2 px-3 py-2 text-sm font-medium bg-primary-600 hover:bg-primary-700 text-white rounded-lg transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-1"
                title={
                  isPolish
                    ? isFullscreen
                      ? 'Zamknij pełny ekran'
            ...
            <div className="relative">
              <button
                ...
                className="inline-flex items-center gap-2 px-3 py-2 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5 rounded-lg transition-colors border border-slate-200 dark:border-transparent focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500"
              >
              ...
              {showExportMenu && (
                <>
                  ...
                  <div className="absolute right-0 top-full mt-1 w-48 bg-white dark:bg-navy-800 rounded-lg shadow-hig-md border border-slate-200 dark:border-navy-700 py-1 z-20">
                    <button
                      onClick={() => {
                        onExportPdf();
                        setShowExportMenu(false);
                      }}
                      className="w-full flex items-center gap-3 px-3 py-2 text-sm text-left hover:bg-slate-100 dark:hover:bg-white/5 transition-colors focus:outline-none focus-visible:bg-slate-100 dark:focus-visible:bg-white/5"
                    >
                    ...
                    <button
                      ...
                      className="w-full flex items-center gap-3 px-3 py-2 text-sm text-left hover:bg-slate-100 dark:hover:bg-white/5 transition-colors focus:outline-none focus-visible:bg-slate-100 dark:focus-visible:bg-white/5"
                    >
                      <FileSpreadsheet className="w-4 h-4 text-green-700 dark:text-green-500" />
                      <span className="text-slate-900 dark:text-white">
            ...
            {isEditable && (
              <button
                ...
                className={`
                                    inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-1
                                    ${
                                      hasUnsavedChanges
                                        ? 'bg-blue-600 hover:bg-blue-700 text-white'
                                        : 'bg-slate-100 border border-slate-200 dark:border-transparent dark:bg-white/5 text-slate-500 dark:text-slate-500 cursor-not-allowed'
                                    }
                                `}
              >
                {isSaving ? (
            ...
            <div className="relative">
              <button
                ...
                className="p-2 text-slate-700 hover:text-slate-900 dark:text-slate-300 dark:hover:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5 rounded-lg transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500"
              >
              ...
              {showMoreMenu && (
                <>
                  ...
                  <div className="absolute right-0 top-full mt-1 w-56 bg-white dark:bg-navy-800 rounded-lg shadow-hig-md border border-slate-200 dark:border-navy-700 py-1 z-20">
                    {isEditable && (
                      <button
                        onClick={() => {
                          onRegenerate();
                        ...
                        className="w-full flex items-center gap-3 px-3 py-2 text-sm text-left hover:bg-slate-100 dark:hover:bg-white/5 transition-colors focus:outline-none focus-visible:bg-slate-100 dark:focus-visible:bg-white/5"
                      >
                        <RefreshCw className="w-4 h-4 text-primary-700 dark:text-primary-500" />
                        <div>
      ...
      {/* Loading overlay */}
      {isLoading && (
        <div className="absolute inset-0 bg-slate-900/20 dark:bg-navy-900/50 flex items-center justify-center z-40">
          <div className="flex items-center gap-3 px-4 py-2 bg-white dark:bg-navy-800 border border-slate-200 dark:border-navy-700 rounded-lg shadow-hig-md">
            <Loader2 className="w-5 h-5 animate-spin text-primary-600 dark:text-blue-500" />
