      ...
      <div className="px-4 sm:px-6 py-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 min-w-0">
            <button
              onClick={onBack}
              className="p-2 text-slate-500 hover:text-slate-700 dark:text-slate-300 dark:hover:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5 rounded-lg transition-colors flex-shrink-0"
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <div className="relative">
              ...
              {showExportMenu && (
                <>
                  ...
                  <div className="absolute right-0 top-full mt-1 w-48 bg-white dark:bg-navy-800 rounded-lg shadow-xl border border-slate-200 dark:border-navy-700 py-1 z-20">
                    <button
                      onClick={() => {
                        onExportPdf();
            ...
            <div className="relative">
              <button
                ...
                className="p-2 text-slate-500 hover:text-slate-700 dark:text-slate-300 dark:hover:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5 rounded-lg transition-colors"
              >
              ...
              {showMoreMenu && (
                <>
                  ...
                  <div className="absolute right-0 top-full mt-1 w-56 bg-white dark:bg-navy-800 rounded-lg shadow-xl border border-slate-200 dark:border-navy-700 py-1 z-20">
                    {isEditable && (
                      <button
                        onClick={() => {
                          onRegenerate();
