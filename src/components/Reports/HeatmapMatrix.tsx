...
const priorities = (t: (key: string, defaultValue: string) => string) => [
  {
    ...
    labelPl: 'Krytyczny',
    labelEn: 'Critical',
    description: t('reports.heatmapMatrix.gapOf3LevelsOr', 'Gap of 3 levels or more'),
    color: '#f43f5e',
    bgColor: '#fef2f2',
  ...
  },
  {
    ...
    labelPl: 'Wysoki',
    labelEn: 'High',
    description: t('reports.heatmapMatrix.gapOf2Levels', 'Gap of 2 levels'),
    color: '#f59e0b',
    bgColor: '#fef3c7',
  ...
  },
  {
    ...
    labelPl: 'Niski',
    labelEn: 'Low',
    description: t('reports.heatmapMatrix.gapUnder1LevelOr', 'Gap under 1 level, or target met'),
    color: '#10b981',
    bgColor: '#d1fae5',
...
export const HeatmapMatrix: React.FC<HeatmapMatrixProps> = ({
  ...
  const [selectedCell, setSelectedCell] = useState<{ axisId: string; priority: string } | null>(
    null
  );
        ...
        {selectedCell && (
          ...
          >
            <motion.div
              ...
              className="bg-white dark:bg-navy-800 rounded-xl shadow-2xl max-w-lg w-full p-6"
