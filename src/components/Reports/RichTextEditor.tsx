...
export const RichTextEditor: React.FC<RichTextEditorProps> = ({
  ...
  return (
    <div className="border border-slate-200 dark:border-navy-700 rounded-lg overflow-hidden bg-white dark:bg-navy-900/50">
      {/* Toolbar */}
      <div className="flex flex-wrap items-center gap-0.5 px-2 py-1.5 bg-slate-50 dark:bg-navy-800/50 border-b border-slate-200 dark:border-navy-700">
        {/* History */}
        <ToolbarButton
          icon={Undo}
        ...
        <ToolbarButton
          ...
          title={t('editor.table', 'Insert Table')}
        />
        <ToolbarButton
          icon={Minus}
          onClick={actions.hr}
          title={t('editor.hr', 'Horizontal Rule')}
        />
      </div>
