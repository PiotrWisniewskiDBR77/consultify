...
// Divider component
const ToolbarDivider: React.FC = () => <div className="w-px h-5 bg-slate-200 dark:bg-white/10 mx-1" />;
    ...
    return (
        <div className="border border-slate-200 dark:border-white/10 rounded-lg overflow-hidden bg-white dark:bg-navy-900/50">
            ...
            <div className="relative">
                ...
                {/* Help text */}
                <div className="absolute bottom-2 right-3 text-xs text-slate-400 pointer-events-none">Markdown</div>
            </div>
