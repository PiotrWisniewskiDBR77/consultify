    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed top-0 left-0 right-0 z-50 bg-white/95 dark:bg-navy-900/95 backdrop-blur-sm border-b border-slate-200 dark:border-navy-700 shadow-sm"
        >
          {/* Progress bar */}
              ...
              <div className="flex items-center gap-3 min-w-0 flex-1">
                ...
                <div className="flex items-center gap-1">
                  <button
                    ...
                    title={`${t('reports.stickyNavigation.previousSectionLabel', 'Previous section')} (K)`}
                  >
                  ...
                  <button
                    ...
                    disabled={sections.length === 0}
                    className="p-1.5 text-slate-600 hover:text-slate-600 dark:text-slate-400 dark:hover:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5 rounded-lg transition-colors disabled:opacity-50"
                    title={`${t('reports.stickyNavigation.nextSectionLabel', 'Next section')} (J)`}
                  >
                      ...
                      >
                        <div className="px-3 py-2 border-b border-slate-200 dark:border-navy-700">
                          <p className="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider">
                            {t('reports.stickyNavigation.jumpToSectionLabel', 'Jump to section')}
                          </p>
                        </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={`
                                    ...
                                    `}
                  title={`${t('reports.stickyNavigation.readingModeLabel', 'Reading mode')} (R)`}
                >
                        ...
                        <div className="space-y-2 text-sm">
                          <div className="flex items-center justify-between">
                            <span className="text-slate-600 dark:text-slate-400">
                              {t('reports.stickyNavigation.nextSectionLabel', 'Next section')}
                            </span>
                          ...
                          <div className="flex items-center justify-between">
                            <span className="text-slate-600 dark:text-slate-400">
                              {t('reports.stickyNavigation.goToLabel', 'Go to...')}
                            </span>
                            <kbd className="px-2 py-0.5 bg-slate-100 dark:bg-white/5 rounded text-xs font-mono">
                              G
                            </kbd>
                          ...
                          <div className="flex items-center justify-between">
                            <span className="text-slate-600 dark:text-slate-400">
                              {t('reports.stickyNavigation.readingModeLabel', 'Reading mode')}
                            </span>
                            <kbd className="px-2 py-0.5 bg-slate-100 dark:bg-white/5 rounded text-xs font-mono">
                              R
                            </kbd>
