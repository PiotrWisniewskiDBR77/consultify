...
export function FeedbackButtons({
  ...
  const submitFeedback = async (
    ...
    additionalData?: Partial<FeedbackData>
  ) => {
  ...
  return (
    <div className={`flex items-center gap-1 ${compact ? '' : 'gap-2'}`}>
      ...
      <button
        ...
        disabled={submitting}
        className={`p-1.5 text-gray-500 dark:text-gray-400 hover:text-green-600 hover:bg-green-50 rounded transition-colors ${
          compact ? '' : 'p-2'
        }`}
        title="Pomocne"
      >
      ...
      <button
        ...
        disabled={submitting}
        className={`p-1.5 text-gray-500 dark:text-gray-400 hover:text-danger-600 hover:bg-danger-50 rounded transition-colors ${
          compact ? '' : 'p-2'
        }`}
        title="Niepomocne"
      >
