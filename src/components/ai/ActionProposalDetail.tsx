  ...
  return (
    <div className="bg-white dark:bg-navy-900 rounded-xl border border-slate-200 dark:border-navy-700 shadow-sm overflow-hidden flex flex-col h-full">
      ...
      <div className="p-6 border-b border-slate-200 dark:border-navy-700 bg-slate-50/50 dark:bg-navy-950/50">
        ...
        {/* Tab Navigation */}
        <div className="flex gap-1 mt-6 border-b border-slate-200 dark:border-navy-700 -mx-6 px-6">
          {tabs.map((tab) => (
            <button
              key={tab.id}
      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        {activeTab === 'details' && (
          <div className="space-y-8">
            ...
            {/* Narrative Summary */}
            <section className="bg-emerald-500/5 dark:bg-emerald-500/5 border border-emerald-500/10 rounded-xl p-4">
              ...
              <div className="p-4 bg-slate-50 dark:bg-navy-950 border border-slate-200 dark:border-navy-700 rounded-xl">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">
                      Based on algorithmic projection
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="p-6 border-t border-slate-200 dark:border-navy-700 bg-slate-50/50 dark:bg-navy-950/50 flex items-center justify-between">
        ...
        <div className="flex gap-3">
          {onModify && (
            <button
              onClick={onModify}
              className="flex items-center gap-2 px-6 py-2.5 rounded-xl bg-white dark:bg-navy-800 border border-slate-200 dark:border-navy-700 text-slate-600 dark:text-slate-300 font-bold text-sm hover:border-indigo-400 transition-all"
            >
              Modify
            </button>
          )}
