 ...
 */
const ConfidenceBadge: React.FC<ConfidenceBadgeProps> = ({ confidence, showLabel = true, size = 'md' }) => {
    ...
    const tooltipText =
        'Confidence score based on evidence consistency and reasoning strength. This is not a prediction accuracy metric.';
