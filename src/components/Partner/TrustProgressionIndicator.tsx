    ...
    return (
        <div className="rounded-3xl border border-slate-200 bg-white/90 p-6 dark:border-white/5 dark:bg-navy-900/60">
            <div className="mb-4 flex items-center justify-between">
                <h3 className="text-lg font-semibold text-navy-900 dark:text-white">Partner Trust Progression</h3>
            ...
            {currentIndex < trustProgression.length - 1 && (
                <div className="mt-6 rounded-2xl bg-gradient-to-r from-brand/10 to-emerald-500/10 p-4 dark:from-brand/20 dark:to-emerald-500/20">
                    <div className="flex items-center justify-between">
                        ...
                        <button className="rounded-2xl bg-brand px-4 py-2 text-sm font-semibold text-white transition hover:bg-brand-dark">
                            View Tasks
                        </button>
                    </div>
                </div>
