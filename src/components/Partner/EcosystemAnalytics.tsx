...
export const EcosystemAnalytics: React.FC<EcosystemAnalyticsProps> = ({
  ...
  if (loading) {
    return (
      <div className="animate-pulse space-y-4 rounded-xl border border-slate-200 bg-white/90 p-6 dark:border-navy-700 dark:bg-navy-900/60">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className={`rounded-xl bg-gradient-to-r ${tierGradient} p-6 text-white shadow-lg`}>
