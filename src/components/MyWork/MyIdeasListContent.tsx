...
export const MyIdeasListContent: React.FC<MyIdeasListContentProps> = ({
  ...
  const renderEmpty = () => {
    if (activeFolder) {
      return (
        <div
          className="flex flex-col items-center justify-center h-64 text-center p-8 bg-white dark:bg-navy-900 border border-slate-200 dark:border-navy-700 rounded-xl"
          data-testid="ideas-folder-empty"
        >
          <div className="relative mb-4">
            <Folder size={44} className="text-slate-400 dark:text-slate-500" />
          </div>
