...
const PROTOTYPE_RADAR_SIGNALS: RadarMapSignal[] = [
  makeSignal(
    ...
    'large',
    'high',
    'AI agents can help automate repetitive knowledge work inside your current projects.'
  ),
  makeSignal(
    'sig-digital-twin',
    'Digital Twin',
    ...
    'medium',
    'medium',
    'Digital twin programs are becoming a key differentiator for industrial execution quality.'
  ),
  makeSignal(
    'sig-prompt-skills',
    'Prompt Skills',
    ...
    'medium',
    'high',
    'Prompt literacy improves the quality and speed of AI-supported project work.'
  ),
  makeSignal(
    'sig-ai-pmo',
    'AI PMO',
    ...
    'medium',
    'high',
    'AI PMO patterns reduce reporting friction and keep delivery governance lightweight.'
  ),
  makeSignal(
    'sig-robot-vision',
    'Robot Vision',
    ...
    'small',
    'medium',
    'Vision systems are entering quality-control workflows beyond manufacturing pilots.'
  ),
  makeSignal(
    'sig-data-quality',
    'Data Quality',
    ...
    'large',
    'high',
    'Data quality remains the bottleneck for reliable AI recommendations in delivery ops.'
  ),
  makeSignal(
    'sig-risk-radar',
    'Risk Radar',
    ...
    'medium',
    'high',
    'Early risk sensing can reduce costly late-stage execution changes.'
  ),
  makeSignal(
    'sig-sales-automation',
    'Sales Automation',
    'LEARN',
    'MY_INDUSTRY',
    'saved',
    ...
    'small',
    'medium',
    'AI-assisted sales workflows are reducing manual follow-up effort in B2B teams.'
  ),
  makeSignal(
    'sig-private-llm',
    'Private LLM',
    ...
    'small',
    'medium',
    'Private model strategies are becoming practical for regulated enterprise contexts.'
  ),
  makeSignal(
    'sig-meeting-notes',
    'Meeting Notes',
    ...
    'medium',
    'high',
    'Structured AI notes can turn conversations into concrete next-step objects faster.'
  ),
  makeSignal(
    'sig-process-mining',
    'Process Mining',
    ...
    'small',
    'medium',
    'Process mining can reveal hidden execution delays in transformation programs.'
  ),
  makeSignal(
    'sig-ot-cyber',
    'OT Cybersecurity',
    ...
    'medium',
    'high',
    'OT security pressure is rising and now influences strategic roadmap decisions.'
  ),
  makeSignal(
    'sig-workflow-auto',
    'Workflow Automation',
    ...
    'large',
    'high',
    'Workflow automation helps remove repetitive coordination from project delivery.'
  ),
  makeSignal(
    'sig-ai-leadership',
    'AI Leadership',
    ...
    'small',
    'medium',
    'Leadership teams need clearer AI framing to guide adoption without chaos.'
  ),
  makeSignal(
    'sig-marketplace-model',
    'Marketplace Model',
    'OBSERVE',
    'MY_INDUSTRY',
    'new',
    ...
    'small',
    'medium',
    'Marketplace packaging can accelerate distribution of reusable transformation assets.'
  ),
  makeSignal(
    'sig-smart-quality',
    'Smart Quality',
    ...
    'medium',
    'medium',
    'Smart quality practices connect operational signals with continuous improvement loops.'
  ),
];
