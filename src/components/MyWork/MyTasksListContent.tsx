...
// Sections kebab "Actions" (§6.4 5-grup: open+stan /
...
export const MyTasksListContent: React.FC<MyTasksListContentProps> = ({
  ...
  // na poziomie tabeli (StandardTable renderuje kolumny jako render(row), nie
  ...
  // Cell markup (title/status/priority/date/
          ...
          <div className="pl-4 pr-1.5 pt-3 pb-4">
            {tasks.length === 0 ? (
              ...
              <StandardTable
                ...
                // dla completed) idzie przez rowClassName.
                rowClassName={(row) => {
                  const task = row as unknown as Task;
                  const isCompleted = ['done', 'completed', 'validated'].includes(
                    task.status?.toLowerCase() || ''
