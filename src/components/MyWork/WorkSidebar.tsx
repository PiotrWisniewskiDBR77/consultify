...
export const WorkSidebar: React.FC<WorkSidebarProps> = ({
  ...
  const decisionSubItems = [
    {
      key: 'my' as DecisionGroup,
      label: t('myWork.decisions.my', 'My Decisions'),
      count: decisionCounts.my,
    },
    {
    ...
    <div className="w-60 bg-white dark:bg-navy-900 shadow-sm h-full flex flex-col">
      ...
      <nav className="flex-1 overflow-y-auto py-2">
        ...
        <div className="mb-1">
          ...
          {/* Task Sub-items */}
          {expandedSections.has('tasks') && (
            <div className="ml-6 border-l border-slate-200 dark:border-navy-700">
