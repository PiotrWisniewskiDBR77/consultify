    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <QuickStat
          ...
          status={
            metrics.avgCapacity > 90 ? 'warning' : metrics.avgCapacity > 100 ? 'danger' : 'neutral'
          }
        />
        <QuickStat
          ...
          trendValue={
            metrics.currentVelocity >= metrics.targetVelocity ? 'On target' : 'Below target'
          }
        ...
        <QuickStat
          ...
          icon={<Target size={18} />}
          status={
            metrics.onTimeRate >= 80 ? 'success' : metrics.onTimeRate >= 60 ? 'warning' : 'danger'
          }
        />
      </div>
