          ...
          <div className="flex items-center justify-center mb-4">
            {listening ? (
              ...
              <button
                ...
                disabled={locked}
                className="w-16 h-16 rounded-full bg-gradient-to-br from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 text-white flex items-center justify-center shadow-lg shadow-red-500/20 transition-all disabled:opacity-40"
              >
                <Mic size={24} />
              </button>
            )}
