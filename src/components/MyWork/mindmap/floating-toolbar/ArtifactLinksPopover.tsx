  ...
  return (
    <div className="w-72 rounded-xl bg-c-surface-raised dark:bg-c-surface border border-c-border-subtle dark:border-c-border shadow-xl p-3 space-y-3">
      ...
      {links.length > 0 ? (
          ...
          {links.map((link, index) => {
            ...
            return (
              <div
                ...
                className="rounded-xl border border-c-border-subtle dark:border-c-border bg-c-surface-raised dark:bg-c-surface px-2.5 py-2"
              >
        ...
        <div className="rounded-xl border border-dashed border-c-border-subtle dark:border-c-border px-3 py-4 text-center text-[11px] text-c-text-secondary dark:text-c-text-muted">
          {isPl
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="flex-1 inline-flex items-center justify-center gap-1 rounded-xl border border-c-border-subtle dark:border-c-border px-3 py-2 text-[11px] font-semibold text-c-text-secondary dark:text-c-text-muted hover:bg-c-surface-raised dark:hover:bg-c-surface-raised transition-colors"
        >
          <Link2 size={11} />
