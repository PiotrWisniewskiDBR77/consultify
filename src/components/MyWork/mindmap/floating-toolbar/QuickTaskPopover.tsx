    ...
    <div className="w-64 rounded-xl bg-white dark:bg-navy-900 shadow-2xl border border-slate-200/40 dark:border-navy-700/40 p-3 space-y-2.5">
      ...
      <div className="flex gap-1.5">
        <button
          ...
          className="flex-1 flex items-center justify-center gap-1 h-7 rounded-lg text-[11px] font-medium bg-primary-500 text-white hover:bg-primary-600 transition-colors"
        >
          <Plus size={11} />
          {isPl ? 'Utwórz' : 'Create'}
        </button>
