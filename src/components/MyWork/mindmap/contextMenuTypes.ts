...
export const MENU_CONTAINER_CLASS =
  'fixed z-[100] min-w-[220px] py-1 rounded-xl bg-c-surface-raised dark:bg-c-surface backdrop-blur-xl border border-c-border-subtle dark:border-c-border shadow-2xl animate-in fade-in zoom-in-95 duration-100';
