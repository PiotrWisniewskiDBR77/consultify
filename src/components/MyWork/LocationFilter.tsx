  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 bg-slate-100 dark:bg-navy-800 hover:bg-slate-200 dark:hover:bg-navy-700 rounded-lg text-sm text-slate-600 dark:text-slate-300 transition-colors border border-slate-200 dark:border-navy-700"
      >
        <MapPin size={16} />
        {displayText}
