    ...
    <div ref={rootRef} className={`relative inline-block ${className}`}>
      ...
      {open && (
        <div
          ...
          className="absolute right-0 z-50 mt-1 w-52 overflow-hidden rounded-xl border border-c-border-subtle bg-c-surface py-1 shadow-lg dark:border-white/10 dark:bg-navy-900"
        >
          <button
            type="button"
            role="menuitem"
