...
export const NotebookTodayView: React.FC<NotebookTodayViewProps> = ({
  ...
  const renderRow = (page: NotebookTodayPage) => (
    ...
    >
      ...
      <span className="min-w-0 flex-1 truncate text-sm font-medium text-slate-700 dark:text-slate-200 group-hover:text-violet-600 dark:group-hover:text-violet-300">
