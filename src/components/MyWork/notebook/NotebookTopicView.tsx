    ...
    >
      ...
      {loading && !agg ? (
        ...
        <div className="flex flex-col items-center gap-3 py-12 text-center px-4">
          ...
          <button
            onClick={load}
            className="px-3 py-1.5 rounded-lg bg-violet-500/10 hover:bg-violet-500/20 text-violet-700 dark:text-violet-300 text-xs font-medium"
          >
            ...
            {agg.notes.length === 0 ? (
              ...
              agg.notes.map((n) => (
                <button
                  ...
                  className="w-full text-left rounded-lg border border-slate-200 dark:border-navy-700 bg-slate-50/70 dark:bg-navy-900/50 px-2.5 py-2 hover:border-violet-300 transition-colors"
                >
                  <div className="flex items-center justify-between gap-2">
                    ...
                    {n.source === 'ai' && (
                      <span className="text-[11px] uppercase tracking-wide text-violet-500 shrink-0">
                        AI
                      </span>
                    )}
                  </div>
