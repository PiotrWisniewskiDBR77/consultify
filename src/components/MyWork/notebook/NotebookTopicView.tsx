    ...
    >
      ...
      {loading && !agg ? (
        ...
        <div className="flex flex-col items-center gap-3 py-12 text-center px-4">
          ...
          <button
            onClick={load}
            className="px-3 py-1.5 rounded-lg bg-primary-500/10 hover:bg-primary-500/20 text-primary-700 dark:text-primary-300 text-xs font-medium"
          >
            ...
            {agg.notes.length === 0 ? (
              ...
              agg.notes.map((n) => (
                <button
                  ...
                  className="w-full text-left rounded-lg border border-slate-200 dark:border-navy-700 bg-slate-50/70 dark:bg-navy-900/50 px-2.5 py-2 hover:border-primary-300 transition-colors"
                >
