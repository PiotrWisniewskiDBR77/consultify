          ...
          {onUploadComplete && (
            <div className="mb-4">
              ...
              <button
                ...
                disabled={uploading}
                className="w-full flex items-center gap-3 p-4 rounded-xl border-2 border-dashed border-slate-300 dark:border-navy-600 hover:border-violet-500 dark:hover:border-violet-500 hover:bg-violet-500/5 transition-colors"
              >
