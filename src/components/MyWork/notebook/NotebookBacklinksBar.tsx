    ...
    <div className="mt-3 flex flex-wrap items-center gap-1.5">
      ...
      {chips.map((chip) => (
        <button
          ...
          className="inline-flex max-w-[220px] items-center gap-1 rounded-full border border-c-border-subtle bg-c-surface px-2 py-0.5 text-[11px] text-c-text-secondary transition-colors hover:bg-c-surface-raised dark:border-navy-700 dark:bg-navy-900 dark:text-c-text-secondary dark:hover:bg-white/[0.04]"
        >
