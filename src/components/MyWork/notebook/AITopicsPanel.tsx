        ...
        <div className="flex items-center gap-1">
          {(topics.length === 0 || error) && (
            <button
              onClick={() => fetchTopics()}
              disabled={loading}
              className="p-1.5 rounded-lg text-violet-600 dark:text-violet-400 hover:bg-violet-500/10 disabled:opacity-50"
        ...
        {loading && topics.length === 0 ? (
          ...
          <div className="flex flex-col items-center gap-3 py-8 text-center px-3">
            ...
            <button
              onClick={() => fetchTopics()}
              disabled={loading}
              className="flex items-center gap-2 px-3 py-2 rounded-lg bg-violet-500/10 hover:bg-violet-500/20 text-violet-700 dark:text-violet-300 text-xs font-medium transition-colors disabled:opacity-50"
            >
              {loading ? <Loader2 size={14} className="animate-spin" /> : <RefreshCw size={14} />}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-2 flex items-center gap-2">
                      <button
                        ...
                        className="flex items-center justify-center gap-1 rounded-lg bg-violet-500/10 hover:bg-violet-500/20 text-violet-700 dark:text-violet-300 px-2.5 py-1 text-[11px] font-medium transition-colors"
                      >
                        {isPl ? 'Zapisz' : 'Save'}
                      </button>
                      <button
