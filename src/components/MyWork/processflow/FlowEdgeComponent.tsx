        ...
        {editing ? (
          <div className="flex items-center gap-0.5">
            <input
              ...
              className="w-full text-[9px] font-medium text-center bg-c-surface border border-primary-400 rounded px-1 outline-none"
            />
            <select
              value={conditionType}
              onChange={(e) => {
          ...
          <div
            className="text-[9px] font-medium text-c-text-secondary text-center cursor-pointer hover:text-primary-600 truncate"
            onDoubleClick={(e) => {
              e.stopPropagation();
