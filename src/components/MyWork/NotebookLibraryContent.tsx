    ...
    >
      ...
      >
        ...
        <input
          ...
          className="w-full px-3 py-2 mb-4 rounded-lg border border-c-border bg-c-bg text-c-text text-sm outline-none focus:ring-2 focus:ring-c-focus focus:border-c-focus-solid"
        />
          ...
          <div className="mb-4">
            ...
            {teams.length ? (
              <select
                ...
                className="w-full px-3 py-2 rounded-lg border border-c-border bg-c-bg text-c-text text-sm outline-none focus:ring-2 focus:ring-c-focus"
              >
                {teams.map((t) => (
