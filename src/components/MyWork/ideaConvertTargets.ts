...
export const IDEA_CONVERT_TARGETS: IdeaConvertTargetMeta[] = [
  { id: 'initiative', status: 'live', group: 'work', labelPl: 'Inicjatywa', labelEn: 'Initiative', descPl: 'Utwórz w PMO', descEn: 'Create in PMO' },
  { id: 'task_set', status: 'live', group: 'work', labelPl: 'Taski', labelEn: 'Tasks', descPl: 'Z next steps', descEn: 'From next steps' },
  { id: 'decision', status: 'live', group: 'work', labelPl: 'Decyzja', labelEn: 'Decision', descPl: 'Artefakt decyzyjny', descEn: 'Decision artifact' },
  { id: 'team_chat', status: 'live', group: 'work', labelPl: 'Team Chat', labelEn: 'Team Chat', descPl: 'Wątek do omówienia', descEn: 'Discussion thread' },
  { id: 'report', status: 'live', group: 'docs', labelPl: 'Raport', labelEn: 'Report', descPl: 'Generuj raport z mapy', descEn: 'Generate report from map' },
  { id: 'presentation', status: 'live', group: 'docs', labelPl: 'Prezentacja', labelEn: 'Presentation', descPl: 'Generuj slajdy z gałęzi', descEn: 'Generate slides from branches' },
  { id: 'action_plan', status: 'soon', group: 'work', labelPl: 'Plan działania', labelEn: 'Action Plan', descPl: 'Plan z timeline', descEn: 'Plan with timeline' },
  { id: 'raid_log', status: 'soon', group: 'work', labelPl: 'RAID Log', labelEn: 'RAID Log', descPl: 'Risks, Actions, Issues, Dependencies', descEn: 'Risks, Actions, Issues, Dependencies' },
  { id: 'financial_model', status: 'soon', group: 'models', labelPl: 'Model finansowy', labelEn: 'Financial Model', descPl: 'Projekcje finansowe', descEn: 'Financial projections' },
  { id: 'budget', status: 'soon', group: 'models', labelPl: 'Budżet', labelEn: 'Budget', descPl: 'Plan budżetowy', descEn: 'Budget plan' },
  { id: 'valuation', status: 'soon', group: 'models', labelPl: 'Wycena', labelEn: 'Valuation', descPl: 'Model wyceny', descEn: 'Valuation model' },
  { id: 'analysis', status: 'soon', group: 'models', labelPl: 'Analiza', labelEn: 'Analysis', descPl: 'Analiza pogłębiona', descEn: 'Deep analysis' },
];
