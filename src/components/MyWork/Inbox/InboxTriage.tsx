      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <select
            ...
            className="text-sm bg-white dark:bg-navy-800 border border-slate-200 dark:border-navy-700 rounded-lg px-3 py-1.5"
          >
            <option value="all">{t('myWork.inbox.filter.all', 'All types')}</option>
            <option value="new_assignment">
              {t('myWork.inbox.filter.assignment', 'Assignments')}
            </option>
