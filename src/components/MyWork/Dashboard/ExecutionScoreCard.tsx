...
import { Award, Flame, Minus, Target, TrendingDown, TrendingUp } from 'lucide-react';
 ...
 */
export const ExecutionScoreCard: React.FC<
  Partial<ExecutionScoreCardProps> & { className?: string }
> = ({
  score: externalScore,
  showTrend = true,
  showRank = false,
  ...
  if (compact) {
    return (
      <div
        className={`flex items-center gap-4 p-4 bg-white dark:bg-navy-900 rounded-xl border border-slate-200 dark:border-navy-700 ${className}`}
      >
        {/* Score */}
