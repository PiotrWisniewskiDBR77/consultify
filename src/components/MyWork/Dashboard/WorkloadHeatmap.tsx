...
const getAllocationTextColor = (allocation: number): string => {
  if (allocation >= 100) return 'text-danger-700 dark:text-danger-300';
      ...
      {showLegend && (
        <div className="flex items-center justify-center gap-4 px-4 py-3 border-t border-slate-100 dark:border-navy-700">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="text-[10px] text-slate-500 dark:text-slate-400">Normal</span>
          </div>
          <div className="flex items-center gap-1">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="text-[10px] text-slate-500 dark:text-slate-400">Overloaded</span>
          </div>
        </div>
      )}
    </div>
