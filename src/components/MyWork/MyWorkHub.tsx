...
const CTA_TONE: Record<'violet' | 'emerald' | 'amber' | 'indigo' | 'neutral', string> = {
  ...
  violet:
    'border-primary-500/30 bg-navy-900 text-white dark:bg-[#F4F7FB] dark:text-navy-950 dark:hover:bg-[#DDE5EF] hover:bg-navy-800 dark:border-primary-400/20 dark:bg-primary-500/80 dark:hover:bg-primary-500',
  emerald:
