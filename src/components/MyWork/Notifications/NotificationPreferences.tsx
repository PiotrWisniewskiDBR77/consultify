...
export const NotificationPreferences: React.FC<NotificationPreferencesProps> = ({
  ...
  if (!preferences) {
    return (
      <div className={`text-center p-8 text-slate-500 dark:text-slate-400 ${className}`}>
        ...
        <div className="space-y-1">
          {(Object.keys(categoryConfig) as NotificationCategory[]).map((category) => (
            <CategoryRow
              ...
              category={category}
              settings={
                preferences.categories[category] || { inapp: true, push: false, email: false }
              }
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between py-3">
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                {t(
                  'myWork.notifications.weeklyDigestDesc',
