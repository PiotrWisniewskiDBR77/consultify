            ...
            {hasMore && (
              <div className="px-3 py-3">
                <button
                  ...
                  disabled={loading}
                  className="w-full py-2 rounded-lg text-[11px] font-semibold text-c-text-secondary bg-c-surface-raised hover:bg-c-border-subtle transition-colors disabled:opacity-40 flex items-center justify-center gap-1.5"
                >
                  {loading ? (
