      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-[1px]">
        ...
        >
          ...
          {selectedList.length > 0 && (
            <div className="border-b border-slate-100 px-5 py-2.5 dark:border-zinc-800">
              <div className="mb-1.5 text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-zinc-500">
                          ...
                          {fieldsMeta.slice(0, 5).map((fm) => {
                            ...
                            return (
                              <div key={fm.id} className="flex items-start gap-2">
                                <span className="w-20 flex-shrink-0 truncate text-[10px] font-medium text-slate-400">
                                  {fm.name}
                                </span>
