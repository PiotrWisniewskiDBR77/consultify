    ...
    <div
      className={`w-full px-4 py-2 flex items-center justify-between transition-colors ${
        lowDays || lowTokens
          ...
          : 'bg-slate-50 border-b border-slate-200 dark:border-navy-700'
      }`}
    >
      <div className="flex items-center space-x-6">
        ...
        >
          <span className="text-xs text-slate-500 dark:text-slate-400 font-medium">AI Budget</span>
          <div className="w-24 h-2 bg-slate-200 dark:bg-navy-700/50 rounded-full overflow-hidden">
            <div
