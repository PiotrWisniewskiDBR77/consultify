    ...
    <div className="space-y-8">
      ...
      <div className="space-y-3">
        {sections.map((section, idx) => (
          ...
          >
            {/* Drag handle (visual) */}
            <div className="pt-1 cursor-grab text-slate-600 dark:text-slate-600 group-hover:text-slate-400 dark:group-hover:text-slate-500">
              <GripVertical className="w-5 h-5" />
            </div>

            {/* Index */}
            <div className="flex-shrink-0 w-7 h-7 rounded-full bg-slate-100 dark:bg-slate-700 flex items-center justify-center text-xs font-semibold text-slate-500 dark:text-slate-400">
              {idx + 1}
            </div>
            ...
            <div className="flex-1 min-w-0 space-y-1">
              <input
                ...
                className="w-full bg-transparent text-sm font-medium text-slate-900 dark:text-white border-b border-transparent hover:border-slate-300 dark:hover:border-slate-600 focus:border-blue-500 focus:outline-none transition-colors pb-0.5"
              />
      ...
      {addingSection ? (
        <div className="p-4 rounded-lg border border-dashed border-blue-300 dark:border-blue-600 bg-blue-50/50 dark:bg-blue-900/10 space-y-3">
          <input
            ...
            autoFocus
            className="w-full px-3 py-2 text-sm border border-slate-200 dark:border-slate-600 rounded-lg bg-white dark:bg-navy-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:outline-none"
          />
          <input
            type="text"
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-4 py-2 text-sm rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
            >
              {isPl ? 'Anuluj' : 'Cancel'}
            </button>
          </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-3 rounded-lg border border-dashed border-slate-300 dark:border-slate-600 text-sm text-slate-500 dark:text-slate-400 hover:border-blue-400 hover:text-blue-500 dark:hover:border-blue-500 dark:hover:text-blue-400 transition-colors"
        >
      ...
      <div className="pt-4 border-t border-slate-200 dark:border-slate-700">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-3 px-6 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-medium text-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
