...
export const SourceSelectStep: React.FC<SourceSelectStepProps> = ({
  ...
  return (
    <div className="space-y-8">
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  ${isSelected ? 'bg-blue-100 dark:bg-blue-900/50 text-blue-600' : 'bg-slate-100 dark:bg-slate-700 text-slate-500'}
                `}
                >
        ...
        <div className="animate-fade-in">
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-slate-200 dark:border-slate-600 rounded-lg bg-white dark:bg-navy-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
      ...
      {/* Report Details */}
      {selectedSource && (
        <div className="animate-fade-in space-y-4 pt-4 border-t border-slate-200 dark:border-slate-700">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-slate-200 dark:border-slate-600 rounded-lg bg-white dark:bg-navy-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-2 border border-slate-200 dark:border-slate-600 rounded-lg bg-white dark:bg-navy-800 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
            />
