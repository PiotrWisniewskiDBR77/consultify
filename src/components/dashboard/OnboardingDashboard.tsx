    ...
    <div className="max-w-5xl mx-auto space-y-6 animate-fade-in">
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-slate-500 dark:text-slate-400">
          Step-by-step roadmap to operational excellence.
        </p>
      </div>
        ...
        <div className="lg:col-span-2 bg-white dark:bg-navy-900 rounded-xl p-5 border border-slate-200 dark:border-c-border-subtle shadow-sm">
          ...
          <div className="space-y-4">
            {steps.map((step) => {
              ...
              const isCurrent =
                status === 'pending' &&
                (!session || getStatus(step.id - 1) === 'completed' || step.id === 1);
        ...
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 dark:bg-navy-800/50 rounded-2xl p-6 border border-blue-100 dark:border-c-border-subtle">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-300">
              "I am monitoring your progress. Once you complete the Expectations phase, I will
              prepare a tailored assessment structure for you."
            </p>
          </div>
        </div>
      </div>
