...
export const CreditNotesPanel: React.FC = () => {
    ...
    return (
        <div className="space-y-6">
            {/* Summary Card */}
            <div className="bg-gradient-to-br from-violet-500/20 to-fuchsia-500/10 border border-violet-500/20 rounded-xl p-5">
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="border-b border-white/[0.06]">
                                <th className="text-left p-4 text-sm font-medium text-slate-400">Credit Note</th>
