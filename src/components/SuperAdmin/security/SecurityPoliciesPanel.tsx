    ...
    <div className="bg-c-surface-raised/50 border border-white/[0.06] rounded-xl p-6">
          ...
          {[
            ...
            <label key={key} className="flex items-center gap-3 cursor-pointer group">
              <input
                ...
                className="w-5 h-5 rounded border-slate-600 bg-c-surface-raised text-primary-500 focus:ring-c-focus"
              />
      ...
      <div className="mt-6">
        ...
        <input
          ...
          className="w-full max-w-xs px-4 py-2.5 bg-c-surface/50 border border-c-border-subtle rounded-lg text-c-text focus:border-c-focus-solid outline-none"
        />
        <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
