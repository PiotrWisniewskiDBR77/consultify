        ...
        <div className="bg-slate-800/50 border border-white/[0.06] rounded-xl p-6">
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-slate-400">Configure password requirements</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
                <div>
                    ...
                    <input
                        ...
                        className="w-full px-4 py-2.5 bg-slate-900/50 border border-white/10 rounded-lg text-white focus:border-violet-500/50 outline-none"
                    />
                </div>
                <div>
                    ...
                    <input
                        ...
                        className="w-full px-4 py-2.5 bg-slate-900/50 border border-white/10 rounded-lg text-white focus:border-violet-500/50 outline-none"
                    />
                    <p className="text-xs text-slate-500 mt-1">Prevent reuse of last N passwords</p>
                </div>
            </div>
            ...
            <div className="mt-6">
                ...
                <input
                    ...
                    className="w-full max-w-xs px-4 py-2.5 bg-slate-900/50 border border-white/10 rounded-lg text-white focus:border-violet-500/50 outline-none"
                />
        ...
        <div className="bg-slate-800/50 border border-white/[0.06] rounded-xl p-6">
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-slate-400">Configure session management</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
                <div>
                    ...
                    <input
                        ...
                        className="w-full px-4 py-2.5 bg-slate-900/50 border border-white/10 rounded-lg text-white focus:border-violet-500/50 outline-none"
                    />
                    <p className="text-xs text-slate-500 mt-1">{Math.round(policy.sessionTimeoutMinutes / 60)} hours</p>
                </div>
                <div>
        ...
        <div className="bg-slate-800/50 border border-white/[0.06] rounded-xl p-6">
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-slate-400">Configure login protection</p>
                </div>
            </div>
        ...
        <div className="bg-slate-800/50 border border-white/[0.06] rounded-xl p-6">
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-slate-400">Configure MFA requirements</p>
                </div>
            </div>
            ...
            <div className="space-y-6">
                ...
                <div>
                    <label className="block text-sm font-medium text-slate-300 mb-2">Allowed MFA Methods</label>
                ...
                <div>
                    <label className="block text-sm font-medium text-slate-300 mb-2">Remember Device (days)</label>
                    <input
                        type="number"
                        min={0}
                        max={90}
                        ...
                        className="w-full max-w-xs px-4 py-2.5 bg-slate-900/50 border border-white/10 rounded-lg text-white focus:border-violet-500/50 outline-none"
                    />
                    <p className="text-xs text-slate-500 mt-1">Set to 0 to always require MFA</p>
                </div>
            </div>
        </div>
    );
