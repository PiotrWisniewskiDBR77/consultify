      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            {!rule.is_active && (
              <span className="px-2 py-0.5 bg-slate-700 rounded text-xs text-slate-400 dark:text-slate-500">
                Disabled
              </span>
            )}
          </div>
          {rule.description && (
            <p className="text-sm text-slate-400 dark:text-slate-500 mt-1">{rule.description}</p>
          )}
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className={`p-2 rounded-lg transition-colors ${
            rule.is_active
              ? 'bg-slate-800 hover:bg-slate-700 text-slate-400 dark:text-slate-500'
