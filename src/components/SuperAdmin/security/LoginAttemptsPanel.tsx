            ...
            <div className="grid grid-cols-4 gap-4 mb-6">
                <div className="bg-slate-800/50 border border-white/[0.06] rounded-xl p-4">
                    ...
                    <div className="flex items-baseline gap-2">
                        <span className="text-2xl font-bold text-white">{stats.loginAttempts.successRate}%</span>
                ...
                <div className="bg-slate-800/50 border border-white/[0.06] rounded-xl p-4">
                    ...
                    <span className="text-sm text-slate-500 ml-2">/ 7 days</span>
                </div>
                ...
                <div className="bg-slate-800/50 border border-white/[0.06] rounded-xl p-4">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm text-slate-400">Active Lockouts</span>
                    </div>
                        ...
                        >
                            ...
                            <div className="flex items-center gap-4">
                                <div className="text-right text-sm">
                                    <p className="text-slate-400">Locked {formatDate(lockout.locked_at)}</p>
                                    {lockout.expires_at && (
                                        <p className="text-slate-500">Expires {formatDate(lockout.expires_at)}</p>
                                    )}
                                </div>
                                <button
