    ...
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2.5 bg-slate-900/50 border border-white/10 rounded-lg text-white placeholder:text-slate-500 dark:text-slate-400 focus:border-violet-500/50 outline-none"
          />
        </div>
        <div>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-2.5 pr-10 bg-slate-900/50 border border-white/10 rounded-lg text-white focus:border-violet-500/50 outline-none"
            />
            <button
              type="button"
      ...
      <label className="flex items-center gap-3 cursor-pointer">
        <input
          ...
          className="w-5 h-5 rounded border-slate-600 bg-slate-800 text-violet-500"
        />
        <div>
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            className="w-full px-4 py-2.5 pr-10 bg-slate-900/50 border border-white/10 rounded-lg text-white placeholder:text-slate-500 dark:text-slate-400 focus:border-violet-500/50 outline-none"
          />
          <button
            type="button"
            onClick={() => setShowPassword(!showPassword)}
              ...
              <div className="bg-slate-800/50 border border-white/[0.06] rounded-xl p-6">
                ...
                <div className="flex gap-3">
                  <input
                    ...
                    className="flex-1 px-4 py-2.5 bg-slate-900/50 border border-white/10 rounded-lg text-white placeholder:text-slate-500 dark:text-slate-400 focus:border-violet-500/50 outline-none"
                  />
                  <button
