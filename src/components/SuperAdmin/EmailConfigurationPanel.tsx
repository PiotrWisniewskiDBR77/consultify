      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2.5 bg-c-surface/50 border border-c-border-subtle rounded-lg text-c-text placeholder:text-slate-500 dark:text-slate-400 focus:border-primary-500/50 outline-none"
          />
        </div>
        <div>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-2.5 pr-10 bg-c-surface/50 border border-c-border-subtle rounded-lg text-c-text focus:border-primary-500/50 outline-none"
            />
            <button
              type="button"
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            className="w-full px-4 py-2.5 pr-10 bg-c-surface/50 border border-c-border-subtle rounded-lg text-c-text placeholder:text-slate-500 dark:text-slate-400 focus:border-primary-500/50 outline-none"
          />
          <button
            type="button"
            onClick={() => setShowPassword(!showPassword)}
              ...
              <div className="bg-c-surface-raised/50 border border-white/[0.06] rounded-xl p-6">
                ...
                <div className="flex gap-3">
                  <input
                    ...
                    className="flex-1 px-4 py-2.5 bg-c-surface/50 border border-c-border-subtle rounded-lg text-c-text placeholder:text-slate-500 dark:text-slate-400 focus:border-primary-500/50 outline-none"
                  />
                  <button
