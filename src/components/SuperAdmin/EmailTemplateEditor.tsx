    ...
    <div className="fixed inset-0 bg-slate-950 z-50 flex flex-col">
      ...
      <header className="flex items-center justify-between px-6 py-4 border-b border-slate-800 bg-slate-900/80 backdrop-blur-sm">
        <div className="flex items-center gap-4">
          <button
            onClick={onClose}
            className="p-2 text-slate-600 dark:text-slate-500 hover:text-white hover:bg-slate-800 rounded-lg transition-colors"
          >
            <X size={20} />
          </button>
          <div>
        ...
        <div className="flex items-center gap-3">
          {!isNew && (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-slate-600 hover:text-white border border-slate-700 rounded-lg hover:bg-slate-800 transition-colors"
            >
              <Send size={16} />
              Test Send
            </button>
        ...
        <div className="w-96  border-slate-800 flex flex-col overflow-hidden">
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-semibold text-slate-600 dark:text-slate-500 uppercase tracking-wider">
                Basic Information
              </h3>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-slate-800 border border-slate-700 text-slate-600 rounded-lg hover:bg-slate-700 transition-colors disabled:opacity-50"
                >
                  <Plus size={16} />
                </button>
              </div>
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
            ...
            {viewMode === 'html' && (
              <div className="h-full flex flex-col">
                <textarea
                  ...
                  className="flex-1 w-full p-4 bg-slate-950 text-slate-600 font-mono text-sm resize-none focus:outline-none"
          ...
          <div className="border-t border-slate-800">
            <details className="group">
              <summary className="px-4 py-3 text-sm font-medium text-slate-600 dark:text-slate-500 cursor-pointer hover:text-white flex items-center gap-2">
...
<body style="font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #374151; margin: 0; padding: 0; background-color: #f3f4f6;">
    <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
        <div style="background: linear-gradient(135deg, #A51C30 0%, #A51C30 100%); border-radius: 16px 16px 0 0; padding: 32px; text-align: center;">
        ...
        <div style="background: white; border-radius: 0 0 16px 16px; padding: 32px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
            ...
            <div style="text-align: center; margin: 32px 0;">
                <a href="{{actionUrl}}" style="display: inline-block; background: linear-gradient(135deg, #A51C30 0%, #A51C30 100%); color: white; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 16px;">Call to Action</a>
            </div>
