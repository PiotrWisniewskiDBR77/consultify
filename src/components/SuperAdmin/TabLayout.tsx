          ...
          {tabs.map((tab) => (
            <button
              ...
              className={`
                ...
                ${
                  activeTab === tab.id
                    ? 'text-slate-900 dark:text-slate-100 border-navy-900 dark:border-white/70 bg-slate-100/80 dark:bg-white/5'
                    : tab.disabled
            ...
            >
              {tab.icon && (
                <span className={activeTab === tab.id ? 'text-slate-900 dark:text-white' : ''}>
                  {tab.icon}
                </span>
              )}
              {tab.label}
