        ...
        {activeMode === 'setCategory' && (
          <div className="px-4 py-3 border-t border-c-border-subtle/50 bg-c-surface-raised/50">
            ...
            <select
              ...
              className="w-full px-3 py-2 bg-c-text text-c-bg border border-c-border-subtle rounded-lg mb-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-c-focus"
            >
