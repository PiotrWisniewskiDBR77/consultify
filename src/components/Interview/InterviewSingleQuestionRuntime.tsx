              ...
              return (
                <button
                  ...
                  className={`w-full flex items-start gap-2.5 rounded-xl px-3 py-2.5 text-left transition-all ${
                    isCurrent
                      ? 'bg-c-info/10 dark:bg-c-info/15 ring-1 ring-c-info/20'
                      : isAnswered
              ...
              <div className={immersive ? 'max-w-2xl mx-auto space-y-5' : 'space-y-5'}>
                    ...
                    <div className="flex items-center gap-2.5">
                      <span
                        className={`inline-flex items-center justify-center w-7 h-7 rounded-lg text-xs font-bold tabular-nums ${
                          immersive
                            ? 'bg-c-info/15 text-c-info ring-1 ring-c-info/20'
                ...
                <div className="space-y-4">
                  ...
                  {(inputMode === 'voice_answer' || isTranscribing) && !voiceNeedsApproval && (
                    <div className="rounded-xl border border-c-success/30 bg-[color:var(--c-success)]/10 px-4 py-3 text-sm text-c-success">
                      {isTranscribing ? (
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              {!readOnly && (
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-xl px-4 py-2.5 text-sm font-medium disabled:opacity-50 bg-c-text text-c-bg hover:opacity-90 transition-opacity"
                >
                  {isPersisting ? (
                    <Loader2 size={16} className="animate-spin" />
                  ) : (
              ...
              {isLastQuestion ? (
                ...
                <button
                  ...
                  className={`inline-flex items-center gap-2 rounded-xl px-5 py-2.5 text-sm font-semibold disabled:opacity-50 ${
                    immersive
                      ? 'bg-navy-900 text-white shadow-lg shadow-c-info/20 hover:bg-c-info/10'
