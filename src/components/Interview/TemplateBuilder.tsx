...
export const TemplateBuilder: React.FC<TemplateBuilderProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="bg-navy-900 border border-navy-700 rounded-xl shadow-2xl w-full max-w-6xl mx-4 max-h-[95vh] overflow-hidden flex flex-col">
        {/* Header */}
            ...
            <button
              ...
              className={`p-2 rounded-lg border transition-all ${
                showPreview
                  ...
                  : 'bg-navy-800 border-navy-600 text-slate-400 hover:text-white'
              }`}
        ...
        {isLoading ? (
          ...
          <div className="flex-1 flex overflow-hidden">
            ...
            <div className="w-80 border-r border-navy-700 p-4 overflow-auto shrink-0">
                    ...
                    <button
                      ...
                      className={`w-full flex items-center justify-between px-3 py-2 rounded-lg transition-all ${
                        activeCategory === cat.id
                          ...
                          : 'bg-navy-800 border border-navy-700 text-slate-400 hover:text-white hover:border-slate-600'
                      }`}
                    >
                      <div className="flex items-center gap-2">
        ...
        {/* Footer */}
        <div className="p-4 border-t border-navy-700 flex items-center justify-between shrink-0">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={onClose}
              className="px-4 py-2 rounded-lg bg-navy-800 border border-navy-600 text-slate-300 hover:bg-navy-700 transition-colors"
            >
            ...
            <button
              ...
              disabled={isSaving}
              className="flex items-center gap-2 px-4 py-2 rounded-lg bg-navy-700 border border-navy-600 text-white hover:bg-navy-600 transition-colors disabled:opacity-50"
            >
...
const QuestionCard: React.FC<QuestionCardProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Expanded Content */}
      {isExpanded && (
        <div className="p-4 pt-0 border-t border-navy-700 space-y-4">
          {/* Question Text */}
          <div>
            <label className="block text-xs font-medium text-slate-400 mb-1.5">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 rounded-lg bg-navy-900 border border-navy-600 text-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500/50 transition-all"
              >
              ...
              <div className="space-y-2">
                {question.answerOptions.map((opt, idx) => (
                  <div key={idx} className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      className="flex-1 px-3 py-1.5 rounded-lg bg-navy-900 border border-navy-600 text-white text-sm focus:border-primary-500 focus:ring-1 focus:ring-primary-500/50 transition-all"
                    />
                    <button
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    className="flex-1 px-3 py-1.5 rounded-lg bg-navy-900 border border-navy-600 text-white text-sm placeholder-slate-500 focus:border-primary-500 focus:ring-1 focus:ring-primary-500/50 transition-all"
                  />
                  <button
