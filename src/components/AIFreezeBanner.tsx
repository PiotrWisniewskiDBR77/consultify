    ...
    <div className="bg-amber-600 dark:bg-amber-900/40 text-white px-4 py-2 flex items-center justify-between shadow-lg z-modal border-b border-amber-500/30 backdrop-blur-md animate-in slide-in-from-top duration-300">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <span className="text-sm ml-2 text-amber-50 opacity-90">
            Budget hard limit reached ({aiFreezeStatus.scope || 'Global'}). AI functionality is
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="bg-white dark:bg-navy-900 text-amber-700 hover:bg-amber-50 px-4 py-1 rounded-lg text-xs font-bold transition-all shadow-sm border border-transparent active:scale-95"
        >
          Increase Budget
        </button>
      </div>
