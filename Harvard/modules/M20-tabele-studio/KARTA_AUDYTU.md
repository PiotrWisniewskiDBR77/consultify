...
| F. Bezpieczeństwo/dostęp | 10 | 6 | Rdzeń szczelny przez `PermissionsService`; W2 naprawił record-templates/form-submissions/row-policies org-guard (commit `e3945bc7fc`); SSO plaintext + share_password nieweryfikowane pozostają P1/P2 |
| G. Środowiska (Railway) | 10 | 0 | Faza 3 niewykonana. |
| **Hard cap zastosowany?** | — | — | NIE: W2 naprawił cross-org WRITE record-templates (`e3945bc7fc`), hard cap zdjęty; Faza 4 niewykonana → max 70; suma 47 < 70 |
