...
| M02 | Canvas | 3 | 6/6 | 7/7 | 199✅ | 20/20 | ✅ | 🟡 | 🟡 | 16 | 🟢 DO ODBIORU |
...
| 8 | **ODBIÓR UI/grafik — audytor + Piotr** | 🟡 | **SCREENY ZROBIONE (2026-06-20)** — pakiet 10 ekr. na dysku `docs/qa/screens/m02-canvas-2026-06-20/` (capture spec `tests/e2e/smoke/m02-canvas-ui-capture.spec.ts`, light+dark): panel+edytor, MD view, menu „…", New Canvas templates, historia wersji, capability-gating strips, **floating AI menu + render tabeli GFM (siatka)**, dark menu, dark split. Ekrany capability (deck 5 slajdów+branding, generacja doc rich-PL+tabela kosztów, plan-checklist) zweryfikowane live owner DBR77. README mapuje 16-ekr. inwentarz. **Formalny odbiór UX (sign-off) = audytor + Piotr** |
| ✔ | **ZAMKNIĘTY (8/8)** | ⬜ | bramka 6 (deploy demo) + formalne sign-offy 7/8 ODROCZONE decyzją Piotra (czekają na flagi Railway demo + przegląd audytora) |
