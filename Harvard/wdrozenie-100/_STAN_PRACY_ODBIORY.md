...
| M13 | Inicjatywy | 2 | 0/16 | — | 🔵 | 🟡 **14/~121** (Playwright+38 screenów 06-21) | 🟡 | ⬜ | ⬜ | 38 | 🔵 PROGRAM M13 DEPTH — osobny SSOT: [`M13-STAN-PRACY-ODBIORY.md`](M13-STAN-PRACY-ODBIORY.md). **Postęp 2026-06-21:** Serie G(5/5)+R(W2 5/5)+**W5 Gantt drag**+**Calendar drag**+**K4 AI-fill**+**Serie C konsolidacja** code-side. **Manual gate: `m13-manual.spec.ts` 14/14 zielone + 38 screenów** (§1/§2 26-sekcji/§3/§4/§5/§6/§11) → [`_ANALIZA_UIUX_M13_2026-06-21.md`](_ANALIZA_UIUX_M13_2026-06-21.md). **Regresja 7/7** (M07 data-loss lock + W5 + K4). **REALNY BŁĄD UI (P1):** DRAFT/utworzone inicjatywy NIEWIDOCZNE na domyślnym Kanban (10→0/0/0/0/0). Reszta scenariuszy (cross-module/AI-gen/pilot/DB) poza headless. Branch `feat/deliverables-w1`→demo |
