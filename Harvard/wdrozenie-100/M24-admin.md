...
| L-08 | martwy kod FE (`AdminSidebar` + resztki `Admin/`) | W-01 | `layout/AdminSidebar.tsx` (0 importerów) | P3 | 3/4 | **✅ ZAMKNIĘTA `d073e66508` (2026-06-17)** — usunięto `Admin/AdminLayout.tsx` (196 lin), `Admin/AdminSidebar.tsx` (614 lin), `layout/AdminSidebar.tsx` (364 lin); wyczyszczono `Admin/index.ts` (4 martwe eksporty); 0 nowych błędów tsc. |
