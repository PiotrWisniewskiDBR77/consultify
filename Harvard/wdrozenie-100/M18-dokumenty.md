...
|----|------|---------|--------------------|-------|------|-----------|---------|
| L-01 | trwałość 6/8 warstw in-memory → utrata po deployu | W-01,W-03,W-04 | mig. `780`+`781`; 6 DAO przepisane na Postgres (0 `new Map`, INSERT+UPSERT) | P1 | 1 | **ZAMKNIĘTA (R6)** — (1) kod (`953955bc2b`+`8d2b5d8cf4`), (2) cold-start CI proof (`approval-coldstart.contract.test.ts` 7/7), (3) **SCHEMA POTWIERDZONA NA ŻYWEJ BAZIE STAGING (trolley)**: wszystkie 12 tabel wave5 (`document_approvals`, `_audit`, `_content_blocks`, `_content_block_audit`, `_brand_voice_profiles`, `_brand_voice_audit`, `_audience_profiles`, `_audience_audit`, `_source_packs`, `_source_pack_audit`, `_share_links`, `_share_link_audit`) ISTNIEJĄ (to_regclass 2026-06-17). (4) **LIVE INSERT→REDEPLOY→SELECT PASS 2026-06-18**: `approval_id='coldstart-proof-1781755353836'`, status=`pending`, `created_at='2026-06-18T04:02:34.475Z'` — rekord PRZEŻYŁ `railway redeploy -s consultify -y`. Dowód: `Harvard/wdrozenie-100/COLD_START_PROOF_2026-06-18.md`. | 2026-06-18 |
