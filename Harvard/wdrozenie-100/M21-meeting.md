...
| L-06 | i18n hybryda 79× `isPolish` (grep) + 109× `t()` | W-01 | `Meeting/*` (grep 2026-06-13=79) | P2 | 4 | **ZABLOKOWANA (Fala 4)** — `public/locales/*` ZAKAZANE w Fali 1; wymaga koordynacji z agentem i18n (inny commit); scope: sweep `t()` przez cały katalog `src/components/Meeting/` |  |
