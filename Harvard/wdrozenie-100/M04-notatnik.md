...
| L-09 | TipTap/SlashMenu 0 testów; S5 fałszywa zieleń; 8 `it.todo` | W-01 | testy notebook | P0-test | — | CZĘŚCIOWO — dołożono kontraktowe: V8 classify `method:'heuristic'` + `notebookHandoffService.validate.test.ts` 4/4 (`e92d779e7b`). POZOSTAJE: testy edytora TipTap/SlashMenu (test-infra, osobna fala) | 2026-06-17 |
