...
|----|------|---------|--------------------|-------|------|--------|
| L-01 | gating pilota tylko klient (serwer przepuszcza CRUD) | W-01 | Rollout CRUD `requireOrgRole('user')` (`rollout.routes.ts`, 17 verbs) | P1 | 2 | otwarta |
...
| L-04 | martwy kod (`ImplementationView`/`views/ExecutionView`/`ExecutionDetailPanel`) + 4 kandydaci | W-01 | importowany nieren./hardcode `projectId="default"` | P2 | 3 | otwarta (D-02) |
...
### 07 · Log — 2026-06-13: brak uwag żywych (jawnie); teczka pogłębiona do M13-level (F Gherkin, C API enumerowane, DP-6/8/9 wpięte). Audyt 2026-06-11/12: ocena 52/100; `b9f2dee9d2`, `9974596da7`, `84757dc672`, `229cb35565`, `2fe1c81be3`. Re-ocena D/G po Fazie 3/4.
