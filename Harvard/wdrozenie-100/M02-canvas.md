...
| L-11 | panel `WorkCanvasDocumentPanel` bez `useTranslation`, hardkody PL/EN | W-01 | re-grep 2026-06-17: **0×** `useTranslation`/`t(`, **28** inline lang-conditionals (panel+`Canvas*`) | P2 | 3/4 | **ZABLOKOWANA-i18n (czeka na decyzję locales)** — `t()` wymaga kluczy w `public/locales/*` (ZAKAZANE dla H1). Czeka na zgodę Piotra (owner i18n) lub koordynację z agentem locale. = M01/L-10 | 2026-06-17 |
