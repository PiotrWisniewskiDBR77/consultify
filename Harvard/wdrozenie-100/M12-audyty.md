...
| L-07 | i18n inline `isPolish`+`tr(en,pl)` | W-01,W-05 | Wizard 45 + Hub 48 + presets 3 = **~96** (grep) | P3 | 4 | **ZABLOKOWANA-i18n (DP-10/M15 — dług spójności, NIE błąd: pełne PL+EN bez braków). Konwersja→`t()` wymaga `public/locales/*` = STREFA ZAKAZANA. Czeka na zdjęcie zakazu przez Piotra LUB agent translacji** | 2026-06-13 |
