...
- Aktualna faza: **I**. Następny krok Claude: **T2.1 kanon nawigacji** (scal `docs/ui-standards/CANON.md` + table-canon + workspace-3-tools-strip w 1 autorytet, wzorzec=Notatnik). T2.3 flagi i T4.1 czekają na D-D / B1b. Reszta pakietów (M16/M21/M23/M24/M27) + T4.2 eksport-Outputs = Faza II.
