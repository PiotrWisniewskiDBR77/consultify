...
export const initiativesLibrary: Record<
    AxisId,
    { id: string; name: string; description: string; complexity: 'Low' | 'Medium' | 'High'; tags: string[] }[]
> = {
    processes: [
        {
            id: 'proc-daily-mgmt',
...
export const quickWinsLibrary = {
    ...
    byAxis: {
        ...
        aiMaturity: [{ title: 'AI Policy Draft', desc: 'Create a simple 1-page guideline on using ChatGPT securely.' }],
    },
};
