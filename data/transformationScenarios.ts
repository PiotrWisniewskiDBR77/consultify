...
export const SCENARIOS: ScenarioArchetype[] = [
  {
    ...
    sacrifices: [
      'Brak efektu "WOW"',
      'Opóźnienie innowacji o 6-12 msc',
      'Frustracja "ambitnych" liderów',
    ],
    impact: {
  ...
  },
  {
    ...
    sacrifices: [
      'Wolniejsze tempo początkowe',
      'Wymaga dwutorowego zarządzania',
      'Ryzyko rozmycia priorytetów',
    ],
    impact: {
  ...
  },
  {
    ...
    risk: 3,
    gains: [
      'Jakość danych = jakość AI',
      'Skalowalność w przyszłości',
      'Prawda o firmie (Data-Driven)',
    ],
    sacrifices: [
      'Ogromne koszty niewidoczne dla biznesu',
      'Nuda przez 9 miesięcy',
  ...
  },
  {
    ...
    sacrifices: [
      'Wysokie ryzyko przepalenia zespołu',
      'Kosztowne licencje',
      'Chaos w trakcie wdrażania',
    ],
    impact: {
