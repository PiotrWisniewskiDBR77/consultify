    ...
    questions: [
      {
        ...
        helpText:
          'Value stream mapping visualizes all steps (value-adding and non-value-adding) in delivering a product/service',
      ...
      },
      {
        ...
        helpText:
          'Improvements should target bottlenecks with the highest impact on customer value',
        dimension: 'value_stream',
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        helpText:
          'Kaizen events, PDCA cycles, or improvement projects should target waste reduction',
        dimension: 'waste_elimination',
      },
      {
    ...
    questions: [
      {
        ...
        helpText:
          "Pull systems prevent overproduction by producing only what's needed when it's needed",
        dimension: 'flow_pull',
      },
      {
        id: 'flow_pull_2',
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        helpText:
          'Frontline workers are closest to problems and should be encouraged to propose solutions',
        dimension: 'continuous_improvement',
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        helpText:
          'Visual management should enable instant problem detection (5S, shadow boards, color coding)',
        dimension: 'visual_management',
      },
    ],
  },
