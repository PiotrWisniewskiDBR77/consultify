/**
 * RapidLean Observation Templates - DBR77 Format
...
export interface ObservationTemplate {
    id: string;
    dimension: string; // Maps to RapidLean dimension
    drdAxis: string; // Maps to DRD axis (1-7)
    drdArea?: string; // Optional DRD area mapping
    name: string;
    description: string;
    checklist: ObservationItem[];
...
export interface ObservationItem {
    id: string;
    text: string;
    type: 'yes_no' | 'scale' | 'text' | 'photo' | 'measurement';
    required: boolean;
    helpText?: string;
    drdMapping?: {
        axis: number;
        area?: string;
        level?: number; // If this observation indicates specific DRD level
    };
}
...
export const RAPID_LEAN_OBSERVATION_TEMPLATES: ObservationTemplate[] = [
    {
        ...
        drdAxis: 'processes', // DRD Axis 1
        drdArea: '1A', // Process Standardization
    ...
    },
    {
        ...
        drdAxis: 'processes', // DRD Axis 1
        drdArea: '1B', // Performance Measurement
    ...
    },
    {
        ...
        drdAxis: 'culture', // DRD Axis 5
        drdArea: '5A', // Continuous Improvement
