...
export const TECH_DEBT_QUESTIONS: TechDebtQuestion[] = [
  ...
  {
    id: 'arch_1',
    text: 'Is the system architecture documented?',
    dimension: 'architecture',
    severity: 'high',
  },
  {
    id: 'arch_2',
    text: 'Can the system scale horizontally?',
    dimension: 'architecture',
    severity: 'critical',
  },
  {
  ...
  {
    id: 'infra_1',
    text: 'Is CI/CD pipeline automated?',
  ...
  {
    id: 'infra_3',
    text: 'Is monitoring and alerting comprehensive?',
    dimension: 'infrastructure',
    severity: 'high',
  },
  ...
  {
    id: 'security_3',
    text: 'Are security patches applied regularly?',
    dimension: 'security',
    severity: 'high',
  },
  ...
  {
    id: 'doc_1',
    text: 'Is API documentation up-to-date?',
