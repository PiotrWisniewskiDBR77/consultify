...
export const CMMI_DMM_QUESTIONS: CMMIDMMQuestion[] = [
  ...
  {
    id: 'strategy_1',
    text: 'Does your organization have a documented data strategy?',
    dimension: 'data_strategy',
  },
  {
    id: 'strategy_2',
    text: 'Is there executive sponsorship for data initiatives?',
    dimension: 'data_strategy',
  },
  ...
  {
    id: 'quality_1',
    text: 'Are data quality metrics defined and monitored?',
    dimension: 'data_quality',
  },
  {
    id: 'quality_2',
    text: 'Is there a formal data validation process?',
    dimension: 'data_quality',
  },
  ...
  {
    id: 'operations_1',
    text: 'Is data lifecycle management automated?',
    dimension: 'data_operations',
  },
  {
    id: 'operations_2',
    text: 'Are data backup and recovery processes tested regularly?',
    dimension: 'data_operations',
  },
  ...
  {
    id: 'platform_1',
    text: 'Is there a centralized data platform (data lake/warehouse)?',
    dimension: 'data_platform',
  },
  {
    id: 'platform_2',
    text: 'Can the platform scale with growing data volumes?',
    dimension: 'data_platform',
  },
  ...
  {
    id: 'value_1',
    text: 'Are advanced analytics (ML/AI) used for business insights?',
    dimension: 'data_value',
  },
  {
    id: 'value_2',
    text: 'Is data monetized or used to create new revenue streams?',
    dimension: 'data_value',
  },
];
...
export const mapCMMIDMMToDRD = (cmmiddmScores: Record<string, number>): number => {
  ...
  const avgScore =
    Object.values(cmmiddmScores).reduce((sum, score) => sum + score, 0) /
    Object.values(cmmiddmScores).length;
