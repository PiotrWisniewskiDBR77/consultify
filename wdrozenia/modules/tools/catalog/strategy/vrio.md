...
- **Category**: Strategy
- **Level**: Core
- **Typical duration**: 90–180 minutes (workshop)
- **Best for**: Internal strategy: identifying sustainable advantages and capability gaps
- **Primary outputs**: VRIO table, advantage classification, capability build initiatives
- **Created**: 2026-01-31
...
VRIO evaluates resources/capabilities by four questions:\n- Value\n- Rarity\n- Imitability\n- Organization\nto determine whether they provide sustained competitive advantage.

---

## Method

1. List key resources/capabilities.\n2) Score each on V/R/I/O.\n3) Classify implication (disadvantage/parity/temporary/sustained).\n4) Decide: protect, invest, partner, or exit.\n5) Convert gaps into initiatives.
...
The Vrio analysis should produce a structured consultant report with the following sections:
...
- **VO (PL)**: "VRIO pomaga zaplanować transformację."
- **VO (EN)**: "VRIO helps plan transformation."
- **On-screen text (PL)**: "VRIO = Plan transformacji"
- **On-screen text (EN)**: "VRIO = Transformation plan"
...
- **VO (PL)**: "Eksportuj raport i generuj inicjatywy. Rozpocznij VRIO już dziś."
- **VO (EN)**: "Export the report and generate initiatives. Start VRIO today."
...
7. **How long does it typically take?**
   A: 90–180 minutes (workshop)

8. **What makes a good VRIO analysis?**
...
11. **What makes a good VRIO analysis?**
    A: A good analysis has clear objectives, complete data, systematic execution, and actionable insights.

### FAQ (at least 8)

1. **What is the main purpose of VRIO?**
   A: VRIO helps internal strategy: identifying sustainable advantages and capability gaps.

2. **When should I use VRIO?**
   A: Use it internal strategy: identifying sustainable advantages and capability gaps.

3. **What are the key outputs?**
   A: Key outputs include VRIO table, advantage classification, capability build initiatives.
...
- **Vrio Deep Dive**: `/knowledge-base/strategy/vrio`
...
- Search for authoritative sources on Vrio

**Tutorials & Examples:**

- Search YouTube: "Vrio tutorial"
- Search YouTube: "Vrio example"
