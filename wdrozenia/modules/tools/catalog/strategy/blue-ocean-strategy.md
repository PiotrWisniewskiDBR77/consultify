...
- **Tool name**: Blue Ocean Strategy
- **Slug**: `blue-ocean-strategy`
- **Category**: Strategy
- **Level**: Advanced
- **Typical duration**: 1 day workshop + iterations
- **Best for**: Creating new market space, breaking value-cost trade-off, strategic renewal
- **Primary outputs**: value innovation hypotheses, new value curve, ERRC grid, initiative backlog
- **Related tools**:
  - [`errc-grid.md`](./errc-grid.md)
- **Created**: 2026-01-31
...
Blue Ocean Strategy aims to make competition irrelevant by creating new market space (“blue oceans”) through **value innovation**: simultaneous pursuit of differentiation and low cost.

---

## Method (high-level)

1. Define current “red ocean” competitive factors.\n2) Use Strategy Canvas (value curve) to map current offerings.\n3) Apply ERRC (Eliminate/Reduce/Raise/Create).\n4) Design the new value curve and validate with customers.\n5) Build the execution plan and initiatives.
...
The Blue Ocean Strategy analysis should produce a structured consultant report with the following sections:
...
- **VO (PL)**: "Blue Ocean Strategy pomaga zaplanować transformację."
- **VO (EN)**: "Blue Ocean Strategy helps plan transformation."
- **On-screen text (PL)**: "Blue Ocean Strategy = Plan transformacji"
- **On-screen text (EN)**: "Blue Ocean Strategy = Transformation plan"
...
- **VO (PL)**: "Eksportuj raport i generuj inicjatywy. Rozpocznij Blue Ocean Strategy już dziś."
- **VO (EN)**: "Export the report and generate initiatives. Start Blue Ocean Strategy today."
...
7. **How long does it typically take?**
   A: 1 day workshop + iterations

8. **What makes a good Blue Ocean Strategy analysis?**
...
11. **What makes a good Blue Ocean Strategy analysis?**
    A: A good analysis has clear objectives, complete data, systematic execution, and actionable insights.

### FAQ (at least 8)

1. **What is the main purpose of Blue Ocean Strategy?**
   A: Blue Ocean Strategy helps creating new market space, breaking value-cost trade-off, strategic renewal.

2. **When should I use Blue Ocean Strategy?**
   A: Use it creating new market space, breaking value-cost trade-off, strategic renewal.

3. **What are the key outputs?**
   A: Key outputs include value innovation hypotheses, new value curve, ERRC grid, initiative backlog.
...
- **Blue Ocean Strategy Deep Dive**: `/knowledge-base/strategy/blue-ocean-strategy`
...
- Search for authoritative sources on Blue Ocean Strategy

**Tutorials & Examples:**

- Search YouTube: "Blue Ocean Strategy tutorial"
- Search YouTube: "Blue Ocean Strategy example"
