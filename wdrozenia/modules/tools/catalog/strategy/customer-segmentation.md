...
The Customer Segmentation analysis should produce a structured consultant report with the following sections:
...
- **VO (PL)**: "Customer Segmentation (STP) pomaga zaplanować transformację."
- **VO (EN)**: "Customer Segmentation (STP) helps plan transformation."
- **On-screen text (PL)**: "Customer Segmentation (STP) = Plan transformacji"
- **On-screen text (EN)**: "Customer Segmentation (STP) = Transformation plan"
...
- **VO (PL)**: "Eksportuj raport i generuj inicjatywy. Rozpocznij Customer Segmentation (STP) już dziś."
- **VO (EN)**: "Export the report and generate initiatives. Start Customer Segmentation (STP) today."
...
A: - Market scope (industry/geo) and customer universe definition
...
7. **How long does it typically take?**
   A: 2–8 hours (single market); 1–2 weeks (with research)

8. **What makes a good Customer Segmentation (STP) analysis?**
...
11. **What makes a good Customer Segmentation (STP) analysis?**
    A: A good analysis has clear objectives, complete data, systematic execution, and actionable insights.

### FAQ (at least 8)

1. **What is the main purpose of Customer Segmentation (STP)?**
   A: Customer Segmentation (STP) helps Customer segmentation structures a market into meaningful groups with different needs and value driv....

2. **When should I use Customer Segmentation (STP)?**
   A: Use it focus decisions, go-to-market design, pricing strategy inputs, product prioritization.

3. **What are the key outputs?**
   A: Key outputs include Segment map, segment attractiveness scoring, target selection, positioning hypotheses, initiative backlog.
...
- **Customer Segmentation Deep Dive**: `/knowledge-base/strategy/customer-segmentation`
...
- Search for authoritative sources on Customer Segmentation

**Tutorials & Examples:**

- Search YouTube: "Customer Segmentation tutorial"
- Search YouTube: "Customer Segmentation example"
