...
- **Tool name**: Porter’s Generic Strategies
- **Slug**: `porter-generic-strategies`
- **Category**: Strategy
- **Level**: Core
- **Typical duration**: 60–120 minutes workshop
- **Best for**: Clarifying “how we win”: cost vs differentiation and broad vs niche scope
- **Primary outputs**: chosen strategy, implications for value chain, trade-offs, initiative themes
- **Created**: 2026-01-31
...
The tool forces a clear choice of competitive advantage (low cost vs differentiation) and scope (broad vs focused) to avoid “stuck in the middle.”

---

## Method (step-by-step)

1. Define competitive scope (broad vs niche).\n2) Define advantage basis (cost vs differentiation).\n3) Test coherence: does value chain support this choice?\n4) Identify trade-offs (what we will NOT do).\n5) Convert into initiatives (capabilities to build, costs to remove, differentiation levers).
...
The Porter Generic Strategies analysis should produce a structured consultant report with the following sections:
...
- **VO (PL)**: "Porter’s Generic Strategies pomaga zaplanować transformację."
- **VO (EN)**: "Porter’s Generic Strategies helps plan transformation."
- **On-screen text (PL)**: "Porter’s Generic Strategies = Plan transformacji"
- **On-screen text (EN)**: "Porter’s Generic Strategies = Transformation plan"
...
- **VO (PL)**: "Eksportuj raport i generuj inicjatywy. Rozpocznij Porter’s Generic Strategies już dziś."
- **VO (EN)**: "Export the report and generate initiatives. Start Porter’s Generic Strategies today."
...
7. **How long does it typically take?**
   A: 60–120 minutes workshop

8. **What makes a good Porter’s Generic Strategies analysis?**
...
11. **What makes a good Porter’s Generic Strategies analysis?**
    A: A good analysis has clear objectives, complete data, systematic execution, and actionable insights.

### FAQ (at least 8)

1. **What is the main purpose of Porter’s Generic Strategies?**
   A: Porter’s Generic Strategies helps clarifying “how we win”: cost vs differentiation and broad vs niche scope.

2. **When should I use Porter’s Generic Strategies?**
   A: Use it clarifying “how we win”: cost vs differentiation and broad vs niche scope.

3. **What are the key outputs?**
   A: Key outputs include chosen strategy, implications for value chain, trade-offs, initiative themes.
...
- **Porter Generic Strategies Deep Dive**: `/knowledge-base/strategy/porter-generic-strategies`
...
- Search for authoritative sources on Porter Generic Strategies

**Tutorials & Examples:**

- Search YouTube: "Porter Generic Strategies tutorial"
- Search YouTube: "Porter Generic Strategies example"
