# Strategic Positioning (Porter) — Value Proposition + Value Chain Fit

## Metadata

- **Tool name**: Strategic Positioning
- **Slug**: `strategic-positioning`
- **Category**: Strategy
- **Level**: Advanced
- **Typical duration**: 2–6 hours workshop
- **Best for**: Defining “where to play” and “how to win” with trade-offs
- **Primary outputs**: positioning statement, trade-offs, value chain implications, initiative themes
- **Related tools**:
  - Existing: `market-forces` (Porter)\n - Recommended: `porter-generic-strategies.md`, `competitive-benchmarking.md`, `customer-segmentation.md`
- **Created**: 2026-01-31
...
Robust strategy is not “being the best.” It is making **choices** (positioning) and configuring a **tailored value chain** to deliver the chosen value proposition with trade-offs.

---

## Method

1. Define competitive arena (industry + geography + segment).\n2) Define value proposition (which customers, which needs, what price/value).\n3) Identify unique activity system (value chain choices that enable the proposition).\n4) Make explicit trade-offs (“what we will not do”).\n5) Stress-test against competitors (benchmarking) and industry economics (Five Forces).\n6) Convert activity-system gaps into initiatives.
...
The Strategic Positioning analysis should produce a structured consultant report with the following sections:
...
- **VO (PL)**: "Strategic Positioning pomaga zaplanować transformację."
- **VO (EN)**: "Strategic Positioning helps plan transformation."
- **On-screen text (PL)**: "Strategic Positioning = Plan transformacji"
- **On-screen text (EN)**: "Strategic Positioning = Transformation plan"
...
- **VO (PL)**: "Eksportuj raport i generuj inicjatywy. Rozpocznij Strategic Positioning już dziś."
- **VO (EN)**: "Export the report and generate initiatives. Start Strategic Positioning today."
...
7. **How long does it typically take?**
   A: 2–6 hours workshop

8. **What makes a good Strategic Positioning analysis?**
...
11. **What makes a good Strategic Positioning analysis?**
    A: A good analysis has clear objectives, complete data, systematic execution, and actionable insights.

### FAQ (at least 8)

1. **What is the main purpose of Strategic Positioning?**
   A: Strategic Positioning helps defining “where to play” and “how to win” with trade-offs.

2. **When should I use Strategic Positioning?**
   A: Use it defining “where to play” and “how to win” with trade-offs.

3. **What are the key outputs?**
   A: Key outputs include positioning statement, trade-offs, value chain implications, initiative themes.
...
- **Strategic Positioning Deep Dive**: `/knowledge-base/strategy/strategic-positioning`
...
- Search for authoritative sources on Strategic Positioning

**Tutorials & Examples:**

- Search YouTube: "Strategic Positioning tutorial"
- Search YouTube: "Strategic Positioning example"
