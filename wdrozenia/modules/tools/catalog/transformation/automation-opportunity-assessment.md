# Automation Opportunity Assessment (RPA / Workflow / Low-code)

## Metadata

- **Tool name**: Automation Opportunity Assessment (RPA / Workflow / Low-code)
- **Slug**: `automation-opportunity-assessment`
- **Category**: Transformation
- **Level**: Core
- **Typical duration**: 60–180 minutes
- **Best for**: Prioritizing automation candidates by ROI, feasibility, and risk.
- **Not for**: Automating broken processes; ignoring exception rates.
- **Primary outputs**: Automation backlog, ROI estimate, feasibility score, delivery approach recommendation.
...
Shared services has high manual volumes and approval bottlenecks.
...
```json
{
  ...
  "artifact": { "type": "automation-opportunity-assessment" },
...
- **VO (PL)**: "Automation Opportunity Assessment (RPA / Workflow / Low-code) pomaga zaplanować transformację."
- **VO (EN)**: "Automation Opportunity Assessment (RPA / Workflow / Low-code) helps plan transformation."
- **On-screen text (PL)**: "Automation Opportunity Assessment (RPA / Workflow / Low-code) = Plan transformacji"
- **On-screen text (EN)**: "Automation Opportunity Assessment (RPA / Workflow / Low-code) = Transformation plan"
...
- **VO (PL)**: "Eksportuj raport i generuj inicjatywy. Rozpocznij Automation Opportunity Assessment (RPA / Workflow / Low-code) już dziś."
- **VO (EN)**: "Export the report and generate initiatives. Start Automation Opportunity Assessment (RPA / Workflow / Low-code) today."
...
1. **What is the main purpose of Automation Opportunity Assessment (RPA / Workflow / Low-code)?**
   A: Automation Opportunity Assessment (RPA / Workflow / Low-code) helps .

2. **When should I use Automation Opportunity Assessment (RPA / Workflow / Low-code)?**
   A: Use it - you need a repeatable, documented way to make decisions.

- you must convert analysis into initiatives with traceability..

3. **What are the key outputs?**
   A: Key outputs include Automation backlog, ROI estimate, feasibility score, delivery approach recommendation..
...
1. **What is the main purpose of Automation Opportunity Assessment (RPA / Workflow / Low-code)?**
   A: Automation Opportunity Assessment (RPA / Workflow / Low-code) helps create structured, evidence-backed artifacts and convert gaps into initiatives.
...
8. **What makes a good Automation Opportunity Assessment (RPA / Workflow / Low-code) analysis?**
...
11. **What makes a good Automation Opportunity Assessment (RPA / Workflow / Low-code) analysis?**
    A: A good analysis has clear objectives, complete data, systematic execution, validated results, and actionable insights.
...
- - See references: UiPath Automation Hub: https://www.uipath.com/product/automation-hub

---

## 14. References (Authoritative Sources)

- UiPath Automation Hub: https://www.uipath.com/product/automation-hub
- NIST CSF: https://www.nist.gov/cyberframework
- Microsoft Power Platform (low-code concepts): https://learn.microsoft.com/power-platform/
