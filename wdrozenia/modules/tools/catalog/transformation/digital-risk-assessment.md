# Digital Risk Assessment (Security/Privacy/Compliance)

## Metadata

- **Tool name**: Digital Risk Assessment (Security/Privacy/Compliance)
- **Slug**: `digital-risk-assessment`
- **Category**: Transformation
- **Level**: Core
- **Typical duration**: 60–180 minutes
- **Best for**: Identifying risks and required controls for transformation initiatives and releases.
- **Not for**: Checklist-only risk review without mitigations.
- **Primary outputs**: Risk register, control requirements, mitigation initiatives, go/no-go flags.
...
- Control mapping and mitigations.
...
Transformation introduces new data flows and vendors; risks must be managed proactively.
...
```json
{
  ...
  "artifact": { "type": "digital-risk-assessment" },
...
- **VO (PL)**: "Digital Risk Assessment (Security/Privacy/Compliance) pomaga zaplanować transformację."
- **VO (EN)**: "Digital Risk Assessment (Security/Privacy/Compliance) helps plan transformation."
- **On-screen text (PL)**: "Digital Risk Assessment (Security/Privacy/Compliance) = Plan transformacji"
- **On-screen text (EN)**: "Digital Risk Assessment (Security/Privacy/Compliance) = Transformation plan"
...
- **VO (PL)**: "Eksportuj raport i generuj inicjatywy. Rozpocznij Digital Risk Assessment (Security/Privacy/Compliance) już dziś."
- **VO (EN)**: "Export the report and generate initiatives. Start Digital Risk Assessment (Security/Privacy/Compliance) today."
...
1. **What is the main purpose of Digital Risk Assessment (Security/Privacy/Compliance)?**
   A: Digital Risk Assessment (Security/Privacy/Compliance) helps create structured, evidence-backed artifacts and convert gaps into initiatives.

2. **When should I use Digital Risk Assessment (Security/Privacy/Compliance)?**
   A: Use it you need a repeatable, documented way to make decisions.
   you must convert analysis into initiatives with traceability..

3. **What are the key outputs?**
   A: Key outputs include Risk register, control requirements, mitigation initiatives, go/no-go flags..
...
8. **What makes a good Digital Risk Assessment (Security/Privacy/Compliance) analysis?**
