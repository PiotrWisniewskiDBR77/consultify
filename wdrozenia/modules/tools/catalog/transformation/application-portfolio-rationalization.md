...
- **Tool name**: Application Portfolio Rationalization
- **Slug**: `application-portfolio-rationalization`
- **Category**: Transformation
- **Level**: Advanced
- **Typical duration**: 60–180 minutes
- **Best for**: Reducing app sprawl via keep/retire/replace/refactor decisions.
- **Not for**: Decisions without usage/cost/risk data.
- **Primary outputs**: App inventory, 6R decisions, rationalization roadmap, savings estimate.
...
Org has 400+ apps with high cost and duplicated capabilities.
...
```json
{
  ...
  "artifact": { "type": "application-portfolio-rationalization" },
...
- **VO (PL)**: "Application Portfolio Rationalization pomaga zaplanować transformację."
- **VO (EN)**: "Application Portfolio Rationalization helps plan transformation."
- **On-screen text (PL)**: "Application Portfolio Rationalization = Plan transformacji"
- **On-screen text (EN)**: "Application Portfolio Rationalization = Transformation plan"
...
- **VO (PL)**: "Eksportuj raport i generuj inicjatywy. Rozpocznij Application Portfolio Rationalization już dziś."
- **VO (EN)**: "Export the report and generate initiatives. Start Application Portfolio Rationalization today."
...
1. **What is Application Portfolio Rationalization used for?**
   A: It's used to evaluate and optimize an organization's application portfolio, reduce IT costs, eliminate redundancy, and align applications with business strategy using the 6R framework.

2. **What inputs are required?**
   A: Required inputs include application inventory (name, function, cost, usage), business context, and optional inputs like technical debt, integration complexity, and business criticality.

3. **How do we validate outputs with evidence?**
   A: Each 6R decision should be backed by evidence such as usage metrics, cost data, technical assessments, and business alignment. Document rationale for each decision.

4. **How do we handle missing data?**
   A: Document data gaps clearly, use best-effort estimates with confidence ranges, and prioritize data collection as part of the rationalization roadmap.

5. **How do we convert outputs to initiatives?**
   A: Convert 6R decisions into initiatives with clear actions (e.g., "Retire Application X by Q2"), expected savings, owners, and timelines. Link initiatives to specific applications.

6. **Who owns the decisions?**
   A: IT leadership owns portfolio decisions, while business owners own application-specific decisions. Establish clear RACI matrix for decision-making and execution.

7. **How often should this be updated?**
   A: Review annually for comprehensive reassessment, and quarterly for tracking progress on rationalization initiatives. Update when significant changes occur in the portfolio.

8. **What are common anti-patterns?**
   A: Common anti-patterns include treating it as a one-time exercise, focusing only on cost without business value, and not involving business stakeholders in decisions.
...
- [ ] No business involvement → Fix: Include business stakeholders in decision-making
- [ ] Cost-only focus → Fix: Consider business value, technical debt, and strategic alignment

### Glossary (short)

| Term                    | Definition                                                                         | Example                                    |
| ----------------------- | ---------------------------------------------------------------------------------- | ------------------------------------------ |
| Application Portfolio   | Complete inventory of all applications in an organization                          | List of 200+ applications with metadata    |
| 6R Framework            | Six rationalization options: Retain, Retire, Replace, Rehost, Replatform, Refactor | "Retire legacy CRM, Replace with SaaS"     |
| Rationalization Roadmap | Prioritized plan for portfolio optimization                                        | "Q1: Retire 10 apps, Q2: Replace 5 apps"   |
| Application Inventory   | Complete list of applications with attributes                                      | Name, cost, usage, owner, technology stack |
| Cost Savings            | Estimated reduction in IT costs from rationalization                               | "$2M annual savings from retiring 20 apps" |

---

## 13. Additional Resources & Learning Links

- - See references: Gartner glossary: https://www.gartner.com/en/information-technology/glossary/application-rationalization

---

## 14. References (Authoritative Sources)

- Gartner glossary: https://www.gartner.com/en/information-technology/glossary/application-rationalization
- Microsoft CAF strategy: https://learn.microsoft.com/azure/cloud-adoption-framework/strategy/
