# Current-State Architecture Map (As-is)

## Metadata

- **Tool name**: Current-State Architecture Map (As-is)
- **Slug**: `current-state-architecture-map`
- **Category**: Transformation
- **Level**: Advanced
- **Typical duration**: 60–180 minutes
- **Best for**: Creating a shared as-is map of systems, integrations, and constraints.
- **Not for**: Deep design of each component; diagrams without maintenance.
- **Primary outputs**: As-is architecture map, integration inventory, constraints, modernization candidates.
...
- Integration inventory (API/file/event).
...
Enterprise with app sprawl and brittle integrations needs an accurate as-is baseline.
...
```json
{
  ...
  "artifact": { "type": "current-state-architecture-map" },
...
- **VO (PL)**: "Current-State Architecture Map (As-is) pomaga zaplanować transformację."
- **VO (EN)**: "Current-State Architecture Map (As-is) helps plan transformation."
- **On-screen text (PL)**: "Current-State Architecture Map (As-is) = Plan transformacji"
- **On-screen text (EN)**: "Current-State Architecture Map (As-is) = Transformation plan"
...
- **VO (PL)**: "Eksportuj raport i generuj inicjatywy. Rozpocznij Current-State Architecture Map (As-is) już dziś."
- **VO (EN)**: "Export the report and generate initiatives. Start Current-State Architecture Map (As-is) today."
...
1. **What is the main purpose of Current-State Architecture Map (As-is)?**
   A: Current-State Architecture Map (As-is) helps create structured, evidence-backed artifacts and convert gaps into initiatives.

2. **When should I use Current-State Architecture Map (As-is)?**
   A: Use it you need a repeatable, documented way to make decisions.
   you must convert analysis into initiatives with traceability..

3. **What are the key outputs?**
   A: Key outputs include As-is architecture map, integration inventory, constraints, modernization candidates..
...
8. **What makes a good Current-State Architecture Map (As-is) analysis?**
...
- - See references: ISO/IEC/IEEE 42010: https://www.iso.org/standard/50508.html
