# Transformation Roadmap (Waves & Dependencies)

## Metadata

- **Tool name**: Transformation Roadmap (Waves & Dependencies)
- **Slug**: `transformation-roadmap`
- **Category**: Transformation
- **Level**: Core
- **Typical duration**: 60–180 minutes
- **Best for**: Sequencing initiatives with dependencies, capacity, and change saturation.
- **Not for**: Detailed sprint planning; ignoring constraints.
- **Primary outputs**: Roadmap by waves, dependency map, milestones, initiative portfolio, KPI checkpoints.
...
- Wave-based planning (0–90 / 90–180 / 180+).
- Dependencies and critical path.
- Change saturation and capacity constraints.
...
Retailer planning a 12-month platform and operating model transformation.
...
```json
{
  ...
  "artifact": { "type": "transformation-roadmap" },
...
- **VO (PL)**: "Transformation Roadmap (Waves & Dependencies) pomaga zaplanować transformację."
- **VO (EN)**: "Transformation Roadmap (Waves & Dependencies) helps plan transformation."
- **On-screen text (PL)**: "Transformation Roadmap (Waves & Dependencies) = Plan transformacji"
- **On-screen text (EN)**: "Transformation Roadmap (Waves & Dependencies) = Transformation plan"
...
- **VO (PL)**: "Eksportuj raport i generuj inicjatywy. Rozpocznij Transformation Roadmap (Waves & Dependencies) już dziś."
- **VO (EN)**: "Export the report and generate initiatives. Start Transformation Roadmap (Waves & Dependencies) today."
...
1. **What is the main purpose of Transformation Roadmap (Waves & Dependencies)?**
   A: Transformation Roadmap (Waves & Dependencies) helps create structured, evidence-backed artifacts and convert gaps into initiatives.

2. **When should I use Transformation Roadmap (Waves & Dependencies)?**
   A: Use it you need a repeatable, documented way to make decisions.
   you must convert analysis into initiatives with traceability..

3. **What are the key outputs?**
   A: Key outputs include Roadmap by waves, dependency map, milestones, initiative portfolio, KPI checkpoints..
...
8. **What makes a good Transformation Roadmap (Waves & Dependencies) analysis?**
...
- - See references: PMI Program Management: https://www.pmi.org/

---

## 14. References (Authoritative Sources)

- PMI Program Management: https://www.pmi.org/
