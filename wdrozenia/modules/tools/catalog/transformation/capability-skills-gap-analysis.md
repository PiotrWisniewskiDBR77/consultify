...
- **Tool name**: Capability / Skills Gap Analysis
- **Slug**: `capability-skills-gap-analysis`
- **Category**: Transformation
- **Level**: Advanced
- **Typical duration**: 60–180 minutes
- **Best for**: Identifying skill gaps for the roadmap and creating hiring/training plan.
- **Not for**: HR theater without linking to execution outcomes.
- **Primary outputs**: Capability map, current vs required skill levels, hiring/training plan, initiatives.
...
Roadmap requires new platform and data skills not present in-house.
...
```json
{
  ...
  "artifact": { "type": "capability-skills-gap-analysis" },
...
- **VO (PL)**: "Capability / Skills Gap Analysis pomaga zaplanować transformację."
- **VO (EN)**: "Capability / Skills Gap Analysis helps plan transformation."
- **On-screen text (PL)**: "Capability / Skills Gap Analysis = Plan transformacji"
- **On-screen text (EN)**: "Capability / Skills Gap Analysis = Transformation plan"
...
- **VO (PL)**: "Eksportuj raport i generuj inicjatywy. Rozpocznij Capability / Skills Gap Analysis już dziś."
- **VO (EN)**: "Export the report and generate initiatives. Start Capability / Skills Gap Analysis today."
...
1. **What is the main purpose of Capability / Skills Gap Analysis?**
   A: Capability / Skills Gap Analysis helps create structured, evidence-backed artifacts and convert gaps into initiatives.

2. **When should I use Capability / Skills Gap Analysis?**
   A: Use it you need a repeatable, documented way to make decisions.
   you must convert analysis into initiatives with traceability..

3. **What are the key outputs?**
   A: Key outputs include Capability map, current vs required skill levels, hiring/training plan, initiatives..
...
8. **What makes a good Capability / Skills Gap Analysis analysis?**
...
- - See references: SFIA: https://sfia-online.org/
...
- Prosci (change adoption): https://www.prosci.com/
