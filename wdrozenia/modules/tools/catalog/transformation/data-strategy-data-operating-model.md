# Data Strategy & Data Operating Model

## Metadata

- **Tool name**: Data Strategy & Data Operating Model
- **Slug**: `data-strategy-data-operating-model`
- **Category**: Transformation
- **Level**: Core
- **Typical duration**: 60–180 minutes
- **Best for**: Aligning data priorities to outcomes and defining roles and operating cadence.
- **Not for**: Tool selection only without governance.
- **Primary outputs**: Data strategy themes, operating model, domain priorities, roadmap initiatives.
...
- Operating cadence for decisions.
...
Company wants reliable analytics; data ownership and definitions are inconsistent.
...
```json
{
  ...
  "artifact": { "type": "data-strategy-data-operating-model" },
...
- **VO (PL)**: "Data Strategy & Data Operating Model pomaga zaplanować transformację."
- **VO (EN)**: "Data Strategy & Data Operating Model helps plan transformation."
- **On-screen text (PL)**: "Data Strategy & Data Operating Model = Plan transformacji"
- **On-screen text (EN)**: "Data Strategy & Data Operating Model = Transformation plan"
...
- **VO (PL)**: "Eksportuj raport i generuj inicjatywy. Rozpocznij Data Strategy & Data Operating Model już dziś."
- **VO (EN)**: "Export the report and generate initiatives. Start Data Strategy & Data Operating Model today."
...
1. **What is the main purpose of Data Strategy & Data Operating Model?**
   A: Data Strategy & Data Operating Model helps create structured, evidence-backed artifacts and convert gaps into initiatives.

2. **When should I use Data Strategy & Data Operating Model?**
   A: Use it you need a repeatable, documented way to make decisions.
   you must convert analysis into initiatives with traceability..

3. **What are the key outputs?**
   A: Key outputs include Data strategy themes, operating model, domain priorities, roadmap initiatives..
...
8. **What makes a good Data Strategy & Data Operating Model analysis?**
...
- - See references: DAMA: https://www.dama.org/content/body-knowledge
...
- ISO 38505-1: https://www.iso.org/standard/56740.html
- NIST Big Data: https://www.nist.gov/programs-projects/nist-big-data-interoperability-framework
