# Change Management Plan (ADKAR + Adoption)

## Metadata

- **Tool name**: Change Management Plan (ADKAR + Adoption)
- **Slug**: `change-management-plan-adkar`
- **Category**: Transformation
- **Level**: Advanced
- **Typical duration**: 60–180 minutes
- **Best for**: Driving adoption with stakeholder mapping, comms/training plan, and ADKAR tracking.
- **Not for**: Comms-only change plans without measurement.
- **Primary outputs**: Stakeholder map, ADKAR plan, comms plan, training plan, adoption KPIs, risk log.
...
- ADKAR stages and interventions.
...
New ways of working face resistance; adoption must be planned and measured.
...
```json
{
  ...
  "artifact": { "type": "change-management-plan-adkar" },
...
- **VO (PL)**: "Change Management Plan (ADKAR + Adoption) pomaga zaplanować transformację."
- **VO (EN)**: "Change Management Plan (ADKAR + Adoption) helps plan transformation."
- **On-screen text (PL)**: "Change Management Plan (ADKAR + Adoption) = Plan transformacji"
- **On-screen text (EN)**: "Change Management Plan (ADKAR + Adoption) = Transformation plan"
...
- **VO (PL)**: "Eksportuj raport i generuj inicjatywy. Rozpocznij Change Management Plan (ADKAR + Adoption) już dziś."
- **VO (EN)**: "Export the report and generate initiatives. Start Change Management Plan (ADKAR + Adoption) today."
...
1. **What is the main purpose of Change Management Plan (ADKAR + Adoption)?**
   A: Change Management Plan (ADKAR + Adoption) helps create structured, evidence-backed artifacts and convert gaps into initiatives.

2. **When should I use Change Management Plan (ADKAR + Adoption)?**
   A: Use it you need a repeatable, documented way to make decisions.
   you must convert analysis into initiatives with traceability..

3. **What are the key outputs?**
   A: Key outputs include Stakeholder map, ADKAR plan, comms plan, training plan, adoption KPIs, risk log..
...
8. **What makes a good Change Management Plan (ADKAR + Adoption) analysis?**
...
- - See references: Prosci ADKAR: https://www.prosci.com/methodology/adkar
...
- Switch (Heath) reference: https://heathbrothers.com/books/switch/
