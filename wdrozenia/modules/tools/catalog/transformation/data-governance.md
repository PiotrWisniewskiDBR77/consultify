# Data Governance (Roles, Policies, Stewardship)

## Metadata

- **Tool name**: Data Governance (Roles, Policies, Stewardship)
- **Slug**: `data-governance`
- **Category**: Transformation
- **Level**: Advanced
- **Typical duration**: 60–180 minutes
- **Best for**: Defining decision rights and policies for data access, retention, and quality.
- **Not for**: Governance theater without enforcement.
- **Primary outputs**: RACI, policy set, stewardship model, issue workflow, decision log.
...
- Policies (access, retention, classification).
- Issue workflow and escalation.
...
Data access requests are slow and inconsistent; quality issues are unmanaged.
...
- **VO (PL)**: "Data Governance (Roles, Policies, Stewardship) pomaga zaplanować transformację."
- **VO (EN)**: "Data Governance (Roles, Policies, Stewardship) helps plan transformation."
- **On-screen text (PL)**: "Data Governance (Roles, Policies, Stewardship) = Plan transformacji"
- **On-screen text (EN)**: "Data Governance (Roles, Policies, Stewardship) = Transformation plan"
...
- **VO (PL)**: "Eksportuj raport i generuj inicjatywy. Rozpocznij Data Governance (Roles, Policies, Stewardship) już dziś."
- **VO (EN)**: "Export the report and generate initiatives. Start Data Governance (Roles, Policies, Stewardship) today."
...
1. **What is the main purpose of Data Governance (Roles, Policies, Stewardship)?**
   A: Data Governance (Roles, Policies, Stewardship) helps create structured, evidence-backed artifacts and convert gaps into initiatives.

2. **When should I use Data Governance (Roles, Policies, Stewardship)?**
   A: Use it you need a repeatable, documented way to make decisions.
   you must convert analysis into initiatives with traceability..

3. **What are the key outputs?**
   A: Key outputs include RACI, policy set, stewardship model, issue workflow, decision log..
...
8. **What makes a good Data Governance (Roles, Policies, Stewardship) analysis?**
