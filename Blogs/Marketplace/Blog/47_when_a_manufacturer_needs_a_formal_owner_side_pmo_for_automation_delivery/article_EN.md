...
Target persona: Plant director or program sponsor after award  
Funnel stage: Decision to delivery (execution governance)  
Core problem: the integrator runs a project plan while the plant runs three incompatible informal plans  
Main promise: clear triggers for standing up owner-side PMO without bureaucracy for its own sake

Not every automation project needs a PMO label.
