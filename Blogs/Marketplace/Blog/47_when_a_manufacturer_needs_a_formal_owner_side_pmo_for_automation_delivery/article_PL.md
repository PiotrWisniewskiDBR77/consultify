# Kiedy producent potrzebuje formalnego PMO po stronie wlasciciela dla dowozenia automatyzacji

Target persona: dyrektor zakladu lub sponsor programu po przyznaniu  
Funnel stage: Decision to delivery (egzekucja, rzadzenie)  
Core problem: integrator prowadzi plan projektu, podczas gdy zaklad prowadzi trzy niekompatybilne nieformalne plany  
Main promise: jasne wyzwalacze uruchomienia PMO po stronie wlasciciela bez biurokracji dla samej biurokracji

Nie kazdy projekt automatyzacji potrzebuje etykiety PMO.
