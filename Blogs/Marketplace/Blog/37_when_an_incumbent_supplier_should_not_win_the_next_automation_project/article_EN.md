...
Target persona: Sponsor / executive steering and integrator governance  
Funnel stage: Evaluation to Decision (award logic and strategic control)  
Core problem: relationship inertia and switching cost fear turn repeat buying into default single sourcing without fresh comparability  
Main promise: explicit non-emotional criteria for when the incumbent path is unsafe for the next scope

Loyalty is not a procurement strategy.
