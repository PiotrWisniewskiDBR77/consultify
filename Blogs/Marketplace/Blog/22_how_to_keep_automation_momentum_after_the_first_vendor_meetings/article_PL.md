# Jak utrzymac ped automatyzacji po pierwszych spotkaniach z dostawcami

Target persona: menedzer projektu / wlasciciel zakupu  
Funnel stage: Consideration do przejscia Decision  
Core problem: wczesne spotkania z dostawcami tworza energie, potem zespoly traca tygodnie na nieustrukturyzowany follow-up, duplikaty pytan i cichy wewnetrzny dryf  
Main promise: rytm operacyjny po spotkaniu, ktory zamienia rozmowy w porownywalne artefakty i datowane decyzje

Pierwsze spotkania z dostawcami sa latwe. Czuc postep. Trudna czesc zaczyna sie, gdy sala pustoszeje.
