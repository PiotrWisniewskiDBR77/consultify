# Wie Sie Automatisierungsprojekt-Risiko zwischen Vertragsaward und Go-Live reviewen

Target persona: Risk-Owner oder Programmsponsor zwischen Award und Inbetriebnahme  
Funnel stage: Delivery (Risiko-Governance-Fenster)  
Core problem: Risikoreviews enden bei Unterschrift, waehrend der echte Drift in der Integration passiert  
Main promise: ein wiederholender Review-Rhythmus, der Vertragssprache mit Hallen-Evidence verbindet

Der Vertrag ist eine Hypothese. Inbetriebnahme ist, wo die Hypothese auf Reibung trifft.
