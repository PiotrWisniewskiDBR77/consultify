# Wann Sie Scope in einem Automatisierungs-Einkauf einfrieren sollten und wann nicht

Target persona: Einkaufsleitung mit technischem Gegenpart  
Funnel stage: Evaluation (Angebots-Normalisierung)  
Core problem: Teams frieren Scope zu frueh ein und zementieren falsche Annahmen, oder sie frieren nie ein und verlieren Vergleichbarkeit  
Main promise: eine einfache Freeze-Regel gebunden an die Evaluationsphase, nicht an Optimismus

Scope-Freeze ist ein Werkzeug. Es ist kein Tugendsignal. Falsch angewendet sperrt es das falsche Problem. Richtig angewendet schuetzt es Vergleichbarkeit und Zeitplan-Sanity.
