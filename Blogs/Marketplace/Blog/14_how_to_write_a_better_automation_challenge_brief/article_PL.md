# Jak napisac lepszy brief automatyzacyjny (challenge brief)

Target persona: wlasciciel projektu / lider inzynierii  
Funnel stage: Consideration  
Core problem: producenci zapraszaja do ofertowania, zanim wyzwanie jest czytelne, co daje nieporownywalne oferty i wolne decyzje  
Main promise: wzor jedno- do dwustronicowy, ktory uwidacznia zakres, ograniczenia i kryteria sukcesu zanim integratorzy odpowiedza

Silny projekt automatyzacji zwykle zaczyna sie od nudnego dokumentu. Nie od decka wizji. Od briefu.
