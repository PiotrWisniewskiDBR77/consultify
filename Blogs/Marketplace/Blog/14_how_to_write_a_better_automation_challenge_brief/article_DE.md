# Wie man ein besseres Automatisierungs-Challenge-Brief schreibt

Target persona: Projekteigentuemer / Engineering Lead  
Funnel stage: Consideration  
Core problem: Hersteller holen Angebote ein, bevor die Herausforderung lesbar ist, was inkonsistente Angebote und langsame Entscheidungen erzeugt  
Main promise: ein ein- bis zweiseitiges Brief-Muster, das Umfang, Constraints und Erfolgskriterien sichtbar macht, bevor Integratoren antworten

Starke Automatisierungsprojekte beginnen oft mit einem langweiligen Dokument. Nicht mit einer Vision-Praesentation. Mit einem Brief.
