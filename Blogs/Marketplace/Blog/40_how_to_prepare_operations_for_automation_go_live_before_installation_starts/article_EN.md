...
Target persona: Plant manager / operations leadership with maintenance and training partners  
Funnel stage: Evaluation to Adoption (readiness while delivery is still upstream)  
Core problem: operations is treated as a recipient of commissioning instead of a co-owner of acceptance and cutover risk  
Main promise: a readiness checklist that runs parallel to installation, not after it

Go-live is not an event on a supplier schedule. It is the moment the line owns outcomes.
