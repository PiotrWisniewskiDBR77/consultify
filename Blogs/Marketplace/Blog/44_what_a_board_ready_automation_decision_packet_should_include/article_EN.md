...
Target persona: Finance partner / program sponsor assembling committee materials  
Funnel stage: Decision (capital documentation)  
Core problem: board packs recycle vendor slides and hide award logic, acceptance, and plant obligations  
Main promise: a repeatable packet structure that survives questions without a side meeting

A board packet is not a vendor beauty deck.
