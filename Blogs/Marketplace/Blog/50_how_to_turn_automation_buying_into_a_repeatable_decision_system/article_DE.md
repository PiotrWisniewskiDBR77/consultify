# Wie Sie Automatisierungs-Einkauf in ein wiederholbares Entscheidungssystem verwandeln

Target persona: COO oder Einkaufsleitung mit mehreren Automatisierungs-Threads  
Funnel stage: Adoption (Betriebsmodell)  
Core problem: jedes Projekt erfindet Templates, Kaempfe und Lieferanten-Chaos neu  
Main promise: ein leichtgewichtiges Decision-Record-System, nicht schwerer Prozess um des Prozesses willen

Wiederholbarkeit ist keine Buerokratie.
