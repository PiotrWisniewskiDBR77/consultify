...
Target persona: Plant manager / IT-OT sponsor / Program owner  
Funnel stage: Adoption  
Core problem: the first champion carried informal decisions, vendor relationships, and operator trust, so the program looks personal instead of institutional  
Main promise: a continuity kit: documented decisions, shared ownership, operator-validated signal rules, and budget line items that survive a personnel change

Champions accelerate starts. Institutions survive handovers.
