# What a Transformation PMO Should Track Every Week
...
**Direct answer:** track weekly signals across delivery truth, dependency risk, decision latency, value hypothesis health, and sponsor airtime needs. If the weekly pack cannot trigger a specific action, it is probably tracking the wrong things.
