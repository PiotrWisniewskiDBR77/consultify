# Warum Transformationskapazitaet vor der Strategie bricht

Target persona: COO / CHRO-Partner / Transformation-Sponsor  
Funnel stage: Awareness  
Core problem: Fuehrung verfeinert weiter die Strategie-Sprache, waehrend Lieferkapazitaet leise kollabiert, was das Portfolio auf dem Papier aligned und in der Praxis unmoeglich macht  
Main promise: Kapazitaet als fruehere Restriktion zu erkennen hilft Sponsoren einzugreifen, bevor die Strategie-Narrative zum Schuldzuweisungsmagnet fuer Teams wird, die nie fuer die Ausfuehrung ausgestattet waren

**Direktantwort:** Kapazitaet bricht zuerst, weil echte Stunden, Aufmerksamkeitsspanne und Integrationslast schwerer zu politisieren sind als Strategie-Folien. Wenn Kapazitaet als unendlich behandelt wird, zeigt sich Strategie-Drift spaeter als verpasste Meilensteine, Qualitaetskollaps und verstecktes Borgen vom Tagesgeschaeft.
