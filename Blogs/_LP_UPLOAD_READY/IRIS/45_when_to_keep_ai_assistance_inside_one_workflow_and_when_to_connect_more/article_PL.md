...
**Direct answer:** Trzymaj asyste AI w jednym workflow, gdy definicje sa niestabilne, szkolenia niekompletne, akceptacje niezmapowane lub wolumen incydentow juz przekracza pojemnosc zespolu. Lacz kolejne workflow tylko wtedy, gdy pierwszy pokazuje stabilne metryki domkniecia przez dwa cykle przegladu, powody override maleja lub sa wytlumaczalne, i mozesz uzyc tych samych pol audytu bez niestandardowych wyjatkow. Laczenie bez dyscypliny domykania mnozy chaos predzej niz wartosc.

Szerokosc latwo demonstrowac.

Glebokosc chroni zaklad.
...
1. zamroz baseline dla aktywnego workflow na 14 dni  
2. przeglad wyjatkow: top 15 motywow z wlascicielami  
3. potwierdz, ze sciezki akceptacji pokrywaja noc i weekend  
4. zmapuj pochodzenie danych dla nastepnego workflow: pole zrodla, odswiezanie, wlasciciel  
5. zdefiniuj rollback: jak odlaczyc asyste bez utraty historii  
6. opublikuj okno startu i komunikacje dla dotknietych zmian  

Pominiecie bramy placisz eskalacjami.
...
- izolowany workflow tworzy podwojne wprowadzanie danych, ktore operatorzy juz odrzucaja  
- BHP lub jakosc wymaga wprost routingu miedzyfunkcyjnego, ktory blokujesz  
- kontrakt z dostawca wymusza pakiet integracji, ktorego nie rozdzielisz  
...
Lacz nastepny workflow tylko wtedy, gdy poprzedni domyka sie na tyle czysto, by mu zaufac.

Jesli nie ufasz domknieciu, nie ufasz szerokosci.
