# Kiedy zaklad potrzebuje jednego operacyjnego arbitra przy sprzecznych sygnalach

Target persona: Kierownik zakladu / Dyrektor operacji / Glowny inzynier  
Funnel stage: Decision  
Core problem: produkcja, jakosc, utrzymanie i logistyka dostaja wiarygodne priorytety z AI, wiec hala czeka na nieformalna negocjacje zamiast wykonywac  
Main promise: jasne kryteria powolania jednej roli arbitra, praw decyzyjnych, limitow czasu i sposobu zapisu override bez zlamania follow-through

**Direct answer:** Potrzebujesz jednego operacyjnego arbitra, gdy sprzeczne sygnaly tworza rownolegle pilne zadania z niekompatybilnymi wlascicielami, rosna powtarzajace eskalacje i mierzalna utrata przepustowosci podczas debat. Arbitr to nie drugi szef od kazdego przypadku; rozstrzyga remisy w opublikowanym zakresie workflow, w ramach czasu i zawsze zapisuje krotka decyzje powiazana ze zrodlami sygnalu. Jesli nie mozesz wskazac arbitra na nocnej zmianie, nie masz arbitrazu, masz polityke.

Sprzeczne sygnaly sa normalne w zlozonym zakladzie.

Nieograniczona debata nie jest.

## Sygnaly, ze jestes poza "zdrowym napieciem"

Obserwuj te wzorce tygodniowo:

- dwie funkcje otwieraja konkurujace zlecenia na ten sam ograniczony zasob  
- zegary SLA sie zeruja, bo odpowiedzialnosc skacze  
- nadzorowie nadpisuja asyste w przeciwnych kierunkach na sasiednich zmianach  
- poranne spotkania powtarzaja ten sam konflikt bez wersjonowanego wyniku  

Jesli trzy lub wiecej wystepuja razem, wprowadz model arbitra.
...
1. lista top 5 motywow konfliktow z ostatnich 30 dni  
2. mapa workflow i sygnalow, ktore je zasilaja  
3. publikacja zakresu arbitrazu: linie, zmiany, typy decyzji  
4. imiona arbitra glownego i zastepcy wg wzorca zmian  
5. maksymalny czas przed domyslna akcja bezpieczna  
6. obowiazkowy log decyzji: jeden akapit, ID sygnalow, wlasciciele  
7. miesieczny przeglad wolumenu arbitrazu; wysoki wolumen znaczy zle progi  
...
Komitety chronia komfort.

Arbitrowie chronia przepustowosc.
...
- konflikty sa rzadkie i lokalne; uzyj wtedy ownership linii  
- przyczyna to zle definicje danych; napraw definicje przed rolami  
- zaklad to jedna linia z jednym nadzorca; nadzorca juz jest arbitrem  
