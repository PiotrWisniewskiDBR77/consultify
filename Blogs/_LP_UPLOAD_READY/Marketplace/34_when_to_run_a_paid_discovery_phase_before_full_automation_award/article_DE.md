...
Kostenlose Arbeit ist keine Sorgfalt.

Sie ist oft der Weg, das Unbekannte nicht zu schreiben.

Bezahlte Discovery ist kein Moralurteil ueber Lieferanten.
...
Illustrative Signale:

- MES-Handshake-Regeln sind intern noch nicht vereinbart
- Seriennummern, Routings oder Rework-Logik sind nicht stabil genug zum Angebot
- IT kann Credential- und Netzwerkfenster nicht schriftlich verbindlich machen
...
- Reichweite, Schutzeinrichtung oder AGV-Routing braucht Layout-Validierung
- Medien und Plattenlasten sind unsicher
- parallele Produktionsrestriktionen sind eng und noch nicht in Zugangsplaenen modelliert
...
- Meilensteinlogik und Akzeptanzobjekte sind funktionsuebergreifend umstritten
- Ersatzteile, Schulung und Garantiestart-Trigger sind offen
- Performance-Remedies sind politisch sensibel
...
Nutzen Sie einen schriftlichen Mini-Scope (illustrativ):

1. Lieferliste mit Akzeptanz fuer die Discovery-Phase selbst
2. Timebox und Site-Access-Annahmen
3. IP- und Wiederverwendungsregeln fuer Zeichnungen und Berechnungen
4. expliziter Ausschluss fuer die bezahlte Phase
5. wie Outputs ein vergleichbares Vollgebot speisen
...
- bezahlte Discovery nutzen, um internen Owner zu vermeiden
- bezahlte Discovery die Shortlist-Disziplin ersetzen lassen
- eine bezahlte Phase ohne schriftlichen Stop unterschreiben, wenn Fakten fehlen
...
Bezahlte Discovery passt dazu, wenn ihre Ergebnisse zu strukturierten Feldern werden, die andere Bieter erfuellen koennen, nicht zu privaten Side Letters.
