...
Bei Automatisierungsprojekten ist es oft der Start echter Verantwortung.

Ein Vertrag soll Ausfuehrung pruefbar machen.
...
Sie wollen Sprache, die ein Dritter lesen und die Grenze verstehen kann.

Schwache Scope-Sprache sieht so aus:
...
Annahmen duerfen bei Signatur nicht verschwinden.

Gute Vertraege verbinden Annahmen mit:
...
Meilensteine duerfen keine Deko-Termine sein.
...
Automatisierungsprojektes aendern sich.
...
Genau deshalb ist spaete Inspektion unangenehm, aber notwendig.

Zu dem Zeitpunkt, an dem der Vertrag zirkuliert:
...
1. technischen Owner: Scope und Exklusionen Zeile fuer Zeile
2. Einkauf: kommerzielle Mechanik und Aenderungsregeln
3. Operations: Abnahme- und Support-Sprache
4. Fragen in ein Klaerungspaket konsolidieren
5. Widersprueche vor Signatur loesen, nicht nach Mobilisierung
...
Diese Denkweise sollte ins Contracting uebergehen:

- weniger versteckte Luecken
- sauberere Vergleichshistorie
- klarere Accountability
...
Ein Vertrag ist keine Trophae.

Er ist ein Inspektionsplan fuer Geld, Zeit und Risiko.

Wenn Umfang, Annahmen, Meilensteine, Abnahme und Aenderungsmechanik schwach sind, schliesst Unterschrift Risiko nicht ab.
