...
Clarifications sind noetig.

Unkontrollierte Clarifications sind, wie Vergleichbarkeit leise stirbt.
...
1. Eine Intake-Adresse oder ein Portal im Einkaufsbesitz  
2. Triage: materiell versus nur administrative Labels  
3. Materielle Antworten an alle aktiven Bieter mit Referenz-ID  
4. Matrix aktualisieren oder explizit als unveraendert markieren mit Versionsbump  
5. Woechentliches Readout an interne Freigeber: was bewegte sich und warum  
...
Ingenieur A antwortet Lieferant B in einem Chat.

Lieferant B aendert Preis und Zeitplan.

Lieferant C wusste nie, dass sich die Annahme bewegte.

Die Tabelle zeigt weiterhin drei vergleichbare Zeilen.

## Reality check: Clarification-Chaos beginnt meist mit einer "kleinen" Antwort, die niemand fuer broadcast-wuerdig haelt

Genau deshalb kommt der Schaden leise.

Die Antwort klingt offensichtlich.

Der Lieferant klingt vernuenftig.

Die Anpassung wirkt gering.

Aber wenn ein Bieter Preis, Scope oder Zeitplan gegen eine veraenderte Annahme aktualisiert, die die anderen nie erhalten haben, ist Vergleichbarkeit bereits gebrochen, bevor es jemand zugibt.
...
Clarification-Disziplin ist die Hygieneschicht, die diesen Vergleich vertrauenswuerdig haelt, wenn E-Mail-Volumen steigt.
...
Vergleichbarkeit braucht einen gemeinsamen Wahrheitsrecord.

Private Wahrheit ist nicht vergleichbar.
