# Was ein gutes werksseitiges Mobilisierungsplan nach Award enthalten sollte

Target persona: Operations-Sponsor fuer Post-Award-Readiness  
Funnel stage: Delivery (Mobilisierung)  
Core problem: Lieferanten mobilisieren, waehrend das Werk das Projekt noch als spaeteres Problem behandelt  
Main promise: ein werksseitiger Mobilisierungsplan mit Daten, Ownern und Abhaengigkeiten, die der Integrator nicht fuer Sie tragen kann

Award ist nicht nur der Start der Lieferantenarbeit.
...
- Tage null bis dreissig: Abhaengigkeiten geschlossen oder rot markiert, Schnittstellentests geplant  
- Tage dreissig bis sechzig: Trainings-Trockenlaeufe, Akzeptanz-Evidence-Templates vereinbart  
- Tag-sechzig-Checkpoint: Go oder No-Go fuer aggressive Inbetriebnahme-Termine  
...
Mobilisierung ist, wo verglichene Angebote auf Werkrealitaet treffen; der Herstellerplan ist die Absicherung, dass Realitaet budgetiert war.
