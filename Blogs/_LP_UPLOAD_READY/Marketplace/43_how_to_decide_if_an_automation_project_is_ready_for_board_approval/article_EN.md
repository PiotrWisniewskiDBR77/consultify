...
Target persona: Plant director / CFO sponsor with board exposure  
Funnel stage: Consideration (capital gate before commitment)  
...
Pause board submission when:

- the preferred supplier changed scope after shortlist without a fresh comparison record
- acceptance criteria exist only in the supplier template
- internal alignment articles (19, 42) would fail if run honestly today

Pausing is cheaper than a board revisit after a failed FAT.
...
The sponsor knows the project.

The plant lead can explain the nuance.

The CFO can smooth over one missing detail.

But if the packet depends on verbal rescue to make comparability, ownership, or acceptance logic understandable, the project is asking the board to approve confidence, not readiness.

## Bounded protocol: fifteen-minute board story

1. Problem and operational boundary in two sentences  
2. What you compared and how offers were made comparable  
3. What you are buying: acceptance objects in plain language  
4. What the plant must deliver: interfaces, downtime, training, spare parts  
5. Capital ask mapped to milestones and go-live readiness  
6. Top three risks and who owns response  

If step two is vague, you are not ready.
...
Board approval should feel boring because the work is already visible.

If the packet needs verbal rescue, send it back to the team.
