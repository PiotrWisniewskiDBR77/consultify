...
Pausieren Sie die Board-Einreichung, wenn:

- der bevorzugte Lieferant den Scope nach Shortlist ohne frischen Vergleichsrecord geaendert hat
- Akzeptanzkriterien nur in der Lieferantenvorlage existieren
- ein ehrlicher interner Alignment-Check heute scheitern wuerde
...
Der Sponsor kennt das Projekt.

Der Werksleiter kann die Nuance erklaeren.

Der CFO kann ein fehlendes Detail glaetten.

Aber wenn das Paket verbale Rettung braucht, um Vergleichbarkeit, Ownership oder Akzeptanzlogik verstaendlich zu machen, bittet das Projekt das Board, Vertrauen zu genehmigen, nicht Readiness.

## Begrenztes Protokoll: fuenfzehnminuetige Board-Story

1. Problem und operatives Boundary in zwei Saetzen  
2. Was verglichen wurde und wie Angebote vergleichbar gemacht wurden  
3. Was gekauft wird: Akzeptanzobjekte in klarer Sprache  
4. Was das Werk liefern muss: Schnittstellen, Stillstand, Training, Ersatzteile  
5. Kapitalanfrage gemappt auf Meilensteine und Go-Live-Readiness  
6. Top-3-Risiken und wer die Response besitzt  

Wenn Schritt zwei vage ist, sind Sie nicht bereit.
...
Board-Readiness ist der interne Spiegel: Nachweis, dass Vergleichbarkeit und Award-Logik vor Kapitalanfragen diszipliniert waren.
...
Board-Freigabe sollte langweilig wirken, weil die Arbeit schon sichtbar ist.

Wenn das Paket verbal gerettet werden muss, zurueck ans Team.
