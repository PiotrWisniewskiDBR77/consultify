# Jak przegladac ryzyko projektu automatyzacji miedzy przyznaniem kontraktu a go-live

Target persona: wlasciciel ryzyka lub sponsor programu miedzy przyznaniem a uruchomieniem  
Funnel stage: Delivery (okno rzadzenia ryzykiem)  
Core problem: przeglady ryzyka koncza sie na podpisie, podczas gdy prawdziwy dryf dzieje sie w integracji  
Main promise: powtarzalny rytm przegladu, ktory laczy jezyk kontraktu z dowodem z hali

Kontrakt to hipoteza.

Uruchomienie to moment, w ktorym hipoteza spotyka sie z tarciem.
...
1. Kontrola dryfu zakresu wzgledem ID bazy  
2. Otwarte problemy: wiek, wlasciciel i przewidywana sciezka  
3. Testy interfejsow: zalicz, niezalicz, zasady odstepstw  
4. Zmiany zamowienia: liczba, kategoria przyczyny, skumulowana ekspozycja  
5. Harmonogram: zuzyty bufor kontra pozostale okna zakladu  
6. Proba akceptacji: szablony dowodow i sygnatariusze  
...
Opublikuj tego samego dnia:

- zaktualizowana lista dziesieciu glownych ryzyk z wlascicielami  
- dziennik decyzji dla odstepstw i zaakceptowanych ekspozycji  
...
Przeglad ryzyka po przyznaniu to sposob, w jaki utrzymujesz uczciwa opowiesc porownawcza, gdy rosnie presja integracji.
