...
Target persona: Risk owner or program sponsor between award and commissioning  
Funnel stage: Delivery (risk governance window)  
Core problem: risk reviews stop at signature while the real drift happens during integration  
Main promise: a repeating review rhythm that connects contract language to floor evidence

The contract is a hypothesis.

Commissioning is where the hypothesis meets friction.
...
1. Scope drift check against baseline ID  
2. Open issues: age, owner, and predicted path  
3. Interface tests: pass, fail, waiver rules  
4. Change orders: count, cause category, cumulative exposure  
5. Schedule: consumed float versus remaining plant windows  
6. Acceptance rehearsal: evidence templates and signatories  
...
- updated top ten risk list with owners  
- decision log for waivers and accepted exposures  
