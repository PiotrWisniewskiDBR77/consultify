...
Acceptance is not a mood at go-live.

It is the operational definition of done.

If you cannot test it, you cannot award it cleanly.
...
- cycle time band under named SKU set and station conditions
- error rate or reject handling behavior under defined inputs
- safety functions validated under named scenarios
- data handshake behavior at named interface points
...
Build a simple dependency list (illustrative):

1. mechanical safety and guarding sign-off
2. basic motion and manual mode controls
3. automatic cycle under constrained SKU set
4. MES or quality system handshake under test loads
5. run-off under production-like conditions
...
Name who can sign each object class:

- operations for throughput and staffing impacts
- quality for defect and traceability impacts
- IT for identity and network impacts
- maintenance for serviceability impacts
...
Write acceptance as testable objects with evidence before mobilization.

Late acceptance is expensive because it is late comparability.
