...
Change Orders sind keine Ueberraschungen.

Sie sind die vorhersagbare Folge unklarer Baselines.
...
Sie brauchen Inklusiven und Exklusiven, auf die beide Seiten referenzieren.
...
Bestaetigen Sie, dass der Vertrag regelt:

- was passiert, wenn eine Annahme falsch ist
- wer wann verifiziert
- ob Preis und Zeit neu geoeffnet oder begrenzt werden

## Schiene 3: werkskontrollierte Abhaengigkeiten haben Owner und Daten

Illustrative werksseitige Risiken:

- Bodenbereitschaft und Medienverfuegbarkeit
- Credential-Ausgabe und Netzsegmente
- Materialversorgung fuer FAT- oder SAT-Analogien
- Personal fuer Parallel-Lauf oder Cutover-Support
...
Fahren Sie eine einstuendige interne Review (illustrativ):

1. Scope-Baseline laut gegen evaluiertes Angebot lesen
2. Top-ten Annahmen listen und Verifikationsdaten markieren
3. Owner fuer Werk-Abhaengigkeiten mit Kalender-Holds zuweisen
4. Eskalationspfad vereinbaren, wenn Aenderung Kosten- oder Zeitplanschwelle kreuzt
...
Inspectability vor Kickoff heisst: Ihre Basis ist strukturiert genug, dass Change Requests klassifizierbar sind statt aus Erinnerung zu streiten.
