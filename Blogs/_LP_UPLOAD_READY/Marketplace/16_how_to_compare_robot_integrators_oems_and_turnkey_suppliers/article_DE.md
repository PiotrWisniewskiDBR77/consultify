...
Robotik-Integratoren, OEMs und Turnkey-Lieferanten koennen Automatisierung liefern.

Sie liefern nicht dieselbe Entscheidung.
...
Reale Lieferanten koennen Mischformen sein.

Diese Archetypen helfen trotzdem, bessere Fragen zu stellen.

### Integrator-gefuehrte Lieferung

**Was es oft optimiert**: flexibles Engineering-Fit zur realen Werkssituation.

**Was Sie erwarten sollten**: mehr Customizing, mehr Schnittstellenarbeit, staerkere Abhaengigkeit von interner Klarheit.

**Wo Konflikt entsteht**: Scope-Drift, Annahmenluecken, Integrationsueberraschungen.
...
- **Hohe werksspezifische Integrationslast** beguenstigt oft Integratorstaerke bei starkem Governance.
- **Wiederholbare geraetezentrische Loesung** passt oft zu OEM-Staerke bei kontrollierter Variabilitaet.
- **Ergebniskauf mit sauberer Grenze** kann zu Turnkey passen, wenn Exclusions ehrlich und messbar sind.

Fehlermodus ist Wahl nach Markenbekanntheit statt nach Problemform.

## Wie man ein faires Vergleichstreffen fuehrt

1. denselben Brief und dieselbe Antwortstruktur senden
2. strukturiertes Q und A zu Annahmen und Exclusions
3. kurze Risiko- und Abhaengigkeitsstellung von jeder Seite verlangen
4. Unterschiede in einer von Einkauf gefuehrten Matrix dokumentieren
5. vermeiden, dass der beste Praesentator standardmaessig gewinnt
...
Integratoren, OEMs und Turnkey sind nicht austauschbare Labels.

Sie implizieren unterschiedliche Ownership-Muster.

Vergleichen Sie Felder, keine Slogans.
