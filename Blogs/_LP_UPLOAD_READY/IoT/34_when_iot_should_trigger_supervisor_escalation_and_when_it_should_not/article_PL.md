...
Glowny problem: supervisory sa ciagniete w kazdy zolty blip, wiec eskalacja staje sie szumem, a hala przestaje traktowac alarmy powaznie  
Glowna obietnica: polityka eskalacji do supervisora: ktore warunki z maszyna przerywaja leadership, ktore zostaja na linii, jak override zmienia regule

Supervisor nie powinien byc ludzkim routerem alarmow.
...
**Nie** wywoluj eskalacji do supervisora dla sygnalow uczenia, pojedynczych skokow bez potwierdzenia albo warunkow, ktore zmiana moze zamknac istniejaca sciezka zlecenia.

Widocznosc moze zostac na ekranie.

Eskalacja powinna byc na tyle rzadka, by pozostac wiarygodna.

## Oddziel powiadomienie operatora od przerwania supervisora

Zaprojektuj dwa kanaly:

- **Kanal operatora**: szybki kontekst, lokalna weryfikacja, standardowe reakcje
- **Kanal supervisora**: zmiana wladzy, ryzyko miedzy zmianami, ekspozycja klienta albo safety, konflikt zasobow
...
1. Wypisz piec scenariuszy stop, ktore zaklad juz traktuje powaznie bez IoT  
2. Mapuj kazdy na: tylko operator, zlecenie maintenance, przerwanie supervisora  
3. Dodaj time boxy: jak dlugo linia posiada problem przed eskalacja  
4. Opublikuj reguly override: kto moze przedluzyc time boxy i na jak dlugo  
5. Przegladaj miesiecznie z probkami jakosci sygnalu, nie tylko licznikami alarmow  
...
Widocznosc w czasie rzeczywistym pomaga zobaczyc wczesniej.

Nie podnosi automatycznie ciezaru.
