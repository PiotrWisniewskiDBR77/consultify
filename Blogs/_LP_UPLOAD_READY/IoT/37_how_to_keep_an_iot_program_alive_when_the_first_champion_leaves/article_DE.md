...
Kernproblem: der erste Champion trug informelle Entscheidungen, Vendor-Beziehungen und Bedienervertrauen, das Programm wirkt persoenlich statt institutionell  
Hauptversprechen: ein Continuity-Kit: dokumentierte Entscheidungen, geteilte Ownership, bedienervalidierte Signalregeln und Budget-Positionen, die Personalwechsel ueberleben

Champions beschleunigen Starts.

Institutionen ueberleben Uebergaben.

Wenn Ihr IoT-Programm stirbt, wenn eine Person die Rolle wechselt, war es nie operationalisiert.

## Direkte Antwort

Halten Sie das Programm am Leben, indem Sie **Wissen aus dem Kopf in Artefakte** verschieben, bevor der Champion geht:

- Decision-Log fuer Schwellen, Eskalationen und Overrides
- benannte Co-Owner fuer OT-Konnektivitaet, Datenqualitaet und Shopfloor-Training
- quartalsweises Review-Kalender, gekoppelt an Planung, nicht an Heldentum
- Budget- und Vendor-Vertragskarte mit Erneuerungs-Triggern

Ziel ist langweilige Kontinuitaet, kein Ersatz-Held.
...
Champions haben diese Spuren oft verwischt.

Institutionelles IoT braucht klare Naehte.

## Schrittfolge: 30-Tage-Continuity-Sprint

1. Arbeitsnotizen des Champions in ein Decision-Log mit Datum und Begruendung exportieren  
2. Halbtages-Workshop mit Bedienern: welche Signale sich noch wahr anfuehlen  
3. Co-Owner mit Backup-Namen zuweisen, nicht nur Primary  
4. einen Monat "keine neuen Alarme" einfrieren, waehrend Ownership stabilisiert wird  
5. einseitige Programm-Charter der Werksfuehrung mit Kosten und Review-Takt vorlegen  
