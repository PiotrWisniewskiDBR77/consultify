...
Glowny problem: override narastaja po cichu, audyty odkrywaja je pozno, a operatorzy ucza sie, ze obejscie jest latwiejsze niz naprawa sygnalu albo procesu pod spodem  
Glowna obietnica: rytm przegladu: co jest logowane, jak dziala wygasanie, kto aprobuje przedluzenia, jak przeglady wiaza sie ze standardami i szkoleniem

Override nie sa haniebne.

Nieprzejrzane override to dlug operacyjny.

IoT sprawia, ze bypass jest widoczny.
...
Jesli override nigdy nie wygasaja, nie masz workflow.
...
1. Eksportuj override aktywne ktorykolwiek dzien w miesiacu, wlacznie z wygaslymi  
2. Sortuj po powtarzajacych sie aktywach i kodach przyczyn  
3. Wybierz top piec wzorcow na 45-minutowy przeglad miedzyfunkcyjny  
4. Przypisz wlascicieli: fix sygnalu, fix procedury, fix szkolenia albo redesign interlock  
5. Opublikuj decyzje w kanale komunikacji zakladu, ktory operatorzy naprawde czytaja  
...
Przegladaj override jak **near miss**: wedlug harmonogramu, z wlascicielami i zwiazkiem ze standardami.

Widocznosc bez przegladu staje sie polityka.

Widocznosc z przegladem staje sie poprawa.
