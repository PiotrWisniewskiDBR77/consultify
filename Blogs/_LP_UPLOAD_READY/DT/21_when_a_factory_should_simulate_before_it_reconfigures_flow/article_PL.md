...
Symuluj najpierw, gdy prawdziwe jest co najmniej jedno z ponizszych:

- nowy przeplyw wspoldzieli waskie gardlo lub bufor z innymi liniami
- zmienia sie obsada, zmianowosc lub logika wsadow
- rebalansujesz prace pod nowy takt lub mix
- zmienia sie intralogistyka lub wielkosc supermarketu
- biznes case zaklada konkretna przepustowosc lub czas realizacji
...
Nie odpowiadaja niezawodnie na to:

- gdzie tworza sie kolejki, gdy wraca zmiennosc
- jak "maly" ruch przesuwa ograniczenie systemu
- czy szybszy lokalny krok nie powoduje glodu upstream
- jak przez prace propaguja sie przezbrojenia lub przerwy wsadowe

Digital Twin w tym kontekscie nie jest pokazem 3D.
...
1. wiarygodnej sekwencji procesu z realistycznymi zakresami czasu cyklu
2. zalozen przezbrojen i awarii jako zakresow, nie pojedynczych punktow
3. scenariuszy popytu lub mixu zamowien od szczytu po spadek
4. regul obsady zgodnych z tym, jak linia jest realnie prowadzona
...
Odpal co najmniej trzy rodziny scenariuszy:

- baseline obecny przeplyw
- proponowany przeplyw przy oczekiwanym popycie
- proponowany przy obciazeniowym popycie lub najgorszym mixie
