...
Target persona: capital project sponsor / engineering director with finance counterpart  
...
Without an explicit contract per gate, teams do one of three things:

- run a model once, then reuse slides until the money is spent  
- postpone simulation until detailed design, when options are already narrow  
- let each function bring its own spreadsheet story with no shared shock set
...
Sponsors need gate-ready evidence, not showroom pacing.
...
For stage-gate use, it helps teams:

- keep option comparisons consistent as the project matures  
- preserve traceability from assumption changes to outcome shifts  
- shorten the distance between engineering insight and sponsor-ready clarity  
