...
- **Base case:** agreed operating story dla normal planning cycles  
- **Peak and recovery:** demand spikes plus ramp story ktore faktycznie wierzysz  
- **Constraint shift set:** bottleneck moves ktorych obawiasz sie po next change wave  
- **Supplier and inbound variants:** lead-time i lot behavior ktore widziales wczesniej  
...
Hypothesis scenarios sa dozwolone.

Musza byc labeled zeby nigdy nie udawaly audited truth.
