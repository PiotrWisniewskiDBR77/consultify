...
Post-investment reviews powinny answer jedno uncomfortable question.

Czy reality diverged od story ktora funded, i co robimy next?

## Kiedy Digital Twin belongs w room

Strong fit signals:

- approval memo referenced named scenarios i guardrails  
- structural albo flow assumptions byly explicit w business case  
- performance lags podczas gdy spend jest on track, sugerujac thesis mismatch  
- musisz decide czy fund corrective layout albo staffing actions  
...
- investment nigdy nie byl modeled jako flow albo constraint decision  
- legal albo contractual compliance jest sole agenda  
- data needed do refresh inputs nie bedzie available przez months i guessing zanieczyszcza review  
- leadership chce tylko narrative win, nie ranked set corrective options  

Skipping twin tutaj to discipline, nie failure.
...
Uzyj twin gdy funded story byla operational.

Skip gdy review nie jest o flow, constraints albo scenario truth.
