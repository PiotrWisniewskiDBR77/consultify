...
Sie kaufen nicht ein Unternehmen.

Sie kaufen eine Kette.
...
1. Vollstaendige Subprozessorliste anfordern, inklusive per Feature-Flag schaltbarer Dienste.
2. jeden Dienst markieren als Inferenz, Logging, Support-Zugriff, Billing-Telemetrie, Security-Scan.
3. pro Hop festhalten: Datentypen, Retention, Verschluesselung, Admin-Zugriffsmodell, Region.
4. gegen nicht verhandelbare RFP-Anhangpunkte pruefen.
5. Konfigurationsreview in einem Test-Tenant ausfuehren, um versteckte Routen zu finden.

## Framework: Datenpfad-Schichten

### Schicht A: Werk bis KI-Edge

- Connectors, Broker, API-Gateways
- Authentifizierungsmuster und Secret-Speicher
...
Subprozessor-Sorgfalt ist keine Papier-Theater.

Sie verhindert stille Umwege fuer Werkswahrheit.

Diagrammieren Sie die Kette, dann testen Sie die Kette.
