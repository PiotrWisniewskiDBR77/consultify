...
A perimeter you can defend includes clear statements on:

- where inference runs and where payloads rest
- whether client content can train or tune the vendor model
- identity, logging, and review expectations for high-impact outputs
- how human approval stays in the loop when stakes rise
