...
- truncated inputs with redaction rules
- confidence and known limitations statement where available
- links to related work orders or specifications
...
- default to safe hold, not silent execution
- route to backup approver pool per plant rules
...
HITL quality is defined by traceability and segregation, not by a second mouse click.

Design approvals like safety interlocks.

Measure whether they actually hold under stress.
