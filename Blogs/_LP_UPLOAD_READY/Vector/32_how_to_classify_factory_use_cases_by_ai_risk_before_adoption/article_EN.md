...
Not every AI use case deserves the same runway.

Classification is how you keep speed without losing control.
...
Risk tiers turn opinions into a repeatable sorting rule.
...
Include exports, screenshots, and support tickets.
...
Post the tier next to the business case.

Procurement and security should see the same label.

## When this framework fails

It fails when teams hide shadow paths, such as operators pasting line data into personal chat tools.

Run a quarterly shadow-use scan alongside formal projects.
...
It is how manufacturers adopt AI at the right speed for each decision type.

Sort use cases before you sort vendors.
