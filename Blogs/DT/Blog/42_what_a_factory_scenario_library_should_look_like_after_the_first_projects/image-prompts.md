## Hero
- objective: Illustrate the article's central tension for DT readers (digital twin program lead / industrial engineering manager scaling simulation beyond pilots).
- scene: Wide manufacturing floor or operations room, readable context, human-in-loop.
- visual style: precise industrial editorial, calm authority, no sci-fi, no cartoon robots
