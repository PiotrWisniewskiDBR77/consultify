# Jak przypisac model ownership miedzy engineering, operations i finance

Target persona: COO / chief engineer ustanawiajacy governance dla plant albo network digital twin  
Funnel stage: Consideration  
Core problem: model staje sie "IT project" albo "engineering hobby" bo zadna function nie owns assumptions, refresh i decision use  
Main promise: simple RACI-style split ktory keep Digital Twin jako decision system z accountable inputs i approved outputs
