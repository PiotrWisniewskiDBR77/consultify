  ...
  steps: [
    {
      ...
      content:
        'Witaj w swojej organizacji! System teraz pamięta Twoje działania. Zacznijmy od pierwszego tematu strategicznego.',
      position: 'bottom',
    },
    {
      id: 'create_axis',
      ...
      content:
        'Oś DRD to przestrzeń dyskusji nad jednym zagadnieniem. Kliknij tutaj, aby nazwać swój pierwszy temat.',
      position: 'bottom',
    },
    {
      id: 'axis_examples',
      ...
      content:
        'Możesz wybrać jeden z szablonów lub stworzyć własną oś. Przykłady: "Strategia technologiczna", "Model operacyjny".',
      position: 'right',
    },
    {
      id: 'add_position',
      ...
      content:
        'Pozycja to jeden punkt widzenia na temat. Opisz, jak TY widzisz sytuację. Później dodasz perspektywy innych osób.',
      position: 'left',
    },
    {
      id: 'ai_partner',
      ...
      content:
        'AI teraz pracuje inaczej — zadaje pytania, które pomagają ustrukturyzować myślenie. Nie daje gotowych odpowiedzi.',
      position: 'left',
    },
    {
      id: 'snapshot',
      ...
      content:
        'Snapshot to "zdjęcie" obecnego stanu myślenia. Nie jest ostateczny — możesz wrócić i zaktualizować. To punkt wyjścia do dyskusji.',
      position: 'top',
    },
  ],
};
