  ...
  steps: [
    {
      ...
      content: {
        en: 'Consultinity uses AI to provide intelligent recommendations, automate analysis, and accelerate your work.',
        pl: 'Consultinity używa AI do dostarczania inteligentnych rekomendacji, automatyzacji analiz i przyspieszania Twojej pracy.',
      },
      placement: 'center',
    },
    {
