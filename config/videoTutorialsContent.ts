...
export const VIDEO_TUTORIALS: VideoTutorial[] = [
    ...
    // ==========================================
    {
        ...
        description: 'An introduction to the Consultinity platform and its key features for digital transformation.',
        descriptionPl: 'Wprowadzenie do platformy Consultinity i jej kluczowych funkcji dla transformacji cyfrowej.',
        duration: '05:30',
