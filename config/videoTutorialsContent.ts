...
export const VIDEO_TUTORIALS: VideoTutorial[] = [
  ...
  // ==========================================
  {
    ...
    description:
      'An introduction to the Consultinity platform and its key features for digital transformation.',
    descriptionPl:
      'Wprowadzenie do platformy Consultinity i jej kluczowych funkcji dla transformacji cyfrowej.',
    duration: '05:30',
    url: '#', // Update with actual video URL after production
    moduleId: 'onboarding',
    difficulty: 'beginner',
    tags: ['introduction', 'overview', 'getting-started'],
    scriptPath: '01-consultinity-welcome.md',
  ...
  },
  {
    ...
    descriptionPl:
      'Wypełnij konfigurację profilu i skonfiguruj podstawowe ustawienia, aby rozpocząć.',
    duration: '03:45',
    url: '#',
    moduleId: 'onboarding',
    difficulty: 'beginner',
  ...
  },
  {
    ...
    descriptionPl:
      'Naucz się nawigować przez różne moduły i szybko znajdować to, czego potrzebujesz.',
    duration: '04:15',
    url: '#',
    moduleId: 'onboarding',
    difficulty: 'beginner',
  ...
  // ==========================================
  {
    ...
    description:
      'Understand the purpose of assessments and how they drive your transformation journey.',
  ...
  },
  {
    ...
    description:
      'Step-by-step guide through the DRD (Digital Readiness Diagnostic) assessment process.',
    descriptionPl:
      'Przewodnik krok po kroku przez proces oceny DRD (Digital Readiness Diagnostic).',
    duration: '15:00',
    url: '#',
    moduleId: 'assessment',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    description:
      'How to effectively upload, organize, and link evidence documents to your assessments.',
  ...
  },
  {
    ...
    description:
      'Learn the art of prioritizing competing initiatives using the impact vs effort framework.',
    descriptionPl:
      'Naucz się sztuki priorytetyzacji konkurujących inicjatyw używając frameworku wpływ vs wysiłek.',
    duration: '05:30',
    url: '#',
    moduleId: 'initiatives',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    description:
      'Create business cases that secure stakeholder buy-in and funding for your initiatives.',
    descriptionPl:
  ...
  // ==========================================
  {
    ...
    descriptionPl:
      'Zbuduj strategiczną mapę drogową, która organizuje inicjatywy w praktyczne fazy.',
    duration: '09:00',
    url: '#',
    moduleId: 'roadmap',
    difficulty: 'intermediate',
  ...
  },
  {
    ...
    descriptionPl:
      'Generuj profesjonalne raporty na spotkania zarządu i aktualizacje dla interesariuszy.',
    duration: '05:15',
    url: '#',
    moduleId: 'reports',
    difficulty: 'beginner',
  ...
  // ==========================================
  {
    ...
    descriptionPl:
      'Włącz i zarządzaj uwierzytelnianiem dwuskładnikowym dla zwiększonego bezpieczeństwa.',
    duration: '03:00',
    url: '#',
    moduleId: 'settings',
    difficulty: 'beginner',
  ...
  },
  {
    ...
    description: 'Connect Consultinity with your existing tools for seamless workflow.',
    descriptionPl: 'Połącz Consultinity z istniejącymi narzędziami dla płynnego workflow.',
    duration: '05:30',
    url: '#',
    moduleId: 'settings',
    difficulty: 'beginner',
  ...
  // ==========================================
  {
    ...
    descriptionPl:
      'Przewodnik na poziomie platformy do tworzenia i zarządzania wieloma organizacjami.',
    duration: '10:00',
    url: '#',
    moduleId: 'superadmin',
    difficulty: 'advanced',
  ...
  },
  {
    ...
    descriptionPl:
      'Zarządzaj subskrypcjami, fakturami i rozliczeniami we wszystkich organizacjach.',
    duration: '08:00',
    url: '#',
    moduleId: 'superadmin',
    difficulty: 'advanced',
