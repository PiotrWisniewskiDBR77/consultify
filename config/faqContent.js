...
export const FAQ_CONTENT = [
    ...
    },
    {
        ...
        answerPl: 'Przejdź do Ustawienia > Integracje > Slack i kliknij "Połącz". Autoryzuj aplikację Consultinity w swoim workspace Slack. Następnie wybierz, które typy powiadomień powinny iść do Slack i określ kanały.',
        moduleId: 'settings',
    ...
    },
    {
        ...
        answerPl: 'Przejdź do Super Admin > Konfiguracja SSO. Wprowadź URL metadanych dostawcy tożsamości lub prześlij plik XML. Zmapuj atrybuty SAML na pola użytkownika Consultinity. Przetestuj połączenie przed włączeniem dla użytkowników.',
        moduleId: 'superadmin',
    ...
    },
    {
        ...
        answerPl: 'Tak, Consultinity jest w pełni zgodny z GDPR. Zapewniamy umowy o przetwarzanie danych (DPA), wspieramy żądania dostępu podmiotów danych (DSAR), umożliwiamy przenoszenie danych i prowadzimy rejestry przetwarzania. Centrum Zgodności pomaga śledzić zgodność Twojej organizacji.',
        moduleId: 'superadmin',
    ...
    // ==========================================
    {
        ...
        answerPl: 'Tak, Consultinity integruje się z popularnymi narzędziami jak Jira, Asana, ClickUp i Trello. Inicjatywy i zadania mogą być synchronizowane dwukierunkowo. Skonfiguruj integracje w Ustawienia > Integracje.',
        moduleId: 'settings',
