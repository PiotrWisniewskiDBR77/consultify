...
export const ACTIVATION_MILESTONES: Record<string, PhaseActivation> = {
    ...
    milestones: [
      {
        id: 'demo_started',
        name: 'Demo Started',
        description: 'User entered demo mode',
        required: true,
      },
      {
        id: 'viewed_3_pages',
        name: 'Viewed 3+ Pages',
        description: 'User explored at least 3 demo pages',
      },
      {
        id: 'used_ai_narrator',
        name: 'Used AI Narrator',
        description: 'User interacted with AI explanations',
      },
    ...
    milestones: [
      {
        id: 'code_entered',
        name: 'Code Entered',
        description: 'User entered access code',
        required: true,
      },
      {
        id: 'trial_started',
        name: 'Trial Started',
        description: 'Trial session activated',
        required: true,
      },
      {
  ...
  E: {
    ...
    milestones: [
      {
        id: 'first_axis_created',
        name: 'First Axis Created',
        description: 'User created first DRD axis',
      },
      {
