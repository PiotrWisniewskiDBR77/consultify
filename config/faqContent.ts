...
export const FAQ_CONTENT: FAQItem[] = [
    ...
    },
    {
        ...
        answer: 'Go to Settings > Integrations > Slack and click "Connect". Authorize the Consultinity app in your Slack workspace. Then select which notification types should go to Slack and specify channels.',
        answerPl:
    ...
    },
    {
        ...
        answer: 'Go to Super Admin > SSO Config. Enter the identity provider metadata URL or upload the XML file. Map SAML attributes to Consultinity user fields. Test the connection before enabling for users.',
        answerPl:
    ...
    },
    {
        ...
        answer: "Yes, Consultinity is fully GDPR compliant. We provide data processing agreements (DPA), support data subject access requests (DSAR), enable data portability, and maintain processing records. The Compliance Center helps track your organization's compliance.",
        answerPl:
    ...
    // ==========================================
    {
        ...
        answer: 'Yes, Consultinity integrates with popular tools like Jira, Asana, ClickUp, and Trello. Initiatives and tasks can be synced bidirectionally. Configure integrations in Settings > Integrations.',
        answerPl:
