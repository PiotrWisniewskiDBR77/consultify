...
export const MODULE_HELP_CONTENT: Record<HelpModuleId, ModuleHelp> = {
  ...
  assessment: {
    ...
    description: {
      en: 'Assess current state and identify gaps',
      pl: 'Ocena aktualnego stanu i identyfikacja luk',
    },
  },
  ...
  implementation: {
    ...
    description: {
      en: 'Execute initiatives and track results',
      pl: 'Wykonywanie inicjatyw i śledzenie wyników',
    },
  },
  ...
  mywork: {
    ...
    description: {
      en: 'Personal workspace and tasks',
      pl: 'Osobista przestrzeń robocza i zadania',
    },
  },
  ...
  settings: {
    ...
    description: {
      en: 'Configure personal preferences',
      pl: 'Konfiguracja preferencji osobistych',
    },
  },
  ...
  admin: {
    ...
    description: {
      en: 'Administrative tools and controls',
      pl: 'Narzędzia i kontrolki administracyjne',
    },
  },
  ...
  knowledge: {
    ...
    description: {
      en: 'Access help articles and tutorials',
      pl: 'Dostęp do artykułów pomocy i tutoriali',
    },
  },
  ...
  onboarding: {
    ...
    description: {
      en: 'Guided start for new users',
      pl: 'Prowadzony start dla nowych użytkowników',
    },
  },
  ...
  'playbook-templates': {
    ...
    icon: 'Layers',
    targetAudience: ['superadmin'],
    relatedModules: ['superadmin', 'email-templates'],
  ...
  'email-templates': {
    ...
    description: {
      en: 'Manage notification and system email templates',
      pl: 'Zarządzanie szablonami powiadomień i wiadomości systemowych',
    },
  },
};
