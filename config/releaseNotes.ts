...
export const RELEASE_NOTES: ReleaseNote[] = [
    {
        ...
        improvements: [
            { en: 'Improved documentation coverage for all modules', pl: 'Poprawione pokrycie dokumentacji dla wszystkich modułów' },
            { en: 'Better bilingual support (EN/PL) throughout help system', pl: 'Lepsze wsparcie dwujęzyczne (EN/PL) w całym systemie pomocy' },
            { en: 'Enhanced FAQ search with tag-based filtering', pl: 'Ulepszone wyszukiwanie FAQ z filtrowaniem tagów' }
        ],
        fixes: [
            { en: 'Fixed help panel animation on mobile devices', pl: 'Naprawiono animację panelu pomocy na urządzeniach mobilnych' },
            { en: 'Resolved video playback issues in Safari', pl: 'Rozwiązano problemy z odtwarzaniem wideo w Safari' }
        ]
    },
    {
        version: '2.4.0',
        ...
        improvements: [
            { en: 'Task filtering now respects user assignments', pl: 'Filtrowanie zadań teraz uwzględnia przypisania użytkowników' },
            { en: 'Project team board shows PMO hierarchy', pl: 'Tablica zespołu projektowego pokazuje hierarchię PMO' }
        ],
        fixes: [
            { en: 'Fixed capability resolution for multi-assigned users', pl: 'Naprawiono rozwiązywanie uprawnień dla użytkowników z wieloma przypisaniami' }
        ]
    },
    {
        version: '2.3.0',
        ...
        improvements: [
            { en: 'Consolidated login UI with cleaner design', pl: 'Skonsolidowany interfejs logowania z czystszym designem' },
            { en: 'Better error messages for authentication failures', pl: 'Lepsze komunikaty błędów dla niepowodzeń uwierzytelniania' }
        ],
        fixes: [
            { en: 'Fixed redirect loop after OAuth callback', pl: 'Naprawiono pętlę przekierowań po wywołaniu OAuth' },
    ...
    },
    {
        ...
        improvements: [
            ...
            { en: 'Better mobile assessment experience', pl: 'Lepsze doświadczenie oceny na urządzeniach mobilnych' }
        ],
        fixes: []
    },
    {
    ...
    },
    {
        ...
        breaking: [
            ...
            { en: 'Legacy assessment exports no longer supported', pl: 'Eksporty starszych ocen nie są już wspierane' }
        ]
    }
];
