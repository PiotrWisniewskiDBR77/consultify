            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
                ...
                {!isAdding && (
                    <button
                        ...
                        className="border border-dashed border-slate-300 dark:border-white/10 rounded-xl p-4 flex flex-col items-center justify-center gap-2 text-slate-400 dark:text-slate-500 hover:text-navy-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/5 transition-all min-h-[160px]"
                    >
                        <Plus size={32} />
                ...
                {isAdding && (
                    <div className="bg-white dark:bg-navy-800 border border-purple-500/50 rounded-xl p-4 shadow-lg shadow-purple-900/20">
                        <div className="space-y-3">
                            ...
                            <div className="border border-dashed border-slate-300 dark:border-white/10 bg-slate-50 dark:bg-navy-900/50 rounded h-16 flex items-center justify-center text-xs text-slate-500 cursor-pointer hover:bg-slate-100 dark:hover:bg-navy-900 transition-colors">
