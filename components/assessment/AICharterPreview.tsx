...
import { AIGeneratedCharter, InitiativeTeamMember, Task } from '../../types';
        ...
        if (editingField === field) {
            return (
                <div className="flex items-start gap-2">
                    ...
                    <button onClick={cancelEditing} className="p-1 bg-slate-500 text-white rounded hover:bg-slate-400">
                        <X size={14} />
                    </button>
                </div>
            );
        ...
        <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 bg-gradient-to-r from-purple-500/10 to-blue-500/10 rounded-xl border border-purple-500/20">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="text-lg font-bold text-navy-900 dark:text-white">AI Generated Charter</h3>
                    ...
                    return (
                        ...
                        >
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <div
                                        className={`p-1.5 rounded-lg bg-${section.color}-100 dark:bg-${section.color}-500/20 text-${section.color}-600 dark:text-${section.color}-400`}
                                    >
                                        {section.icon}
                                    </div>
                                    <span className="font-medium text-navy-900 dark:text-white">{section.title}</span>
                                </div>
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-sm text-slate-600 dark:text-slate-300 italic">
                                                    {renderEditableText(charter.applicantOneLiner || '', 'oneLiner', [
                                                        'applicantOneLiner',
                                                    ])}
                                                </div>
                                            </div>
                                        ...
                                        <div className="space-y-3 bg-white dark:bg-navy-900 p-4 rounded-lg border border-red-200 dark:border-red-500/20">
                                            <div>
                                                ...
                                                <div className="text-sm text-slate-700 dark:text-slate-300 mt-1">
                                                    {renderEditableText(
                                                        charter.problemStructured.symptom,
                                                        'symptom',
                                                        ['problemStructured', 'symptom'],
                                                        true,
                                                    )}
                                                </div>
                                            </div>
                                            <div>
                                                ...
                                                <div className="text-sm text-slate-700 dark:text-slate-300 mt-1">
                                                    {renderEditableText(
                                                        charter.problemStructured.rootCause,
                                                        'rootCause',
                                                        ['problemStructured', 'rootCause'],
                                                        true,
                                                    )}
                                                </div>
                                            </div>
                                            <div>
                                                ...
                                                <div className="text-sm text-slate-700 dark:text-slate-300 mt-1">
                                                    {renderEditableText(
                                                        charter.problemStructured.costOfInaction,
                                                        'costOfInaction',
                                                        ['problemStructured', 'costOfInaction'],
                                                        true,
                                                    )}
                                                </div>
                                            </div>
                                    ...
                                    {section.id === 'target' && charter.targetState && (
                                        <div className="grid grid-cols-3 gap-4">
                                            {['process', 'behavior', 'capability'].map((key) => (
                                                <div
                                                    key={key}
                                                    className="bg-white dark:bg-navy-900 p-3 rounded-lg border border-green-200 dark:border-green-500/20"
                                                >
                                                    <label className="text-xs text-green-600 uppercase font-bold capitalize">
                                                        {key}
                                                    </label>
                                                    <ul className="mt-2 space-y-1">
                                                        {(
                                                            (charter.targetState[
                                                                key as keyof typeof charter.targetState
                                                            ] as string[]) || []
                                                        ).map((item, i) => (
                                                            <li
                                                                key={i}
                                        ...
                                        <div className="space-y-2">
                                            {(charter.killCriteria || []).map((criteria, i) => (
                                                ...
                                                >
                                                    ...
                                                    <button
                                                        onClick={() => {
                                                            const updated = charter.killCriteria.filter(
                                                                (_, idx) => idx !== i,
                                                            );
                                        ...
                                        <div className="space-y-2">
                                            {(charter.suggestedTasks || []).map((task, i) => (
                                                ...
                                                >
                                                    ...
                                                    <button
                                                        onClick={() => {
                                                            const updated = charter.suggestedTasks.filter(
                                                                (_, idx) => idx !== i,
                                                            );
