...
import { DBR77AssessmentData, DBR77WorkstationAssessment, DBR77ProcessAssessment } from '../../../../types';
import { 
    DBR77_PHASES, 
    DBR77_WASTES, 
            ...
            <div className="border-b border-slate-200 dark:border-white/10 pb-4 mb-6">
                <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                        <span className={`px-3 py-1 rounded-full text-sm font-medium bg-${roleEvolution.color}-100 text-${roleEvolution.color}-700`}>
                            {roleEvolution.name}
                        </span>
                        <p className="text-xs text-slate-400 mt-1">Strona {index + 1} z {total}</p>
                    </div>
                </div>
            </div>
                ...
                <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-4">
                    ...
                    <div className="space-y-2 text-sm">
                        ...
                        <div className="flex justify-between">
                            ...
                            <span className={`font-bold ${workstation.leanAssessment.standardizedWork ? 'text-green-600' : 'text-red-600'}`}>
                ...
                <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-4">
                    ...
                    <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                            ...
                            <span className="font-bold text-purple-600">{workstation.automationPotential.taskAutomationPercent}%</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-slate-600 dark:text-slate-400">% augmentacji AI:</span>
                            <span className="font-bold text-blue-600">{workstation.automationPotential.augmentationPercent}%</span>
                        </div>
                        <div className="flex justify-between">
                        ...
                        <div className="flex justify-between">
                            ...
                            <span className={`font-bold ${workstation.automationPotential.retrainingNeeded ? 'text-amber-600' : 'text-green-600'}`}>
...
export const DBR77ReportTemplate: React.FC<DBR77ReportTemplateProps> = ({
    ...
    const totalSavings = data.workstations.reduce((sum, ws) => 
        sum + (ws.automationPotential.estimatedSavings || 0), 0
    ) + data.processes.reduce((sum, p) => 
            ...
            <div className="p-8 min-h-screen">
                ...
                <div className="mb-8">
                    ...
                    <div className="space-y-3">
                        {data.workstations
                            .sort((a, b) => (b.automationPotential.estimatedSavings || 0) - (a.automationPotential.estimatedSavings || 0))
                            .slice(0, 5)
                            .map((ws, idx) => (
                                <div key={ws.id} className="flex items-center gap-4 p-3 bg-slate-50 dark:bg-navy-900/50 rounded-lg">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="text-xs text-slate-500">{ws.department} • {ws.headcount} FTE</div>
                                    </div>
                                    <div className="text-right">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-4 gap-3">
                        {Object.entries(DBR77_ROLE_EVOLUTION).map(([key, config]) => {
                            ...
                            return (
                                <div key={key} className={`p-3 rounded-lg bg-${config.color}-50 dark:bg-${config.color}-900/20 text-center`}>
