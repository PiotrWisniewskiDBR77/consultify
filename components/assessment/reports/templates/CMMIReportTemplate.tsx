                            ...
                            <div key={cat.id} className={`bg-${cat.config.color}-50 dark:bg-${cat.config.color}-900/20 rounded-xl p-4`}>
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-500">{cat.config.namePL}</p>
                                    </div>
                    ...
                    <table className="w-full text-sm">
                        <thead>
                            <tr className="bg-slate-100 dark:bg-navy-800">
                                ...
                                <th className="text-center px-2 py-2 text-xs font-medium text-slate-500">L3</th>
                                <th className="text-center px-2 py-2 text-xs font-medium text-slate-500">L4</th>
                                <th className="text-center px-2 py-2 text-xs font-medium text-slate-500">L5</th>
                            </tr>
                        </thead>
