...
export const ExternalDigitalWorkspace: React.FC<ExternalDigitalWorkspaceProps> = ({ projectId, organizationId }) => {
        ...
        <div className="p-6 max-w-7xl mx-auto">
                    ...
                    {FRAMEWORKS.map((fw) => (
                        ...
                        >
                            ...
                            <div className="text-sm text-gray-600 dark:text-gray-400">
                                {fw.name.split('(')[1]?.replace(')', '') || fw.name}
                            </div>
                        </button>
                    ))}
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6">
                ...
                >
                    ...
                    <p className="text-sm text-gray-500">AI will auto-extract scores and map to DRD framework</p>
                </div>
            </div>
