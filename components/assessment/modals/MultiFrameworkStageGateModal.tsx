...
> = {
    ...
    LEAN: {
        minCompleteness: 0.7,
        requiresReviewer: true,
        additionalChecks: ['At least one process must be documented', 'At least one workstation must be assessed'],
    },
};
    ...
    const validateAssessment = async () => {
        ...
        try {
            ...
            if (framework === 'SIRI') {
                ...
                const assessedDimensions = Object.values(dimensions).filter((v: any) => v != null && v > 0).length;
                checks.push({
            ...
            if (framework === 'CMMI') {
                ...
                const assessedPAs = Object.values(practiceAreas).filter((v: any) => v != null && v > 0).length;
                checks.push({
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative bg-white dark:bg-navy-800 rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
                    ...
                    <div className="mb-6">
                        ...
                        {isValidating ? (
                            <div className="flex items-center justify-center py-8">
                                ...
                                <span className="ml-2 text-gray-500">Validating assessment...</span>
                            </div>
                        ) : (
                ...
                <div className="flex items-center justify-between px-6 py-4 border-t border-gray-200 dark:border-navy-700 bg-gray-50 dark:bg-navy-900">
                    <button
                        onClick={onClose}
                        className="px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-navy-700 rounded-lg transition-colors"
                    >
                        Cancel
                    </button>
