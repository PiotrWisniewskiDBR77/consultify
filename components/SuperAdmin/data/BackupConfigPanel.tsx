                        ...
                        <div className="space-y-6">
                            <label className="flex items-center justify-between cursor-pointer group">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="sr-only"
                                    />
                                    <div className={`w-12 h-6 rounded-full transition-colors ${config.enabled ? 'bg-violet-600' : 'bg-slate-700'}`}>
                                        <div className={`w-5 h-5 rounded-full bg-white shadow transform transition-transform ${config.enabled ? 'translate-x-6' : 'translate-x-0.5'} mt-0.5`} />
                                    </div>
                                </div>
                            </label>
                            ...
                            <div className="space-y-3">
                                <label className="flex items-center gap-3 cursor-pointer group">
                                    ...
                                    />
                                    <div>
                                        <span className="text-slate-300 group-hover:text-white">Include Attachments</span>
                                        <p className="text-xs text-slate-500">Backup uploaded files and documents</p>
                                    </div>
                                </label>
                                ...
                                <label className="flex items-center gap-3 cursor-pointer group">
                                    ...
                                    />
                                    <div>
                                        <span className="text-slate-300 group-hover:text-white">Include Audit Logs</span>
                        ...
                        <div className="bg-slate-800/50 border border-white/[0.06] rounded-xl p-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="p-4 bg-slate-900/50 rounded-lg">
                                    ...
                                    {config.last_backup_status && (
                                        <span className={`inline-flex items-center gap-1 mt-1 text-xs ${
                                            config.last_backup_status === 'success' ? 'text-emerald-400' : 'text-red-400'
                                        }`}>
                                ...
                                <div className="p-4 bg-slate-900/50 rounded-lg">
                                    ...
                                    <p className="text-white font-medium">{formatFileSize(config.last_backup_size)}</p>
                                </div>
