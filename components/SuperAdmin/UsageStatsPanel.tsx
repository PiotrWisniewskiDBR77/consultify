        ...
        <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                    ...
                    <div className="text-2xl font-bold text-white">{totals.totalAiCalls.toLocaleString()}</div>
                </div>
                <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                    <div className="flex items-center gap-3 mb-2">
                    ...
                    <div className="text-2xl font-bold text-white">{(totals.totalTokens / 1000000).toFixed(2)}M</div>
                </div>
            </div>
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="border-b border-white/5">
                                <th className="text-left p-4 text-xs text-slate-500 uppercase">Organization</th>
                                <th className="text-left p-4 text-xs text-slate-500 uppercase">Plan</th>
                                <th className="text-right p-4 text-xs text-slate-500 uppercase">Users</th>
                                <th className="text-right p-4 text-xs text-slate-500 uppercase">AI Calls</th>
                                <th className="text-right p-4 text-xs text-slate-500 uppercase">Tokens</th>
                            </tr>
                        </thead>
                        <tbody>
                            {orgUsage.map((org) => (
