...
export const WebhookDeliveriesModal: React.FC<WebhookDeliveriesModalProps> = ({ webhookId, onClose }) => {
            ...
            <div className="bg-slate-900 border border-white/10 rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
                ...
                <div className="flex items-center justify-between p-6 border-b border-white/10">
                    <div>
                        ...
                        <p className="text-sm text-slate-400 mt-1">Recent webhook deliveries and their status</p>
                    </div>
