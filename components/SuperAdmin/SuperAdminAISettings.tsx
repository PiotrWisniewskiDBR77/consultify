        ...
        <div className="p-6 space-y-6 overflow-y-auto h-full">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-400 mt-1">Platform-wide AI configuration and constraints</p>
                </div>
                ...
                <div className="bg-white/5 rounded-2xl border border-white/10 p-6">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-400">Default model and fallback chain</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="w-full px-4 py-2 bg-navy-900/30 border border-dashed border-white/20 rounded-xl text-slate-400 text-sm"
                        >
                ...
                <div className="bg-white/5 rounded-2xl border border-white/10 p-6">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-400">Global request throttling</p>
                        </div>
                    </div>
                ...
                <div className="bg-white/5 rounded-2xl border border-white/10 p-6">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-400">PII detection and encryption</p>
                        </div>
                    </div>
                        ...
                        <div className="flex items-center justify-between p-4 bg-navy-900/30 rounded-xl border border-white/10">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm text-slate-400">Encrypt all AI requests/responses</div>
                                </div>
                            </div>
                ...
                <div className="bg-white/5 rounded-2xl border border-white/10 p-6">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-400">Circuit breaker and data residency</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="p-4 bg-navy-900/30 rounded-xl border border-white/10">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label className="block text-sm text-slate-400 mb-1">Cooldown (seconds)</label>
                                    <input
                                        type="number"
