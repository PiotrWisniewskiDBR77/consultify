        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-4 gap-4">
                ...
                <div className="bg-slate-800/50 border border-white/[0.06] rounded-xl p-5">
                    <div className="flex items-center justify-between mb-3">
                        <span className="text-sm text-slate-400">Revenue ({period}d)</span>
                ...
                <div className="bg-slate-800/50 border border-white/[0.06] rounded-xl p-6">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-400">Subscribers by plan</p>
                        </div>
                    </div>
                ...
                <div className="bg-slate-800/50 border border-white/[0.06] rounded-xl p-6">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-400">New vs churned ({period} days)</p>
                        </div>
                    </div>
            ...
            <div className="bg-slate-800/50 border border-white/[0.06] rounded-xl p-6">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-400">Monthly revenue by plan</p>
                    </div>
                </div>
