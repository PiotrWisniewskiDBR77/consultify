...
export const IndustryBaselineCard: React.FC<IndustryBaselineCardProps> = ({
    ...
    return (
        <div className="space-y-6">
            <div className="bg-blue-50 dark:bg-blue-900/10 p-4 rounded-lg flex items-start gap-3 border border-blue-100 dark:border-white/5">
                ...
                <div>
                    ...
                    <p className="text-xs text-blue-800 dark:text-blue-200 mt-1">
                        Below are the top megatrends affecting your industry globally. AI has prioritized these based on
                        market signals and your context.
                    </p>
                </div>
            </div>
            ...
            {error && <div className="p-4 bg-red-100 text-red-600 rounded">Error loading baseline: {error}</div>}
            ...
            {!loading && !error && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {megatrends.map((trend) => (
                        <div
                            key={trend.id}
                            className="p-5 rounded-lg border border-slate-200 dark:border-white/10 bg-white dark:bg-navy-800 hover:shadow-lg hover:border-purple-200 dark:hover:border-purple-500/30 transition-all duration-200 group relative overflow-hidden"
                        >
                            {/* Accent Bar */}
                            <div
