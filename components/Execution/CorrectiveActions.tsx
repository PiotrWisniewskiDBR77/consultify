    ...
    const [localActions] = useState<CorrectiveAction[]>([
        {
            ...
            description: 'User adoption is below target. Need additional training and change management support.',
            status: 'IN_PROGRESS',
            priority: 'HIGH',
            linkedKPIId: 'kpi-3',
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-5 gap-4">
                ...
                <div className="bg-white dark:bg-navy-900 rounded-xl p-4 border border-slate-200 dark:border-white/10">
                    ...
                    <div className={`text-2xl font-bold ${stats.overdue > 0 ? 'text-red-600' : 'text-green-600'}`}>
                        {stats.overdue}
                    </div>
                </div>
            </div>
