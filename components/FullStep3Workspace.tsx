            ...
            <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-4">
                ...
                {viewMode === 'gantt' && (
                    <div className="h-[600px] w-full">
                        <RoadmapGantt initiatives={initiatives as any} onUpdateInitiative={onUpdateInitiative as any} />
                    </div>
                )}
                            ...
                            <tbody>
                                {initiatives.map((init) => (
                                    ...
                                    >
                                        ...
                                        <td className="p-3 text-[10px] text-slate-400">{getAxisLabel(init.axis)}</td>
                                        <td className="p-3">
                                            <select
                                                value={init.quarter}
                                                onChange={(e) =>
