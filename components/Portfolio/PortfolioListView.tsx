        ...
        return [...initiatives].sort((a, b) => {
            ...
            switch (sortConfig.field) {
                case 'name':
                    ...
                    break;
                case 'status':
                    comparison = (PRIORITY_ORDER[a.status] || 99) - (PRIORITY_ORDER[b.status] || 99);
                    break;
                case 'priority':
                    comparison = (STATUS_ORDER[a.priority] || 99) - (STATUS_ORDER[b.priority] || 99);
                    break;
            ...
            <table className="w-full">
                <thead className="sticky top-0 bg-slate-50 dark:bg-navy-950 z-10">
                    <tr className="border-b border-slate-200 dark:border-white/10">
                        ...
                        >
                            <div className="flex items-center justify-end gap-1 text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase">
                                Budget
