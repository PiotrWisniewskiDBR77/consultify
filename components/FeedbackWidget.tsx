            ...
            <div className="p-5">
              ...
              {step === 'type' && (
                <div className="grid grid-cols-2 gap-3">
                  {(Object.entries(feedbackTypeConfig) as [FeedbackType, typeof feedbackTypeConfig.bug][]).map(([type, config]) => {
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <textarea
                      ...
                      placeholder={
                        selectedType === 'bug' 
                          ? t('feedback.placeholder.bug', 'Opisz błąd - co robiłeś, co się stało, czego oczekiwałeś...')
                          : selectedType === 'feature'
                          ? t('feedback.placeholder.feature', 'Opisz funkcję, którą chciałbyś zobaczyć...')
                          : t('feedback.placeholder.general', 'Podziel się swoimi przemyśleniami...')
                      }
                      rows={5}
              ...
              {step === 'success' && (
                <div className="text-center py-6">
                  ...
                  <p className="text-slate-500 dark:text-slate-400 text-sm mb-6">
                    {t('feedback.successMessage', 'Twój feedback został przesłany do naszego zespołu. Dziękujemy za pomoc w ulepszaniu aplikacji!')}
                  </p>
                  <button
                    onClick={handleClose}
