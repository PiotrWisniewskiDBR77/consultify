...
import { 
  ChevronDown, Check, Crown, Briefcase, Users, 
  Eye, HelpCircle, Shield, Building
} from 'lucide-react';
                ...
                <div className="space-y-2">
                  {hoveredRole.standards?.prince2 && (
                    <div className="flex items-start gap-2 text-xs">
                      <span className="font-medium text-gray-500 dark:text-gray-400 min-w-[60px]">PRINCE2:</span>
                      <span className="text-gray-700 dark:text-gray-300">{hoveredRole.standards.prince2}</span>
                    </div>
                  )}
                  {hoveredRole.standards?.pmbok && (
                    <div className="flex items-start gap-2 text-xs">
                      <span className="font-medium text-gray-500 dark:text-gray-400 min-w-[60px]">PMBOK:</span>
                      <span className="text-gray-700 dark:text-gray-300">{hoveredRole.standards.pmbok}</span>
                    </div>
                  )}
                </div>
              </div>
