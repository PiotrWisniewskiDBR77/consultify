                                            ...
                                            >
                                                <div className="flex items-start gap-4">
                                                    ...
                                                    <div className="flex-1">
                                                        <h4 className={`text-sm font-bold mb-1 transition-colors ${isSelected ? 'text-blue-700 dark:text-blue-100' : 'text-navy-900 dark:text-slate-200 group-hover:text-blue-600 dark:group-hover:text-white'
                                                            }`}>
                                                            {level.title}
                                                        </h4>
                                                        <p className={`text-xs leading-relaxed transition-colors ${isSelected ? 'text-blue-600/80 dark:text-blue-200/80' : 'text-slate-500 dark:text-slate-400 group-hover:text-navy-700 dark:group-hover:text-slate-300'
                                                            }`}>
                                                            {level.description}
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div className="mt-1 shrink-0">
                                                        <div className={`w-5 h-5 rounded-full border flex items-center justify-center transition-colors ${isSelected ? 'border-blue-500 bg-blue-500' : 'border-slate-300 dark:border-slate-600 group-hover:border-slate-400 dark:group-hover:border-slate-500'
                                                            }`}>
