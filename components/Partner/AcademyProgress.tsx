...
export const AcademyProgress: React.FC<AcademyProgressProps> = ({
    ...
    return (
        <div className="space-y-6">
            {/* Progress Overview */}
            <div className="rounded-3xl border border-slate-200 bg-gradient-to-br from-purple-50 to-indigo-50 p-6 dark:border-white/5 dark:from-purple-500/10 dark:to-indigo-500/10">
                        ...
                        {certifications.map((cert) => {
                            ...
                            return (
                                <div
                                    ...
                                    className={`cursor-pointer rounded-2xl bg-gradient-to-br ${info.color} p-4 text-white shadow-lg transition hover:shadow-xl`}
                                >
            ...
            {!stats.certificationReady && (
                <div className="rounded-3xl border border-dashed border-purple-300 bg-purple-50/50 p-6 text-center dark:border-purple-500/30 dark:bg-purple-500/5">
                    ...
                    <button className="mt-4 rounded-2xl bg-purple-600 px-6 py-2 text-sm font-semibold text-white transition hover:bg-purple-700">
                        Continue Learning
                    </button>
                </div>
            )}
        ...
        <div
            className={`flex items-center justify-between rounded-2xl border p-4 transition ${
                isCompleted
                    ...
                    : 'border-slate-100 bg-slate-50/50 hover:border-brand/30 dark:border-white/5 dark:bg-navy-950/20'
            }`}
        >
            <div className="flex items-center gap-4">
                <div
                    className={`flex h-10 w-10 items-center justify-center rounded-xl ${
                        isCompleted ? 'bg-emerald-500 text-white' : 'bg-slate-100 text-slate-500 dark:bg-white/10'
                    }`}
                >
