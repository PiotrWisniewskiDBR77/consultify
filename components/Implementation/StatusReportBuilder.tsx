        ...
        >
            <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                    {icon}
                    <h4 className="font-medium text-navy-900 dark:text-white">{section.title || sectionKey}</h4>
                </div>
                <div className="flex items-center gap-2">
                    {renderStatusIndicator(section.status, 'lg')}
                    <span className={`text-sm font-medium ${STATUS_CONFIG[section.status]?.color || 'text-slate-500'}`}>
        ...
        <div className="space-y-6">
            ...
            >
                ...
                {currentReport.metrics && (
                    <div className="grid grid-cols-4 gap-4 mt-4 pt-4 border-t border-slate-200 dark:border-white/10">
            ...
            {currentReport.executiveSummary && (
                <div className="bg-white dark:bg-navy-900 rounded-xl border border-slate-200 dark:border-white/10 p-4">
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-300">{currentReport.executiveSummary}</p>
                </div>
            )}
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="bg-white dark:bg-navy-900 rounded-xl border border-slate-200 dark:border-white/10 p-4">
                    ...
                    {currentReport.accomplishments && currentReport.accomplishments.length > 0 ? (
                        ...
                        <p className="text-sm text-slate-400">No accomplishments recorded</p>
                    )}
                </div>
            ...
            {currentReport.recommendations && (
                <div className="bg-purple-50 dark:bg-purple-900/10 border border-purple-200 dark:border-purple-500/20 rounded-xl p-4">
                    ...
                    <p className="text-sm text-purple-600 dark:text-purple-400">{currentReport.recommendations}</p>
                </div>
            )}
