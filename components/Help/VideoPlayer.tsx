                ...
                <div className="px-4 pt-8 pb-2">
                    ...
                    {currentChapter && (
                        <p className="text-white/60 text-xs mt-0.5">
                            {lang === 'pl' && currentChapter.titlePl ? currentChapter.titlePl : currentChapter.title}
                        </p>
                    )}
                </div>
                                        ...
                                        <div className="max-h-48 overflow-y-auto">
                                            {chapters.map((chapter, idx) => (
                                                <button
                                                    ...
                                                    className={`w-full flex items-center gap-2 px-3 py-2 text-left hover:bg-white/10 transition-colors ${currentChapter === chapter ? 'bg-purple-500/20 text-purple-400' : 'text-white'}`}
                                                >
                                ...
                                <div className="absolute bottom-full right-0 mb-2 w-40 bg-slate-900 rounded-lg shadow-xl border border-white/10 overflow-hidden">
                                    ...
                                    {PLAYBACK_SPEEDS.map(speed => (
                                        <button
                                            ...
                                            className={`w-full flex items-center justify-between px-3 py-2 text-sm hover:bg-white/10 transition-colors ${playbackSpeed === speed ? 'text-purple-400' : 'text-white'}`}
                                        >
                                            <span>{speed}x</span>
