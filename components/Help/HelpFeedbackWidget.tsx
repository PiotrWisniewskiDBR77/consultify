        ...
        return (
            <div className={`flex items-center gap-2 ${className}`}>
                ...
                <button
                    ...
                    className="p-1.5 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/30 text-slate-500 hover:text-green-600 dark:hover:text-green-400 transition-colors disabled:opacity-50"
                    title={tTrans.yes}
                >
                    <ThumbsUp size={16} />
                </button>
                <button
                    ...
                    disabled={isSubmitting}
                    className="p-1.5 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/30 text-slate-500 hover:text-red-600 dark:hover:text-red-400 transition-colors disabled:opacity-50"
                    title={tTrans.no}
                >
                    <ThumbsDown size={16} />
                </button>
