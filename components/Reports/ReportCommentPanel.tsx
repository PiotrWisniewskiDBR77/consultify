...
export const ReportCommentPanel: React.FC<ReportCommentPanelProps> = ({
    ...
    const [commentType, setCommentType] = useState<'FEEDBACK' | 'SUGGESTION' | 'QUESTION'>('FEEDBACK');
    ...
    return (
        <div className="h-full flex flex-col bg-white dark:bg-navy-900 border-l border-slate-200 dark:border-white/10">
            {/* Header */}
                ...
                {loading ? (
                    ...
                    comments.map(comment => {
                        ...
                        return (
                            <div
                                key={comment.id}
                                className="bg-slate-50 dark:bg-navy-950 rounded-lg border border-slate-200 dark:border-white/10 overflow-hidden"
                            >
                                {/* Comment header */}
                                <div className="px-3 py-2 flex items-center justify-between border-b border-slate-200 dark:border-white/10">
                                    <div className="flex items-center gap-2">
                                ...
                                {/* Comment actions */}
                                <div className="px-3 py-2 border-t border-slate-200 dark:border-white/10 flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                        {!comment.aiResponse && (
                                            <button
            ...
            {/* New comment form */}
            <div className="shrink-0 p-4 border-t border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-navy-950">
                <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1">
                        <textarea
                            ...
                            rows={2}
                            className="w-full px-3 py-2 text-sm rounded-lg border border-slate-200 dark:border-white/10 bg-white dark:bg-navy-900 text-navy-900 dark:text-white resize-none"
                        />
                    </div>
                    <button
