        ...
        <div ref={containerRef} className="max-w-4xl mx-auto py-8 px-6">
            ...
            <div className="mb-8">
                ...
                <div className="flex items-center gap-4 text-sm text-slate-500 dark:text-slate-400">
                    ...
                    <span>•</span>
                    <span>
                        {t('reports.lastUpdated', 'Last updated')}: {new Date(report.updatedAt).toLocaleDateString()}
                    </span>
                    {readOnly && (
                        <>
                            <span>•</span>
            ...
            <div className="space-y-4">
                ...
                {draggedSection && (
                    ...
                    >
                        <span className="text-sm text-slate-500">{t('reports.dropHere', 'Drop section here')}</span>
                    </div>
                )}
            ...
            {showAddMenu !== null && <div className="fixed inset-0 z-0" onClick={() => setShowAddMenu(null)} />}
        </div>
    );
};
