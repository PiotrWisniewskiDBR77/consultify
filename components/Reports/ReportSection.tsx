...
export const ReportSection: React.FC<ReportSectionProps> = ({
    ...
    return (
        ...
        >
            {/* Edit header */}
            <div
                className={`flex items-center justify-between gap-4 ${panelMode ? 'p-4 border-b border-slate-200 dark:border-white/10' : 'mb-4'}`}
            >
                {/* Title input */}
                <input
                    type="text"
            ...
            {/* Quick AI actions */}
            <div
                className={`flex items-center gap-2 ${panelMode ? 'p-4 border-t border-slate-200 dark:border-white/10' : 'mt-4'}`}
            >
