...
export const ReportFooter: React.FC<ReportFooterProps> = ({
    ...
    return (
        <div className={`bg-slate-50 dark:bg-navy-800/50 rounded-xl border border-slate-200 dark:border-white/10 p-4 ${className}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div className="flex items-start gap-2">
                    ...
                    <div>
                        <span className="text-xs font-medium text-slate-500 dark:text-slate-400 block">ISO 21500:2021</span>
                ...
                <div className="flex items-start gap-2">
                    ...
                    <div>
                        <span className="text-xs font-medium text-slate-500 dark:text-slate-400 block">PMBOK 7th Edition</span>
            ...
            {dataSnapshot && (
                <div className="flex items-center gap-2 mb-3 pb-3 border-b border-slate-200 dark:border-white/10">
                    ...
                    <span className="text-xs text-slate-500 dark:text-slate-400">
                        ...
                        {' '}{dataSnapshot.tasksAnalyzed || 0} tasks, 
                        {' '}{dataSnapshot.initiativesAnalyzed || 0} initiatives, 
                        {' '}{dataSnapshot.decisionsAnalyzed || 0} decisions, 
                        {' '}{dataSnapshot.risksAnalyzed || 0} risks
                    </span>
                </div>
            )}
            ...
            <div className="flex flex-wrap items-center gap-4 text-xs text-slate-400">
                <span>Report ID: <code className="px-1 py-0.5 bg-slate-200 dark:bg-navy-700 rounded">{reportId}</code></span>
