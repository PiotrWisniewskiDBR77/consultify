...
export const ExportControls: React.FC<ExportControlsProps> = ({
    ...
    return (
        <div className={`flex flex-wrap items-center gap-3 ${className}`}>
            ...
            <button
                disabled={disabled}
                className="flex items-center gap-2 px-4 py-2 border border-slate-200 dark:border-white/10 hover:bg-slate-50 dark:hover:bg-white/5 text-slate-600 dark:text-slate-300 rounded-lg font-medium transition-colors disabled:opacity-50"
