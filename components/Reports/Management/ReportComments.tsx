...
const CommentInput: React.FC<{
    ...
    autoFocus?: boolean;
    className?: string;
}> = ({ placeholder = 'Add a comment...', onSubmit, teamMembers = [], autoFocus = false, className = '' }) => {
...
export const ReportComments: React.FC<ReportCommentsProps> = ({
    ...
    return (
        <div className={`${className}`}>
            ...
            {isLocked && (
                <div className="text-center py-3 text-sm text-slate-400 flex items-center justify-center gap-2">
                    <Clock size={14} />
