                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-500/10 rounded border border-blue-100 dark:border-blue-500/20">
                                                    <p className="text-xs text-blue-700 dark:text-blue-300 italic h-24 overflow-y-auto">
                                                        {initiative.strategicFit?.reasoning ||
                                                            'Click Sparkles to analyze...'}
                                                    </p>
                                                </div>
                                                        ...
                                                        {Object.entries(readinessData.details).map(([key, score]) => {
                                                            ...
                                                            return (
                                                                <div key={key} className="flex items-center gap-3">
                                                                    ...
                                                                    <span
                                                                        className={`text-xs font-medium ${isComplete ? 'text-green-500' : 'text-slate-500'}`}
                                                                    >
                                                                        {score}/{maxScore}
                                                                    </span>
                                                                </div>
                                                        ...
                                                        <div className="mt-4 p-3 bg-amber-50 dark:bg-amber-900/10 rounded-lg border border-amber-200 dark:border-amber-500/20">
                                                            <p className="text-xs text-amber-700 dark:text-amber-400">
                                                                <span className="font-bold">
                                                                    {t('initiative.incompleteLabel')}
                                                                </span>{' '}
                                                                Fill in missing sections to reach 80% before advancing
                                                                to Review.
                                                            </p>
                                                        </div>
                                                    )}
                                ...
                                <div className="bg-slate-50 dark:bg-navy-950 rounded-xl p-5 border border-slate-200 dark:border-white/5">
                                    ...
                                    <div className="grid grid-cols-3 gap-4">
                                        {['Process', 'Behavior', 'Capability'].map((type) => (
                                            <div
                                                key={type}
                                                className="bg-white dark:bg-navy-900 p-3 rounded-lg border border-slate-200 dark:border-white/5"
                                            >
                                                <h4 className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase mb-2 border-b border-slate-100 dark:border-white/5 pb-1 flex justify-between">
                                                    ...
                                                    <button
                                                        onClick={() =>
                                                            handleGenerateList('targetState', type.toLowerCase())
                                                        }
                                                        disabled={isGenerating}
                                                        ...
                                                        <div key={idx} className="flex gap-1 group">
                                                            ...
                                                            <input
                                                                ...
                                                                onChange={(e) => {
                                                                    ...
                                                                    const key =
                                                                        type.toLowerCase() as keyof typeof newState;
                                                            ...
                                                            <button
                                                                ...
                                                                className="opacity-0 group-hover:opacity-100 text-slate-600 hover:text-red-500"
                                                            >
                                                                <X size={12} />
                                                            </button>
                                                        </div>
                                    ...
                                    <div className="bg-slate-50 dark:bg-navy-950 rounded-xl p-5 border border-slate-200 dark:border-white/5">
                                        ...
                                        <div className="space-y-2">
                                            {(initiative.attachments || []).map((att, idx) => (
                                                <div
                                                    key={idx}
                                                    className="flex items-center justify-between bg-white dark:bg-navy-900 p-2 rounded border border-slate-200 dark:border-white/5"
                                                >
                                                    <div className="flex items-center gap-2">
                                    ...
                                    <div className="bg-slate-50 dark:bg-navy-950 rounded-xl p-5 border border-slate-200 dark:border-white/5">
                                        ...
                                        <div className="space-y-3">
                                            {(initiative.changeLog || []).map((log, idx) => (
                                                <div
                                                    key={idx}
                                                    className="bg-white dark:bg-navy-900 p-2 rounded border border-slate-200 dark:border-white/5"
                                                >
                                                    ...
                                                    <p className="text-xs text-navy-900 dark:text-white mb-1">
                                                        {log.change}
                                                    </p>
                                ...
                                <div className="space-y-8 overflow-y-auto pr-2">
                                                            ...
                                                            <input
                                                                ...
                                                                onChange={(e) => {
                                                                    ...
                                                                    setInitiative({
                                                                        ...
                                                                        effortProfile: {
                                                                            analytical:
                                                                                initiative.effortProfile?.analytical ||
                                                                                1,
                                                                            operational:
                                                                                initiative.effortProfile?.operational ||
                                                                                1,
                                                                            change:
                                                                                initiative.effortProfile?.change || 1,
                                                                            [metric.key]: val,
                                                                        },
                                                                    });
                                                                }}
                                    ...
                                    <div className="bg-slate-50 dark:bg-navy-950 rounded-xl p-5 border border-slate-200 dark:border-white/5 space-y-4">
                                        ...
                                        {(
                                            ...
                                            <div
                                                key={idx}
                                                className="flex gap-2 bg-slate-50 dark:bg-navy-950 p-2 rounded border border-slate-200 dark:border-white/5"
                                            >
                                                <select
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="grid grid-cols-1 gap-4">
                                            <div className="bg-slate-50 dark:bg-navy-950 p-3 rounded border border-slate-200 dark:border-white/5">
                                                <label
                                                    className="text-xs font-bold text-slate-500 uppercase mb-1 flex items-center gap-2 cursor-pointer hover:text-purple-500"
                                                ...
                                                <div>
                                                    ...
                                                    {initiative.scopeIn?.map((s, idx) => (
                                                        <div key={idx} className="flex gap-1 mb-1">
                                                            <input
                                                                className="w-full bg-white dark:bg-navy-900 text-xs p-1 rounded border border-orange-500/20 dark:border-white/10 text-navy-900 dark:text-white"
                                                                value={s}
                                                                onChange={(e) =>
                                                                    handleArrayChange('scopeIn', idx, e.target.value)
                                                                }
                                                            />
                                                    ...
                                                    {initiative.scopeOut?.map((s, idx) => (
                                                        <div key={idx} className="flex gap-1 mb-1">
                                                            <input
                                                                ...
                                                                value={s}
                                                                onChange={(e) =>
                                                                    handleArrayChange('scopeOut', idx, e.target.value)
                                                                }
                                                            />
                                    ...
                                    <div className="bg-blue-500/5 p-4 rounded border border-blue-500/10 flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            >
                                                ...
                                                {isGenerating
                                                    ? t('common.analyzing')
                                                    : t('initiative.autoFillExecution')}
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <InputGroup label={t('initiative.endDate')}>
                                            <input
                                                ...
                                                onChange={(e) =>
                                                    setInitiative({ ...initiative, endDate: e.target.value })
                                                }
                                            />
                                        </InputGroup>
                                        <InputGroup label={t('initiative.pilotEnd')}>
                                            <input
                                                ...
                                                className="w-full bg-white dark:bg-navy-950 border border-slate-200 dark:border-white/10 rounded p-2 text-navy-900 dark:text-white"
                                                value={
                                                    initiative.pilotEndDate ? initiative.pilotEndDate.split('T')[0] : ''
                                                }
                                                onChange={(e) =>
                                    ...
                                    <div className="bg-slate-50 dark:bg-navy-950 rounded-xl p-4 border border-slate-200 dark:border-white/5">
                                        ...
                                        <div className="space-y-3">
                                            {initiative.milestones?.map((m, idx: number) => (
                                                <div
                                                    key={idx}
                                                    className={`p-3 rounded border transition-colors ${m.isDecisionGate ? 'bg-blue-50 dark:bg-blue-900/10 border-blue-200 dark:border-blue-500/30' : 'bg-white dark:bg-navy-900 border-slate-200 dark:border-white/5'} `}
                                                >
                                    ...
                                    <div className="bg-slate-50 dark:bg-navy-950 rounded-xl p-4 border border-slate-200 dark:border-white/5">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) =>
                                                setInitiative({
                                                    ...initiative,
                                                    competenciesRequired: e.target.value
                                                        .split(',')
                                                        .map((s) => s.trim()),
                                                })
                                            }
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="bg-orange-50 dark:bg-orange-500/5 border border-orange-200 dark:border-orange-500/10 rounded-xl p-4">
                                        ...
                                        {initiative.keyRisks?.map((risk, idx: number) => (
                                            <div
                                                key={idx}
                                                className="mb-4 bg-white dark:bg-navy-900 p-3 rounded border border-slate-200 dark:border-white/5"
                                            >
                                                <input
                                ...
                                <div className="space-y-6">
                                    ...
                                    <InputGroup label={t('initiative.valueTiming')}>
                                        <Select
                                            ...
                                            onChange={(val) =>
                                                setInitiative({ ...initiative, valueTiming: val as any })
                                            }
                                ...
                                <div className="bg-slate-50 dark:bg-navy-950 rounded-xl p-6 border border-slate-200 dark:border-white/5 flex flex-col items-center justify-center text-center relative">
                                    ...
                                    <p className="text-slate-500 dark:text-slate-400 text-sm mb-6">
                                        ...
                                        <span className="text-navy-900 dark:text-white font-mono">
                                            $
                                            {(
                                                (initiative.costCapex || 0) + (initiative.costOpex || 0)
                                            ).toLocaleString()}
                                        </span>
                                    </p>
                                    ...
                                    <div className="grid grid-cols-3 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <Select
                                                ...
                                                onChange={(val) =>
                                                    setInitiative({ ...initiative, ownerBusinessId: val })
                                                }
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Select
                                                ...
                                                onChange={(val) =>
                                                    setInitiative({ ...initiative, ownerExecutionId: val })
                                                }
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="text-sm text-white font-medium">
                                                    {users.find((u) => u.id === initiative.decisionOwnerId)
                                                        ?.firstName || t('common.notAssigned')}{' '}
                                        ...
                                        {initiative.changeLog && initiative.changeLog.length > 0 ? (
                                            initiative.changeLog
                                                ...
                                                .map((log, idx) => (
                                                    <div
                                                        key={idx}
                                                        className="flex items-start gap-3 p-3 bg-white dark:bg-navy-900 rounded border border-slate-200 dark:border-white/5"
                                                    >
                                    ...
                                    <div className="space-y-3">
                                        {(initiative.teamMembers || []).length === 0 ? (
                                            ...
                                            (initiative.teamMembers || []).map((member, idx) => (
                                                <div
                                                    key={member.id}
                                                    className="bg-white dark:bg-navy-900 p-4 rounded-lg border border-slate-200 dark:border-white/5 flex items-center gap-4"
                                                >
                                    ...
                                    <div className="space-y-3">
                                        {(initiative.relatedInitiatives || []).length === 0 ? (
                                            ...
                                            (initiative.relatedInitiatives || []).map((rel, idx) => (
                                                <div
                                                    key={rel.id}
                                                    className="bg-white dark:bg-navy-900 p-3 rounded-lg border border-slate-200 dark:border-white/5 flex items-center gap-3"
                                                >
                                                    <select
                                ...
                                <div className="space-y-4">
                                    {(initiative.comments || []).length === 0 ? (
                                        ...
                                        (initiative.comments || []).map((comment) => (
                                            <div
                                                key={comment.id}
                                                className="bg-white dark:bg-navy-950 rounded-xl p-4 border border-slate-200 dark:border-white/5"
                                            >
                                                <div className="flex gap-3">
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        <div className="flex gap-4 mt-2">
                                                            <button className="text-xs text-slate-400 hover:text-blue-500">
                                                                {t('common.reply')}
                                                            </button>
                                                            <button className="text-xs text-slate-400 hover:text-blue-500">
                                                                {t('common.react')}
                                                ...
                                                <div key={version.id} className="flex gap-4">
                                                    ...
                                                    <div className="pb-4">
                                                        ...
                                                        <div className="flex items-center gap-2 mt-1 text-xs text-slate-400">
                                                            <span>
                                                                {version.createdByUser?.firstName}{' '}
                                                                {version.createdByUser?.lastName}
                                                            </span>
                                                            <span>•</span>
