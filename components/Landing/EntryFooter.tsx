...
export const EntryFooter: React.FC = () => {
    ...
    const sections = [
        ...
        },
        {
            ...
            links: [
                { label: t('landing.footer.resources.masterclass', 'Masterclass'), href: 'https://masterclass.dbr77.com/?utm_source=Consultinity&utm_medium=Footer&utm_campaign=landing_footer', external: true },
                { label: t('landing.footer.resources.blog', 'Blog'), href: 'https://dbr77.com/blog/', external: true },
                { label: t('landing.footer.resources.podcast', 'Factory on Air'), href: 'https://open.spotify.com/show/7MJjs0AJ79hfRaCrcFbs4B', external: true },
            ]
        },
        {
    ...
    return (
        <footer className="bg-white dark:bg-navy-950 border-t border-slate-200 dark:border-white/5 py-16 px-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 lg:gap-12">
                    ...
                    <div className="col-span-2 space-y-6">
                        ...
                        <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed max-w-xs">
                            {t('landing.footer.tagline', 'Empowering organizations to navigate digital transformation with AI-driven strategy and human-led governance.')}
                        </p>
                        ...
                        {/* Company Info */}
                        <div className="text-[10px] text-slate-400 space-y-2 pt-2">
                            {/* HQ - Poland */}
                            <div>
                                <p className="font-semibold text-slate-500 dark:text-slate-300">{COMPANY.headquarters.name}</p>
                                <p>{COMPANY.headquarters.address}, {COMPANY.headquarters.city}</p>
                                <p className="opacity-70">NIP: {COMPANY.headquarters.nip} | KRS: {COMPANY.headquarters.krs}</p>
                            </div>
                            {/* USA & Germany - compact */}
                            <div className="flex flex-wrap gap-x-4 gap-y-1 opacity-70">
                                <span>{COMPANY.usa.name} · {COMPANY.usa.city}</span>
                                <span>{COMPANY.germany.name} · {COMPANY.germany.city}</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex items-center gap-4 flex-wrap justify-center lg:justify-end">
                            {PARTNERSHIPS.futureFactory.enabled && (
                                ...
                                >
                                    ...
                                    <span className="text-[9px] font-medium text-slate-400 uppercase tracking-wider group-hover:text-green-600 transition-colors">
                            ...
                            {PARTNERSHIPS.ampc.enabled && (
                                ...
                                >
                                    ...
                                    <span className="text-[9px] font-medium text-slate-400 uppercase tracking-wider group-hover:text-blue-600 transition-colors">
