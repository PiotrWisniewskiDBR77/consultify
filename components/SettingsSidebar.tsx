...
const menuItems: MenuItem[] = [
    ...
    { id: 'ai-preferences', labelKey: 'settings.modules.aiPreferences', icon: <Brain size={20} />, separator: 'before' },
    { id: 'notifications', labelKey: 'settings.modules.notifications', icon: <Bell size={20} /> },
    { id: 'security', labelKey: 'settings.modules.security', icon: <Shield size={20} />, separator: 'before' },
    { id: 'integrations', labelKey: 'settings.modules.integrations', icon: <Link size={20} /> },
    { id: 'appearance', labelKey: 'settings.modules.appearance', icon: <Palette size={20} />, separator: 'before' },
];
...
const MenuButton: React.FC<{
    ...
    return (
        ...
        >
            <span className={`shrink-0 ${activeSection === item.id ? 'text-purple-500 dark:text-purple-400' : 'text-slate-400 dark:text-slate-500 group-hover:text-slate-600 dark:group-hover:text-slate-300'}`}>
                {item.icon}
            </span>
    ...
    return (
        ...
        >
            ...
            <div className="h-16 border-b border-slate-200 dark:border-white/5 flex items-center px-4 gap-3 relative shrink-0">
                <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-slate-600 to-slate-700 dark:from-purple-600 dark:to-purple-700 flex items-center justify-center shadow-lg shrink-0">
            ...
            <div className="p-3 border-t border-slate-200 dark:border-white/5 shrink-0">
                <div className={`flex items-center gap-3 px-2 py-2 mb-1 overflow-hidden transition-all duration-300 ${showFull ? 'opacity-100' : 'opacity-0 h-0 hidden'}`}>
                    <div className="w-8 h-8 rounded-full bg-purple-600/20 flex items-center justify-center shrink-0">
                        <UserCircle size={16} className="text-purple-500 dark:text-purple-400" />
                    </div>
