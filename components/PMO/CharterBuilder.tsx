                    ...
                    <div className="max-w-2xl">
                        ...
                        <div className="space-y-2">
                            {(formData.deliverables || []).map((item, index) => (
                                <div key={index} className="flex items-center gap-2">
                                    <input
                                        ...
                                        className="flex-1 px-3 py-2 bg-slate-50 dark:bg-navy-800 border border-slate-200 dark:border-white/10 rounded-lg text-navy-900 dark:text-white disabled:opacity-60"
                                    />
                                    {!readOnly && (
                                        <button
                            ...
                            {(formData.deliverables || []).length === 0 && (
                                <p className="text-sm text-slate-400 py-4 text-center">No deliverables defined</p>
                            )}
                        </div>
                    </div>
                )}
                    ...
                    <div className="max-w-2xl">
                        <div className="flex items-center justify-between mb-4">
                            <div>
                                ...
                                <p className="text-sm text-slate-500">How will success be measured?</p>
                            </div>
                            {!readOnly && (
                                <button
                        ...
                        <div className="space-y-2">
                            ...
                            {(formData.successCriteria || []).length === 0 && (
                                <p className="text-sm text-slate-400 py-4 text-center">No success criteria defined</p>
                            )}
                        </div>
                    </div>
                )}
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-3">
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500">What is included in this initiative?</p>
                                </div>
                                {!readOnly && (
                                    <button
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-3">
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500">What is explicitly excluded?</p>
                                </div>
                                {!readOnly && (
                                    <button
                    ...
                    <div className="max-w-2xl">
                        <div className="flex items-center justify-between mb-4">
                            <div>
                                ...
                                <p className="text-sm text-slate-500">What could go wrong?</p>
                            </div>
                            {!readOnly && (
                                <button
