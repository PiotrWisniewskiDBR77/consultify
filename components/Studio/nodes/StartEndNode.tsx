...
export const StartEndNode: React.FC<NodeProps<StartEndData>> = memo(({ data, selected, isConnectable }: any) => {
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-center gap-2">
                {isStart ? <Play size={14} className="text-green-400" /> : <Flag size={14} className="text-red-400" />}
