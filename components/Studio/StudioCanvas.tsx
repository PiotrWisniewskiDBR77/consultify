        ...
        <div ref={reactFlowWrapper} className={`h-full w-full relative ${className}`}>
            ...
            >
                ...
                <Controls 
                    ...
                    className="!bg-slate-800/90 !backdrop-blur-sm !border-white/10 !rounded-lg [&>button]:!bg-transparent [&>button]:!border-white/10 [&>button]:!text-slate-400 [&>button:hover]:!bg-white/10 [&>button:hover]:!text-white"
                />
