                            ...
                            {roles.map((role) => (
                                ...
                                >
                                    <div className="flex flex-col items-center gap-1">
                                        ...
                                        {role.isSystem && <Lock size={10} className="text-slate-400" />}
                                    </div>
                                </th>
                            ))}
                        </tr>
                                                        ...
                                                        {!readOnly && (
                                                            <Tooltip
                                                                content={
                                                                    allGranted
                                                                        ? t(
                                                                              'admin.permissions.revokeAll',
                                                                              'Revoke all in category',
                                                                          )
                                                                        : t(
                                                                              'admin.permissions.grantAll',
                                                                    ...
                                                                    className={cn(
                                                                        ...
                                                                        allGranted
                                                                            ...
                                                                            : someGranted
                                                                              ...
                                                                              : 'bg-slate-200 dark:bg-navy-700 text-slate-400 hover:bg-slate-300 dark:hover:bg-navy-600',
                                                                    )}
                                                                >
                                                                    {allGranted ? (
                                                                        <Check size={14} />
                                                        ...
                                                        return (
                                                            <td key={role.id} className="px-4 py-2.5 text-center">
                                                                <button
                                                                    onClick={() =>
                                                                        !isLocked &&
                                                                        handleToggle(permission.id, role.id)
                                                                    }
