...
import { Check, Download, FileJson, FileSpreadsheet, FileText, HelpCircle, Loader2, X } from 'lucide-react';
                    ...
                    <div className="flex flex-wrap gap-2">
                        {(['all', 'active', 'inactive', 'pending'] as ExportFilter[]).map((f) => (
                            ...
                            >
                                ...
                                <span className="ml-1.5 text-xs text-slate-400">({filteredCounts[f] || 0})</span>
                            </button>
                        ))}
                    </div>
                </div>
