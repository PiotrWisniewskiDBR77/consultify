...
const FilterFieldEditor: React.FC<FilterFieldEditorProps> = ({ field, value, onChange, onClose }) => {
    const { t } = useTranslation();
            ...
            <div className="space-y-4">
                ...
                {field.type === 'daterange' && (
                    <div className="flex items-center gap-2">
                        <input
                            type="date"
                            value={typeof localValue === 'object' && 'start' in localValue ? localValue.start : ''}
                            onChange={(e) =>
                                setLocalValue({
