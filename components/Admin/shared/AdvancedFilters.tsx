...
export const AdvancedFilters: React.FC<AdvancedFiltersProps> = ({
    ...
    const formatFilterValue = useCallback(
        (filter: FilterValue, field: FilterField): string => {
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            {preset.isDefault && (
                                                <Star
                                                    size={10}
                                                    className="inline ml-1 text-amber-500 fill-amber-500"
                                                />
                                            )}
                                        </button>
            ...
            >
                <div className="space-y-4">
                    <p className="text-sm text-slate-500 dark:text-slate-400">
                        {t('admin.filters.savePresetDescription', 'Give your filter combination a name to quickly apply it later.')}
                    </p>
                    <input
                        type="text"
                        value={presetName}
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => {
                                            if (e.target.checked) {
                                                ...
                                                setLocalValue(
                                                    (localValue as string[]).filter((v) => v !== opt.value),
                                                );
                                            }
                                        }}
                ...
                {field.type === 'daterange' && (
                    <div className="flex items-center gap-2">
                        <input
                            type="date"
                            value={
                                typeof localValue === 'object' && 'start' in localValue
                                    ? localValue.start
                                    : ''
                            }
                            onChange={(e) =>
                                setLocalValue({
                                    start: e.target.value,
                                        ...
                                        typeof localValue === 'object' && 'end' in localValue
                                            ? localValue.end
                                            : '',
                                })
                            }
