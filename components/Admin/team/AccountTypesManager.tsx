            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">
                        {t('admin.team.accountTypes.subtitle', '{{count}} users across {{types}} account types', {
                            count: totalUsers,
                ...
                {accountTypes.map((type) => {
                    ...
                    return (
                        <div
                            key={type.id}
                            className={cn(
                                'relative p-5 bg-white dark:bg-navy-800 rounded-xl border transition-all cursor-pointer',
                                isSelected
