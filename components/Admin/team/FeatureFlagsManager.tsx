        ...
        <div className={cn('space-y-6', className)}>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex gap-2">
                    ...
                    >
                        <option value="all">
                            {t('admin.features.allCategories', 'All Categories')}
                        </option>
                        {categories.map((cat) => (
                    ...
                    >
                        <option value="all">
                            {t('admin.features.allStatus', 'All Status')}
                        </option>
                                                ...
                                                <div className="px-4 pb-4 bg-slate-50 dark:bg-navy-900">
                                                    <div className="pt-4 space-y-4">
                                                        ...
                                                        {flag.enabled && onUpdateRollout && (
                                                            <div>
                                                                <label className="block text-sm font-medium text-slate-600 dark:text-slate-400 mb-2">
                                                                    {t(
                                                                        'admin.features.rolloutPercentage',
                                                                        'Rollout Percentage',
                                                                    )}
                                                                </label>
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                            ...
                                                            {flag.targetedGroups &&
                                                                flag.targetedGroups.length > 0 && (
                                                                    <div>
                                                                        <p className="text-sm font-medium text-slate-600 dark:text-slate-400 mb-1">
                                                                            {t(
                                                                                'admin.features.targetedGroups',
                                                                                'Targeted Groups',
                                                                            )}
                                                                        </p>
                                                                        <div className="flex flex-wrap gap-1">
