            ...
            >
                ...
                <div className="flex items-center gap-1">
                    {currentManager && !disabled && (
                        <button
                            onClick={handleClear}
                            className="p-1 text-slate-400 hover:text-slate-600 hover:bg-slate-100 dark:hover:bg-navy-700 rounded"
                        >
                            <X size={14} />
                        </button>
                    )}
                    ...
                    <div className="p-2 border-b border-slate-200 dark:border-navy-700">
                        <div className="relative">
                            ...
                            <input
                                ...
                                placeholder={t('admin.team.manager.searchPlaceholder', 'Search by name or email...')}
