...
const categoryInfo: Record<StatusCategory, { icon: React.ElementType; label: string; color: string }> = {
    todo: { icon: CircleDashed, label: 'To Do', color: 'text-slate-500' },
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h3 className="text-lg font-semibold text-navy-900 dark:text-white flex items-center gap-2">
                        ...
                        <Tooltip content={t('admin.workspace.statuses.tooltip', 'Configure task workflow statuses')}>
