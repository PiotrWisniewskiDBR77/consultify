...
export const CompanyAddressSettings: React.FC<CompanyAddressSettingsProps> = ({
    ...
    const validate = useCallback(() => {
        ...
        if (!formData.postalCode.trim()) {
            newErrors.postalCode = t('admin.org.address.errors.postalCodeRequired', 'Postal code is required');
        }
        if (!formData.country) {
        ...
        <div className={cn('space-y-6', className)}>
            ...
            <div className="p-6 bg-white dark:bg-navy-800 rounded-xl border border-slate-200 dark:border-navy-700">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">
                    {t('admin.org.address.description', 'This address will appear on invoices and official documents.')}
                </p>
