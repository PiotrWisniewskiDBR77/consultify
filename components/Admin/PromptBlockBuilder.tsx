...
export const PromptBlockBuilder: React.FC<PromptBlockBuilderProps> = ({
    ...
    const [expandedCategories, setExpandedCategories] = useState<Set<string>>(new Set(['ROLE', 'BEHAVIOR']));
    ...
    return (
        <div className={`flex flex-col lg:flex-row gap-4 ${className}`}>
            {/* Block Library */}
            <div className="lg:w-1/2 flex flex-col bg-white dark:bg-navy-900 rounded-xl border border-slate-200 dark:border-white/10">
            ...
            <div className="lg:w-1/2 flex flex-col gap-4">
                {/* Selected blocks */}
                <div className="flex-1 bg-white dark:bg-navy-900 rounded-xl border border-slate-200 dark:border-white/10">
                    <div className="p-4 border-b border-slate-200 dark:border-white/10">
