...
export const IntegrationsManagementPanel: React.FC<IntegrationsManagementPanelProps> = ({ className = '' }) => {
                ...
                <div className="flex items-start justify-between">
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <button
                            ...
                            className="p-2 text-slate-400 hover:text-violet-500 hover:bg-violet-50 dark:hover:bg-violet-900/20 rounded-lg transition-colors"
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="p-2 text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 rounded-lg hover:bg-slate-100 dark:hover:bg-navy-700"
                    >
                        <X size={18} />
                    </button>
                </div>
                                    ...
                                    <div className="space-y-1">
                                        {events.map(event => (
                                            ...
                                            >
                                                ...
                                                <code className="text-xs text-slate-400 bg-slate-100 dark:bg-navy-600 px-1.5 py-0.5 rounded">
                                                    {event.id}
                                                </code>
                                            </label>
                                        ))}
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    <button
                        onClick={loadData}
                        disabled={loading}
                        className="p-2 text-slate-500 hover:text-violet-500 hover:bg-violet-50 dark:hover:bg-violet-900/20 rounded-lg transition-colors disabled:opacity-50"
