                ...
                <div className="space-y-6">
                            ...
                            <div className="bg-black/20 rounded-lg p-4">
                                ...
                                <div className="space-y-3 text-sm">
                                    <div className="flex justify-between items-center py-2 border-b border-white/5">
                                        ...
                                        <span className="text-slate-400">0 - 1,000 tokens/month</span>
                                    </div>
                                    <div className="flex justify-between items-center py-2 border-b border-white/5">
                                        <span className="text-blue-400">Standard</span>
                                        <span className="text-slate-400">1,001 - 50,000 tokens/month</span>
                                    </div>
                                    <div className="flex justify-between items-center py-2 border-b border-white/5">
                                        <span className="text-amber-400">Premium</span>
                                        <span className="text-slate-400">50,001 - 200,000 tokens/month</span>
                                    </div>
                                    <div className="flex justify-between items-center py-2">
                                        <span className="text-purple-400">Reasoning</span>
                                        <span className="text-slate-400">200,001+ tokens/month</span>
                                    </div>
                                </div>
                    ...
                    <div className="admin-card overflow-hidden">
                        <div className="px-4 py-3 border-b border-[var(--admin-border)]">
                            ...
                            <p className="text-xs text-slate-500 mt-1">Assign AI access tiers to individual users</p>
                        </div>
