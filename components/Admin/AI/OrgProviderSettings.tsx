                        ...
                        {disabledProviders.map(provider => (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    disabled={savingProvider === provider.id}
                                    className="flex items-center gap-2 px-3 py-2 bg-slate-500/20 hover:bg-emerald-500/20 text-slate-400 hover:text-emerald-400 rounded-lg transition-colors disabled:opacity-50"
                                >
                                    {savingProvider === provider.id ? (
                                        <RefreshCw size={16} className="animate-spin" />
                                    ) : (
