                ...
                >
                    ...
                    <div className="relative z-10 text-center px-8 max-w-md">
                        ...
                        <motion.div
                            ...
                            className="mb-12"
                        >
                            <div className="w-20 h-20 mx-auto bg-gradient-to-br from-purple-500 to-indigo-600 rounded-2xl flex items-center justify-center shadow-2xl shadow-purple-500/30 mb-6">
