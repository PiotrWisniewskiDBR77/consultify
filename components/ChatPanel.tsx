...
export const ChatPanel: React.FC<ChatPanelProps> = ({
    ...
    const { speak, stopSpeaking, isSpeaking, voiceEnabled, toggleVoice, ttsSupported } = useVoiceChat();
    ...
    useEffect(() => {
        ...
        const lastAIMessage = [...messages].reverse().find((msg) => msg.role === 'ai' && msg.id !== 'stream');
