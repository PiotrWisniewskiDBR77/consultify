...
export const VelocityChart: React.FC<Partial<VelocityChartProps> & { className?: string }> = ({
    ...
    return (
        ...
        >
            ...
            <div className="flex items-start justify-between mb-4">
                <div>
                    ...
                    <div className="flex items-baseline gap-2">
                        ...
                        <span className="text-sm text-slate-400">tasks/week</span>
                    </div>
                </div>
            ...
            {/* Chart */}
            <div className="mb-4">
                <BarChart data={metrics.data} maxValue={maxValue} height={height} />
            ...
            <div className="flex items-center justify-between pt-4 border-t border-slate-100 dark:border-white/5">
                ...
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-slate-500">{t('myWork.dashboard.completed', 'Completed')}</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded bg-slate-200 dark:bg-white/10" />
                        <span className="text-xs text-slate-500">{t('myWork.dashboard.created', 'Created')}</span>
                    </div>
                </div>
