...
const DecisionItem: React.FC<{
    ...
    const isUrgent = decision.daysWaiting > 3 || decision.priority === 'critical' || decision.priority === 'high';
    ...
    return (
        <motion.div
            ...
            className={`
                p-4 border-b border-slate-100 dark:border-white/5 last:border-0
