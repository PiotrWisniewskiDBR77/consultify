...
const SettingsSection: React.FC<{
    ...
    return (
        ...
        >
            <div className="p-4 border-b border-slate-100 dark:border-white/5 bg-slate-50 dark:bg-navy-800/50">
    ...
    return (
        <div className="flex-1">
            ...
            <select
                ...
                className="w-full px-3 py-2 bg-slate-100 dark:bg-navy-800 border border-slate-200 dark:border-white/10 rounded-lg text-sm text-navy-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500"
            >
                {hours.map((hour) => (
        ...
        <div className="space-y-6 max-w-2xl">
            ...
            >
                ...
                <SettingToggle
                    ...
                    description={t('notifications.email.taskAssignedDesc', 'When someone assigns a task to you')}
                ...
                <SettingToggle
                    ...
                    description={t('notifications.email.decisionsDesc', 'When a decision needs your approval')}
                ...
                <SettingToggle
                    ...
                    description={t('notifications.email.mentionsDesc', 'When someone mentions you in comments')}
                ...
                <SettingToggle
                    ...
                    description={t('notifications.email.deadlinesDesc', 'Reminders for upcoming task deadlines')}
                ...
                <SettingToggle
                    ...
                    description={t('notifications.email.weeklyReportDesc', 'Weekly progress summary every Monday')}
            ...
            >
                ...
                <SettingToggle
                    ...
                    description={t('notifications.inApp.aiSuggestionsDesc', 'Recommendations from AI assistant')}
            ...
            >
                <SettingToggle
                    ...
                    description={t('notifications.quietHours.enableDesc', 'Pause notifications during specific times')}
