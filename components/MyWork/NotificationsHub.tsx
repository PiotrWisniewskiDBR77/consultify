            ...
            >
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2">
                        <p className={`text-[13px] leading-tight ${isExpanded ? '' : 'line-clamp-2'} ${
                            notification.read 
                        ...
                        <div className="px-4 pb-3 pl-[52px] space-y-3">
                            ...
                            <div className="flex flex-wrap items-center gap-2">
                                ...
                                {notification.severity && notification.severity !== 'INFO' && (
                                    <div className={`px-2 py-1 rounded text-[11px] font-medium ${
...
export const NotificationsHub: React.FC<NotificationsHubProps> = ({
    ...
    const handleNotificationClick = (notification: Notification) => {
        ...
        } else if (notification.relatedObjectType === 'DECISION' && notification.relatedObjectId && onOpenDecision) {
    ...
    return (
        <div className="flex flex-col h-full bg-white dark:bg-navy-900">
            ...
            <div className="shrink-0 flex items-center justify-between gap-3 px-4 py-2.5 bg-white dark:bg-navy-900 border-b border-slate-200 dark:border-white/10">
                {/* Mode Pill Tabs */}
            ...
            <div className="shrink-0 flex items-center gap-2 px-4 py-2 bg-slate-50/50 dark:bg-navy-800/30 border-b border-slate-100 dark:border-white/5">
