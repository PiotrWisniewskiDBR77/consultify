...
export const ArtifactsPanel: React.FC<ArtifactsPanelProps> = ({
    ...
    const navigateArtifact = useCallback(
        (direction: 'prev' | 'next') => {
            const newIndex =
                direction === 'prev' ? Math.max(0, currentIndex - 1) : Math.min(artifacts.length - 1, currentIndex + 1);
                ...
                <div className="flex items-center gap-1">
                    ...
                    {onToggleFullscreen && (
                        <button
                            ...
                            title={
                                isFullscreen
                                    ? t('artifacts.exitFullscreen', 'Exit fullscreen')
                                    : t('artifacts.fullscreen', 'Fullscreen')
                            }
                        >
