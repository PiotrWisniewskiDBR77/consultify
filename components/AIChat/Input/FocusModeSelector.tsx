  ...
  const getColorClasses = (color: string, isActive: boolean) => {
    const colors: Record<string, { active: string; inactive: string }> = {
      purple: {
        ...
        inactive: 'text-slate-600 dark:text-slate-400 border-transparent hover:bg-purple-50 dark:hover:bg-purple-900/20'
      },
      blue: {
        active: 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 border-blue-300 dark:border-blue-700',
        inactive: 'text-slate-600 dark:text-slate-400 border-transparent hover:bg-blue-50 dark:hover:bg-blue-900/20'
      },
      green: {
        active: 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 border-green-300 dark:border-green-700',
        inactive: 'text-slate-600 dark:text-slate-400 border-transparent hover:bg-green-50 dark:hover:bg-green-900/20'
      },
      amber: {
        active: 'bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 border-amber-300 dark:border-amber-700',
        inactive: 'text-slate-600 dark:text-slate-400 border-transparent hover:bg-amber-50 dark:hover:bg-amber-900/20'
      },
      cyan: {
        active: 'bg-cyan-100 dark:bg-cyan-900/30 text-cyan-700 dark:text-cyan-300 border-cyan-300 dark:border-cyan-700',
        inactive: 'text-slate-600 dark:text-slate-400 border-transparent hover:bg-cyan-50 dark:hover:bg-cyan-900/20'
      }
    };
