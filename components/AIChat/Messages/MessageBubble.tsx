...
import { Bot, User, Sparkles, FileCode, ChevronDown, ChevronUp } from 'lucide-react';
import { ChatMessage, MessageFeedback, Artifact } from '../../../types';
    ...
    >
      ...
      <div className={`flex-1 max-w-[85%] ${isUser ? 'items-end' : 'items-start'}`}>
        ...
        {hasArtifacts && (
          ...
          >
            <FileCode size={14} />
            {message.artifacts!.length} {message.artifacts!.length === 1 
