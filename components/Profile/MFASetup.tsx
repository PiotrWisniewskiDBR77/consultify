...
type MFAStep = 'initial' | 'method-select' | 'setup-app' | 'setup-sms' | 'verify' | 'backup' | 'recovery' | 'complete';
...
export const MFASetup: React.FC<MFASetupProps> = ({ isEnabled, onUpdate }) => {
    ...
    const regenerateBackupCodes = async () => {
        if (verificationCode.length !== 6) {
            setError(t('security.mfa.codeRequired', 'Enter your current 2FA code to regenerate backup codes'));
            return;
        }
                ...
                <div className="bg-white dark:bg-navy-900 rounded-2xl border border-slate-200 dark:border-white/10 overflow-hidden">
                    ...
                    <div className="divide-y divide-slate-100 dark:divide-white/5">
                        ...
                        <button
                            ...
                            className="w-full p-4 flex items-center justify-between hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors text-left"
                        >
                            <div className="flex items-center gap-3">
                    ...
                    <div className="bg-white dark:bg-navy-900 rounded-2xl border border-slate-200 dark:border-white/10 p-6">
                        ...
                        <div className="flex gap-3 mb-4">
                            <input
                                ...
                                maxLength={6}
                                placeholder="000000"
                                className="w-32 px-4 py-2 text-center text-lg font-mono tracking-widest border border-slate-200 dark:border-white/10 rounded-lg bg-white dark:bg-navy-950 text-slate-900 dark:text-white focus:ring-2 focus:ring-purple-500"
                            />
                            <button
    ...
    if (disableConfirm) {
        return (
            <div className="max-w-md mx-auto bg-red-50 dark:bg-red-900/10 rounded-2xl p-6 border border-red-200 dark:border-red-500/30 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="flex gap-3">
                    <button
                        onClick={disableMFA}
                        disabled={loading || verificationCode.length !== 6}
                        className="flex-1 py-3 bg-red-600 hover:bg-red-700 text-white rounded-lg font-medium transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                    >
        ...
        <div className="max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="bg-white dark:bg-navy-900 rounded-2xl border border-slate-200 dark:border-white/10 overflow-hidden">
                    ...
                    <div className="p-6">
                        ...
                        <button
                            onClick={startSetup}
                            disabled={loading}
                            className="w-full py-4 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white rounded-xl font-semibold transition-all disabled:opacity-50 flex items-center justify-center gap-2 shadow-lg shadow-indigo-500/25"
                        >
                            {loading ? (
                ...
                <div className="bg-white dark:bg-navy-900 rounded-2xl border border-slate-200 dark:border-white/10 p-6">
                    ...
                    <div className="mb-6">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 border border-slate-200 dark:border-white/10 rounded-xl bg-white dark:bg-navy-950 text-slate-900 dark:text-white focus:ring-2 focus:ring-purple-500 placeholder-slate-400"
                        />
                        <p className="mt-2 text-xs text-slate-500">
                            {t('security.mfa.phoneFormat', 'Use international format (e.g., +1 for US, +44 for UK)')}
                        </p>
                    </div>
                ...
                <div className="bg-white dark:bg-navy-900 rounded-2xl border border-slate-200 dark:border-white/10 p-6">
                    ...
                    <div className="flex gap-3 mb-6">
                        <input
                            ...
                            maxLength={6}
                            placeholder="000000"
                            className="w-40 px-4 py-3 text-center text-xl font-mono tracking-[0.5em] border border-slate-200 dark:border-white/10 rounded-xl bg-white dark:bg-navy-950 text-slate-900 dark:text-white focus:ring-2 focus:ring-purple-500"
                        ...
                        <div className="flex-1 space-y-6">
                            ...
                            <div className="pt-4 border-t border-slate-100 dark:border-white/5">
                                ...
                                <p className="text-sm text-slate-500 mb-3">
                                    {t('security.mfa.verifyDesc', 'Enter the 6-digit code from your authenticator app')}
                                </p>
                                <div className="flex gap-3">
                                    <input
                                        type="text"
            ...
            {step === 'backup' && (
                <div className="bg-white dark:bg-navy-900 rounded-2xl border border-slate-200 dark:border-white/10 p-6">
                    ...
                    <div className="bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-500/30 rounded-xl p-5 mb-6">
                    ...
                    <button
                        ...
                        className="w-full mt-6 py-4 bg-slate-900 dark:bg-white text-white dark:text-navy-900 rounded-xl font-bold transition-colors hover:bg-slate-800 dark:hover:bg-slate-100"
                    >
    ...
    return (
        <div>
            ...
            <div className="flex gap-3">
                <button
                    onClick={onCopyAll}
                    className="flex-1 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5 rounded-lg transition-colors flex items-center justify-center gap-2"
                >
