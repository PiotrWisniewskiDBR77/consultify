        ...
        <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 rounded-lg">
                    ...
                    <div className="flex items-center gap-6 text-sm">
                        <div className="text-center">
                            ...
                            <p className="text-gray-500 text-xs">Zaakceptowane</p>
                        </div>
                        <div className="text-center">
                            <p className="text-lg font-semibold text-red-600">{stats.rejected || 0}</p>
                            <p className="text-gray-500 text-xs">Odrzucone</p>
                        </div>
                        {stats.acceptanceRate !== null && (
                            <div className="text-center">
                                <p className="text-lg font-semibold text-blue-600">{stats.acceptanceRate}%</p>
                                <p className="text-gray-500 text-xs">Akceptacja</p>
                            </div>
                        )}
                    </div>
                </div>
            ...
            {loading && filteredDrafts.length === 0 && (
                <div className="flex items-center justify-center py-8">
                    ...
                    <span className="ml-2 text-gray-500">Ładowanie sugestii...</span>
                </div>
            )}
