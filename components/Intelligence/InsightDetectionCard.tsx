...
export function InsightDetectionCard({ insight, onConfirm, onDismiss, onEdit }: InsightDetectionCardProps) {
    const [expanded, setExpanded] = React.useState(false);

    return (
        <div className="bg-white dark:bg-navy-900 rounded-xl border border-slate-200 dark:border-white/10 shadow-sm overflow-hidden transition-all duration-200 hover:shadow-md">
            {/* Header */}
            ...
            <div className="px-4 pb-3">
                <p className="text-xs text-slate-500 dark:text-slate-400 italic line-clamp-2">"{insight.sourceText}"</p>
            </div>
