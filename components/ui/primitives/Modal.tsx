    ...
    return createPortal(
        <AnimatePresence>
          ...
          `}
                ...
                >
                    {/* Overlay */}
                    <motion.div className="absolute inset-0 bg-black/30 dark:bg-black/50" variants={overlayVariants} />
            ...
            `}
                    ...
                    >
                        ...
                        {/* Footer */}
                        {footer && (
                            <div className="px-6 py-4 bg-slate-50 dark:bg-navy-950 border-t border-slate-200 dark:border-white/10 flex items-center justify-end gap-3">
                                {footer}
                            </div>
                        )}
                    </motion.div>
