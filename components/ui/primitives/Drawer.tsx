...
export const DrawerHeader = React.forwardRef<HTMLDivElement, DrawerHeaderProps>(
    ({ title, description, children, className = '', ...props }, ref) => {
        return (
            <div
                ref={ref}
                className={`px-6 py-4 border-b border-slate-200 dark:border-white/10 ${className}`}
                {...props}
            >
                {title && <h2 className="text-lg font-semibold text-navy-900 dark:text-white pr-8">{title}</h2>}
...
export const DrawerFooter = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
    ({ className = '', children, ...props }, ref) => {
        return (
            <div
                ref={ref}
                className={`px-6 py-4 border-t border-slate-200 dark:border-white/10 flex items-center justify-end gap-3 ${className}`}
                {...props}
            >
                {children}
            </div>
