...
export const LoadingOverlay: React.FC<LoadingOverlayProps> = ({ visible = true, message, blur = true }) => {
...
export const InlineLoader: React.FC<InlineLoaderProps> = ({ loading = false, size = 'sm', text, children }) => {
