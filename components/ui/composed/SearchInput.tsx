      ...
      >
          ...
          <div className="relative">
            ...
            {value && (
              <button
                type="button"
                onClick={handleClear}
                className="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 transition-colors rounded-lg hover:bg-slate-200 dark:hover:bg-white/10"
              >
                <X size={iconSize - 2} />
              </button>
            )}
        ...
        <AnimatePresence>
          {showDropdown && hasDropdownContent && (
            <motion.div
              className="absolute top-full left-0 right-0 mt-2 py-2 bg-white dark:bg-navy-900 rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.12)] dark:shadow-[0_10px_40px_rgba(0,0,0,0.4)] border border-slate-200/50 dark:border-white/10 overflow-hidden z-50"
