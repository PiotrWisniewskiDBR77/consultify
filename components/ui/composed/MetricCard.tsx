...
export const MetricCard = forwardRef<HTMLDivElement, MetricCardProps>(
    (
        ...
        const trend: TrendDirection =
            trendProp ?? (change ? (change > 0 ? 'up' : change < 0 ? 'down' : 'neutral') : 'neutral');
        ...
        return (
            <Card ref={ref} padding="lg" hoverable={!!onClick} onClick={onClick} className={className}>
                <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                        {/* Title */}
                        <p className="text-sm font-medium text-slate-500 dark:text-slate-400 truncate mb-1">{title}</p>
