...
const menuItems: MenuItem[] = [
    ...
    { id: 'organization', labelKey: 'admin.modules.organization', icon: <Building2 size={20} />, separator: 'before' },
    ...
    { id: 'security', labelKey: 'admin.modules.security', icon: <Shield size={20} />, separator: 'before' },
        ...
        >
            ...
            <div className="h-16 border-b border-slate-200 dark:border-white/5 flex items-center px-4 gap-3 relative shrink-0">
                ...
                >
                    ...
                    <div className="text-[10px] text-slate-500 uppercase tracking-widest whitespace-nowrap truncate max-w-[140px]">
