        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                    {t('billing.tax.description', 'Configure your tax ID and billing information for invoices')}
                </p>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2.5 rounded-lg border border-slate-200 dark:border-white/10 bg-white dark:bg-navy-950 text-slate-900 dark:text-white placeholder-slate-400 focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                        />
                    </div>
                </div>
