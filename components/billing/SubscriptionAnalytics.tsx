    ...
    const fetchAllData = async () => {
        ...
        try {
            const [mrrRes, trendRes, churnRes, ltvRes, cohortsRes, expansionRes] = await Promise.all([
                Api.get('/billing/analytics/mrr'),
                Api.get(`/billing/analytics/mrr/trend?days=${selectedPeriod}`),
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <select
                        ...
                        className="px-3 py-1.5 rounded-lg border border-slate-200 dark:border-white/10 bg-white dark:bg-navy-800 text-sm"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-white dark:bg-navy-800 rounded-xl p-5 border border-slate-200 dark:border-white/10">
                    <div className="flex items-center justify-between mb-3">
                        <span className="text-sm font-medium text-slate-500 dark:text-slate-400">Churn Rate</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                {/* Plan Distribution */}
                <div className="bg-white dark:bg-navy-800 rounded-xl p-6 border border-slate-200 dark:border-white/10">
                    <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">Revenue by Plan</h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {/* Churn Analysis */}
                <div className="bg-white dark:bg-navy-800 rounded-xl p-6 border border-slate-200 dark:border-white/10">
                    <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">Churn Analysis</h3>
                ...
                {/* Expansion Revenue */}
                <div className="bg-white dark:bg-navy-800 rounded-xl p-6 border border-slate-200 dark:border-white/10">
                    <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">Expansion Revenue</h3>
                    <div className="overflow-x-auto">
                        <table className="w-full">
                            <thead>
                                <tr className="text-left text-xs text-slate-500 dark:text-slate-400">
            ...
            {/* Cohort Retention */}
            <div className="bg-white dark:bg-navy-800 rounded-xl p-6 border border-slate-200 dark:border-white/10">
                <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">Cohort Retention</h3>
            ...
            {/* LTV Details */}
            <div className="bg-white dark:bg-navy-800 rounded-xl p-6 border border-slate-200 dark:border-white/10">
                <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">Customer Value Metrics</h3>
