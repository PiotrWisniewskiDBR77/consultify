...
export const SubscriptionManager: React.FC<SubscriptionManagerProps> = ({ onPlanChanged }) => {
    ...
    const [discount, setDiscount] = useState<{ valid: boolean; discount?: any; error?: string } | null>(null);
    ...
    const handleValidateDiscount = async () => {
        ...
        try {
            ...
            setDiscount(result);
            if (!result.valid) {
                toast.error(result.error || t('billing.subscription.invalidDiscount', 'Invalid discount code'));
            }
        } catch (error) {
    ...
    return (
        <div className="space-y-8">
            {/* Current Plan Card */}
            {currentPlan && (
                <div className="bg-gradient-to-br from-purple-600 to-indigo-600 rounded-2xl p-6 text-white relative overflow-hidden">
                    ...
                    <div className="bg-white dark:bg-navy-900 rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in-95">
                                ...
                                <div className="flex gap-2">
                                    <div className="relative flex-1">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-slate-200 dark:border-white/10 bg-white dark:bg-navy-950 text-slate-900 dark:text-white placeholder-slate-400 focus:ring-2 focus:ring-purple-500"
                                        />
                                    </div>
                                    <button
                        ...
                        <div className="p-6 pt-0 flex gap-3">
                            <button
                                ...
                                className="flex-1 py-3 rounded-xl border border-slate-200 dark:border-white/10 text-slate-700 dark:text-slate-300 font-medium hover:bg-slate-50 dark:hover:bg-white/5"
                            >
