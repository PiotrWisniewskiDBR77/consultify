                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2 rounded-lg border border-slate-200 dark:border-white/10 bg-white dark:bg-navy-800 text-slate-900 dark:text-white"
                            />
                        </div>
                        <select
                            value={countryFilter}
                                    ...
                                    {filteredRates.map(rate => (
                                        <tr key={rate.id} className="hover:bg-slate-50 dark:hover:bg-white/5">
                                            ...
                                            <td className="px-4 py-3 text-right">
                                                ...
                                                {rate.inclusive && (
                                                    <span className="ml-1 text-xs text-slate-500">(incl.)</span>
                                                )}
                                            </td>
                        ...
                        <div className="md:col-span-2">
                            ...
                            <div className="flex gap-2">
                                <input
                                    ...
                                    className="flex-1 px-3 py-2 rounded-lg border border-slate-200 dark:border-white/10 bg-white dark:bg-navy-800 text-slate-900 dark:text-white font-mono"
                                />
                                <button
                ...
                <div className="bg-white dark:bg-navy-800 rounded-xl border border-slate-200 dark:border-white/10 p-6">
                    ...
                    {calcResult && (
                        <div className="bg-slate-50 dark:bg-navy-900/50 rounded-lg p-4">
                            <h4 className="font-medium text-slate-900 dark:text-white mb-3">Calculation Result</h4>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex gap-3 pt-4">
                        <button
                            type="button"
                            onClick={onClose}
                            className="flex-1 px-4 py-2 rounded-lg border border-slate-200 dark:border-white/10 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-white/5"
                        >
                            Cancel
                        </button>
                        <button
