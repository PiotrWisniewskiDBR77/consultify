                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={3}
                            className="w-full px-4 py-3 bg-slate-50 dark:bg-navy-800 border border-slate-200 
                                dark:border-white/10 rounded-xl focus:ring-2 focus:ring-emerald-500 outline-none resize-none transition-all"
                        />
                    </div>
                    ...
                    <div className="flex gap-3 pt-2">
                        <button
                            type="button"
                            onClick={onClose}
                            className="flex-1 py-3 text-slate-500 hover:text-navy-900 dark:hover:text-white 
