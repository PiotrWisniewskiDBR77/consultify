                    ...
                    <div className="p-4 border-t border-slate-100 dark:border-white/5 space-y-4">
                        <div className="flex gap-2">
                            <input
                                ...
                                disabled={readOnly}
                                className="flex-1 px-3 py-2 bg-slate-50 dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-lg
                    ...
                    {onCalculate && (
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 text-slate-700 dark:text-slate-300 
                                bg-slate-100 dark:bg-navy-700 rounded-lg hover:bg-slate-200 
