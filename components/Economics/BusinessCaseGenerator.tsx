...
export const BusinessCaseGenerator: React.FC<BusinessCaseGeneratorProps> = ({
    ...
    const sectionLabels: Record<keyof GenerationOptions['sections'], { label: string; icon: React.ReactNode }> = {
                            ...
                            <button
                                ...
                                className={`flex-1 py-2 px-3 text-sm font-medium rounded-lg transition-colors ${
                                    options.language === 'pl'
                                        ...
                                        : 'bg-white dark:bg-navy-800 text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-white/10'
                                }`}
                            >
                                🇵🇱 Polski
                            </button>
