...
export const Step3Workspace: React.FC<Step3WorkspaceProps> = ({ profile, sessionData, onStartFullProject }) => {
    return (
                    ...
                    <div className="space-y-3">
                        {sessionData.challengesMap && sessionData.challengesMap.length > 0 ? (
                            sessionData.challengesMap.map((challenge) => (
                                <div
                                    key={challenge.id}
                                    className="p-3 bg-white/5 rounded-lg border border-white/5 flex flex-col gap-2"
                                >
                        ...
                        <div className="space-y-2">
                            {sessionData.constraints && sessionData.constraints.length > 0 ? (
                                sessionData.constraints.map((c) => (
                                    <div
                                        key={c.id}
                                        className="text-sm p-2 bg-white/5 rounded border border-white/5 flex justify-between"
                                    >
