import { Activity, ArrowRight, Clock, DollarSign, Hash, Sliders, TrendingUp } from 'lucide-react';
...
export const FullStep4Workspace: React.FC<FullStep4WorkspaceProps> = ({
    ...
    const economics = fullSession.economics || {
        totalCost: 0,
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-4">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="bg-navy-950/50 border border-white/5 p-3 rounded-xl">
                        ...
                        <div className="text-xl font-bold text-white">${economics.totalCost.toLocaleString()}k</div>
                    </div>
                    ...
                    <div className="bg-navy-950/50 border border-white/5 p-3 rounded-xl">
                        ...
                        <div
                            className={`text-xl font-bold ${economics.overallROI > 100 ? 'text-purple-400' : 'text-white'}`}
                        >
                    ...
                    <div className="bg-navy-950/50 border border-white/5 p-3 rounded-xl">
                        ...
                        <div className="text-xl font-bold text-blue-400">
                            {economics.paybackPeriodYears.toFixed(1)}{' '}
                            <span className="text-xs text-slate-500">{t.summary.years}</span>
                        </div>
                    </div>
                </div>
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody>
                            {initiatives.map((init) => (
                                ...
                                >
                                    <td className="p-3">
                                        <div className="font-medium text-white text-xs">{init.name}</div>
