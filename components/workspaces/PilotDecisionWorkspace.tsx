import { ArrowRight, CheckCircle, Lightbulb, Scale } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white dark:bg-navy-950 rounded-xl border border-slate-200 dark:border-white/5 p-4 shadow-sm">
                        <h3 className="font-bold text-navy-900 dark:text-white mb-4">
                            Pilot Candidates (High Priority)
                        </h3>
                            ...
                            {candidates.map((init) => (
                                ...
                                >
                                    <div className="flex justify-between items-start">
                                        <h4 className="font-semibold text-sm text-navy-900 dark:text-white">
                                            {init.name}
                                        </h4>
                                        {selectedPilotId === init.id && (
                        ...
                        <div className="bg-blue-600/5 border border-blue-600/10 rounded-xl p-4 flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-600 dark:text-slate-300">
                                    ...
                                    <strong>{candidates[0]?.name || 'the top candidate'}</strong> is the optimal pilot.
                                    It offers high visibility with manageable risk.
                                </p>
                            </div>
                        </div>
