            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">
                        {t('settings.ai.models.description', 'Choose and configure AI models for different use cases')}
                    </p>
                </div>
                <button
                    onClick={handleSave}
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-500">Based on average usage patterns</p>
                        </div>
                    </div>
                    <div className="text-right">
                        <p className="text-2xl font-bold text-violet-600">${costEstimate.monthly.toFixed(2)}</p>
                        <p className="text-sm text-slate-500">${costEstimate.daily.toFixed(2)}/day</p>
                    </div>
                </div>
            </div>
                        ...
                        {availableModels.map((model) => (
                            ...
                            >
                                ...
                                <div className="flex items-center gap-4 mt-3 text-xs">
                                    ...
                                    <span className="text-slate-500">${model.costPer1kTokens}/1K tokens</span>
                                </div>
                            </button>
                        ))}
                    </div>
                ...
                <div className="bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-xl p-6 space-y-6">
                    ...
                    <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-navy-950 rounded-lg">
                        <div>
                            ...
                            <p className="text-sm text-slate-500">Show responses as they're generated</p>
                        </div>
                        <button
