            ...
            {activeTab === 'ip' && (
                <div className="bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-xl p-6 space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        {ipRules.length === 0 && (
                            <p className="text-center text-slate-500 py-8">No IP rules configured</p>
                        )}
                    </div>
                </div>
            )}
                ...
                <div className="bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-xl p-6 space-y-6">
                        ...
                        <div className="p-4 border border-purple-200 dark:border-purple-500/30 rounded-lg bg-purple-50 dark:bg-purple-500/5 space-y-4">
                            ...
                            {newQuestion.questionId === 0 && (
                                <input
                                    ...
                                    onChange={(e) => setNewQuestion({ ...newQuestion, customQuestion: e.target.value })}
                    ...
                    <div className="space-y-2">
                        ...
                        {securityQuestions.length === 0 && (
                            <p className="text-center text-slate-500 py-8">No security questions set up</p>
                        )}
                    </div>
                </div>
            )}
                ...
                <div className="bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-xl p-6 space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        {recoveryContacts.length === 0 && (
                            <p className="text-center text-slate-500 py-8">No recovery contacts configured</p>
                        )}
                    </div>
                </div>
            )}
                ...
                <div className="bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-xl p-6 space-y-6">
                    ...
                    <div className="space-y-2 max-h-96 overflow-y-auto">
                        ...
                        {loginLocations.length === 0 && (
                            <p className="text-center text-slate-500 py-8">No login locations recorded</p>
                        )}
                    </div>
                </div>
            )}
                ...
                <div className="bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-xl p-6 space-y-6">
                    ...
                    <div className="space-y-2 max-h-96 overflow-y-auto">
                        ...
                        {suspiciousActivities.length === 0 && (
                            <p className="text-center text-slate-500 py-8">No suspicious activities detected</p>
                        )}
                    </div>
                </div>
            )}
                ...
                <div className="bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-xl p-6 space-y-6">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-navy-950 rounded-lg">
                            <div>
                                <label className="font-medium text-slate-900 dark:text-white">Geolocation Alerts</label>
