...
export const ExportDataSettings: React.FC<ExportDataSettingsProps> = ({ currentUser }) => {
    ...
    const getStatusBadge = (status: ExportRequest['status']) => {
        switch (status) {
            ...
            case 'expired':
                return (
                    <span className="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium rounded-full bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-400">
    ...
    return (
        <div className="space-y-6">
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-base">{t('settings.export.history', 'Export History')}</CardTitle>
                    <CardDescription>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-base">{t('settings.export.whatIncluded', "What's Included")}</CardTitle>
                </CardHeader>
                <CardContent>
