...
export const NotificationSettingsV2: React.FC<NotificationSettingsV2Props> = ({ className = '' }) => {
    ...
    const showSaveSuccess = () => {
        setSaveMessage({ type: 'success', text: t('settings.notifications.saved', 'Preferences saved successfully') });
