...
export const AIParametersSettings: React.FC<AIParametersSettingsProps> = ({ currentUser, onUpdateUser }) => {
    ...
    const [responseSpeed, setResponseSpeed] = useState<'fast' | 'balanced' | 'detailed'>('balanced');
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            setSaveStatus('error');
            toast.error(error.message || t('settings.ai.parameters.error', 'Failed to save AI parameters'));
        } finally {
            setIsSaving(false);
        }
    };
        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400">
                    {t('settings.ai.parameters.subtitle', 'Fine-tune AI behavior and response characteristics')}
                </p>
            </div>
