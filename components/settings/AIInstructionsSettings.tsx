    ...
    <div className={`space-y-6 ${className}`}>
      <div>
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
          {t('settings.ai.instructionsDesc', 'Tell the AI about yourself, your preferences, or how you want responses formatted.')}
        </p>
      </div>
      ...
      <textarea
        ...
        placeholder={t('settings.ai.instructionsPlaceholder', 'e.g., "I prefer concise responses with bullet points. Focus on practical solutions."')}
        rows={6}
