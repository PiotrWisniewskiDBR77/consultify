...
import { AlertTriangle, Check, Copy, Download, Key, Mail, Phone, RefreshCw, Shield } from 'lucide-react';
...
export const RecoveryOptionsSettings: React.FC<RecoveryOptionsSettingsProps> = ({ currentUser }) => {
    ...
    const handleSave = async () => {
        ...
        setSaving(true);
        try {
            const updates = editMode === 'email' ? { recoveryEmail: editValue } : { recoveryPhone: editValue };
    ...
    const handleGenerateBackupCodes = async () => {
        ...
        try {
            ...
            toast({
                ...
                description: t('settings.recovery.codesGeneratedDesc', 'Save these codes in a secure location'),
            });
        } catch (error) {
        ...
        <div className="space-y-6">
            ...
            >
                ...
                >
                    {recoveryScore === 3
                        ...
                        : t('settings.recovery.statusImprove', 'Add more recovery options to secure your account')}
                </AlertDescription>
            </Alert>
                ...
                <CardContent>
                    {editMode === 'email' ? (
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            >
                                {recoveryOptions.recoveryEmail ? t('common.change', 'Change') : t('common.add', 'Add')}
                            </Button>
                        </div>
                    )}
                </CardContent>
                ...
                <CardContent>
                    {editMode === 'phone' ? (
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            >
                                {recoveryOptions.recoveryPhone ? t('common.change', 'Change') : t('common.add', 'Add')}
                            </Button>
                        </div>
                    )}
                </CardContent>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <CardDescription>
                                    {t('settings.recovery.backupCodesDesc', 'One-time use codes for account recovery')}
                                </CardDescription>
                            </div>
                        </div>
            ...
            <Dialog open={showBackupCodes} onOpenChange={setShowBackupCodes}>
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        <DialogTitle>{t('settings.recovery.backupCodesTitle', 'Your Backup Codes')}</DialogTitle>
                        <DialogDescription>
                            {t(
