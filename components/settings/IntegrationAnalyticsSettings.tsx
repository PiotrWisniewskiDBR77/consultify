                ...
                <div className="flex items-center gap-2">
                    ...
                    {logs.length > 0 && (
                        <button
                            ...
                            disabled={exporting}
                            className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-brand border border-slate-200 dark:border-white/10 rounded-lg hover:bg-slate-100 dark:hover:bg-navy-700 transition-colors disabled:opacity-50"
                        >
                ...
                <>
                    ...
                    {metrics.length > 0 && (
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            {/* Requests Over Time */}
                            <div className="p-6 bg-white dark:bg-navy-900 rounded-lg border border-slate-200 dark:border-white/10">
                            ...
                            {/* Success vs Failures */}
                            <div className="p-6 bg-white dark:bg-navy-900 rounded-lg border border-slate-200 dark:border-white/10 lg:col-span-2">
                                <h4 className="text-sm font-semibold text-slate-900 dark:text-white mb-4">
                    ...
                    {/* Logs Table */}
                    <div className="bg-white dark:bg-navy-900 rounded-lg border border-slate-200 dark:border-white/10">
                        <div className="p-4 border-b border-slate-200 dark:border-white/10 flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <select
                                    ...
                                    className="text-xs px-2 py-1 bg-slate-50 dark:bg-navy-800 border border-slate-200 dark:border-white/10 rounded text-slate-900 dark:text-white"
                                >
                                    <option value="all">{t('settings.analytics.filterAll', 'All')}</option>
                                    <option value="success">{t('settings.analytics.filterSuccess', 'Success')}</option>
