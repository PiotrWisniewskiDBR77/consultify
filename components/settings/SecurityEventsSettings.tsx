...
export const SecurityEventsSettings: React.FC<SecurityEventsSettingsProps> = ({ currentUser, className = '' }) => {
    ...
    return (
        <div className={`space-y-6 ${className}`}>
            ...
            {showAlertSettings && (
                <div className="bg-white dark:bg-navy-900 rounded-xl border border-slate-200 dark:border-white/10 p-6 animate-in slide-in-from-top-2 duration-300">
            ...
            <div className="flex items-center gap-3 flex-wrap">
                <div className="relative flex-1 min-w-[200px]">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-lg text-slate-900 dark:text-white placeholder-slate-400 focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    />
                </div>
                <div className="relative">
                    <button
                        onClick={() => setShowFilterDropdown(!showFilterDropdown)}
                        className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-lg hover:border-purple-300 dark:hover:border-purple-500/50 transition-colors"
                    >
            ...
            {loading ? (
                ...
                <div className="bg-white dark:bg-navy-900 rounded-xl border border-slate-200 dark:border-white/10 p-12 text-center">
