...
export const PasswordSecuritySettings: React.FC<PasswordSecuritySettingsProps> = ({ currentUser }) => {
    ...
    const getDeviceIcon = (deviceInfo: string) => {
        ...
        if (info.includes('mobile') || info.includes('iphone') || info.includes('android')) return Smartphone;
        return Monitor;
    };
            ...
            <div className={sectionClass}>
                ...
                {expandedSections.sessions && (
                    <div className="border-t border-slate-100 dark:border-white/5">
                        {sessions.length > 1 && (
                            <div className="p-4 border-b border-slate-100 dark:border-white/5 flex justify-end">
                                <button
