...
export const EmailSignaturesSettings: React.FC<EmailSignaturesSettingsProps> = ({ currentUser }) => {
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogContent className="sm:max-w-lg">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {t('settings.signatures.dialogDesc', 'This signature will be available for use in emails')}
                        </DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4 py-4">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="content">{t('settings.signatures.content', 'Signature Content')}</Label>
                            <Textarea
                                id="content"
