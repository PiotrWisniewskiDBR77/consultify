        ...
        <div className={`space-y-6 ${className}`}>
            ...
            {(testResults.stt !== null || testResults.tts !== null) && (
                <div className="flex gap-4 p-3 bg-slate-50 dark:bg-white/5 rounded-lg">
                    <div className="flex items-center gap-2">
                        ...
                        {testResults.stt === false && <XCircle size={16} className="text-red-500" />}
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {testResults.tts === false && <XCircle size={16} className="text-red-500" />}
            ...
            <div className="space-y-3">
                ...
                <select
                    ...
                    className="w-full px-3 py-2 border border-slate-200 dark:border-white/10 rounded-lg bg-white dark:bg-navy-900 text-slate-700 dark:text-slate-300"
                >
