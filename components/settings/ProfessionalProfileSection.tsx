...
export const ProfessionalProfileSection: React.FC<ProfessionalProfileSectionProps> = ({
    ...
    const [certifications, setCertifications] = useState<Certification[]>(currentUser.certifications || []);
            ...
            <div className="bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-xl p-6">
                ...
                <div className="flex gap-2">
                    <input
                        ...
                        className="flex-1 px-4 py-2 bg-slate-50 dark:bg-navy-950/50 border border-slate-200 dark:border-white/10 rounded-lg text-slate-900 dark:text-white focus:ring-2 focus:ring-purple-500/50 outline-none"
                    />
                    <button
                        onClick={addSkill}
            ...
            <div className="p-4 border border-purple-200 dark:border-purple-500/30 rounded-lg bg-purple-50 dark:bg-purple-500/5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <textarea
                        ...
                        rows={3}
                        className="md:col-span-2 px-3 py-2 bg-white dark:bg-navy-950 border border-slate-200 dark:border-white/10 rounded-lg resize-none"
                    />
                </div>
                <div className="flex gap-2 mt-4">
        ...
        <div className="p-4 border border-slate-200 dark:border-white/10 rounded-lg hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
            <div className="flex items-start justify-between">
                <div className="flex-1">
                    ...
                    {edu.fieldOfStudy && <p className="text-xs text-slate-500 mt-1">{edu.fieldOfStudy}</p>}
                    <div className="flex gap-4 mt-2 text-xs text-slate-500">
        ...
        <div className="p-4 border border-slate-200 dark:border-white/10 rounded-lg hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
            <div className="flex items-start justify-between">
                <div className="flex-1">
                    ...
                    {work.location && <p className="text-xs text-slate-500 mt-1">{work.location}</p>}
                    <div className="flex gap-4 mt-2 text-xs text-slate-500">
