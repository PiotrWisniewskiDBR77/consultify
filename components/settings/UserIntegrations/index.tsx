...
import { AlertCircle, Check, CheckCircle2, Database, Loader2, MessageSquare, Plug, RefreshCw } from 'lucide-react';
...
export const UserIntegrations: React.FC<UserIntegrationsProps> = ({ className = '' }) => {
    ...
    const { integrations, providers, connectedCount, loading, error, connect, disconnect, testConnection, refresh } =
        useUserIntegrations();
