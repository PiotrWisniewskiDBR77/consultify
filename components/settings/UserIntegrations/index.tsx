...
import { 
    Plug, Loader2, AlertCircle, RefreshCw, Check,
        ...
        <div className={`space-y-6 ${className}`}>
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-slate-500 dark:text-slate-400 mt-1">
                            {t('settings.integrations.description', 'Connect your personal accounts to receive notifications and sync data.')}
                        </p>
                    </div>
                    <button
                        onClick={refresh}
            ...
            <div className="text-sm text-slate-500 dark:text-slate-400 bg-slate-50 dark:bg-navy-800/50 rounded-lg p-4">
                ...
                <ul className="list-disc list-inside space-y-1">
                    <li>{t('settings.integrations.notePersonal', 'These are your personal connections. Each team member sets up their own.')}</li>
                    <li>{t('settings.integrations.noteOAuth', 'We use secure OAuth to connect. We never store your passwords.')}</li>
                    <li>{t('settings.integrations.noteRevoke', 'You can revoke access at any time from here or from the provider\'s settings.')}</li>
                </ul>
            </div>
        </div>
    );
