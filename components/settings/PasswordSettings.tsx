      ...
      <form onSubmit={handleSubmit} className="space-y-4 max-w-md">
        ...
        <div>
          ...
          {confirmPassword && !passwordsMatch && (
            <p className="text-sm text-red-500 mt-1">{t('settings.password.mismatch', 'Passwords do not match')}</p>
          )}
        </div>
        ...
        >
          {loading ? t('common.saving', 'Saving...') : t('settings.password.update', 'Update Password')}
        </button>
      </form>
    </div>
  );
