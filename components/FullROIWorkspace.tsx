import { Activity, ArrowRight, DollarSign, FileText, Layers, PieChart, TrendingUp } from 'lucide-react';
    ...
    const renderCostStructure = () => (
        <div className="p-10 text-center bg-navy-900 border border-white/10 rounded-xl">
            ...
            <p className="text-slate-500 max-w-md mx-auto">
                Model breaking down Capex (One-off) vs Opex (Recurring) for each initiative. (Placeholder for Cost
                Modeling Tool)
            </p>
        </div>
    );
        ...
        <div className="bg-white text-navy-900 p-8 rounded-xl shadow-2xl max-w-4xl mx-auto">
            ...
            <div className="space-y-4 mb-8">
                ...
                <p className="text-slate-700 leading-relaxed">
                    The proposed transformation program delivers immediate operational efficiencies while positioning
                    the organization for long-term growth. With a payback period of{' '}
                    <strong>{economics.paybackPeriodYears.toFixed(1)} years</strong>, the initiative is self-funding
                    within the strategic horizon. Key value drivers include process automation (40%), data monetization
                    (30%), and legacy cost reduction (30%).
                </p>
            </div>
