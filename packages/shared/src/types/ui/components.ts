...
import { ChangeEvent, FocusEvent, KeyboardEvent, MouseEvent, ReactNode } from 'react';
...
export type ColorVariant = 'primary' | 'secondary' | 'success' | 'warning' | 'danger' | 'info' | 'neutral';
