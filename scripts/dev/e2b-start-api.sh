#!/usr/bin/env bash
# E2 — lokalne API na kopii bazy consultify_kopia_e2b (nigdy na zywej bazie)
set -euo pipefail
cd "$(dirname "$0")/../.."
set -a
...
export DATABASE_URL="postgres://postgres:postgres@127.0.0.1:54418/consultify_kopia_e2b"
...
export PORT="${E2B_PORT:-4224}"
export CAPABILITY_ENFORCE="${E2B_CAPABILITY_ENFORCE:-shadow}"
