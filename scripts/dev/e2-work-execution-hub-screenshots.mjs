...
await warmPage.goto(`${base}/execution-work-analysis.html?report=work&state=ready&lang=en&theme=light`, {
...
for (const variant of [
  { language: 'en', theme: 'light', file: 'work-analysis-light.png' },
  { language: 'en', theme: 'dark', file: 'work-analysis-en-dark.png' },
  { language: 'pl', theme: 'dark', file: 'work-analysis-dark.png' },
]) {
  ...
  await page.goto(
    `${base}/execution-work-analysis.html?report=work-shell&state=ready&lang=${variant.language}&theme=${variant.theme}`,
