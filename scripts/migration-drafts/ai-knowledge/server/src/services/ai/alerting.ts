...
class AlertingService {
     ...
     */
    logToConsole(alert) {
        const logMethod = alert.severity === SEVERITY.CRITICAL || alert.severity === SEVERITY.ERROR
            ? 'error'
    ...
    getSeverityColor(severity) {
        switch (severity) {
            ...
            case SEVERITY.ERROR: return '#fd7e14';    // Orange
            case SEVERITY.WARNING: return '#ffc107';  // Yellow
            case SEVERITY.INFO: return '#17a2b8';     // Blue
