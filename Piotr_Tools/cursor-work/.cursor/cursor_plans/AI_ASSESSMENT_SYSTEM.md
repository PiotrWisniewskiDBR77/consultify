...
const AI_PARTNER_CONFIG = {
  ...
  blocked: ['JUMP_TO_CONCLUSION', 'SUMMARIZE_PREMATURELY', 'SUGGEST_SOLUTION', 'EVALUATE_ANSWERS'],
...
```tsx
const { workflowStatus, reviews, versions, submitForReview, approve, reject, restoreVersion } =
