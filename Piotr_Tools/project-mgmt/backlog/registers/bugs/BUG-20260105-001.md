...
Panel Admin pokazuje "undefined undefined" w sekcji Billing Name

### Kategoria

- [x] 🎨 UI/UX & Frontend (wyświetlanie, interakcja)
...
- [x] 📈 **P2 - Średni** (utrudnia pracę, obejścia dostępne)
...
- [x] **S3 - Minor** (drobne błędy, obejścia dostępne)
