...
- Naprawiono 19 etykiet w toolCompletion.ts: 2 kształtu A oraz 17 kształtu B.
- Kształt A: Portfolio mission -> Misja portfela i kontekst; Risk mission -> Misja i kontekst.
- Kształt B: nazwy misji, elementów portfela oraz stanów final source summary zastąpiono nazwami wyprowadzonymi z title.pl odpowiednich paczek. Hybrydy w badanym pliku spadły z 34 do 17.
