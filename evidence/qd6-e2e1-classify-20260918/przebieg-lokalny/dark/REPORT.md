# E2E-1 krok 2 — admin-nw-northwind-admin-en-dark
...
- Classes: PRODUCT 13 · CONTRACT 32 · ENV 2
...
| 04-tools | kebab | Row actions | PASS | — | — | screenshots/04-tools-kebab-row-actions-48.png | — |
...
| 04-tools | ai | Teresa | PASS | — | — | screenshots/04-tools-ai-teresa-5.png | — |
...
| 05-assessment | kebab | Row actions | PASS | — | — | screenshots/05-assessment-kebab-row-actions-21.png | — |
| 05-assessment | kebab | Row actions | PASS | — | — | screenshots/05-assessment-kebab-row-actions-23.png | — |
| 05-assessment | kebab | Row actions | PASS | — | — | screenshots/05-assessment-kebab-row-actions-25.png | — |
| 05-assessment | kebab | Row actions | PASS | — | — | screenshots/05-assessment-kebab-row-actions-27.png | — |
| 05-assessment | kebab | Row actions | PASS | — | — | screenshots/05-assessment-kebab-row-actions-29.png | — |
| 05-assessment | right-panel | first-row | PASS | — | — | screenshots/05-assessment-right-panel-first-row.png | — |
| 05-assessment | create | Add files | FAIL | CONTRACT | control not interactable within the harness budget and the app reported no error | screenshots/05-assessment-create-add-files-34.png | — |
...
| 06-audits | kebab | Row actions | PASS | — | — | screenshots/06-audits-kebab-row-actions-24.png | — |
...
| 07-initiatives | kebab | Row actions | PASS | — | — | screenshots/07-initiatives-kebab-row-actions-38.png | — |
...
| 08-projects | create | Triage all new items for me | BLOCKED | PRODUCT | a view attempted a domain write (blocked before network) | screenshots/08-projects-create-triage-all-new-items-for-me-32.png | WebSocket connection to 'ws://127.0.0.1:5430/socket.io/?EIO=4&transport=websocket' failed: Error during WebSocket handshake: net::ERR_NETWORK_IO_SUSPENDED; [ConversationStore] Create error: TypeError: Failed to fetch     at window.fetch (http://127.0.0.1:5430/src/services/globalAuthFetchGuard.ts:34:28)     at window.fetch (http://127.0.0.1:5430/src/services/feedbackCollector/NetworkBuffer.ts:43:32)     at window.fetch (http://127.0.0.1:5430/src/service; [UnifiedChatPanel] Failed to create conversation: TypeError: Failed to fetch     at window.fetch (http://127.0.0.1:5430/src/services/globalAuthFetchGuard.ts:34:28)     at window.fetch (http://127.0.0.1:5430/src/services/feedbackCollector/NetworkBuffer.ts:43:32)     at window.fetch (http://127.0.0.1: |
| 08-projects | ai | none | MISSING | CONTRACT | surface absent; single-variant evidence cannot separate a stale selector from a missing feature | screenshots/08-projects-ai-missing.png | — |
| 09-execution | menu1 | /execution | PASS | — | — | screenshots/09-execution-menu1-execution.png | Failed to load resource: net::ERR_NAME_NOT_RESOLVED; Failed to load resource: net::ERR_NAME_NOT_RESOLVED |
| 09-execution | menu2 | none | MISSING | ENV | the browser never reached a server: Failed to load resource: net::ERR_INTERNET_DISCONNECTED | screenshots/09-execution-menu2-missing.png | Failed to load resource: net::ERR_INTERNET_DISCONNECTED; Failed to load resource: net::ERR_INTERNET_DISCONNECTED |
| 09-execution | menu3 | Teresa | PASS | — | — | screenshots/09-execution-menu3-teresa-1.png | Failed to load resource: net::ERR_INTERNET_DISCONNECTED; Failed to load resource: net::ERR_INTERNET_DISCONNECTED; Failed to load resource: net::ERR_INTERNET_DISCONNECTED; Failed to load resource: net::ERR_INTERNET_DISCONNECTED |
...
| 09-execution | right-panel | first-row | FAIL | ENV | the browser never reached a server: Failed to load resource: net::ERR_INTERNET_DISCONNECTED | screenshots/09-execution-right-panel-first-row.png | Failed to load resource: net::ERR_INTERNET_DISCONNECTED; Failed to load resource: net::ERR_INTERNET_DISCONNECTED; Failed to load resource: net::ERR_INTERNET_DISCONNECTED; Failed to load resource: net::ERR_INTERNET_DISCONNECTED |
...
| 09-execution | ai | Teresa | PASS | — | — | screenshots/09-execution-ai-teresa-5.png | Failed to load resource: net::ERR_INTERNET_DISCONNECTED; Failed to load resource: net::ERR_INTERNET_DISCONNECTED; Failed to load resource: net::ERR_INTERNET_DISCONNECTED; Failed to load resource: net::ERR_INTERNET_DISCONNECTED |
| 10-results | menu1 | /results/kpi | PASS | — | — | screenshots/10-results-menu1-results-kpi.png | Failed to load resource: net::ERR_INTERNET_DISCONNECTED; Failed to load resource: net::ERR_INTERNET_DISCONNECTED |
| 10-results | menu2 | KPI | PASS | — | — | screenshots/10-results-menu2-kpi-1.png | Failed to load resource: net::ERR_INTERNET_DISCONNECTED; Failed to load resource: net::ERR_INTERNET_DISCONNECTED; Failed to load resource: net::ERR_INTERNET_DISCONNECTED; Failed to load resource: net::ERR_INTERNET_DISCONNECTED |
...
| --- | --- | --- | --- | --- |
| 01-chat | 13 | 13/13 | — | 2483 |
| 02-my-work | 8 | 8/8 | — | 2718 |
| 03-interview | 14 | 14/14 | — | 2819 |
| 04-tools | 49 | 49/49 | — | 2978 |
| 05-assessment | 18 | 18/18 | — | 3076 |
| 06-audits | 17 | 17/17 | — | 2230 |
| 07-initiatives | 22 | 22/22 | — | 2603 |
| 08-projects | 8 | 8/8 | — | 551163 |
| 09-execution | 8 | 8/8 | — | 1019140 |
| 10-results | 14 | 14/14 | — | 474624 |
| 11-materials | 16 | 16/16 | — | 2088 |
| 12-meeting | 9 | 9/9 | — | 2372 |
| 13-organization | 16 | 16/16 | — | 3121 |
| 14-admin | 16 | 16/16 | — | 2415 |
| 15-settings | 7 | 7/7 | — | 1913 |
| 16-partners | 9 | 9/9 | — | 1951 |
