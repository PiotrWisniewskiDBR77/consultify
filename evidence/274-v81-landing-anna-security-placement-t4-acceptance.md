# V8.1 Evidence - Landing Anna security placement T4 Acceptance
...
The bounded `Landing Anna security placement` packet is accepted.

## What is now true

1. `SecurityView` exposes `AnnaAssistantWidget`
...
1. pricing-page Anna placement remains separate residual scope
