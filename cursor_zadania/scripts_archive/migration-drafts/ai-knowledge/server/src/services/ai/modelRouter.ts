 ...
 * Source: server/services/ai/modelRouter.js
 * Target: server/src/services/ai/modelRouter.ts
 * Status: wrapper
 *
 * TODO:
...
class ModelRouter {
    ...
    async getDefaultProvider() {
        ...
        return new Promise((resolve) => {
            db.get('SELECT * FROM llm_providers WHERE is_default = 1 AND is_active = 1 LIMIT 1', [], (err, row) => {
                if (row) {
