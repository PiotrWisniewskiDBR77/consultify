 ...
 * Source: server/services/ai/logger.js
 * Target: server/src/services/ai/logger.ts
 * Status: wrapper
 *
 * TODO:
...
const aiLogger = {
    ...
    startSpan(operationName, attributes = {}) {
        ...
        const context = new TraceContext(parentContext?.traceId, TraceContext.generateSpanId(), parentContext?.spanId);
