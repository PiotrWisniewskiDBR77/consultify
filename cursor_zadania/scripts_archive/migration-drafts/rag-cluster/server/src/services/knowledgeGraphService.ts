...
const KnowledgeGraphService = {
    ...
    initialize: async () => {
        return new Promise((resolve, reject) => {
            ...
            KnowledgeGraphService.loadGraphCache().then(resolve).catch(reject);
        });
    },
        ...
        return new Promise((resolve, reject) => {
            ...
            db.all('SELECT * FROM kg_nodes', [], (err, nodes) => {
                ...
                db.all('SELECT * FROM kg_edges', [], (err, edges) => {
                    ...
                    console.log(
                        `[KnowledgeGraph] Loaded ${graphCache.nodes.size} nodes, ${graphCache.edges.size} edges`,
                    );
                    resolve();
                });
            });
    ...
    findNode: async (name) => {
        ...
        for (const [id, node] of graphCache.nodes) {
            if (node.name.toLowerCase().includes(nameLower) || nameLower.includes(node.name.toLowerCase())) {
                return node;
            }
        }
    ...
    seedDefaultKnowledge: async () => {
        const concepts = [
            ...
            },
            {
                name: 'Six Sigma',
                type: NODE_TYPES.METHODOLOGY,
                description: 'Data-driven approach to eliminating defects',
            },
            ...
            // Digital Transformation Concepts
            {
                ...
                description: 'Integration of digital technology into all business areas',
            },
            {
                name: 'Cloud Computing',
                type: NODE_TYPES.CONCEPT,
                description: 'On-demand availability of computer resources',
            },
            {
            ...
            { name: 'Machine Learning', type: NODE_TYPES.CONCEPT, description: 'AI systems that learn from data' },
            {
                name: 'Data Analytics',
                type: NODE_TYPES.CONCEPT,
                description: 'Analysis of data for insights and decisions',
            },
            {
                name: 'Automation',
                type: NODE_TYPES.CONCEPT,
                description: 'Technology to perform tasks with minimal human intervention',
            },
            {
                name: 'IoT',
                type: NODE_TYPES.CONCEPT,
                description: 'Internet of Things - connected devices and sensors',
            },
            ...
            // Change Management
            {
                name: 'ADKAR',
                type: NODE_TYPES.FRAMEWORK,
                description: 'Change management model: Awareness, Desire, Knowledge, Ability, Reinforcement',
            },
            { name: 'Kotter 8 Steps', type: NODE_TYPES.FRAMEWORK, description: "Kotter's 8-step change model" },
            {
                name: 'Change Readiness',
                type: NODE_TYPES.CONCEPT,
                description: 'Organization capacity to adopt change',
            },
            {
                name: 'Stakeholder Management',
                type: NODE_TYPES.PRACTICE,
                description: 'Managing stakeholder expectations and engagement',
            },
            ...
            // Strategy
            {
                ...
                type: NODE_TYPES.PRACTICE,
                description: 'Process of defining strategy and direction',
            },
            {
                name: 'SWOT Analysis',
            ...
            },
            {
                ...
                type: NODE_TYPES.FRAMEWORK,
                description: 'Framework for industry analysis',
            },
            {
            ...
            },
            {
                name: 'OKRs',
                type: NODE_TYPES.FRAMEWORK,
                description: 'Objectives and Key Results goal-setting framework',
            },
            {
                name: 'Balanced Scorecard',
                type: NODE_TYPES.FRAMEWORK,
                description: 'Strategic performance management tool',
            },
