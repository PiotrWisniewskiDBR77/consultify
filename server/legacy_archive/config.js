...
export const GOOGLE_CALLBACK_URL =
  validatedConfig.GOOGLE_CALLBACK_URL || 'http://localhost:3005/api/auth/google/callback';
...
export const LINKEDIN_CALLBACK_URL =
  validatedConfig.LINKEDIN_CALLBACK_URL || 'http://localhost:3005/api/auth/linkedin/callback';
...
export const MICROSOFT_CALLBACK_URL =
  validatedConfig.MICROSOFT_CALLBACK_URL || 'http://localhost:3005/api/auth/microsoft/callback';
