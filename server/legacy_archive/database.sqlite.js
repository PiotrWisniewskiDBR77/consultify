...
const GLOBAL_KEY = '__CONSULTINITY_SQLITE_INSTANCE__';
...
export function initDb(db) {
    db.serialize(() => {
        ...
        db.run(`CREATE TABLE IF NOT EXISTS rapid_lean_assessments (
            ...
            value_stream_score REAL,
            waste_elimination_score REAL,
            flow_pull_score REAL,
            quality_source_score REAL,
            continuous_improvement_score REAL,
            visual_management_score REAL,
            overall_score REAL,
