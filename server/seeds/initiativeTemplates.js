...
const DEFAULT_TEMPLATES = [
  // ============= DATA Category =============
  {
    ...
    category: 'DATA',
    description:
      'Implement a centralized master data management platform to ensure data quality, consistency, and governance across the organization.',
    applicableAxes: ['dataManagement'],
    templateData: {
      problemStructured: {
        symptom:
          'Inconsistent and duplicated data across systems leading to reporting errors and poor decision-making',
        rootCause:
          'Lack of centralized data governance and fragmented data storage across multiple legacy systems',
        costOfInaction:
          'Estimated 15-20% efficiency loss due to data reconciliation efforts and delayed decision cycles',
      },
      targetState: {
        process: [
  ...
  },
  {
    ...
    category: 'DATA',
    description:
      'Build a modern data lake architecture to centralize data storage, enable advanced analytics, and support AI/ML initiatives.',
    applicableAxes: ['dataManagement', 'aiMaturity'],
    templateData: {
      problemStructured: {
        symptom:
          'Inability to leverage data for advanced analytics and AI due to siloed data storage',
        rootCause:
          'Legacy data warehouse architecture that cannot scale or handle unstructured data',
        costOfInaction:
          'Missing competitive insights and ML opportunities worth estimated 5-10% revenue improvement',
      },
      targetState: {
        process: [
        ...
        capability: ['Cloud-native data lake operational', 'ML/AI-ready data pipelines'],
      },
      killCriteria: [
      ...
      suggestedTasks: [
        ...
        {
          title: 'Security & Governance Setup',
          taskType: 'BUILD',
          priority: 'high',
          estimatedHours: 80,
          stepPhase: 'pilot',
        ...
        {
          title: 'Analytics Layer Implementation',
          taskType: 'BUILD',
          priority: 'medium',
          estimatedHours: 120,
          stepPhase: 'rollout',
  ...
  // ============= PROCESS Category =============
  {
    ...
    category: 'PROCESS',
    description:
      'Automate key business processes using RPA, workflow engines, and intelligent automation to improve efficiency and reduce errors.',
  ...
  },
  {
    ...
    category: 'PROCESS',
    description:
      'Modernize or replace legacy ERP systems to improve business process efficiency, enable real-time insights, and reduce technical debt.',
    ...
    templateData: {
      problemStructured: {
        ...
        costOfInaction:
          'Increasing maintenance costs, security risks, and inability to support business growth',
      },
      targetState: {
        process: ['Streamlined end-to-end business processes', 'Real-time operational visibility'],
        behavior: ['Users adopt standard processes', 'Finance closes books in 3 days vs 10'],
        capability: ['Modern cloud ERP operational', 'Integration layer connecting all systems'],
      },
      killCriteria: [
  ...
  // ============= PRODUCT Category =============
  {
    ...
    category: 'PRODUCT',
    description:
      'Launch a new digital product or service from ideation through go-to-market, using agile methodologies and lean startup principles.',
    ...
    templateData: {
      problemStructured: {
        ...
        costOfInaction:
          'Competitors capturing digital market share, estimated 10-15% revenue at risk',
      },
      targetState: {
        process: ['Agile product development cycles', 'Continuous customer feedback loops'],
        behavior: ['Product team operates autonomously', 'Data-driven decision making'],
        capability: ['MVP launched with paying customers', 'Product-market fit validated'],
      },
      killCriteria: [
  ...
  },
  {
    ...
    category: 'PRODUCT',
    description:
      'Build a self-service customer portal to improve customer experience, reduce support costs, and increase engagement.',
    ...
    templateData: {
      ...
      targetState: {
        process: ['70% of inquiries resolved via self-service', 'Omnichannel customer experience'],
        behavior: [
          'Customers prefer self-service for routine tasks',
          'Support focuses on complex issues',
        ],
        capability: ['Modern customer portal live', 'Integrated with backend systems'],
      },
      killCriteria: [
  ...
  // ============= CULTURE Category =============
  {
    ...
    category: 'CULTURE',
    description:
      'Comprehensive change management program to drive digital adoption, build digital skills, and shift organizational culture.',
    ...
    templateData: {
      ...
      targetState: {
        ...
        behavior: ['Leaders champion digital transformation', 'Teams embrace continuous learning'],
        capability: [
  ...
  },
  {
    ...
    category: 'CULTURE',
    description:
      'Establish an internal digital skills academy to upskill workforce, reduce skill gaps, and build sustainable digital capabilities.',
    ...
    templateData: {
      ...
      targetState: {
        process: ['Learning paths for all digital roles', 'Regular skill assessments'],
        behavior: ['Continuous learning is part of culture', 'Knowledge sharing is rewarded'],
        capability: ['Digital academy platform operational', '30% of workforce upskilled'],
      },
      killCriteria: [
  ...
  // ============= SECURITY Category =============
  {
    ...
    category: 'SECURITY',
    description:
      'Implement a Zero Trust security model to protect digital assets, reduce attack surface, and ensure compliance.',
    ...
    templateData: {
      ...
      targetState: {
        process: ['Every access request verified', 'Continuous monitoring and response'],
        behavior: [
          'Security-first mindset across organization',
          'Least privilege access by default',
        ],
        capability: ['Zero Trust architecture deployed', 'SOC operational 24/7'],
      },
      killCriteria: [
  ...
  },
  {
    ...
    category: 'SECURITY',
    description:
      'Upgrade Security Information and Event Management (SIEM) capabilities and establish or enhance Security Operations Center.',
    applicableAxes: ['cybersecurity'],
    templateData: {
      problemStructured: {
      ...
      targetState: {
        process: ['Real-time threat detection', 'Automated incident response for common threats'],
        behavior: ['Proactive threat hunting', 'Continuous security improvement'],
        capability: ['Modern SIEM platform operational', 'SOC team trained and effective'],
      },
      killCriteria: [
      ...
      suggestedTasks: [
        ...
        {
          title: 'SOC Process Implementation',
          taskType: 'BUILD',
          priority: 'high',
          estimatedHours: 60,
          stepPhase: 'rollout',
  ...
  // ============= AI_ML Category =============
  {
    ...
    category: 'AI_ML',
    description:
      'Launch an AI pilot program to prove value, build capabilities, and establish foundations for AI at scale.',
    ...
    templateData: {
      ...
      targetState: {
        ...
        capability: ['2-3 AI models in production', 'Internal AI team established'],
      },
      killCriteria: [
  ...
  },
  {
    ...
    category: 'AI_ML',
    description:
      'Establish MLOps practices and platform to operationalize machine learning models at scale with proper governance.',
    applicableAxes: ['aiMaturity', 'processes'],
    templateData: {
      problemStructured: {
        symptom: 'ML models stuck in notebooks, not making it to production',
        rootCause:
          'Lack of MLOps practices, tools, and collaboration between data science and engineering',
      ...
      targetState: {
        ...
        capability: ['MLOps platform operational', 'Model registry and versioning in place'],
      },
      killCriteria: [
      ...
      suggestedTasks: [
        {
          title: 'Current ML Workflow Assessment',
          taskType: 'ANALYSIS',
          priority: 'high',
          estimatedHours: 40,
          stepPhase: 'design',
