...
const mockBilling = {
    ...
    getOrgBalance: function () { return Promise.resolve({ balance: 1000, billingStatus: 'ACTIVE', organizationType: 'PAID' }); },
    hasOrgSufficientBalance: function () { return Promise.resolve({ allowed: true, balance: 1000 }); }
};
