...
const { QualityChecker, QUALITY_THRESHOLDS } = require('./qualityChecker');
...
The assessment reveals several important insights.`;
    ...
    describe('checkLanguageQuality()', () => {
        ...
        it('should flag placeholder text', () => {
            const content = 'The result is [TODO: add value here] and we need to FIXME the calculation.';

            const result = checker.checkLanguageQuality(content);

            expect(result.issues).toContain('Contains placeholder text');
        });
