...
import AICostControlService from './aiCostControlService.js';
import CircuitBreakerService from './circuitBreakerService.js';
import { GoogleGenerativeAI } from '@google/generative-ai';
import { aiResponsePostProcessor } from './aiResponsePostProcessor.js';
import { createAIQueueService } from './ai/legacy/aiQueueService.js';
import { createAILLMService } from './ai/legacy/aiLLMService.js';
...
const aiQueueService = createAIQueueService({ deps });
const aiLLMService = createAILLMService({ deps, AccessPolicyService });
...
const AiService = {
    ...
    // --- ASYNC QUEUE SUPPORT ---
    queueTask: aiQueueService.queueTask,
    getJobStatus: aiQueueService.getJobStatus,

    // --- CORE LLM INTERACTION ---
    callLLM: aiLLMService.callLLM,
    streamLLM: aiLLMService.streamLLM,
...
- description: 2 sentences(pros / cons).
    ...
    testProviderConnection: aiLLMService.testProviderConnection,
