...
export class SuperAdminController {
     ...
     * Update organization
     */
    static updateOrganization = asyncHandler(async (req: AuthenticatedRequest<UpdateOrganizationAdminRequest>, res: Response): Promise<void> => {
        const { id } = req.params;
     ...
     * Update user
     */
    static updateUser = asyncHandler(async (req: AuthenticatedRequest<UpdateUserAdminRequest>, res: Response): Promise<void> => {
        const { id } = req.params;
