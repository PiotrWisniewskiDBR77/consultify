...
export class PMOAnalysisController {
     ...
     */
    static getProjectAnalysis = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> => {
     ...
     */
    static getProjectProgress = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> => {
        const { projectId } = req.params;
        const orgId = req.user?.organizationId;
     ...
     */
    static getProjectDependencies = asyncHandler(async (req: AuthenticatedRequest, res: Response): Promise<void> => {
        const { projectId } = req.params;
        const orgId = req.user?.organizationId;
