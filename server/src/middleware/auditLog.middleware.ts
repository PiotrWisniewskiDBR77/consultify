 ...
 */
const auditLogMiddleware = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    ...
    (res.end as any) = function (chunk?: any, encodingOrCb?: any, cb?: any) {
        ...
        if (res.statusCode >= 200 && res.statusCode < 300) {
            try {
                ...
                const organizationId = user ? user.organizationId : (req.body as any)?.organizationId || 'unknown';
