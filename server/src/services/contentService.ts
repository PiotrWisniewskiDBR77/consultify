...
export class ContentService {
  ...
  async updateCategory(
    id: string,
    updates: Partial<import('./content/CategoryService.js').CategoryRecord>
  ) {
  ...
  async getUserFavorites(
    userId: string,
    options?: import('./content/FavoriteService.js').GetUserFavoritesOptions
  ) {
  ...
  async logAnalyticsEvent(
    data: import('./content/ContentAnalyticsService.js').LogAnalyticsEventData
  ) {
...
export const listCategories = (contentType: string) =>
  contentServiceInstance.listCategories(contentType);
export const updateCategory = (id: string, updates: any) =>
  contentServiceInstance.updateCategory(id, updates);
...
export const updateTag = (id: string, updates: any) =>
  contentServiceInstance.updateTag(id, updates);
...
export const resolveComment = (id: string, userId: string) =>
  contentServiceInstance.resolveComment(id, userId);
...
export const getContentReviews = (id: string, type: string) =>
  contentServiceInstance.getContentReviews(id, type);
...
export const approveReview = (id: string, notes?: string | null) =>
  contentServiceInstance.approveReview(id, notes);
export const rejectReview = (id: string, notes: string) =>
  contentServiceInstance.rejectReview(id, notes);
export const requestChanges = (id: string, notes: string) =>
  contentServiceInstance.requestChanges(id, notes);
...
export const getAnalyticsDashboard = (options?: any) =>
  contentServiceInstance.getAnalyticsDashboard(options);
