...
import type { SWOTItem } from './swotTypes.js';

type SwotStrengthClassification = NonNullable<SWOTItem['classification']>;
const DECLARED_UNCONFIRMED_LABEL = {
  pl: 'Deklaracja — brak niezależnego potwierdzenia',
  en: 'Declared — no independent confirmation',
};
