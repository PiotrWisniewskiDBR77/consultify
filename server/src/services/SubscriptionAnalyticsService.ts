...
import { CohortAnalysisOptions, CohortAnalyticsService, CohortData } from './analytics/CohortAnalyticsService.js';
...
import { CustomerCounts, SnapshotResult, SnapshotService, SubscriptionEventData } from './analytics/SnapshotService.js';
...
class SubscriptionAnalyticsServiceClass {
    ...
    async getLTV(options: LTVOptions = {}): Promise<LTVData> {
        ...
        const currentArpa = mrrData.activeSubscriptions > 0 ? mrrData.totalMRR / mrrData.activeSubscriptions : 0;
...
export const getMRRHistory = (opts?: MRRTrendOptions) => subscriptionAnalyticsServiceInstance.getMRRHistory(opts);
...
export const calculateLTV = (opts?: LTVOptions) => subscriptionAnalyticsServiceInstance.calculateLTV(opts);
