 ...
 */
export async function getRolePermissions(role: Role | null = null): Promise<RolePermissionMappingRow[]> {
 ...
 */
export async function getContentPermissions(contentId: string, contentType: string): Promise<ContentPermissionRow[]> {
 ...
 */
export async function validateContentAction(params: ValidateContentActionParams): Promise<ValidateContentActionResult> {
