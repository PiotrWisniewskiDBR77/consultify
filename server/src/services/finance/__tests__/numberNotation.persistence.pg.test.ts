...
const REAL_FIGURES: Array<{
  ...
  {
    issuer: 'Coca-Cola 10-K 2025 · total assets',
    token: '100,549',
    notation: 'en',
    expected: 100549,
  },
  ...
  {
    issuer: 'Grupa Apator RS 2024 · total assets',
    token: '1 227 799',
    notation: 'eu',
    expected: 1227799,
  },
...
describe.skipIf(!REAL_PG)(
  'RC-00 — corrected magnitudes survive the real financial_statement_values column',
  () => {
