...
export async function logRetrievalTrace(params: LogRetrievalTraceParams): Promise<RetrievalTrace> {
  ...
  const trace: RetrievalTrace = {
    ...
    scopeResolutionSummary: validated.scopeResolutionSummary as ScopeResolutionSummary,
    ...
    results: validated.results as RetrievalResult[],
    deniedEntries: validated.deniedEntries as DeniedEntry[],
