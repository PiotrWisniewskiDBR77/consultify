...
export const recordUsage = (params: RecordUsageParams) =>
  payAsYouGoServiceInstance.recordUsage(params);
export const getCurrentPeriodUsage = (
  orgId: string,
  periodStart: Date | null = null,
  periodEnd: Date | null = null
...
export const getPayAsYouGoForecast = (orgId: string) =>
  payAsYouGoServiceInstance.getPayAsYouGoForecast(orgId);
