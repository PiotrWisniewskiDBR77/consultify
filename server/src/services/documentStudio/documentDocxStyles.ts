...
/** Named styles added only for the opt-in DRD report profile. */
export const DRD_DOCX_STYLE_IDS = Object.freeze({
  BODY: 'Tresc',
  LEAD: 'Lead',
  KICKER: 'Kicker',
  CAPTION: 'Podpis',
  ...
  TOC1: 'TOC1',
  TOC2: 'TOC2',
  UNNUMBERED_HEADING: 'NaglowekBezNumeru',
  UNNUMBERED_SECTION: 'NaglowekBezNumeru2',
} as const);
...
export function buildDocxStyleConfig(
  ...
  if (isDrdReportProfile(schema)) {
    paragraphStyles.push(
      ...
      {
        id: DRD_DOCX_STYLE_IDS.SIGNATURE,
        name: 'Sygnatura',
        basedOn: DRD_DOCX_STYLE_IDS.BODY,
        next: DRD_DOCX_STYLE_IDS.BODY,
      ...
      {
        id: DRD_DOCX_STYLE_IDS.UNNUMBERED_SECTION,
