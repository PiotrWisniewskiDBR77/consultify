...
export class BillingWebhookServiceClass {
    ...
    async invoicePaymentFailed(orgId: string, inv: any, err: any = null) {
        return this.triggerEvent(orgId, BILLING_EVENT_TYPES.INVOICE_PAYMENT_FAILED, { ...inv, error: err });
    }
    ...
    async creditNoteApplied(orgId: string, cn: any, inv: any) {
        return this.triggerEvent(orgId, BILLING_EVENT_TYPES.CREDIT_NOTE_APPLIED, { credit_note: cn, invoice: inv });
    }
