 ...
 */
export async function createOrganization(params: CreateOrganizationParams): Promise<CreateOrganizationResult> {
 ...
 */
export async function updateAISettings(orgId: string, settings: UpdateAISettingsParams): Promise<void> {
 ...
 */
export async function updateMemberRole(params: UpdateMemberRoleParams): Promise<UpdateMemberRoleResult> {
 ...
 */
export async function getMemberRole(organizationId: string, userId: string): Promise<OrganizationRole | null> {
