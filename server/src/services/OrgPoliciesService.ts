...
export async function upsertOrgPolicy(
  ...
  try {
    ...
    try {
      ...
      // An unconfirmed rollback may retain the transaction and its policy lock.
      discardReason = new Error('Organization policy transaction cleanup was not confirmed');
    }
    throw error;
  } finally {
