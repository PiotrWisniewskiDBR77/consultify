...
export const INDUSTRY_BENCHMARK_PROFILES: Record<BenchmarkIndustry, IndustryBenchmarkProfile> = {
  ...
  'professional-services': {
    ...
    ratios: {
      ...
      CURRENT_RATIO: {
        p25: 1.2, median: 1.7, p75: 2.4, unit: 'x',
  ...
  'logistics-transport': {
    ...
    ratios: {
      ...
      REVENUE_PER_EMPLOYEE: {
        p25: 300000, median: 450000, p75: 700000, unit: 'x',
  ...
  construction: {
    ...
    ratios: {
      ...
      DEBT_TO_EQUITY: {
        p25: 0.7, median: 1.4, p75: 2.3, unit: 'x',
  ...
  'hospitality-food-service': {
    ...
    ratios: {
      ...
      DIO: {
        p25: 20, median: 10, p75: 5, unit: 'days',
        source: 'Ekspercka estymacja — żywność psująca się, krótki cykl zapasów',
        asOf: `${YEAR}-01`, confidence: 'expert-estimate',
      },
      REVENUE_PER_EMPLOYEE: {
        p25: 120000, median: 200000, p75: 320000, unit: 'x',
  ...
  healthcare: {
    ...
    ratios: {
      ...
      DIO: {
        p25: 45, median: 25, p75: 12, unit: 'days',
        source: 'Ekspercka estymacja — leki i materiały medyczne',
        asOf: `${YEAR}-01`, confidence: 'expert-estimate',
      },
      REVENUE_PER_EMPLOYEE: {
        p25: 200000, median: 320000, p75: 500000, unit: 'x',
  ...
  generic: {
    ...
    ratios: {
      ...
      NET_MARGIN: {
        p25: 1, median: 4, p75: 9, unit: '%',
        source: 'Ekspercka estymacja — rozpiętość międzybranżowa (brak segmentu)',
        asOf: `${YEAR}-01`, confidence: 'expert-estimate',
      },
      ROE: {
        p25: 4, median: 11, p75: 20, unit: '%',
        source: 'Ekspercka estymacja — rozpiętość międzybranżowa (brak segmentu)',
        asOf: `${YEAR}-01`, confidence: 'expert-estimate',
      },
      ROA: {
        p25: 1.5, median: 5, p75: 10, unit: '%',
        source: 'Ekspercka estymacja — rozpiętość międzybranżowa (brak segmentu)',
        asOf: `${YEAR}-01`, confidence: 'expert-estimate',
      },
      CURRENT_RATIO: {
        p25: 0.9, median: 1.4, p75: 2.0, unit: 'x',
        source: 'Ekspercka estymacja — rozpiętość międzybranżowa (brak segmentu)',
        asOf: `${YEAR}-01`, confidence: 'expert-estimate',
      },
      QUICK_RATIO: {
        p25: 0.6, median: 1.1, p75: 1.7, unit: 'x',
        source: 'Ekspercka estymacja — rozpiętość międzybranżowa (brak segmentu)',
        asOf: `${YEAR}-01`, confidence: 'expert-estimate',
      },
      DEBT_TO_EQUITY: {
        p25: 0.5, median: 1.2, p75: 2.2, unit: 'x',
        source: 'Ekspercka estymacja — rozpiętość międzybranżowa (brak segmentu)',
        asOf: `${YEAR}-01`, confidence: 'expert-estimate',
      },
      INVENTORY_TURNOVER: {
        p25: 4, median: 10, p75: 25, unit: 'x',
        source: 'Ekspercka estymacja — rozpiętość międzybranżowa (brak segmentu)',
        asOf: `${YEAR}-01`, confidence: 'expert-estimate',
      },
      DSO: {
        p25: 75, median: 45, p75: 20, unit: 'days',
        source: 'Ekspercka estymacja — rozpiętość międzybranżowa (brak segmentu)',
        asOf: `${YEAR}-01`, confidence: 'expert-estimate',
      },
      DIO: {
        p25: 70, median: 35, p75: 10, unit: 'days',
        source: 'Ekspercka estymacja — rozpiętość międzybranżowa (brak segmentu)',
        asOf: `${YEAR}-01`, confidence: 'expert-estimate',
      },
      REVENUE_PER_EMPLOYEE: {
        p25: 250000, median: 450000, p75: 750000, unit: 'x',
        source: 'Ekspercka estymacja — rozpiętość międzybranżowa (brak segmentu)',
        asOf: `${YEAR}-01`, confidence: 'expert-estimate',
      },
    },
...
export function resolveBenchmarkIndustry(segment?: string | null): BenchmarkIndustry {
  ...
  if (
    has(
      'logistyk', 'logistic', 'transport', 'spedycj', 'spedyc', 'shipping', 'freight',
      'kurier', 'courier', 'magazyn', 'warehous', 'fleet', 'flota'
    )
  )
    return 'logistics-transport';
  if (
    has(
      'budow', 'construction', 'deweloper', 'developer', 'general contractor',
      'wykonawstwo', 'inżynier lądow', 'civil engineering'
    )
  )
    return 'construction';
  if (
    has(
      'hotel', 'hospitality', 'gastronom', 'restaurant', 'restauracj', 'catering',
      'horeca', 'food service', 'turystyk', 'tourism'
    )
  )
    return 'hospitality-food-service';
  if (
    has(
      'health', 'zdrowi', 'medical', 'medyczn', 'clinic', 'klinik', 'szpital',
      'hospital', 'pharma', 'farmac', 'ochrona zdrowia'
    )
  )
    return 'healthcare';
  if (
    has(
      'retail', 'detal', 'e-commerce', 'ecommerce', 'sklep', 'shop', 'handel',
      'wholesale', 'hurt', 'marketplace'
    )
  )
    return 'retail-ecommerce';
  if (
    has(
      'consult', 'doradz', 'services', 'usług', 'uslug', 'law', 'kancelar',
      'account', 'księg', 'ksieg', 'agency', 'agenc', 'advisor', 'professional'
    )
  )
    return 'professional-services';
  if (
    has(
      'manufactur', 'produkc', 'przemysł', 'przemysl', 'industrial', 'machinery',
      'maszyn', 'automotive', 'component', 'komponent', 'factory', 'fabryk', 'chem', 'pharma-mfg'
    )
  )
...
export function getBenchmarkIndustryLabel(
  industry: BenchmarkIndustry
): { pl: string; en: string } {
