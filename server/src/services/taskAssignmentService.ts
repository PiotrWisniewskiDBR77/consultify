...
export class TaskAssignmentService {
     ...
     */
    static async reassignTask(taskId: string, newAssigneeId: string, options: any = {}): Promise<any> {
     ...
     * @private
     */
    private static async _notifyEscalation(task: any, recipient: any, level: number, reason: string): Promise<void> {
        try {
