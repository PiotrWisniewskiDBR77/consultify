...
export class UserActivityServiceClass {
    ...
    async getActivityHistory(userId: string, organizationId: string, limit: number = 30): Promise<ActivitySummary[]> {
...
export const calculateActivitySummary = (userId: string, orgId: string, periodStart: string, periodEnd: string) =>
