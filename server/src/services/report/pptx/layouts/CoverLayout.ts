 ...
 */
import type { DesignTokens, LayoutResult, UnifiedSlide, UnifiedReportMeta, CoverContent } from '../types.js';
...
export function CoverLayout(
  ...
  if (meta.confidentiality && meta.confidentiality !== 'public') {
    elements.push(
      ConfidentialityBanner({ level: meta.confidentiality }, tokens)
    );
  }
