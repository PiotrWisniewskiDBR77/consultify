...
const LAYOUT_TEMPLATES: LayoutTemplate[] = [
  // Cover
  { id: 'cover_centered', intents: ['cover'], gridTemplate: `"full"`, regions: [{ area: 'full' }], minBlocks: 1, maxBlocks: 3, hasImageSlot: false, tags: ['clean', 'dramatic'] },
  { id: 'cover_left_image', intents: ['cover'], gridTemplate: `"image content"`, regions: [{ area: 'image', maxBlocks: 1, preferredBlockTypes: ['image'] }, { area: 'content' }], minBlocks: 2, maxBlocks: 4, hasImageSlot: true, tags: ['visual', 'professional'] },
  { id: 'cover_bottom_strip', intents: ['cover'], gridTemplate: `"main" "strip"`, regions: [{ area: 'main' }, { area: 'strip', maxBlocks: 1, preferredBlockTypes: ['metric_strip'] }], minBlocks: 2, maxBlocks: 4, hasImageSlot: false, tags: ['data', 'corporate'] },
  // Executive summary
  { id: 'exec_full', intents: ['executive_summary', 'key_messages'], gridTemplate: `"full"`, regions: [{ area: 'full' }], minBlocks: 2, maxBlocks: 6, hasImageSlot: false, tags: ['clean', 'text-focused'] },
  { id: 'exec_left_bullets', intents: ['executive_summary'], gridTemplate: `"left right"`, regions: [{ area: 'left', preferredBlockTypes: ['heading', 'bullet_list', 'paragraph'] }, { area: 'right', preferredBlockTypes: ['kpi_widget', 'chart', 'metric_strip'] }], minBlocks: 3, maxBlocks: 6, hasImageSlot: false, tags: ['balanced', 'data'] },
  { id: 'exec_top_kpi', intents: ['executive_summary', 'performance_overview'], gridTemplate: `"kpi" "content"`, regions: [{ area: 'kpi', maxBlocks: 1, preferredBlockTypes: ['metric_strip', 'kpi_widget'] }, { area: 'content' }], minBlocks: 2, maxBlocks: 5, hasImageSlot: false, tags: ['data-first', 'dashboard'] },
  // Content
  { id: 'content_full', intents: ['key_messages', 'comparison', 'recommendation_portfolio'], gridTemplate: `"full"`, regions: [{ area: 'full' }], minBlocks: 1, maxBlocks: 8, hasImageSlot: false, tags: ['versatile', 'clean'] },
  { id: 'content_left_right', intents: ['key_messages', 'comparison'], gridTemplate: `"left right"`, regions: [{ area: 'left' }, { area: 'right' }], minBlocks: 2, maxBlocks: 6, hasImageSlot: false, tags: ['balanced', 'comparison'] },
  { id: 'content_right_image', intents: ['key_messages', 'recommendation_portfolio'], gridTemplate: `"content image"`, regions: [{ area: 'content' }, { area: 'image', maxBlocks: 1, preferredBlockTypes: ['image', 'chart', 'smart_diagram'] }], minBlocks: 2, maxBlocks: 5, hasImageSlot: true, tags: ['visual', 'engaging'] },
  { id: 'content_left_image', intents: ['key_messages'], gridTemplate: `"image content"`, regions: [{ area: 'image', maxBlocks: 1, preferredBlockTypes: ['image', 'smart_diagram'] }, { area: 'content' }], minBlocks: 2, maxBlocks: 5, hasImageSlot: true, tags: ['visual', 'reversed'] },
  { id: 'content_top_bottom', intents: ['key_messages', 'roadmap'], gridTemplate: `"top" "bottom"`, regions: [{ area: 'top' }, { area: 'bottom' }], minBlocks: 2, maxBlocks: 6, hasImageSlot: false, tags: ['layered', 'structured'] },
  { id: 'content_overlay', intents: ['key_messages', 'single_insight'], gridTemplate: `"overlay"`, regions: [{ area: 'overlay' }], minBlocks: 1, maxBlocks: 3, hasImageSlot: true, tags: ['dramatic', 'visual'] },
  // Data / KPI
  { id: 'kpi_grid_4', intents: ['performance_overview', 'single_insight'], gridTemplate: `"heading heading" "kpi1 kpi2" "kpi3 kpi4"`, regions: [{ area: 'heading', maxBlocks: 1 }, { area: 'kpi1', maxBlocks: 1, preferredBlockTypes: ['kpi_widget'] }, { area: 'kpi2', maxBlocks: 1, preferredBlockTypes: ['kpi_widget'] }, { area: 'kpi3', maxBlocks: 1, preferredBlockTypes: ['kpi_widget', 'chart'] }, { area: 'kpi4', maxBlocks: 1, preferredBlockTypes: ['kpi_widget', 'chart'] }], minBlocks: 3, maxBlocks: 5, hasImageSlot: false, tags: ['dashboard', 'data-heavy'] },
  { id: 'data_strip_chart', intents: ['performance_overview', 'single_insight'], gridTemplate: `"heading" "strip" "chart"`, regions: [{ area: 'heading', maxBlocks: 1 }, { area: 'strip', maxBlocks: 1, preferredBlockTypes: ['metric_strip'] }, { area: 'chart', maxBlocks: 1, preferredBlockTypes: ['chart'] }], minBlocks: 2, maxBlocks: 3, hasImageSlot: false, tags: ['metrics-first', 'analytical'] },
  { id: 'data_dual_chart', intents: ['single_insight', 'comparison'], gridTemplate: `"heading heading" "chart1 chart2"`, regions: [{ area: 'heading', maxBlocks: 1 }, { area: 'chart1', maxBlocks: 1, preferredBlockTypes: ['chart'] }, { area: 'chart2', maxBlocks: 1, preferredBlockTypes: ['chart'] }], minBlocks: 2, maxBlocks: 3, hasImageSlot: false, tags: ['comparison', 'data'] },
  // Section divider
  { id: 'divider_centered', intents: ['section_intro'], gridTemplate: `"full"`, regions: [{ area: 'full' }], minBlocks: 1, maxBlocks: 2, hasImageSlot: false, tags: ['minimal', 'divider'] },
  { id: 'divider_numbered', intents: ['section_intro'], gridTemplate: `"number content"`, regions: [{ area: 'number', maxBlocks: 1 }, { area: 'content' }], minBlocks: 1, maxBlocks: 2, hasImageSlot: false, tags: ['numbered', 'structured'] },
  // Timeline / process
  { id: 'timeline_full', intents: ['roadmap'], gridTemplate: `"heading" "timeline"`, regions: [{ area: 'heading', maxBlocks: 1 }, { area: 'timeline', maxBlocks: 1, preferredBlockTypes: ['timeline_block', 'smart_diagram'] }], minBlocks: 2, maxBlocks: 3, hasImageSlot: false, tags: ['sequential', 'process'] },
  { id: 'process_top_steps_bottom_detail', intents: ['roadmap'], gridTemplate: `"steps" "detail"`, regions: [{ area: 'steps', maxBlocks: 1, preferredBlockTypes: ['smart_diagram'] }, { area: 'detail' }], minBlocks: 2, maxBlocks: 5, hasImageSlot: false, tags: ['process', 'detailed'] },
  // Risk
  { id: 'risk_matrix', intents: ['risk_management'], gridTemplate: `"heading" "matrix"`, regions: [{ area: 'heading', maxBlocks: 1 }, { area: 'matrix', maxBlocks: 1, preferredBlockTypes: ['smart_diagram', 'table'] }], minBlocks: 2, maxBlocks: 3, hasImageSlot: false, tags: ['risk', 'matrix'] },
  { id: 'risk_left_matrix_right_list', intents: ['risk_management'], gridTemplate: `"matrix list"`, regions: [{ area: 'matrix', preferredBlockTypes: ['smart_diagram'] }, { area: 'list', preferredBlockTypes: ['bullet_list', 'callout'] }], minBlocks: 2, maxBlocks: 4, hasImageSlot: false, tags: ['risk', 'actionable'] },
  // Recommendation / next steps
  { id: 'recommendation_callout', intents: ['recommendation_portfolio', 'next_steps'], gridTemplate: `"heading" "content" "callout"`, regions: [{ area: 'heading', maxBlocks: 1 }, { area: 'content' }, { area: 'callout', maxBlocks: 1, preferredBlockTypes: ['callout'] }], minBlocks: 2, maxBlocks: 5, hasImageSlot: false, tags: ['actionable', 'structured'] },
  { id: 'next_steps_checklist', intents: ['next_steps'], gridTemplate: `"heading heading" "list sidebar"`, regions: [{ area: 'heading', maxBlocks: 1 }, { area: 'list', preferredBlockTypes: ['bullet_list', 'numbered_list'] }, { area: 'sidebar', preferredBlockTypes: ['callout', 'kpi_widget'] }], minBlocks: 2, maxBlocks: 4, hasImageSlot: false, tags: ['checklist', 'actionable'] },
  // Single insight
  { id: 'quote_centered', intents: ['single_insight'], gridTemplate: `"full"`, regions: [{ area: 'full' }], minBlocks: 1, maxBlocks: 2, hasImageSlot: false, tags: ['minimal', 'impactful'] },
  { id: 'quote_with_image', intents: ['single_insight'], gridTemplate: `"image quote"`, regions: [{ area: 'image', maxBlocks: 1, preferredBlockTypes: ['image'] }, { area: 'quote' }], minBlocks: 2, maxBlocks: 3, hasImageSlot: true, tags: ['visual', 'personal'] },
  // Comparison
  { id: 'comparison_two_col', intents: ['comparison'], gridTemplate: `"heading heading" "left right"`, regions: [{ area: 'heading', maxBlocks: 1 }, { area: 'left' }, { area: 'right' }], minBlocks: 3, maxBlocks: 7, hasImageSlot: false, tags: ['comparison', 'balanced'] },
  { id: 'comparison_three_col', intents: ['comparison'], gridTemplate: `"heading heading heading" "a b c"`, regions: [{ area: 'heading', maxBlocks: 1 }, { area: 'a' }, { area: 'b' }, { area: 'c' }], minBlocks: 4, maxBlocks: 8, hasImageSlot: false, tags: ['comparison', 'options'] },
  // Generic "smart"
  { id: 'smart_60_40', intents: ['key_messages', 'recommendation_portfolio', 'executive_summary'], gridTemplate: `"main side"`, regions: [{ area: 'main' }, { area: 'side' }], minBlocks: 2, maxBlocks: 6, hasImageSlot: false, tags: ['asymmetric', 'professional'] },
  { id: 'smart_header_three_col', intents: ['key_messages', 'roadmap', 'comparison'], gridTemplate: `"heading heading heading" "a b c"`, regions: [{ area: 'heading', maxBlocks: 1 }, { area: 'a' }, { area: 'b' }, { area: 'c' }], minBlocks: 4, maxBlocks: 7, hasImageSlot: false, tags: ['columns', 'structured'] },
];
...
function countSideBySideColumns(layout: LayoutTemplate): number {
  ...
  for (const row of rows) {
    const areas = row.replace(/"/g, '').trim().split(/\s+/).filter((a) => a && a !== '.');
...
function shouldAvoidSplit(
  ...
  for (const row of rows) {
    const areas = Array.from(
      new Set(row.replace(/"/g, '').trim().split(/\s+/).filter((a) => a && a !== '.'))
    );
  ...
  const assigned = assignBlocksToRegions(blocks.map((b) => ({ ...b })), layout, composition);
  ...
  const TALL_FILL = new Set([
    'chart', 'image', 'smart_diagram', 'smart_layout', 'kpi_widget', 'table', 'timeline_block', 'metric_strip',
  ]);
    ...
    if (metrics.length) {
      push('metric_strip', {
        metrics: metrics.map((m: unknown) => {
          ...
          return { label: str(mm.label || mm.name || 'Metric'), value: str(mm.value ?? ''), trend: mm.trend };
        }),
      });
    }
    ...
    const regions = c.regions
      ...
      .map((r) => {
        ...
        return {
          ...
          blockTypes: Array.isArray(bt) ? bt.filter((x): x is string => typeof x === 'string') : undefined,
        };
      });
...
export function resolveTemplateIdFromCardShape(card: {
  ...
  layout_id?: string;
  blocks: DecisionBlock[];
  composition?: { layoutVariantId?: string; regions?: { area: string; blockTypes?: string[] }[] } | null;
}): string {
...
export const __TEST_ONLY__ = { LAYOUT_TEMPLATES, shouldAvoidSplit, isSplitLikeLayout, estimateBlockWeight };
