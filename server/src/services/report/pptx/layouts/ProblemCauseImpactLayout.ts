 ...
 */
import type { DesignTokens, LayoutResult, UnifiedSlide, UnifiedReportMeta, RootCauseContent } from '../types.js';
...
export function ProblemCauseImpactLayout(
  ...
  elements.push(SlideTitle({ text: slide.key_message || (meta.language === 'pl' ? 'Analiza Przyczyn' : 'Root Cause Analysis') }, tokens));
