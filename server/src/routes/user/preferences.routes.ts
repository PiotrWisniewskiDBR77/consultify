...
router.get('/options', verifyToken, asyncHandler(async (_req: AuthRequest, res: Response) => {
    res.json({
...
router.put('/', verifyToken, asyncHandler(async (req: AuthRequest, res: Response) => {
    const userId = req.user?.id;
...
router.put('/ui', verifyToken, asyncHandler(async (req: AuthRequest, res: Response) => {
    const userId = req.user?.id;
