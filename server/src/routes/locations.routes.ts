...
if (typeof locationsRoutesJS === 'function') {
    ...
    router.use(locationsRoutesJS as unknown as unknown as unknown as RequestHandler);
} else if (locationsRoutesJS && typeof (locationsRoutesJS as { handle?: unknown }).handle === 'function') {
