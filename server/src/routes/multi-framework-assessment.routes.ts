...
const frameworkModule = (await import('./multi-framework-assessment.js')) as any;
const multi_framework_assessmentRoutesJS = frameworkModule.default || frameworkModule;
