...
router.get(
  '/:orgId/admin/invitations',
  requireRole('ADMIN', 'OWNER', 'SUPERADMIN'),
  AdminIamController.list
);
router.post(
  '/:orgId/admin/invitations',
  requireRole('ADMIN', 'OWNER', 'SUPERADMIN'),
  AdminIamController.command('CREATE')
);
router.post(
  '/:orgId/admin/invitations/:invitationId/resend',
  requireRole('ADMIN', 'OWNER', 'SUPERADMIN'),
  AdminIamController.command('RESEND')
);
router.post(
  '/:orgId/admin/invitations/:invitationId/revoke',
  requireRole('ADMIN', 'OWNER', 'SUPERADMIN'),
  AdminIamController.command('REVOKE')
);
router.patch(
  '/:orgId/admin/members/:memberId/role',
  requireRole('ADMIN', 'OWNER', 'SUPERADMIN'),
  AdminIamController.changeRole
);
router.post(
  '/:orgId/admin/members/:memberId/revoke',
  requireRole('ADMIN', 'OWNER', 'SUPERADMIN'),
  AdminIamController.revokeMember
);
