 ...
 */
router.get('/', verifyToken, requireRole(['super_admin', 'admin']), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
 ...
 */
router.get('/categories', verifyToken, requireRole(['super_admin', 'admin']), asyncHandler(async (_req: AuthRequest, res: Response) => {
    try {
 ...
 */
router.get('/:id', verifyToken, requireRole(['super_admin', 'admin']), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const { id } = req.params;
 ...
 * Create new prompt
 */
router.post('/', verifyToken, requireRole(['super_admin']), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
 ...
 */
router.put('/:id', verifyToken, requireRole(['super_admin']), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const { id } = req.params;
        const { name, category, description, template, variables, is_active } = req.body;
        const userId = req.user?.id;
 ...
 */
router.delete('/:id', verifyToken, requireRole(['super_admin']), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const { id } = req.params;
 ...
 */
router.post('/:id/test', verifyToken, requireRole(['super_admin', 'admin']), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const { id } = req.params;
 ...
 */
router.post('/:id/restore-version', verifyToken, requireRole(['super_admin']), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const { id } = req.params;
        ...
        `, [id, version]) as { template?: string } | null;
