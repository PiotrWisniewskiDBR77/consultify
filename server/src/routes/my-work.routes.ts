...
if (typeof my_workRoutesJS === 'function') {
    ...
    router.use(my_workRoutesJS as unknown as unknown as unknown as RequestHandler);
} else if (my_workRoutesJS && typeof (my_workRoutesJS as { handle?: unknown }).handle === 'function') {
