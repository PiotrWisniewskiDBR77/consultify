...
router.get(
    '/providers/health',
    asyncHandler(LLMController.getProvidersHealth)
);
...
router.get(
    ...
    asyncHandler(LLMController.getRecommendedProvider)
);
...
router.post(
    '/providers',
    verifyToken,
    asyncHandler(LLMController.createProvider)
);
...
router.put(
    '/providers/:id',
    verifyToken,
    asyncHandler(LLMController.updateProvider)
);
...
router.delete(
    '/providers/:id',
    verifyToken,
    asyncHandler(LLMController.deleteProvider)
);
...
router.get(
    '/health/status',
    verifyToken,
    asyncHandler(LLMController.getHealthStatus)
);
...
router.get(
    '/health/detailed',
    verifyToken,
    asyncHandler(LLMController.getDetailedHealth)
);
 ...
 */
router.post(
    '/health/test-provider',
    verifyToken,
    asyncHandler(LLMController.testProviderHealth)
);
 ...
 */
router.post(
    '/health/test/:capabilityId',
    verifyToken,
    asyncHandler(LLMController.testCapability)
);
...
router.get(
    '/analytics',
    verifyToken,
    asyncHandler(LLMController.getAnalytics)
);
...
router.get(
    '/logs',
    verifyToken,
    asyncHandler(LLMController.getLogs)
);
...
router.get(
    '/control/usage',
    verifyToken,
    asyncHandler(LLMController.getUsageStats)
);
...
router.get(
    '/costs',
    verifyToken,
    asyncHandler(LLMController.getCosts)
);
...
router.get(
    '/diagnose',
    asyncHandler(LLMController.diagnose)
);
...
router.put(
    '/providers/:id/tier',
    verifyToken,
    asyncHandler(LLMController.updateProviderTier)
);
...
router.get(
    '/tiers/assignments',
    verifyToken,
    asyncHandler(LLMController.getTierAssignments)
);
...
router.post(
    '/tiers/assign',
    verifyToken,
    asyncHandler(LLMController.assignToTier)
);
...
router.delete(
    '/tiers/assign',
    verifyToken,
    asyncHandler(LLMController.removeFromTier)
);
...
router.put(
    '/tiers/priority',
    verifyToken,
    asyncHandler(LLMController.updateTierPriority)
);
