...
if (typeof contextRoutesJS === 'function') {
    ...
    router.use(contextRoutesJS as unknown as unknown as unknown as RequestHandler);
} else if (contextRoutesJS && typeof (contextRoutesJS as { handle?: unknown }).handle === 'function') {
