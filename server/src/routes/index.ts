...
export { default as baselinesRoutes } from './baselines.routes.ts';
...
export { default as documentRoutes } from './documents.routes.ts';
export { default as economicsRoutes } from './economics.routes.ts';
...
export { default as genericReportsRoutes } from './generic-reports.routes.ts';
...
export { default as helpRoutes } from './help.routes.ts';
...
export { default as legalRoutes } from './legal.routes.ts';
...
export { default as reportsRoutes } from './reports.routes.ts';
...
export { default as statusReportsRoutes } from './status-reports.routes.ts';
