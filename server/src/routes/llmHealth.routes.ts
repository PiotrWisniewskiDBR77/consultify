 ...
 */
router.get('/health/:providerId', asyncHandler(async (req, res: Response) => {
 ...
 */
router.post('/health/test', asyncHandler(async (req, res: Response) => {
 ...
 */
router.get('/health/summary', asyncHandler(async (_req, res: Response) => {
 ...
 */
router.get('/health/errors', asyncHandler(async (_req, res: Response) => {
