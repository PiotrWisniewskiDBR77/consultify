...
if (typeof securityRoutesJS === 'function') {
    ...
    router.use(securityRoutesJS as unknown as unknown as unknown as RequestHandler);
} else if (securityRoutesJS && typeof (securityRoutesJS as { handle?: unknown }).handle === 'function') {
