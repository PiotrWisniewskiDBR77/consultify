...
interface DraftServiceInterface {
    ...
    getDraftStats?: (userId: string, organizationId: string) => Promise<{
        total: number;
        approved?: number;
        modified?: number;
    }>;
...
router.get('/:id', asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    try {
        ...
        if (aiLogger?.error) {
            aiLogger.error('DraftsAPI', `GET /:id error: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
 ...
 */
router.get('/entity/:type/:id', asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    try {
        ...
        if (aiLogger?.error) {
            aiLogger.error('DraftsAPI', `GET /entity error: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
...
router.post('/', asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    try {
        ...
        if (aiLogger?.error) {
            aiLogger.error('DraftsAPI', `POST / error: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
...
router.patch('/:id/approve', asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    try {
        ...
        if (aiLogger?.error) {
            aiLogger.error('DraftsAPI', `PATCH /approve error: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
...
router.patch('/:id/reject', asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    try {
        ...
        if (aiLogger?.error) {
            aiLogger.error('DraftsAPI', `PATCH /reject error: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
...
router.get('/user/stats', asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    try {
        ...
        if (aiLogger?.error) {
            aiLogger.error('DraftsAPI', `GET /stats error: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
 ...
 */
router.delete('/expired', asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    try {
        ...
        if (aiLogger?.error) {
            aiLogger.error('DraftsAPI', `DELETE /expired error: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
