 ...
 */
router.get('/consents', asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
 ...
 */
router.put('/consents', asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const userId = req.user!.id;
 ...
 */
router.get('/retention', asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const userId = req.user!.id;
 ...
 */
router.put('/retention', asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const userId = req.user!.id;
 ...
 */
router.get('/export-status', asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const userId = req.user!.id;
 ...
 * Request data export
 */
router.post('/export-request', asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const userId = req.user!.id;
 ...
 */
router.get('/download-export/:requestId', asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const userId = req.user!.id;
 ...
 */
router.post('/deletion-request', asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const userId = req.user!.id;
 ...
 */
router.post('/cancel-deletion', asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const userId = req.user!.id;
 ...
 */
router.get('/deletion-status', asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const userId = req.user!.id;
