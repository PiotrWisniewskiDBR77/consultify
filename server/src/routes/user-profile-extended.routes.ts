...
if (typeof user_profile_extendedRoutesJS === 'function') {
    ...
    router.use(user_profile_extendedRoutesJS as RequestHandler);
} else if (user_profile_extendedRoutesJS && typeof (user_profile_extendedRoutesJS as { handle?: unknown }).handle === 'function') {
