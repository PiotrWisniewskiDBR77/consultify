    ...
    asyncHandler(async (req: AuthRequest, res: Response) => {
        ...
        try {
            ...
            const phaseMap: Record<string, number> = {
                'Initiation': 1, 'Planning': 2, 'Design': 3, 'Development': 4,
                'Execution': 5, 'Closure': 6
            };
    ...
    asyncHandler(async (req: AuthRequest, res: Response) => {
        ...
        try {
            ...
            const taskLabels = [
                ...
                { id: 'milestone', name: 'Milestone', pmoRelevance: 0.90, color: '#44FF44' },
                { id: 'deliverable', name: 'Deliverable', pmoRelevance: 0.85, color: '#4444FF' },
                { id: 'risk-item', name: 'Risk Item', pmoRelevance: 0.80, color: '#FFAA00' },
