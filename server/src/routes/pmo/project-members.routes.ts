 ...
 */
router.get('/:projectId', verifyToken, isAuthenticated, asyncHandler(async (req: AuthRequest, res: Response) => {
 ...
 */
router.post('/:projectId', verifyToken, isAuthenticated, asyncHandler(async (req: AuthRequest, res: Response) => {
  const { projectId } = req.params;
 ...
 */
router.put('/:projectId/:memberId', verifyToken, isAuthenticated, asyncHandler(async (req: AuthRequest, res: Response) => {
 ...
 */
router.delete('/:projectId/:memberId', verifyToken, isAuthenticated, asyncHandler(async (req: AuthRequest, res: Response) => {
  const { projectId, memberId } = req.params;
 ...
 */
router.get('/:projectId/roles/available', verifyToken, isAuthenticated, asyncHandler(async (req: AuthRequest, res: Response) => {
  const roles = [
 ...
 */
router.post('/:projectId/invite', verifyToken, isAuthenticated, asyncHandler(async (req: AuthRequest, res: Response) => {
  const { projectId } = req.params;
