...
const metricsModule = (await import('./performance-metrics.js')) as any;
const performance_metricsRoutesJS = metricsModule.default || metricsModule;
...
if (
    ...
    // Fallback or error
    logger.error('performance-metrics.js did not export a valid router');
}
