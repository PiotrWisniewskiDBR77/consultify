...
router.post(
    ...
    asyncHandler(async (req: AuthRequest, res: Response) => {
        ...
        try {
            ...
            logger.info(`[HelpFeedback] User ${req.userId} - ${content_type}:${content_id} - helpful: ${is_helpful}`, {
                comment,
            });
...
const MODULE_KNOWLEDGE: Record<string, { description: string; features: string[]; tips: string[] }> = {
    dashboard: {
        description: 'The central command center showing transformation progress, KPIs, and quick actions.',
        features: [
    ...
    assessment: {
        description: 'AI-powered digital maturity assessment using industry frameworks (CMMI, LEAN, Industry 4.0).',
        features: [
    ...
    initiatives: {
        description: 'Create and manage digital transformation initiatives with full lifecycle tracking.',
        features: [
    ...
    roadmap: {
        description: 'Strategic planning timeline showing all initiatives, milestones, and dependencies.',
        features: [
