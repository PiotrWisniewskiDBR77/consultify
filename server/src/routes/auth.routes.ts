...
router.post('/refresh', validateBody(RefreshTokenRequestSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
...
// GET ACTIVE SESSIONS
router.get('/sessions', verifyToken, asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
...
// REVOKE SESSION
router.delete('/sessions/:id', verifyToken, validateParams(SessionIdParamSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    const { id } = req.params;
...
router.post('/logout', verifyToken, asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
...
router.post('/revert-impersonation', verifyToken, asyncHandler(async (req: AuthRequest, res: Response) => {
...
router.post('/demo-login', asyncHandler(async (req: AuthRequest, res: Response) => {
...
router.post('/register', validateBody(RegisterRequestSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    const {
...
router.post('/revoke-all', verifyToken, validateBody(RevokeAllTokensRequestSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
...
router.post('/change-password', verifyToken, validateBody(ChangePasswordRequestSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
...
// EMAIL VERIFICATION
router.post('/verify-email', validateBody(VerifyEmailRequestSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
...
// MFA SETUP
router.post('/mfa/setup', verifyToken, asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
...
router.post('/mfa/enable', verifyToken, validateBody(MFAEnableRequestSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    const { token } = req.body;
    try {
...
router.post('/mfa/disable', verifyToken, validateBody(MFADisableRequestSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    const { token } = req.body;
    try {
