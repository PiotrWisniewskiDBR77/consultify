...
if (typeof videosRoutesJS === 'function') {
    ...
    router.use(videosRoutesJS as unknown as unknown as unknown as RequestHandler);
} else if (videosRoutesJS && typeof (videosRoutesJS as { handle?: unknown }).handle === 'function') {
