...
if (typeof organization_dataRoutesJS === 'function') {
  ...
  router.use(organization_dataRoutesJS as unknown as unknown as unknown as RequestHandler);
} else if (
  organization_dataRoutesJS &&
  typeof (organization_dataRoutesJS as { handle?: unknown }).handle === 'function'
) {
