...
if (typeof webhookSubscriptionsRoutesJS === 'function') {
    ...
    router.use(webhookSubscriptionsRoutesJS as RequestHandler);
} else if (webhookSubscriptionsRoutesJS && typeof (webhookSubscriptionsRoutesJS as { handle?: unknown }).handle === 'function') {
