...
const securityPoliciesModule = (await import('./securityPolicies.js')) as any;
const securityPoliciesRoutesJS = securityPoliciesModule.default || securityPoliciesModule;
