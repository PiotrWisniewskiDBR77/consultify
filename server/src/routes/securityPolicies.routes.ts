...
if (typeof securityPoliciesRoutesJS === 'function') {
    ...
    router.use(securityPoliciesRoutesJS as unknown as unknown as unknown as RequestHandler);
} else if (securityPoliciesRoutesJS && typeof (securityPoliciesRoutesJS as { handle?: unknown }).handle === 'function') {
