...
import { verifyToken, requireSuperAdmin, type AuthRequest } from '../middleware/auth.middleware.js';
...
router.get('/stats', verifyToken, requireSuperAdmin, validateQuery(BillingStatsQuerySchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        ...
        `, [startDate]) as { total_revenue: number; invoice_count: number } | null;
        ...
        const trends = await dbAll(`
            ...
            ORDER BY date ASC
        `, [startDate]) as Array<{ date: string; new_subscriptions: number; churned: number }>;
...
router.get('/invoices', verifyToken, validateQuery(ListInvoicesQuerySchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
...
router.get('/invoices/:id', verifyToken, validateParams(InvoiceIdParamSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const { id } = req.params;
        const isSuperAdmin = req.user!.role === 'SUPERADMIN';
...
router.post('/invoices', verifyToken, requireSuperAdmin, validateBody(CreateInvoiceRequestSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        ...
        const count = await dbGet(`SELECT COUNT(*) as count FROM invoices`) as { count: number } | null;
...
router.put('/invoices/:id', verifyToken, requireSuperAdmin, validateParams(InvoiceIdParamSchema), validateBody(UpdateInvoiceRequestSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const { id } = req.params;
...
router.post('/invoices/:id/send', verifyToken, requireSuperAdmin, validateParams(InvoiceIdParamSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const { id } = req.params;
...
router.get('/subscriptions', verifyToken, validateQuery(ListSubscriptionsQuerySchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const { status, organizationId, page, pageSize } = req.query as {
            status?: string;
            organizationId?: string;
...
router.get('/subscriptions/:id', verifyToken, validateParams(SubscriptionIdParamSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const { id } = req.params;
        const isSuperAdmin = req.user!.role === 'SUPERADMIN';
...
router.post('/subscriptions', verifyToken, requireSuperAdmin, validateBody(CreateSubscriptionRequestSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        ...
        `, [organizationId]) as { id: string } | null;
...
router.put('/subscriptions/:id', verifyToken, requireSuperAdmin, validateParams(SubscriptionIdParamSchema), validateBody(UpdateSubscriptionRequestSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const { id } = req.params;
...
router.post('/subscriptions/:id/cancel', verifyToken, validateParams(SubscriptionIdParamSchema), validateBody(CancelSubscriptionRequestSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const { id } = req.params;
...
router.get('/plans', verifyToken, validateQuery(ListPlansQuerySchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
...
router.post('/plans', verifyToken, requireSuperAdmin, validateBody(CreatePlanRequestSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const {
            name, description, priceMonthly, priceYearly,
            currency, features, limits,
            trialDays, isPublic, sortOrder
        } = req.body;
...
router.put('/plans/:id', verifyToken, requireSuperAdmin, validateParams(PlanIdParamSchema), validateBody(UpdatePlanRequestSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const { id } = req.params;
        const updates: string[] = [];
        const params: SQLParams = [];
...
router.get('/credit-notes', verifyToken, asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const { organizationId, page = 1, pageSize = 50 } = req.query as {
            organizationId?: string;
            page?: number;
            pageSize?: number;
        };
...
router.post('/credit-notes', verifyToken, requireSuperAdmin, validateBody(CreateCreditNoteRequestSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
...
router.get('/usage', verifyToken, validateQuery(UsageQuerySchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
...
router.post('/usage', verifyToken, validateBody(RecordUsageRequestSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
...
router.post('/spending-alerts', verifyToken, validateBody(CreateSpendingAlertRequestSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const orgId = req.user!.organizationId;
...
router.put('/spending-alerts/:id', verifyToken, validateParams(SpendingAlertIdParamSchema), validateBody(UpdateSpendingAlertRequestSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const { id } = req.params;
        const orgId = req.user!.organizationId;
        const { type, threshold, thresholdType, action, notifyEmails, isActive } = req.body;
...
router.post('/spending-alerts/:id/toggle', verifyToken, validateParams(SpendingAlertIdParamSchema), validateBody(ToggleSpendingAlertRequestSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const { id } = req.params;
        const orgId = req.user!.organizationId;
...
router.delete('/spending-alerts/:id', verifyToken, validateParams(SpendingAlertIdParamSchema), asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const { id } = req.params;
        const orgId = req.user!.organizationId;
...
router.get('/addons', verifyToken, asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
...
router.get('/webhook-events', verifyToken, requireBillingAccess, asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
...
router.get('/webhook-events/stats', verifyToken, requireBillingAccess, asyncHandler(async (req: AuthRequest, res: Response) => {
    try {
        const orgId = (req as unknown as { org?: { id: string } }).org?.id || req.user!.organizationId;
