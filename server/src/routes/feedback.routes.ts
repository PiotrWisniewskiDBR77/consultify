...
router.post('/', asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    const runResult = await dbRun(sql, [id, userId, userEmail, userName, type, message, rating, JSON.stringify(metadata || {})]);
 ...
 */
router.post('/:id/respond', asyncHandler(async (req: AuthRequest, res: Response) => {
