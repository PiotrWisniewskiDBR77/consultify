 ...
 */
router.get('/superadmin', verifyToken, requireRole(['superadmin']), asyncHandler(async (_req: AuthRequest, res: Response) => {
 ...
 * Requires: SuperAdmin role
 */
router.put('/superadmin', verifyToken, requireRole(['superadmin']), asyncHandler(async (req: AuthRequest, res: Response) => {
 ...
 */
router.get('/org/:orgId', verifyToken, asyncHandler(async (req: AuthRequest, res: Response) => {
 ...
 * Requires: Admin role for the organization
 */
router.put('/org/:orgId', verifyToken, asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    try {
        ...
        const isAdmin = userRole === 'superadmin' || userRole === 'SUPERADMIN' ||
 ...
 */
router.put('/user', verifyToken, asyncHandler(async (req: AuthRequest, res: Response) => {
 ...
 */
router.get('/effective', verifyToken, asyncHandler(async (req: AuthRequest, res: Response) => {
 ...
 */
router.get('/available-models', verifyToken, asyncHandler(async (req: AuthRequest, res: Response) => {
 ...
 */
router.get('/proactivity', verifyToken, asyncHandler(async (req: AuthRequest, res: Response) => {
 ...
 */
router.get('/proactivity/modes', verifyToken, asyncHandler(async (_req: AuthRequest, res: Response) => {
 ...
 */
router.get('/audit', verifyToken, asyncHandler(async (req: AuthRequest, res: Response) => {
 ...
 */
router.get('/audit/org/:orgId', verifyToken, asyncHandler(async (req: AuthRequest, res: Response) => {
    if (!AISettingsService?.getAuditLog) {
        return res.status(503).json({ error: 'AI Settings service not available' });
    }
 ...
 */
router.get('/user/costs', verifyToken, asyncHandler(async (req: AuthRequest, res: Response) => {
 ...
 * Requires: Admin role for the organization
 */
router.get('/org/:orgId/users/tiers', verifyToken, asyncHandler(async (req: AuthRequest, res: Response) => {
 ...
 * Requires: Admin role for the organization
 */
router.put('/org/:orgId/users/:userId/tier', verifyToken, asyncHandler(async (req: AuthRequest, res: Response) => {
 ...
 * Requires: Admin role for the organization
 */
router.get('/org/:orgId/costs', verifyToken, asyncHandler(async (req: AuthRequest, res: Response) => {
 ...
 * Requires: Admin role
 */
router.get('/compliance/export/:format', verifyToken, asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    try {
        ...
        // Check admin access
        if (userRole !== 'superadmin' && userRole !== 'SUPERADMIN' && userRole !== 'admin' && userRole !== 'ADMIN') {
            return res.status(403).json({ error: 'Admin access required' });
        }
        ...
        if (format === 'csv') {
            ...
            return res.send(typeof report.data === 'string' ? report.data : Buffer.from(JSON.stringify(report.data)));
        } else {
            res.json(report);
        }
    } catch (error: unknown) {
 ...
 * Requires: Admin role
 */
router.post('/compliance/generate', verifyToken, asyncHandler(async (req: AuthRequest, res: Response) => {
    if (!AISettingsService?.generateComplianceReport) {
        return res.status(503).json({ error: 'AI Settings service not available' });
    }
