...
const RAPID_LEAN_OBSERVATION_TEMPLATES = [
  {
    ...
    description:
      'Observe value stream flow from order to delivery. Maps to DRD Axis 1: Digital Processes',
    photoRequired: true,
    notesRequired: true,
    estimatedTime: 15,
    checklist: [
  ...
  },
  {
    ...
    description:
      'Observe Kaizen boards, suggestion systems. Maps to DRD Axis 5: Organizational Culture',
    photoRequired: true,
    notesRequired: true,
    estimatedTime: 10,
    checklist: [
  ...
  },
  {
    ...
    description:
      'Observe KPIs, standards, visual controls. Maps to DRD Axis 5: Organizational Culture',
    photoRequired: true,
    notesRequired: true,
    estimatedTime: 10,
    checklist: [
