...
const ensureTable = async () => {
    ...
    `);
    await dbRun(`CREATE INDEX IF NOT EXISTS idx_compliance_org ON compliance_settings(organization_id)`);
    await dbRun(`CREATE INDEX IF NOT EXISTS idx_compliance_type ON compliance_settings(setting_type)`);
};
