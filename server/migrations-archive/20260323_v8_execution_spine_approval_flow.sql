...
ALTER TABLE v8_execution_runs ADD COLUMN review_submitted_at TEXT;
ALTER TABLE v8_execution_runs ADD COLUMN review_completed_at TEXT;
ALTER TABLE v8_execution_runs ADD COLUMN review_completed_by TEXT;
