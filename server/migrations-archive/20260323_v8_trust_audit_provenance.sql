...
ALTER TABLE v8_degraded_conditions ADD COLUMN resolved_at TEXT;
ALTER TABLE v8_degraded_conditions ADD COLUMN resolved_by TEXT;
ALTER TABLE v8_degraded_conditions ADD COLUMN resolution_note TEXT;
