...
ALTER TABLE v8_context_snapshots ADD COLUMN parent_snapshot_id TEXT REFERENCES v8_context_snapshots(snapshot_id);
...
ALTER TABLE v8_context_snapshots ADD COLUMN archived_at TEXT;
