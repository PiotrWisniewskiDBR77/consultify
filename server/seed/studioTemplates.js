  ...
  // =====================
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: { label: 'Step 1', description: 'First action' },
      },
      {
        id: 'step-2',
        type: 'processStep',
        position: { x: 500, y: 100 },
        data: { label: 'Step 2', description: 'Second action' },
      },
      {
        id: 'step-3',
        type: 'processStep',
        position: { x: 750, y: 100 },
        data: { label: 'Step 3', description: 'Third action' },
      },
      {
        id: 'end-1',
        type: 'startEnd',
    ...
    nodes: [
      {
        ...
        type: 'startEnd',
        position: { x: 50, y: 150 },
        data: { label: 'Request Submitted', isStart: true },
      },
      {
        id: 'review',
        type: 'processStep',
        position: { x: 250, y: 150 },
        data: { label: 'Manager Review', description: 'Initial review' },
      },
      {
        id: 'decision1',
        type: 'decision',
        position: { x: 480, y: 85 },
        data: { label: 'Approved?', yesLabel: 'Yes', noLabel: 'No' },
      },
      {
        id: 'revise',
        type: 'processStep',
        position: { x: 480, y: 300 },
        data: { label: 'Revise Request', description: 'Make changes' },
      },
      {
        id: 'final',
        type: 'processStep',
        position: { x: 700, y: 150 },
        data: { label: 'Final Approval', description: 'Director approval' },
      },
      {
        id: 'decision2',
        type: 'decision',
      ...
      },
      {
        ...
        data: { label: 'Approved', isStart: false },
      },
      {
        id: 'rejected',
        type: 'startEnd',
        position: { x: 1150, y: 250 },
        data: { label: 'Rejected', isStart: false },
      },
    ],
    edges: [
    ...
    nodes: [
      {
        ...
        type: 'startEnd',
        position: { x: 50, y: 100 },
        data: { label: 'New Hire', isStart: true },
      },
      {
        id: 'docs',
        type: 'processStep',
        position: { x: 250, y: 100 },
        data: { label: 'Paperwork', description: 'Complete HR documents' },
      },
      {
        id: 'it',
        type: 'processStep',
        position: { x: 500, y: 100 },
        data: { label: 'IT Setup', description: 'Equipment & accounts' },
      },
      {
        id: 'training',
        type: 'processStep',
        position: { x: 750, y: 100 },
        data: { label: 'Training', description: 'Initial training' },
      },
      {
        id: 'mentor',
        type: 'processStep',
        position: { x: 1000, y: 100 },
        data: { label: 'Mentor Assignment', description: 'Assign buddy' },
      },
      {
        id: 'end',
        type: 'startEnd',
        position: { x: 1250, y: 100 },
        data: { label: 'Onboarded', isStart: false },
      },
    ],
    edges: [
    ...
    nodes: [
      {
        ...
        type: 'orgUnit',
        position: { x: 350, y: 50 },
        data: { label: 'CEO', role: 'Chief Executive', type: 'person' },
      },
      {
        id: 'cto',
        type: 'orgUnit',
        position: { x: 100, y: 200 },
        data: { label: 'CTO', role: 'Technology', type: 'person' },
      },
      {
        id: 'cfo',
        type: 'orgUnit',
        position: { x: 350, y: 200 },
        data: { label: 'CFO', role: 'Finance', type: 'person' },
      },
      {
        id: 'coo',
        type: 'orgUnit',
        position: { x: 600, y: 200 },
        data: { label: 'COO', role: 'Operations', type: 'person' },
      },
      {
        id: 'eng',
        type: 'orgUnit',
      ...
      },
      {
        ...
        data: { label: 'Product', type: 'department' },
      },
      {
        id: 'fin',
        type: 'orgUnit',
        position: { x: 350, y: 350 },
        data: { label: 'Finance', type: 'department' },
      },
      {
        id: 'ops',
        type: 'orgUnit',
        position: { x: 500, y: 350 },
        data: { label: 'Operations', type: 'department' },
      },
      {
        id: 'hr',
        type: 'orgUnit',
        position: { x: 700, y: 350 },
        data: { label: 'HR', type: 'department' },
      },
    ],
    edges: [
    ...
    nodes: [
      {
        ...
        type: 'mindmapNode',
        position: { x: 350, y: 200 },
        data: { label: 'Project Idea', level: 0, color: 'blue' },
      },
      {
        id: 'goals',
        type: 'mindmapNode',
        position: { x: 100, y: 100 },
        data: { label: 'Goals', level: 1, color: 'green' },
      },
      {
        id: 'resources',
        type: 'mindmapNode',
        position: { x: 600, y: 100 },
        data: { label: 'Resources', level: 1, color: 'amber' },
      },
      {
        id: 'risks',
        type: 'mindmapNode',
        position: { x: 100, y: 300 },
        data: { label: 'Risks', level: 1, color: 'red' },
      },
      {
        id: 'timeline',
        type: 'mindmapNode',
        position: { x: 600, y: 300 },
        data: { label: 'Timeline', level: 1, color: 'purple' },
      },
      {
        id: 'goal1',
        type: 'mindmapNode',
        position: { x: -50, y: 50 },
        data: { label: 'Goal 1', level: 2, color: 'green' },
      },
      {
        id: 'goal2',
        type: 'mindmapNode',
        position: { x: -50, y: 150 },
        data: { label: 'Goal 2', level: 2, color: 'green' },
      },
      {
        id: 'res1',
        type: 'mindmapNode',
        position: { x: 750, y: 50 },
        data: { label: 'Team', level: 2, color: 'amber' },
      },
      {
        id: 'res2',
        type: 'mindmapNode',
        position: { x: 750, y: 150 },
        data: { label: 'Budget', level: 2, color: 'amber' },
      },
    ],
    edges: [
  ...
  // =====================
  {
    ...
    nodes: [
      // Headers - Roles
      {
        ...
        type: 'raciCell',
        position: { x: 150, y: 0 },
        data: { isHeader: true, headerType: 'role', role: 'PM' },
      },
      {
        id: 'h-dev',
        type: 'raciCell',
        position: { x: 300, y: 0 },
        data: { isHeader: true, headerType: 'role', role: 'Dev' },
      },
      {
        id: 'h-qa',
        type: 'raciCell',
        position: { x: 450, y: 0 },
        data: { isHeader: true, headerType: 'role', role: 'QA' },
      },
      {
        id: 'h-lead',
        type: 'raciCell',
        position: { x: 600, y: 0 },
        data: { isHeader: true, headerType: 'role', role: 'Lead' },
      },
      // Headers - Tasks
      {
        id: 'h-t1',
        type: 'raciCell',
        position: { x: 0, y: 80 },
        data: { isHeader: true, headerType: 'task', task: 'Planning' },
      },
      {
        id: 'h-t2',
        type: 'raciCell',
        position: { x: 0, y: 160 },
        data: { isHeader: true, headerType: 'task', task: 'Development' },
      },
      {
        id: 'h-t3',
        type: 'raciCell',
        position: { x: 0, y: 240 },
        data: { isHeader: true, headerType: 'task', task: 'Testing' },
      },
      {
        id: 'h-t4',
        type: 'raciCell',
        position: { x: 0, y: 320 },
        data: { isHeader: true, headerType: 'task', task: 'Deployment' },
      },
  ...
  // =====================
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        type: 'swimlane',
        position: { x: 0, y: 140 },
        data: { label: 'Operations', color: 'green' },
        style: { width: 800, height: 120 },
      },
      {
        id: 'lane-fin',
        type: 'swimlane',
        position: { x: 0, y: 280 },
        data: { label: 'Finance', color: 'amber' },
        style: { width: 800, height: 120 },
      },
      // Process steps
      {
...
async function seedTemplates() {
  ...
  try {
    ...
    const tableCheck = await new Promise((resolve, reject) => {
      db.get(
        "SELECT name FROM sqlite_master WHERE type='table' AND name='studio_templates'",
        (err, row) => {
          if (err) reject(err);
          else resolve(row);
        }
    ...
    const existing = await dbAll(
      'SELECT id, name FROM studio_templates WHERE organization_id IS NULL'
    );
