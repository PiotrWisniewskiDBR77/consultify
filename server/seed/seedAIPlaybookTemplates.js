  ...
  const templates = [
    {
      ...
      description:
        'AI-orchestrated workflow to unblock a stalled initiative through task creation, meeting scheduling, and stakeholder engagement.',
    ...
    },
    {
      ...
      description:
        'Re-engage a user who shows signs of disengagement through targeted help and check-ins.',
    ...
    },
    {
      ...
      description:
        'Systematic cleanup of overdue tasks with reprioritization and stakeholder communication.',
...
export { seedAIPlaybookTemplates };
