...
const DEPENDENCIES = [
  {
    from: 'Cloud Infrastructure Migration',
    to: 'AI-Powered Demand Forecasting',
  ...
  {
    from: 'Data Lake Implementation',
    to: 'Real-time Analytics Dashboard',
    type: 'FINISH_TO_START',
  },
  {
    from: 'Zero Trust Security Implementation',
    to: 'Customer Data Platform',
    type: 'START_TO_START',
  },
  {
    from: 'IoT Factory Floor Integration',
    to: 'Digital Twin Manufacturing',
    type: 'FINISH_TO_START',
  },
