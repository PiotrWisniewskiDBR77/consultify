...
// Demo Users
const DEMO_USERS = [
    { id: 'demo-user-ceo', email: 'anna.kowalska@acme-demo.com', firstName: 'Anna', lastName: 'Kowalska', role: 'ADMIN', title: 'CEO' },
    { id: 'demo-user-cto', email: 'tomasz.nowak@acme-demo.com', firstName: 'Tomasz', lastName: 'Nowak', role: 'ADMIN', title: 'CTO' },
    { id: 'demo-user-cfo', email: 'maria.wisniewska@acme-demo.com', firstName: 'Maria', lastName: 'Wiśniewska', role: 'ADMIN', title: 'CFO' },
    { id: 'demo-user-pm1', email: 'jan.kowalczyk@acme-demo.com', firstName: 'Jan', lastName: 'Kowalczyk', role: 'USER', title: 'Project Manager' },
    { id: 'demo-user-pm2', email: 'ewa.nowicka@acme-demo.com', firstName: 'Ewa', lastName: 'Nowicka', role: 'USER', title: 'Senior PM' },
    { id: 'demo-user-analyst', email: 'piotr.lewandowski@acme-demo.com', firstName: 'Piotr', lastName: 'Lewandowski', role: 'USER', title: 'Business Analyst' },
    { id: 'demo-user-dev1', email: 'karolina.mazur@acme-demo.com', firstName: 'Karolina', lastName: 'Mazur', role: 'USER', title: 'Tech Lead' },
    { id: 'demo-user-dev2', email: 'michal.wojcik@acme-demo.com', firstName: 'Michał', lastName: 'Wójcik', role: 'USER', title: 'Senior Developer' },
];
...
const DEMO_TASKS = [
    ...
    createTask({ id: uuidv4(), initiativeId: 'demo-init-rpa', projectId: 'demo-proj-transform', status: 'COMPLETED', priority: 'HIGH', assignee: 'demo-user-analyst', dueDate: '2025-01-15' }, {
        title: {
    ...
    createTask({ id: uuidv4(), initiativeId: 'demo-init-rpa', projectId: 'demo-proj-transform', status: 'COMPLETED', priority: 'HIGH', assignee: 'demo-user-dev1', dueDate: '2025-01-30' }, {
        title: {
    ...
    createTask({ id: uuidv4(), initiativeId: 'demo-init-rpa', projectId: 'demo-proj-transform', status: 'COMPLETED', priority: 'HIGH', assignee: 'demo-user-dev2', dueDate: '2025-02-28' }, {
        title: {
    ...
    createTask({ id: uuidv4(), initiativeId: 'demo-init-rpa', projectId: 'demo-proj-transform', status: 'IN_PROGRESS', priority: 'HIGH', assignee: 'demo-user-pm1', dueDate: '2025-04-30' }, {
        title: {
    ...
    createTask({ id: uuidv4(), initiativeId: 'demo-init-rpa', projectId: 'demo-proj-transform', status: 'IN_PROGRESS', priority: 'MEDIUM', assignee: 'demo-user-analyst', dueDate: '2025-03-31' }, {
        title: {
    ...
    createTask({ id: uuidv4(), initiativeId: 'demo-init-rpa', projectId: 'demo-proj-transform', status: 'TODO', priority: 'MEDIUM', assignee: 'demo-user-dev2', dueDate: '2025-05-31' }, {
        title: {
    ...
    createTask({ id: uuidv4(), initiativeId: 'demo-init-cloud', projectId: 'demo-proj-transform', status: 'COMPLETED', priority: 'HIGH', assignee: 'demo-user-dev1', dueDate: '2025-01-20' }, {
        title: { pl: 'Audyt infrastruktury on-premise', en: 'On-Premise Infrastructure Audit', de: 'On-Premise-Infrastruktur-Audit', es: 'Auditoría de Infraestructura On-Premise', ar: 'تدقيق البنية التحتية المحلية', ja: 'オンプレミスインフラの監査' }
    }),
    createTask({ id: uuidv4(), initiativeId: 'demo-init-cloud', projectId: 'demo-proj-transform', status: 'COMPLETED', priority: 'HIGH', assignee: 'demo-user-dev1', dueDate: '2025-02-15' }, {
        title: { pl: 'Projekt architektury AWS', en: 'AWS Architecture Design', de: 'AWS-Architekturdesign', es: 'Diseño de Arquitectura AWS', ar: 'تصميم بنية AWS', ja: 'AWSアーキテクチャ設計' }
    }),
    createTask({ id: uuidv4(), initiativeId: 'demo-init-cloud', projectId: 'demo-proj-transform', status: 'COMPLETED', priority: 'HIGH', assignee: 'demo-user-dev2', dueDate: '2025-03-01' }, {
        title: { pl: 'Migracja środowiska DEV', en: 'DEV Environment Migration', de: 'DEV-Umgebungsmigration', es: 'Migración del Entorno DEV', ar: 'هجرة بيئة التطوير', ja: 'DEV環境の移行' }
    }),
    createTask({ id: uuidv4(), initiativeId: 'demo-init-cloud', projectId: 'demo-proj-transform', status: 'IN_PROGRESS', priority: 'HIGH', assignee: 'demo-user-dev2', dueDate: '2025-04-15' }, {
        title: { pl: 'Migracja środowiska UAT', en: 'UAT Environment Migration', de: 'UAT-Umgebungsmigration', es: 'Migración del Entorno UAT', ar: 'هجرة بيئة الاختبار', ja: 'UAT環境の移行' }
    }),
    createTask({ id: uuidv4(), initiativeId: 'demo-init-cloud', projectId: 'demo-proj-transform', status: 'TODO', priority: 'HIGH', assignee: 'demo-user-dev1', dueDate: '2025-05-30' }, {
        title: { pl: 'Migracja PROD - faza 1', en: 'PROD Migration - Phase 1', de: 'PROD-Migration - Phase 1', es: 'Migración PROD - Fase 1', ar: 'هجرة الإنتاج - المرحلة 1', ja: 'PROD移行 - フェーズ1' }
    }),
    createTask({ id: uuidv4(), initiativeId: 'demo-init-cloud', projectId: 'demo-proj-transform', status: 'TODO', priority: 'MEDIUM', assignee: 'demo-user-dev1', dueDate: '2025-06-30' }, {
        title: { pl: 'Konfiguracja Disaster Recovery', en: 'Disaster Recovery Setup', de: 'Disaster-Recovery-Einrichtung', es: 'Configuración de Recuperación ante Desastres', ar: 'إعداد استعادة الكوارث', ja: '災害復旧の設定' }
    }),
    
    // Data Lake Tasks
    createTask({ id: uuidv4(), initiativeId: 'demo-init-data-lake', projectId: 'demo-proj-transform', status: 'COMPLETED', priority: 'HIGH', assignee: 'demo-user-analyst', dueDate: '2025-02-01' }, {
        title: { pl: 'Wybór technologii (Snowflake vs Databricks)', en: 'Technology Selection (Snowflake vs Databricks)', de: 'Technologieauswahl (Snowflake vs Databricks)', es: 'Selección de Tecnología (Snowflake vs Databricks)', ar: 'اختيار التكنولوجيا (Snowflake مقابل Databricks)', ja: 'テクノロジー選択（Snowflake vs Databricks）' }
    }),
    createTask({ id: uuidv4(), initiativeId: 'demo-init-data-lake', projectId: 'demo-proj-transform', status: 'IN_PROGRESS', priority: 'HIGH', assignee: 'demo-user-dev1', dueDate: '2025-04-30' }, {
        title: { pl: 'Budowa Data Lake na AWS S3', en: 'Data Lake Build on AWS S3', de: 'Data Lake-Aufbau auf AWS S3', es: 'Construcción de Data Lake en AWS S3', ar: 'بناء بحيرة البيانات على AWS S3', ja: 'AWS S3でのデータレイク構築' }
    }),
    createTask({ id: uuidv4(), initiativeId: 'demo-init-data-lake', projectId: 'demo-proj-transform', status: 'IN_PROGRESS', priority: 'MEDIUM', assignee: 'demo-user-analyst', dueDate: '2025-05-15' }, {
        title: { pl: 'Integracja źródeł danych (ERP, CRM, IoT)', en: 'Data Sources Integration (ERP, CRM, IoT)', de: 'Datenquellenintegration (ERP, CRM, IoT)', es: 'Integración de Fuentes de Datos (ERP, CRM, IoT)', ar: 'تكامل مصادر البيانات (ERP, CRM, IoT)', ja: 'データソース統合（ERP、CRM、IoT）' }
    }),
    createTask({ id: uuidv4(), initiativeId: 'demo-init-data-lake', projectId: 'demo-proj-transform', status: 'TODO', priority: 'MEDIUM', assignee: 'demo-user-analyst', dueDate: '2025-06-30' }, {
        title: { pl: 'Budowa dashboardów analitycznych', en: 'Analytics Dashboards Build', de: 'Aufbau von Analyse-Dashboards', es: 'Construcción de Dashboards Analíticos', ar: 'بناء لوحات المعلومات التحليلية', ja: '分析ダッシュボードの構築' }
    }),
    
    // AI Hub Tasks
    createTask({ id: uuidv4(), initiativeId: 'demo-init-ai-predict', projectId: 'demo-proj-ai-hub', status: 'IN_PROGRESS', priority: 'HIGH', assignee: 'demo-user-cto', dueDate: '2025-04-15' }, {
        title: { pl: 'Analiza przypadków użycia AI', en: 'AI Use Cases Analysis', de: 'KI-Anwendungsfallanalyse', es: 'Análisis de Casos de Uso de IA', ar: 'تحليل حالات استخدام الذكاء الاصطناعي', ja: 'AIユースケース分析' }
    }),
    createTask({ id: uuidv4(), initiativeId: 'demo-init-ai-predict', projectId: 'demo-proj-ai-hub', status: 'TODO', priority: 'HIGH', assignee: 'demo-user-dev1', dueDate: '2025-06-30' }, {
        title: { pl: 'Integracja z czujnikami IoT', en: 'IoT Sensors Integration', de: 'IoT-Sensorintegration', es: 'Integración con Sensores IoT', ar: 'التكامل مع أجهزة استشعار إنترنت الأشياء', ja: 'IoTセンサー統合' }
    }),
    createTask({ id: uuidv4(), initiativeId: 'demo-init-ai-chatbot', projectId: 'demo-proj-ai-hub', status: 'IN_PROGRESS', priority: 'MEDIUM', assignee: 'demo-user-analyst', dueDate: '2025-04-30' }, {
        title: { pl: 'Wybór platformy NLP (OpenAI vs Azure)', en: 'NLP Platform Selection (OpenAI vs Azure)', de: 'NLP-Plattformauswahl (OpenAI vs Azure)', es: 'Selección de Plataforma NLP (OpenAI vs Azure)', ar: 'اختيار منصة NLP (OpenAI مقابل Azure)', ja: 'NLPプラットフォーム選択（OpenAI vs Azure）' }
    }),
    createTask({ id: uuidv4(), initiativeId: 'demo-init-ai-chatbot', projectId: 'demo-proj-ai-hub', status: 'TODO', priority: 'MEDIUM', assignee: 'demo-user-analyst', dueDate: '2025-05-31' }, {
        title: { pl: 'Przygotowanie bazy wiedzy', en: 'Knowledge Base Preparation', de: 'Wissensbasisvorbereitung', es: 'Preparación de Base de Conocimientos', ar: 'إعداد قاعدة المعرفة', ja: 'ナレッジベースの準備' }
    }),
];
...
// Demo Benefits
const DEMO_BENEFITS = [
    { id: uuidv4(), initiativeId: 'demo-init-rpa', name: 'Redukcja FTE w operacjach', type: 'FINANCIAL', plannedValue: 280000, actualValue: 295000, status: 'REALIZED', category: 'Cost Savings' },
    { id: uuidv4(), initiativeId: 'demo-init-rpa', name: 'Skrócenie czasu procesów o 60%', type: 'OPERATIONAL', plannedValue: null, actualValue: null, status: 'REALIZED', category: 'Efficiency' },
    { id: uuidv4(), initiativeId: 'demo-init-rpa', name: 'Redukcja błędów o 95%', type: 'QUALITY', plannedValue: null, actualValue: null, status: 'IN_PROGRESS', category: 'Quality' },
    { id: uuidv4(), initiativeId: 'demo-init-cloud', name: 'Redukcja kosztów infrastruktury', type: 'FINANCIAL', plannedValue: 180000, actualValue: 165000, status: 'IN_PROGRESS', category: 'Cost Savings' },
    { id: uuidv4(), initiativeId: 'demo-init-cloud', name: 'Zwiększenie dostępności do 99.9%', type: 'OPERATIONAL', plannedValue: null, actualValue: null, status: 'TRACKING', category: 'Reliability' },
    { id: uuidv4(), initiativeId: 'demo-init-erp', name: 'Usprawnienie procesów finansowych', type: 'FINANCIAL', plannedValue: 320000, actualValue: 345000, status: 'REALIZED', category: 'Revenue' },
    { id: uuidv4(), initiativeId: 'demo-init-crm', name: 'Wzrost konwersji sprzedaży o 15%', type: 'FINANCIAL', plannedValue: 250000, actualValue: 280000, status: 'REALIZED', category: 'Revenue' },
];
...
async function seedUsers() {
    ...
    for (const user of DEMO_USERS) {
        ...
        `, [user.id, DEMO_ORG_ID, user.email, hashedPassword, user.firstName, user.lastName, user.role, user.title]);
    }
...
async function seedProjects() {
    ...
    for (const project of DEMO_PROJECTS) {
        ...
        `, [
            project.id, DEMO_ORG_ID, project.name, project.description,
            project.status, project.phase, project.phase,
            project.startDate, project.targetDate, project.budget,
...
async function seedInitiatives() {
    ...
    for (const init of DEMO_INITIATIVES) {
        ...
        `, [
            init.id, DEMO_ORG_ID, init.projectId, init.name, init.description, 
            `Problem: ${init.valueDriver} - ${init.description.substring(0, 100)}`,
            statusMap[init.status] || 'step3', init.status.toLowerCase(),
            priorityMap[init.priority] || 'Med', init.costCapex, init.costOpex,
            init.expectedRoi, init.owner, init.owner
        ]);
    }
...
async function seedTasks() {
    ...
    for (const task of DEMO_TASKS) {
        ...
        `, [
            task.id, DEMO_ORG_ID, task.projectId, task.initiativeId, task.title,
            statusMap[task.status] || 'todo', task.priority.toLowerCase(), task.assignee, task.dueDate
        ]);
    }
...
async function seedBenefits() {
    ...
    for (const benefit of DEMO_BENEFITS) {
        ...
        `, [
            benefit.id, DEMO_ORG_ID, benefit.initiativeId, benefit.name, benefit.type,
            benefit.plannedValue, benefit.actualValue, benefit.status, benefit.category
        ]);
    }
