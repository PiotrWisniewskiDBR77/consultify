    ...
    // ==========================================
    {
        ...
        steps: [
            ...
            },
            {
                ...
                actionType: 'CTA',
                actionPayload: { label: 'help.playbooks.demo_mode_explained.steps.3.action', route: '/auth?action=trial' }
            }
        ]
    },
    {
        ...
        steps: [
            ...
            },
            {
                ...
                actionType: 'CTA',
                actionPayload: { label: 'help.playbooks.start_trial_from_demo.steps.2.action', route: '/auth?action=trial' }
            }
        ]
    },
    ...
    // ==========================================
    {
        ...
        steps: [
            ...
            },
            {
                ...
                actionType: 'CTA',
                actionPayload: { label: 'help.playbooks.trial_days_remaining.steps.3.action', route: '/billing' }
            }
        ]
    },
    {
        ...
        steps: [
            ...
            },
            {
                ...
                actionType: 'CTA',
                actionPayload: { label: 'help.playbooks.invite_team.steps.3.action', route: '/settings/team' }
            }
        ]
    },
    {
        ...
        steps: [
            ...
            },
            {
                ...
                actionType: 'CTA',
                actionPayload: { label: 'help.playbooks.upgrade_to_paid.steps.2.action', route: '/billing/plans' }
            }
        ]
    },
    {
        ...
        steps: [
            ...
            },
            {
                ...
                actionType: 'CTA',
                actionPayload: { label: 'help.playbooks.trial_last_week_upgrade.steps.2.action', route: '/settings?tab=billing' }
            }
        ]
    },
    {
        ...
        steps: [
            ...
            },
            {
                ...
                actionType: 'CTA',
                actionPayload: { label: 'help.playbooks.trial_expired_upgrade.steps.2.action', route: '/settings?tab=billing', primary: true }
            }
        ]
    },
    {
        ...
        steps: [
            ...
            },
            {
                ...
                actionType: 'CTA',
                actionPayload: { label: 'help.playbooks.invite_blocked_explained.steps.2.action', route: '/settings?tab=billing' }
            }
        ]
    },
    ...
    // ==========================================
    {
        ...
        steps: [
            ...
            },
            {
                ...
                actionType: 'CTA',
                actionPayload: { label: 'help.playbooks.first_value_checklist.steps.2.action', route: '/settings/organization' }
            },
            {
                title: 'help.playbooks.first_value_checklist.steps.3.title',
                contentMd: 'help.playbooks.first_value_checklist.steps.3.content',
                actionType: 'CTA',
                actionPayload: { label: 'help.playbooks.first_value_checklist.steps.3.action', route: '/settings/team' }
            },
            {
                title: 'help.playbooks.first_value_checklist.steps.4.title',
                contentMd: 'help.playbooks.first_value_checklist.steps.4.content',
                actionType: 'CTA',
                actionPayload: { label: 'help.playbooks.first_value_checklist.steps.4.action', route: '/projects/new' }
            }
        ]
    },
    {
        ...
        steps: [
            ...
            },
            {
                ...
                actionType: 'CTA',
                actionPayload: { label: 'help.playbooks.invite_users.steps.3.action', route: '/settings/team' }
            }
        ]
    },
    {
        ...
        steps: [
            ...
            },
            {
                ...
                actionType: 'CTA',
                actionPayload: { label: 'help.playbooks.use_ai_features.steps.3.action', action: 'open_ai_chat' }
            }
        ]
    },
    ...
    // ==========================================
    {
        ...
        steps: [
            ...
            },
            {
                ...
                actionType: 'CTA',
                actionPayload: { label: 'help.playbooks.manage_users.steps.3.action', route: '/admin/users' }
            }
        ]
    },
    {
        ...
        steps: [
            ...
            },
            {
                ...
                actionType: 'CTA',
                actionPayload: { label: 'help.playbooks.billing_overview.steps.3.action', route: '/billing' }
            }
        ]
    },
    {
        ...
        steps: [
            ...
            },
            {
                ...
                actionType: 'CTA',
                actionPayload: { label: 'help.playbooks.partner_attribution_explained.steps.2.action', route: '/settings/organization' }
            }
        ]
    }
];
