...
const defaultMegatrends = [
  ...
  },
  {
    industry: 'general',
    type: 'Technology',
    label: 'Machine Learning in Operations',
    description: '',
    base_impact_score: 5,
    initial_ring: 'Now',
  },
  ...
  },
  {
    industry: 'general',
    type: 'Technology',
    label: 'Autonomous Mobile Robots (AMR)',
    description: '',
    base_impact_score: 4,
    initial_ring: 'Watch Closely',
  },
  ...
  },
  {
    industry: 'general',
    type: 'Technology',
    label: 'Computer Vision (Quality, Safety)',
    description: '',
    base_impact_score: 4,
    initial_ring: 'Watch Closely',
  },
  ...
  },
  {
    industry: 'general',
    type: 'Technology',
    label: 'Blockchain for Traceability',
    description: '',
    base_impact_score: 3,
    initial_ring: 'On the Horizon',
  },
  ...
  },
  {
    industry: 'general',
    type: 'Technology',
    label: 'Quantum Computing (far horizon)',
    description: '',
    base_impact_score: 2,
    initial_ring: 'On the Horizon',
  },
  {
    industry: 'general',
    type: 'Technology',
    label: 'Augmented Reality (AR) for maintenance',
    description: '',
    base_impact_score: 3,
    initial_ring: 'On the Horizon',
  },
  {
    industry: 'general',
    type: 'Technology',
    label: 'Virtual Reality (VR) training',
    description: '',
    base_impact_score: 3,
    initial_ring: 'On the Horizon',
  },
  ...
  // Business (Competitive Pressure)
  {
    industry: 'general',
    type: 'Business',
    label: 'Servitization (Product → Service)',
    description: '',
    base_impact_score: 5,
    initial_ring: 'Now',
  },
  ...
  },
  {
    industry: 'general',
    type: 'Business',
    label: 'Platformization / Marketplaces',
    description: '',
    base_impact_score: 4,
    initial_ring: 'Watch Closely',
  },
  ...
  },
  {
    industry: 'general',
    type: 'Business',
    label: 'Shorter product lifecycles',
    description: '',
    base_impact_score: 4,
    initial_ring: 'Watch Closely',
  },
  ...
  },
  {
    industry: 'general',
    type: 'Business',
    label: 'Subscription models in industry',
    description: '',
    base_impact_score: 4,
    initial_ring: 'Watch Closely',
  },
  ...
  },
  {
    industry: 'general',
    type: 'Business',
    label: 'Direct-to-customer models',
    description: '',
    base_impact_score: 3,
    initial_ring: 'On the Horizon',
  },
  ...
  },
  {
    industry: 'general',
    type: 'Business',
    label: 'Automation-driven cost competition',
    description: '',
    base_impact_score: 4,
    initial_ring: 'Watch Closely',
  },
  {
    industry: 'general',
    type: 'Business',
    label: 'Speed-to-market as advantage',
    description: '',
    base_impact_score: 4,
    initial_ring: 'Watch Closely',
  },
  {
    industry: 'general',
    type: 'Business',
    label: 'Digital sales channels (B2B)',
    description: '',
    base_impact_score: 3,
    initial_ring: 'On the Horizon',
  },
  {
    industry: 'general',
    type: 'Business',
    label: 'Standardization vs differentiation',
    description: '',
    base_impact_score: 3,
    initial_ring: 'On the Horizon',
  },
  ...
  },
  {
    industry: 'general',
    type: 'Business',
    label: 'New entrants from tech sector',
    description: '',
    base_impact_score: 3,
    initial_ring: 'On the Horizon',
  },
  {
    industry: 'general',
    type: 'Business',
    label: 'Consolidation of suppliers',
    description: '',
    base_impact_score: 3,
    initial_ring: 'On the Horizon',
  },
  ...
  },
  {
    industry: 'general',
    type: 'Societal',
    label: 'Carbon footprint transparency',
    description: '',
    base_impact_score: 5,
    initial_ring: 'Now',
  },
  ...
  },
  {
    industry: 'general',
    type: 'Societal',
    label: 'Employee expectations (purpose, tools)',
    description: '',
    base_impact_score: 3,
    initial_ring: 'On the Horizon',
  },
  ...
  },
  {
    industry: 'general',
    type: 'Societal',
    label: 'Speed & reliability expectations',
    description: '',
    base_impact_score: 4,
    initial_ring: 'Watch Closely',
  },
  {
    industry: 'general',
    type: 'Societal',
    label: 'Customer transparency demands',
    description: '',
    base_impact_score: 3,
    initial_ring: 'On the Horizon',
  },
  {
    industry: 'general',
    type: 'Societal',
    label: 'Social responsibility of manufacturers',
    description: '',
    base_impact_score: 4,
    initial_ring: 'Watch Closely',
  },
