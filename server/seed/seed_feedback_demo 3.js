...
const SYSTEM_FEEDBACK = [
    ...
    {
        type: 'BUG',
        message: 'Application crashes when exporting large assessment reports (>50 pages) to PDF. The browser freezes and eventually shows "Page Unresponsive" error. This is blocking our quarterly review process.',
        severity: 'CRITICAL',
        status: 'IN_PROGRESS',
        priority: 'critical',
    ...
    {
        type: 'BUG',
        message: 'Login fails intermittently with SSO. About 20% of login attempts result in "Session expired" error even with fresh credentials. Users have to try 2-3 times to get in.',
        severity: 'HIGH',
        status: 'NEW',
        priority: 'high',
        context: '/login',
    ...
    {
        type: 'BUG',
        message: 'Dashboard charts not loading on Safari 17. Shows blank space where charts should be. Works fine on Chrome and Firefox.',
        severity: 'MEDIUM',
        status: 'PENDING',
        priority: 'medium',
        context: '/dashboard',
    ...
    {
        type: 'BUG',
        message: 'Notification bell shows wrong count. It says 5 unread but when I click there are only 2 notifications.',
        severity: 'LOW',
        status: 'NEW',
        priority: 'low',
    ...
    {
        type: 'BUG',
        message: 'AI suggestions sometimes appear in English even when the app is set to Polish language. Inconsistent localization.',
        severity: 'MEDIUM',
        status: 'REVIEWED',
        priority: 'medium',
        context: '/ai-chat',
        adminResponse: 'Thank you for reporting! We are working on improving AI response localization. Fix planned for v2.5.',
    },
    
    // BUGS - Various
    {
        type: 'BUG',
        message: 'Cannot upload files larger than 10MB. The upload appears to complete but the file is not saved. No error message shown.',
        severity: 'MEDIUM',
        status: 'RESOLVED',
        priority: 'medium',
        context: '/documents',
    ...
    {
        type: 'BUG',
        message: 'Timeline view in Roadmap module overlaps items when there are more than 20 initiatives. Text becomes unreadable.',
        severity: 'MEDIUM',
        status: 'NEW',
        priority: 'medium',
        context: '/roadmap',
    ...
    {
        type: 'BUG',
        message: 'Print function cuts off right side of reports. About 2cm of content is missing when printing directly from browser.',
        severity: 'LOW',
        status: 'PENDING',
        priority: 'low',
        context: '/reports',
    ...
    {
        type: 'IDEA',
        message: 'Would love to have a mobile app! I often need to check assessment status or approve initiatives when away from my desk. Even a simple read-only app would be incredibly useful.',
        severity: 'NORMAL',
        status: 'REVIEWED',
        priority: 'high',
        context: '/dashboard',
        adminResponse: 'Great idea! Mobile app is on our roadmap for Q3 2026. We will start with iOS and Android apps with core features.',
        rating: 5,
    },
    {
        type: 'IDEA',
        message: 'Integration with Microsoft Teams would be amazing. We could get notifications about initiative updates directly in our team channels. Many enterprise tools have this already.',
        severity: 'NORMAL',
        status: 'IN_PROGRESS',
        priority: 'high',
    ...
    {
        type: 'IDEA',
        message: 'Add keyboard shortcuts for power users. Things like Ctrl+N for new initiative, Ctrl+S to save, Ctrl+/ for search. Would speed up daily work significantly.',
        severity: 'NORMAL',
        status: 'NEW',
        priority: 'medium',
        context: '/',
    ...
    {
        type: 'IDEA',
        message: 'Custom dashboard widgets would be great. I want to see my KPIs at a glance without navigating to different modules. Let users drag and arrange their own dashboard.',
        severity: 'NORMAL',
        status: 'PENDING',
        priority: 'medium',
        context: '/dashboard',
    ...
    {
        type: 'IDEA',
        message: 'Bulk actions for initiatives - select multiple and change status, assign owner, or move to different phase. Currently have to do each one individually.',
        severity: 'NORMAL',
        status: 'NEW',
        priority: 'medium',
        context: '/initiatives',
    ...
    {
        type: 'IDEA',
        message: 'Dark mode please! Working late hours and the bright interface is harsh on the eyes. Many modern apps have this as standard.',
        severity: 'NORMAL',
        status: 'IN_PROGRESS',
        priority: 'medium',
        context: '/settings',
    ...
    {
        type: 'IDEA',
        message: 'Add templates for common initiative types. We often create similar initiatives (Process Automation, Digital Training, etc.) and having templates would save time.',
        severity: 'NORMAL',
        status: 'REVIEWED',
        priority: 'medium',
        context: '/initiatives/new',
        adminResponse: 'Initiative templates are now available in the latest update! Check the "Templates" tab when creating new initiatives.',
        rating: 4,
    },
    {
        type: 'IDEA',
        message: 'Would be nice to have a "Focus Mode" that hides all distractions and shows only the current task/assessment I am working on.',
        severity: 'NORMAL',
        status: 'NEW',
        priority: 'low',
        context: '/assessment',
    ...
    {
        type: 'IDEA',
        message: 'Export to PowerPoint format for executive presentations. Currently I have to screenshot charts and paste them manually.',
        severity: 'NORMAL',
        status: 'NEW',
        priority: 'medium',
    ...
    {
        type: 'IDEA',
        message: 'AI should remember my preferences across sessions. It keeps asking about company size and industry every time I start a new chat.',
        severity: 'NORMAL',
        status: 'RESOLVED',
        priority: 'medium',
        context: '/ai-chat',
        adminResponse: 'AI memory feature is now live! The AI will remember your context and preferences across conversations.',
        rating: 4,
    },
    ...
    {
        type: 'IDEA',
        message: 'Just wanted to say the new assessment wizard is fantastic! It reduced our assessment time from 3 days to just 4 hours. The AI suggestions are spot-on. Great work team!',
        severity: 'NORMAL',
        status: 'REVIEWED',
        priority: 'low',
        context: '/assessment',
        adminResponse: 'Thank you so much for the kind words! We are thrilled the new wizard is helping your team. Feel free to share any other feedback!',
        rating: 5,
    },
];
...
const FEATURE_REQUESTS = [
    {
        ...
        description: 'Native mobile apps for iOS and Android to access key features on the go. Should include dashboard view, initiative status, notifications, and basic AI chat capabilities.',
        impact: 'high',
        status: 'PLANNED',
        votes: 47,
    ...
    },
    {
        ...
        description: 'Bi-directional integration with MS Teams: notifications in channels, ability to create initiatives from Teams, and embedded dashboard widgets.',
        impact: 'high',
        status: 'IN_PROGRESS',
        votes: 38,
    ...
    },
    {
        ...
        description: 'System-wide dark theme option. Should respect OS preference and include manual toggle. All charts and graphs should adapt to dark theme.',
        impact: 'medium',
        status: 'IN_PROGRESS',
        votes: 52,
    ...
    },
    {
        ...
        description: 'Global keyboard shortcuts for common actions: navigation, creating items, saving, searching. Include a shortcut cheat sheet accessible via Ctrl+?',
        impact: 'medium',
        status: 'PLANNED',
        votes: 29,
        targetRelease: 'Q2 2026',
    },
    {
        ...
        description: 'Drag-and-drop dashboard builder. Users should be able to add/remove widgets, resize them, and save multiple dashboard layouts for different use cases.',
        impact: 'high',
        status: 'REVIEWING',
        votes: 41,
    ...
    },
    {
        ...
        description: 'Multi-select initiatives and perform bulk operations: change status, assign owner, update phase, add tags, or delete. Essential for portfolio management.',
        impact: 'high',
        status: 'PLANNED',
        votes: 34,
    ...
    },
    {
        ...
        description: 'Slack app with notifications, slash commands to check status, and ability to create quick notes/updates directly from Slack.',
        impact: 'medium',
        status: 'REVIEWING',
        votes: 25,
    },
    {
        ...
        description: 'Export reports and dashboards directly to .pptx format with editable charts. Include multiple template options for different presentation styles.',
        impact: 'medium',
        status: 'NEW',
        votes: 31,
    },
    {
        ...
        description: 'Global search across all modules with filters, saved searches, and search history. Include boolean operators and field-specific searches.',
        impact: 'medium',
        status: 'PLANNED',
        votes: 27,
        targetRelease: 'Q2 2026',
    },
    {
        ...
        description: 'Interactive onboarding for new users with step-by-step tutorials, sample data option, and contextual help throughout the first week.',
        impact: 'medium',
        status: 'COMPLETED',
        votes: 19,
    ...
    },
    {
        ...
        description: 'Outbound webhooks for key events (initiative created, status changed, assessment completed). Include webhook management UI and retry logic.',
        impact: 'high',
        status: 'COMPLETED',
        votes: 22,
    ...
    },
    {
        ...
        description: 'AI should remember user preferences, company context, and past conversations. Build a knowledge graph of user interactions for personalized suggestions.',
        impact: 'high',
        status: 'COMPLETED',
        votes: 36,
    ...
    },
    {
        ...
        description: 'Distraction-free mode that hides navigation, notifications, and other UI elements. Shows only the current task with a clean interface.',
        impact: 'low',
        status: 'NEW',
        votes: 14,
    },
    {
        ...
        description: 'Traditional Gantt chart visualization for roadmap with dependencies, milestones, critical path highlighting, and resource allocation view.',
        impact: 'high',
        status: 'REVIEWING',
        votes: 33,
    ...
    },
    {
        ...
        description: 'Two-way sync with Jira and Linear. Map initiatives to epics, sync status updates, and import existing projects.',
        impact: 'high',
        status: 'PLANNED',
        votes: 28,
        targetRelease: 'Q3 2026',
...
const generateAIAnalysis = (feedback) => {
    ...
    if (msg.includes('crash') || msg.includes('error') || msg.includes('fail')) categories.push('stability');
    if (msg.includes('slow') || msg.includes('performance') || msg.includes('speed')) categories.push('performance');
    if (msg.includes('ui') || msg.includes('interface') || msg.includes('design')) categories.push('ui');
    if (msg.includes('feature') || msg.includes('add') || msg.includes('want')) categories.push('feature');
    if (msg.includes('mobile') || msg.includes('app')) categories.push('mobile');
    if (msg.includes('integration') || msg.includes('teams') || msg.includes('slack')) categories.push('integration');
    ...
    return {
        ...
        priorityScore,
        suggestedActions: feedback.type === 'BUG' 
