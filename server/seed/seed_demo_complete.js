...
const TEAM_MEMBERS = [
  {
    ...
    lastName: 'Chen',
    role: 'USER',
    email: 'sarah.chen@techvision.demo',
  ...
  },
  {
    ...
    lastName: 'Johnson',
    role: 'USER',
    email: 'marcus.j@techvision.demo',
    avatar: 'https://i.pravatar.cc/150?u=marcus-j',
  },
  {
    id: uuidv4(),
    firstName: 'Elena',
    lastName: 'Rodriguez',
    role: 'USER',
    email: 'elena.r@techvision.demo',
    avatar: 'https://i.pravatar.cc/150?u=elena-r',
  },
  {
    id: uuidv4(),
    firstName: 'David',
    lastName: 'Kim',
    role: 'USER',
    email: 'david.kim@techvision.demo',
...
const INITIATIVES = [
  ...
  {
    name: 'Smart Production Line Integration',
    category: 'processes',
    priority: 'HIGH',
    status: 'IN_PROGRESS',
    effort: 'L',
...
const TASK_TEMPLATES = [
  // In Progress
  {
    title: 'Configure ML pipeline for demand forecasting',
    status: 'IN_PROGRESS',
    priority: 'HIGH',
    dueOffset: 3,
  },
  {
    title: 'Review supplier integration API documentation',
    status: 'IN_PROGRESS',
    priority: 'MEDIUM',
    dueOffset: 2,
  },
  {
    title: 'Prepare stakeholder presentation for Q1 review',
    status: 'IN_PROGRESS',
    priority: 'HIGH',
    dueOffset: 1,
  },
  {
    title: 'Test new customer portal authentication flow',
    status: 'IN_PROGRESS',
    priority: 'HIGH',
    dueOffset: 4,
  },
  {
    title: 'Document data governance policies',
    status: 'IN_PROGRESS',
    priority: 'MEDIUM',
    dueOffset: 5,
  },
  ...
  {
    title: 'Create training materials for new ERP module',
    status: 'TODO',
    priority: 'MEDIUM',
    dueOffset: 10,
  },
  ...
  {
    title: 'Set up monitoring dashboards for production',
    status: 'TODO',
    priority: 'MEDIUM',
    dueOffset: 8,
  },
  ...
  // Done (recently)
  {
    title: 'Complete Phase 1 infrastructure setup',
    status: 'DONE',
    priority: 'HIGH',
    dueOffset: -2,
  },
  ...
  {
    title: 'Research AI model optimization techniques',
    status: 'TODO',
    priority: 'MEDIUM',
    dueOffset: 15,
  },
  {
    title: 'Draft communication plan for go-live',
    status: 'TODO',
    priority: 'MEDIUM',
    dueOffset: 20,
  },
  {
    title: 'Coordinate with legal on data compliance',
    status: 'TODO',
    priority: 'HIGH',
    dueOffset: 7,
  },
...
const NOTIFICATION_TEMPLATES = [
  {
    ...
    message: 'You have been assigned to "Configure ML pipeline for demand forecasting"',
    read: false,
  },
  {
    type: 'assessment_approved',
    title: 'Assessment Approved',
    message: 'Digital Factory 4.0 assessment has been approved by stakeholders',
    read: false,
  },
  {
    type: 'initiative_update',
    title: 'Initiative Status Changed',
    message: 'Predictive Maintenance System moved to Approved status',
    read: false,
  },
  {
    type: 'deadline_reminder',
    title: 'Deadline Approaching',
    message: 'Task "Prepare stakeholder presentation" is due tomorrow',
    read: false,
  },
  {
    type: 'comment_mention',
    title: 'You were mentioned',
    message: 'Sarah Chen mentioned you in a comment on the Data Lake project',
    read: true,
  },
  {
    type: 'report_ready',
    title: 'Report Generated',
    message: 'Your DRD Executive Summary is ready for download',
    read: true,
  },
  {
    type: 'team_update',
    title: 'New Team Member',
    message: 'David Kim has joined the Digital Factory 4.0 project',
    read: true,
  },
  {
    type: 'milestone_completed',
    title: 'Milestone Completed',
    message: 'Phase 1 of Supply Chain Digitalization is complete',
    read: true,
  },
];
