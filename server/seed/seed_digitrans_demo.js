...
const DEMO_ORG = {
  ...
  description:
    'Wiodąca polska firma konsultingowa specjalizująca się w transformacji cyfrowej przedsiębiorstw.',
};
...
const ASSESSMENT_SCENARIOS = [
  {
    ...
    description:
      'Kompleksowa ocena dojrzałości cyfrowej w kontekście Przemysłu 4.0. Obejmuje IoT, automatyzację i smart manufacturing.',
    status: 'APPROVED',
    scores: {
      processes: {
        asIs: 4,
        toBe: 6,
        justification: 'Automatyzacja kluczowych procesów produkcyjnych',
      },
      digitalProducts: {
        asIs: 3,
        toBe: 5,
        justification: 'Wdrożenie czujników IoT i systemów SCADA',
      },
      businessModels: {
        asIs: 3,
        toBe: 5,
        justification: 'Product-as-a-Service dla kluczowych klientów',
      },
      dataManagement: {
        asIs: 4,
        toBe: 6,
        justification: 'Centralne repozytorium danych produkcyjnych',
      },
      ...
      aiMaturity: {
        asIs: 2,
        toBe: 5,
        justification: 'Predictive maintenance i optymalizacja produkcji',
      },
    },
  },
  {
    ...
    description:
      'Transformacja łańcucha dostaw w kierunku pełnej widoczności i predykcji. Integracja z dostawcami i optymalizacja zapasów.',
    status: 'IN_REVIEW',
    scores: {
      ...
      digitalProducts: {
        asIs: 2,
        toBe: 4,
        justification: 'Portal dostawców i tracking w czasie rzeczywistym',
      },
      ...
      cybersecurity: {
        asIs: 4,
        toBe: 6,
        justification: 'Bezpieczeństwo danych w sieci partnerskiej',
      },
      aiMaturity: {
        asIs: 1,
        toBe: 4,
        justification: 'Demand forecasting i inventory optimization',
      },
    },
  },
  {
    ...
    description:
      'Budowa omnichannelowej platformy obsługi klienta. Personalizacja, CRM nowej generacji i integracja touchpointów.',
    status: 'IN_REVIEW',
    scores: {
      ...
      businessModels: {
        asIs: 4,
        toBe: 6,
        justification: 'Subscription models i personalized offerings',
      },
      dataManagement: {
        asIs: 3,
        toBe: 6,
        justification: 'Customer 360 view i real-time analytics',
      },
  ...
  },
  {
    ...
    description:
      'Budowa zdolności AI/ML w organizacji. MLOps, governance modeli i demokratyzacja data science.',
    status: 'DRAFT',
    scores: {
      ...
      businessModels: {
        asIs: 2,
        toBe: 5,
        justification: 'AI-as-a-Service dla jednostek biznesowych',
      },
  ...
  },
  {
    ...
    description:
      'Monitorowanie i raportowanie ESG w czasie rzeczywistym. Digital twin dla śladu węglowego i circular economy.',
    status: 'DRAFT',
    scores: {
...
const INITIATIVES = [
  ...
  {
    name: 'Integracja Linii Produkcyjnej 4.0',
    nameEn: 'Smart Production Line Integration',
    category: 'processes',
    priority: 'HIGH',
    status: 'IN_PROGRESS',
    effort: 'L',
  ...
  {
    name: 'System Predictive Maintenance',
    nameEn: 'Predictive Maintenance System',
    category: 'aiMaturity',
    priority: 'HIGH',
    status: 'APPROVED',
    effort: 'M',
  ...
  {
    name: 'Wdrożenie Digital Twin',
    nameEn: 'Digital Twin Implementation',
  ...
  // From Supply Chain
  {
    ...
    nameEn: 'Real-time Inventory Tracking',
  ...
  {
    name: 'Portal Dostawców 2.0',
    nameEn: 'Supplier Portal 2.0',
    category: 'processes',
    priority: 'MEDIUM',
    status: 'IN_PROGRESS',
    effort: 'M',
  ...
  {
    name: 'Platforma Customer 360',
    nameEn: 'Customer 360 Platform',
    category: 'dataManagement',
    priority: 'HIGH',
    status: 'IN_PROGRESS',
    effort: 'L',
  ...
  {
    name: 'Wdrożenie AI Chatbot',
    nameEn: 'AI Chatbot Implementation',
    category: 'aiMaturity',
    priority: 'MEDIUM',
    status: 'COMPLETED',
    effort: 'S',
  ...
  {
    name: 'Redesign Aplikacji Mobilnej',
    nameEn: 'Mobile App Redesign',
    category: 'digitalProducts',
    priority: 'HIGH',
    status: 'IN_PROGRESS',
    effort: 'M',
  ...
  // From AI Operations
  {
    name: 'Budowa Platformy MLOps',
    nameEn: 'ML Platform Setup',
    category: 'aiMaturity',
    priority: 'HIGH',
    status: 'APPROVED',
    effort: 'L',
  ...
  {
    name: 'Architektura Data Lake',
    nameEn: 'Data Lake Architecture',
    category: 'dataManagement',
    priority: 'HIGH',
    status: 'IN_PROGRESS',
    effort: 'L',
  ...
  {
    name: 'Framework AI Ethics',
    nameEn: 'AI Ethics Framework',
    category: 'culture',
    priority: 'MEDIUM',
    status: 'DRAFT',
    effort: 'S',
  ...
  // From Sustainability
  {
    name: 'Dashboard Śladu Węglowego',
    nameEn: 'Carbon Footprint Dashboard',
    category: 'dataManagement',
    priority: 'MEDIUM',
    status: 'COMPLETED',
    effort: 'M',
  ...
  {
    name: 'Automatyzacja Raportowania ESG',
    nameEn: 'ESG Reporting Automation',
    category: 'processes',
    priority: 'HIGH',
    status: 'IN_PROGRESS',
    effort: 'M',
  ...
  {
    name: 'Circular Economy Tracker',
    nameEn: 'Circular Economy Tracker',
    category: 'businessModels',
    priority: 'LOW',
    status: 'DRAFT',
    effort: 'M',
    impact: 'MEDIUM',
...
const TASK_TEMPLATES = [
  ...
  {
    title: 'Konfiguracja pipeline ML dla prognozowania popytu',
    titleEn: 'Configure ML pipeline for demand forecasting',
    status: 'IN_PROGRESS',
    priority: 'HIGH',
    dueOffset: 3,
  },
  {
    title: 'Przegląd dokumentacji API integracji dostawców',
    titleEn: 'Review supplier integration API documentation',
    status: 'IN_PROGRESS',
    priority: 'MEDIUM',
    dueOffset: 2,
  },
  {
    title: 'Przygotowanie prezentacji dla stakeholderów Q1',
    titleEn: 'Prepare stakeholder presentation for Q1 review',
    status: 'IN_PROGRESS',
    priority: 'HIGH',
    dueOffset: 1,
  },
  {
    title: 'Testowanie flow autentykacji portalu klienta',
    titleEn: 'Test new customer portal authentication flow',
    status: 'IN_PROGRESS',
    priority: 'HIGH',
    dueOffset: 4,
  },
  {
    title: 'Dokumentacja polityk data governance',
    titleEn: 'Document data governance policies',
    status: 'IN_PROGRESS',
    priority: 'MEDIUM',
    dueOffset: 5,
  },
  ...
  // To Do
  {
    title: 'Zaplanowanie demo czujników IoT z dostawcą',
    titleEn: 'Schedule vendor demo for IoT sensors',
    status: 'TODO',
    priority: 'LOW',
    dueOffset: 7,
  },
  {
    title: 'Przygotowanie materiałów szkoleniowych ERP',
    titleEn: 'Create training materials for new ERP module',
    status: 'TODO',
    priority: 'MEDIUM',
    dueOffset: 10,
  },
  {
    title: 'Analiza zależności systemów legacy',
    titleEn: 'Analyze legacy system dependencies',
    status: 'TODO',
    priority: 'HIGH',
    dueOffset: 5,
  },
  {
    title: 'Konfiguracja dashboardów monitoringu',
    titleEn: 'Set up monitoring dashboards for production',
    status: 'TODO',
    priority: 'MEDIUM',
    dueOffset: 8,
  },
  {
    title: 'Przegląd wyników audytu bezpieczeństwa',
    titleEn: 'Review security audit findings',
    status: 'TODO',
    priority: 'HIGH',
    dueOffset: 3,
  },
  ...
  // Done (recently)
  {
    title: 'Zakończenie setup infrastruktury Fazy 1',
    titleEn: 'Complete Phase 1 infrastructure setup',
    status: 'DONE',
    priority: 'HIGH',
    dueOffset: -2,
  },
  {
    title: 'Finalizacja negocjacji kontraktu z vendorem',
    titleEn: 'Finalize vendor contract negotiations',
    status: 'DONE',
    priority: 'HIGH',
    dueOffset: -3,
  },
  {
    title: 'Deploy środowiska stagingowego',
    titleEn: 'Deploy staging environment',
    status: 'DONE',
    priority: 'MEDIUM',
    dueOffset: -1,
  },
  {
    title: 'Przeprowadzenie testów UAT',
    titleEn: 'Conduct user acceptance testing',
    status: 'DONE',
    priority: 'HIGH',
    dueOffset: -4,
  },
  {
    ...
    titleEn: 'Update project timeline documentation',
    status: 'DONE',
    priority: 'LOW',
    dueOffset: -5,
  },
  ...
  // Upcoming
  {
    title: 'Planowanie kickoff meeting Fazy 2',
    titleEn: 'Plan Phase 2 kickoff meeting',
    status: 'TODO',
    priority: 'HIGH',
    dueOffset: 14,
  },
  {
    title: 'Przygotowanie propozycji budżetowej dla zarządu',
    titleEn: 'Prepare budget proposal for board',
    status: 'TODO',
    priority: 'HIGH',
    dueOffset: 12,
  },
  {
    title: 'Research technik optymalizacji modeli AI',
    titleEn: 'Research AI model optimization techniques',
    status: 'TODO',
    priority: 'MEDIUM',
    dueOffset: 15,
  },
  {
    title: 'Przygotowanie planu komunikacji go-live',
    titleEn: 'Draft communication plan for go-live',
    status: 'TODO',
    priority: 'MEDIUM',
    dueOffset: 20,
  },
  {
    title: 'Koordynacja z prawnym ws. compliance',
    titleEn: 'Coordinate with legal on data compliance',
    status: 'TODO',
    priority: 'HIGH',
    dueOffset: 7,
  },
  ...
  // More variety
  {
    title: 'Optymalizacja wydajności zapytań DB',
    titleEn: 'Optimize database query performance',
    status: 'IN_PROGRESS',
    priority: 'MEDIUM',
    dueOffset: 6,
  },
  {
    title: 'Przegląd metryk jakości kodu',
    titleEn: 'Review code quality metrics',
    status: 'TODO',
    priority: 'LOW',
    dueOffset: 9,
  },
  {
    title: 'Przygotowanie planu testów DR',
    titleEn: 'Prepare disaster recovery test plan',
    status: 'TODO',
    priority: 'HIGH',
    dueOffset: 11,
  },
  {
    ...
    titleEn: 'Update API documentation',
    status: 'DONE',
    priority: 'MEDIUM',
    dueOffset: -6,
  },
  {
    title: 'Przeprowadzenie retrospektywy zespołu',
    titleEn: 'Conduct team retrospective',
    status: 'DONE',
    priority: 'MEDIUM',
    dueOffset: -7,
  },
...
const NOTIFICATION_TEMPLATES = [
  {
    ...
    message: 'Zostało Ci przypisane zadanie "Konfiguracja pipeline ML"',
    read: false,
  },
  {
    type: 'assessment_approved',
    title: 'Ocena zatwierdzona',
    titleEn: 'Assessment Approved',
    message: 'Ocena "Cyfrowa Transformacja Produkcji" została zatwierdzona przez stakeholderów',
    read: false,
  },
  {
    type: 'initiative_update',
    title: 'Zmiana statusu inicjatywy',
    titleEn: 'Initiative Status Changed',
    message: 'System Predictive Maintenance zmienił status na Zatwierdzony',
    read: false,
  },
  {
    ...
    message: 'Zadanie "Prezentacja dla stakeholderów" jest do wykonania jutro',
    read: false,
  },
  {
    type: 'comment_mention',
    title: 'Wspomniano Cię',
    titleEn: 'You were mentioned',
    message: 'Anna Kowalska wspomniała Cię w komentarzu projektu Data Lake',
    read: true,
  },
  {
    type: 'report_ready',
    ...
    message: 'Twój raport DRD Executive Summary jest gotowy do pobrania',
    read: true,
  },
  {
    type: 'team_update',
    ...
    message: 'Tomasz Lewandowski dołączył do projektu Cyfrowa Transformacja Produkcji',
    read: true,
  },
  {
    type: 'milestone_completed',
    title: 'Kamień milowy ukończony',
    titleEn: 'Milestone Completed',
    message: 'Faza 1 Digitalizacji Łańcucha Dostaw została zakończona',
    read: true,
  },
];
...
const ROADMAP_ITEMS = [
  {
    quarter: 'Q1 2026',
    name: 'Fundament Transformacji',
    initiatives: ['Architektura Data Lake', 'Analiza systemów legacy'],
    status: 'COMPLETED',
  },
  {
    quarter: 'Q1 2026',
    name: 'Quick Wins',
    initiatives: ['Dashboard Śladu Węglowego', 'Wdrożenie AI Chatbot'],
    status: 'COMPLETED',
  },
  {
    quarter: 'Q2 2026',
    name: 'Platformy Kluczowe',
    initiatives: ['Platforma Customer 360', 'Portal Dostawców 2.0'],
    status: 'IN_PROGRESS',
  },
  {
    quarter: 'Q2 2026',
    name: 'Automatyzacja',
    initiatives: ['System Predictive Maintenance', 'AI Demand Forecasting'],
    status: 'IN_PROGRESS',
  },
  {
    quarter: 'Q3 2026',
    name: 'Integracja 4.0',
    initiatives: ['Integracja Linii Produkcyjnej 4.0', 'Real-time Inventory Tracking'],
    status: 'PLANNED',
  },
  {
    quarter: 'Q3 2026',
    name: 'AI/ML Scale',
    initiatives: ['Budowa Platformy MLOps', 'Framework AI Ethics'],
    status: 'PLANNED',
  },
  {
    quarter: 'Q4 2026',
    name: 'Digital Twin',
    initiatives: ['Wdrożenie Digital Twin', 'Circular Economy Tracker'],
    status: 'PLANNED',
  },
  {
    quarter: 'Q4 2026',
    name: 'Sustainability',
    initiatives: ['Automatyzacja Raportowania ESG'],
    status: 'PLANNED',
  },
];
...
async function seedDigiTransDemo() {
  ...
  try {
    ...
    await dbRun(
      ...
      [
        DEMO_PROJECT_ID,
        'Program Transformacji Cyfrowej 2026',
        DEMO_ORG.id,
        DEMO_USER.id,
        'Kompleksowy program transformacji cyfrowej DigiTrans Consulting obejmujący wszystkie kluczowe obszary biznesowe.',
      ]
    );
    ...
    for (const scenario of ASSESSMENT_SCENARIOS) {
      ...
      console.log(
        `   ✓ ${scenario.name} (${scenario.status}) - Gap: ${(overallToBe - overallAsIs).toFixed(1)}`
      );
    }
    ...
    for (let i = 0; i < TASK_TEMPLATES.length; i++) {
      ...
      await dbRun(
        ...
        [
          ...
          DEMO_USER.id,
          Math.abs(task.dueOffset) + Math.floor(Math.random() * 10),
        ]
      );
    }
