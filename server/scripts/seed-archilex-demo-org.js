...
async function seedInitiatives() {
  ...
  const initiatives = [
    { id: IDS.INIT_H1, proj: IDS.PROJ_GOVERNANCE, name: 'Portfolio Governance Centralisation', axis: 'strategic', status: 'step4_pilot', owner: IDS.USER_PMO },
    { id: IDS.INIT_H2, proj: IDS.PROJ_COMPLIANCE, name: 'Compliance Monitoring Automation', axis: 'operational', status: 'step4_pilot', owner: IDS.USER_CFO },
    { id: IDS.INIT_H3, proj: IDS.PROJ_DIGITAL, name: 'Executive Real-Time Dashboard', axis: 'digital', status: 'step5_full', owner: IDS.USER_CTO },
    { id: IDS.INIT_E1, proj: IDS.PROJ_PEOPLE, name: 'Assessment Toolkit Standardisation', axis: 'change', status: 'step4_pilot', owner: IDS.USER_PMO },
    { id: IDS.INIT_E2, proj: IDS.PROJ_COMPLIANCE, name: 'RAID Workflow Automation', axis: 'operational', status: 'step4_pilot', owner: IDS.USER_PMO },
    { id: IDS.INIT_E3, proj: IDS.PROJ_GOVERNANCE, name: 'Cross-BU Dependency Mapping', axis: 'strategic', status: 'step4_pilot', owner: IDS.USER_ADMIN },
    { id: IDS.INIT_C1, proj: IDS.PROJ_DIGITAL, name: 'Historical Data Migration', axis: 'digital', status: 'step5_full', owner: IDS.USER_CTO },
    { id: IDS.INIT_C2, proj: IDS.PROJ_PEOPLE, name: 'Stakeholder Communication Framework', axis: 'change', status: 'step5_full', owner: IDS.USER_PMO },
    ...
    { id: IDS.INIT_F1, proj: IDS.PROJ_PEOPLE, name: 'Consultant Onboarding Revamp', axis: 'change', status: 'step3_list', owner: IDS.USER_PMO },
    { id: IDS.INIT_F2, proj: IDS.PROJ_COMPLIANCE, name: 'Finance Data Integration Layer', axis: 'finance', status: 'step3_list', owner: IDS.USER_CFO },
    { id: IDS.INIT_F3, proj: IDS.PROJ_DIGITAL, name: 'Client Portal Self-Service Module', axis: 'digital', status: 'step2_assessment', owner: IDS.USER_CTO },
    ...
    { id: IDS.INIT_F5, proj: IDS.PROJ_PEOPLE, name: 'Talent Retention Program', axis: 'change', status: 'step3_list', owner: IDS.USER_PMO },
  ];
