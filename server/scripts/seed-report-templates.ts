...
const DRD_FULL_DIAGNOSTIC: TemplateDefinition = {
  ...
  description:
    'Comprehensive digital maturity diagnostic covering all 7 transformation axes with deep analysis, heatmaps, benchmarking, strategic gap analysis, transformation roadmap, investment prioritization, and risk assessment. The definitive report for transformation teams and board-level decision making. 30-50 pages.',
...
const DRD_PRESENTATION: TemplateDefinition = {
  ...
  description:
    'Slide-style presentation optimized for C-suite workshops, steering committees, and board meetings. Focused on impact, decisions, and next steps. Visual-first design with punchy headlines, scorecard views, and clear action items. 15-25 slides.',
  source_type: 'ASSESSMENT',
  report_type: 'ASSESSMENT_DRD',
  is_default: false,
  layout_profile: 'DOCUMENT_A4_PORTRAIT',
  sections: [
    {
      ...
      config: {
        ...
        showVersion: false,
        showOrganization: true,
        subtitle: 'Digital Readiness Diagnosis — Results & Strategic Decisions',
      },
    },
    {
      key: 'agenda',
      type: 'summary',
      title: 'Agenda & Meeting Objectives',
      required: true,
      order: 1,
      defaultLength: 'short',
      defaultLanguage: 'executive',
      promptHints:
        'Create an agenda slide: (1) Meeting purpose — one powerful sentence; (2) Agenda — 6-8 numbered items matching presentation flow; (3) Expected Outcomes — 3 bullet points on decisions to make today. Bullet points only, no paragraphs. Clean and authoritative.',
    },
    {
    ...
    },
    {
      ...
      promptHints:
        'Create a visual scorecard: (1) Overall maturity score displayed prominently; (2) Compact table — all 7 axes with: axis name, achieved, target, gap bar, RAG color; (3) One-sentence narrative summarizing the pattern. Optimize for visual impact — this is the slide everyone will photograph.',
    },
    {
      key: 'strengths_recognition',
      type: 'recommendations',
      ...
      defaultLanguage: 'executive',
      promptHints:
        'Highlight 4-5 strengths from highest-scoring areas. Each: (1) Positive headline; (2) Score backing it up; (3) Why it matters — one sentence on business value. Use ✅ indicators. This slide should generate pride before the harder conversations.',
    },
    {
      key: 'critical_gaps',
      type: 'recommendations',
      ...
      defaultLanguage: 'executive',
      promptHints:
        'Present 5-6 most significant gaps. Each: (1) Specific gap title (not generic); (2) Current vs Target score; (3) Business impact — one real-world consequence sentence; (4) Urgency: Immediate / Short-term / Medium-term. Sort by urgency. Use 🔴/🟡 indicators. Be direct but constructive — frame gaps as opportunities. End with: "The good news: these gaps have clear, actionable solutions."',
    },
    {
      key: 'priority_axes_deep_dive',
      type: 'axis_analysis',
...
const DRD_EXECUTIVE_BRIEF: TemplateDefinition = {
  ...
  description:
    'Ultra-concise strategic brief for time-constrained executives and investors. Distills the entire DRD assessment into a 3-5 page document with headline scores, top gaps, investment ask, and immediate next steps. Perfect for pre-reads and email attachments.',
  source_type: 'ASSESSMENT',
  report_type: 'ASSESSMENT_DRD',
  is_default: false,
  layout_profile: 'DOCUMENT_A4_PORTRAIT',
  sections: [
    {
      ...
      config: {
        ...
        showVersion: false,
        showOrganization: true,
        subtitle: 'Digital Readiness — Executive Brief',
      },
    },
    {
      key: 'at_a_glance',
    ...
    },
    {
      ...
      defaultLanguage: 'executive',
      promptHints:
        'List exactly 5 findings — the 5 things this executive MUST know. Each: bold one-line statement + one supporting sentence with data. Mix strengths and gaps (approximately 2 strengths, 3 gaps). Start with the single most important finding. Use 🟢/🔴 indicators.',
    },
    {
      key: 'investment_case',
      type: 'recommendations',
    ...
    },
    {
      ...
      defaultLanguage: 'executive',
      promptHints:
        'Present top 5 transformation risks as a compact table: Risk | Probability (H/M/L) | Impact (H/M/L) | Mitigation. Include both execution risks (talent, budget, timeline) and strategic risks (competitive pressure, regulatory, technology obsolescence). Keep each row to 1-2 lines.',
    },
    {
      key: 'call_to_action',
      type: 'next_steps',
      ...
      defaultLanguage: 'executive',
      promptHints:
        'Exactly 3 immediate actions the executive should take: (1) Approve — what decision is needed; (2) Fund — what investment to commit; (3) Meet — what workshop/review to schedule. Each with a specific timeline (this week, this month, this quarter). End with: "Detailed report available upon request."',
    },
  ],
};
...
const SIRI_FULL_REPORT: TemplateDefinition = {
  ...
  description:
    'Comprehensive Smart Industry Readiness Index assessment covering all 8 dimensions across Process, Technology, and Organization blocks. Includes dimension analysis, radar charts, global benchmarking, band progression analysis, and a phased implementation roadmap. 25-40 pages.',
  source_type: 'ASSESSMENT',
  ...
  sections: [
    {
      ...
      config: {
        ...
        showVersion: true,
        showOrganization: true,
        subtitle: 'Smart Industry Readiness Index — Assessment Report',
      },
    },
    {
      key: 'executive_summary',
...
const SIRI_ACTION_PLAN: TemplateDefinition = {
  ...
  description:
    'Operational transformation plan focused on concrete actions, timelines, and responsibilities. Translates SIRI assessment findings into a 12-month sprint-based execution plan for plant managers and operational leaders. 10-18 pages.',
  source_type: 'ASSESSMENT',
  report_type: 'ASSESSMENT_SIRI',
  is_default: false,
  layout_profile: 'DOCUMENT_A4_PORTRAIT',
  sections: [
    {
      ...
      config: {
        ...
        showDate: true,
        showOrganization: true,
        subtitle: 'Smart Factory — 12-Month Action Plan',
      },
    },
    {
      key: 'situation_summary',
      type: 'summary',
      title: 'Current Situation & Objectives',
      required: true,
      order: 1,
      defaultLength: 'medium',
      defaultLanguage: 'business',
      promptHints:
        'Concise situation assessment (200 words): (1) Where we are — overall SIRI band and what it means operationally; (2) Where we need to be — target band and what capabilities that unlocks; (3) The gap — quantified in band points and translated to operational impact (e.g., "Closing the Intelligence gap from Band 2→4 would enable predictive maintenance saving €200K/year in unplanned downtime"); (4) 12-month objective — specific target band after executing this plan.',
    },
    {
      key: 'quick_wins',
      type: 'action_plan',
      title: 'Sprint 1: Quick Wins (Month 1-3)',
      required: true,
      order: 2,
      defaultLength: 'medium',
      defaultLanguage: 'business',
      promptHints:
        'Detail 4-6 quick win actions for months 1-3. Each action: (1) Name; (2) Which SIRI dimension it addresses; (3) Current state; (4) Target state after action; (5) Key activities (3-5 bullets); (6) Owner (role, not name); (7) Budget estimate; (8) Success metric. Focus on: connectivity standardization, data pipeline fixes, existing tool optimization, training quick sessions. These should be achievable without major investment or procurement.',
    },
    {
      key: 'foundation_sprint',
      type: 'action_plan',
      title: 'Sprint 2: Foundation Building (Month 4-6)',
      required: true,
      order: 3,
      defaultLength: 'medium',
      defaultLanguage: 'business',
      promptHints:
        'Detail 3-5 foundation initiatives for months 4-6: analytics platform MVP, edge computing deployment, workforce upskilling program launch. Each with same structure: name, dimension, activities, owner, budget, success metric. These build on Sprint 1 outputs and prepare for intelligence capabilities.',
    },
    {
      key: 'intelligence_sprint',
      type: 'action_plan',
      title: 'Sprint 3: Intelligence Layer (Month 7-9)',
      required: true,
      order: 4,
      defaultLength: 'medium',
      defaultLanguage: 'business',
      promptHints:
        'Detail 3-4 intelligence-focused initiatives for months 7-9: predictive maintenance PoC, real-time analytics dashboards, ML model development. Show how these depend on foundation work from Sprint 2. Include go/no-go decision criteria at sprint boundaries.',
    },
    {
      key: 'scale_sprint',
      type: 'action_plan',
      title: 'Sprint 4: Scale & Optimize (Month 10-12)',
      required: true,
      order: 5,
      defaultLength: 'medium',
      defaultLanguage: 'business',
      promptHints:
        'Detail 3-4 scaling initiatives for months 10-12: production AI optimization, digital twin pilot, cross-plant replication. Include: how to measure success of the full 12-month program, expected SIRI band improvement, and handover to BAU operations.',
    },
    {
      key: 'resource_plan',
      type: 'table',
    ...
    },
    {
      ...
      defaultLanguage: 'business',
      promptHints:
        'Define program governance: (1) KPI Dashboard — 8-10 KPIs tracking transformation progress (operational KPIs like OEE improvement, and transformation KPIs like SIRI band movement); (2) Governance Cadence — weekly stand-ups, monthly steering committee, quarterly board reviews; (3) Decision Rights — who approves budget, scope changes, go/no-go at sprint boundaries; (4) Escalation Path — how to handle blockers and scope changes; (5) Risk Triggers — early warning indicators that the program is going off track.',
    },
  ],
};
  ...
  sections: [
    {
      ...
      config: {
        ...
        showVersion: true,
        showOrganization: true,
        subtitle: 'ADMA — Digital Maturity Assessment Report',
      },
    },
    {
      key: 'executive_summary',
    ...
    },
    {
      ...
      defaultLanguage: 'technical',
      promptHints:
        'Assess the current technology stack against ADMA requirements: (1) Current Stack Overview — ERP, MES, PLM, SCADA, BI, IoT platform; (2) Gap Analysis — what is missing or outdated; (3) Integration Assessment — how well do systems communicate; (4) Technology Recommendations — specific tools/platforms for each gap area; (5) Build vs Buy analysis for key capabilities. Present as a comparison table: Current Tool | Gap | Recommended Solution | Priority.',
    },
    {
      key: 'transformation_roadmap',
      type: 'action_plan',
      title: 'Transformation Roadmap & Investment Case',
      required: true,
      order: 30,
      defaultLength: 'long',
      defaultLanguage: 'business',
      promptHints:
        'Design an 18-month transformation roadmap with investment case: (1) Phase 1: Foundation (M1-M6) — data platform, connectivity, change management; (2) Phase 2: Intelligence (M7-M12) — analytics, edge computing, IoT expansion; (3) Phase 3: Optimization (M13-M18) — supply chain tower, dynamic scheduling, advanced services. For each phase: initiatives, budget, team, KPIs. Total Investment Summary: per-phase and cumulative. Expected ROI timeline. Include a maturity target: current ADMA score → expected score after each phase.',
    },
    {
      key: 'appendix',
      type: 'appendix',
      title: 'Appendix: Scores, Methodology & Glossary',
      required: false,
      order: 100,
      defaultLength: 'long',
      defaultLanguage: 'technical',
      promptHints:
        'Comprehensive appendix: (1) All 12 dimension scores with evidence notes; (2) ADMA maturity scale definitions (Level 1-5); (3) Assessment metadata; (4) Glossary of manufacturing and digital terms; (5) ADMA network references.',
    },
  ],
};
...
const ADMA_BRIEF: TemplateDefinition = {
  ...
  description:
    'Concise steering committee brief for ADMA assessments, especially useful for in-progress or preliminary results. Provides snapshot of maturity profile, top gaps, quick wins, and investment preview. 5-10 pages.',
  source_type: 'ASSESSMENT',
  report_type: 'ASSESSMENT_ADMA',
  is_default: false,
  layout_profile: 'DOCUMENT_A4_PORTRAIT',
  sections: [
    {
      ...
      config: {
        ...
        showDate: true,
        showOrganization: true,
        subtitle: 'ADMA — Assessment Brief',
      },
    },
    {
      key: 'snapshot',
      ...
      config: { showOverallScore: true, showGap: true },
      promptHints:
        'Create a one-page maturity snapshot: (1) Overall Score — big number with maturity level label; (2) 5-Pillar Summary — pillar name, score, target, one-word status; (3) Completion Note — if assessment is not 100% complete, note this and indicate confidence level. Should be readable in under 30 seconds.',
    },
    {
      key: 'key_findings',
      type: 'key_messages',
      title: 'Key Findings (Top 5)',
      required: true,
      order: 2,
      defaultLength: 'short',
      defaultLanguage: 'executive',
      promptHints:
        'Exactly 5 key findings — mix of strengths (2) and gaps (3). Each: bold headline + one data-backed sentence. Use 🟢 for strengths and 🔴 for critical gaps. Start with the most strategically important finding.',
    },
    {
      key: 'pillar_summary',
      type: 'matrix',
      title: 'Pillar-by-Pillar Summary',
      required: true,
      order: 3,
      defaultLength: 'medium',
      defaultLanguage: 'business',
      promptHints:
        'Compact summary of all 5 pillars in 2-3 sentences each: (1) Score interpretation; (2) Single biggest strength; (3) Single biggest gap. Use a consistent format for quick scanning. Include a small summary table at the top.',
    },
    {
      key: 'quick_wins',
      type: 'action_plan',
      title: 'Quick Wins (Next 90 Days)',
      required: true,
      order: 4,
      defaultLength: 'medium',
      defaultLanguage: 'business',
      promptHints:
        'List 5-7 quick wins achievable in 90 days: Name | Pillar | Effort (Low/Medium) | Impact (Description) | Estimated Cost. Focus on actions requiring no procurement, no organizational change, and minimal budget. These should generate visible progress and build momentum.',
    },
    {
      key: 'investment_preview',
      type: 'recommendations',
      ...
      defaultLanguage: 'executive',
      promptHints:
        'Brief investment overview: (1) Estimated Total (range) for full transformation; (2) Top 3 investment priorities with budget, timeline, expected impact; (3) Quick comparison: investment vs cost of inaction. This is a preview — full investment case available in the comprehensive report.',
    },
    {
      key: 'next_steps',
      type: 'next_steps',
      ...
      defaultLanguage: 'executive',
      promptHints:
        '4 immediate next steps: (1) Complete the assessment if not at 100%; (2) Schedule deep-dive workshop; (3) Approve quick wins budget; (4) Set 90-day review date. Each with timeline and responsible role.',
    },
  ],
};
...
const TOOL_EVALUATION: TemplateDefinition = {
  ...
  description:
    'In-depth evaluation report for a single tool-based assessment session. Covers tool scoring methodology, detailed findings per evaluation criterion, strengths & weaknesses analysis, fit assessment, implementation considerations, and actionable recommendations. 10-20 pages.',
  source_type: 'TOOL',
  ...
  sections: [
    {
      ...
      config: {
        ...
        showDate: true,
        showOrganization: true,
        subtitle: 'Tool Assessment — Evaluation Report',
      },
    },
    {
      key: 'executive_summary',
    ...
    },
    {
      ...
      config: { showOverallScore: true, showGap: true },
      promptHints:
        'Present detailed scores: (1) Overall Score prominently displayed; (2) Criterion-by-criterion table — criterion name, weight, raw score, weighted score, RAG status; (3) Score distribution analysis — where does this tool excel vs fall short; (4) Score comparison to "ideal" baseline. Use markdown tables with clear formatting.',
    },
    {
      key: 'strengths',
      type: 'findings',
      title: 'Strengths & Differentiators',
      required: true,
      order: 4,
      defaultLength: 'medium',
      defaultLanguage: 'business',
      promptHints:
        'Detail 5-7 key strengths: For each: (1) Strength title; (2) Evidence — specific observation from the evaluation; (3) Business value — why this matters for the organization; (4) Comparison note — how this compares to alternatives if applicable. Be specific — "Excellent UX" is weak, "Intuitive drag-and-drop workflow builder reduced configuration time by 60% during PoC" is strong.',
    },
    {
      key: 'weaknesses',
      type: 'findings',
    ...
    },
    {
      ...
      defaultLanguage: 'business',
      promptHints:
        'Address implementation practicalities: (1) Estimated Timeline — phases and duration; (2) Resource Requirements — internal team, external support; (3) Budget — licensing, implementation, training, ongoing costs; (4) Integration Effort — complexity of connecting with existing systems; (5) Change Management — user adoption challenges and mitigation; (6) Risk Factors — top 3-4 implementation risks with mitigation strategies.',
    },
    {
      key: 'recommendation',
      type: 'recommendations',
...
const TOOL_COMPARISON: TemplateDefinition = {
  ...
  description:
    'Side-by-side comparison report for multiple tool assessment sessions. Features a structured comparison matrix, scoring breakdown, fit analysis for each candidate, and a clear winner recommendation. Ideal for technology selection decisions. 12-20 pages.',
  source_type: 'TOOL',
  ...
  sections: [
    {
      ...
      config: {
        ...
        showDate: true,
        showOrganization: true,
        subtitle: 'Tool Assessment — Comparison Report',
      },
    },
    {
      key: 'executive_summary',
    ...
    },
    {
      ...
      defaultLanguage: 'business',
      promptHints:
        'TCO comparison over 3 years: (1) Cost Breakdown Table — rows: licensing (Y1/Y2/Y3), implementation, training, customization, integration, support, infrastructure; columns: each tool; (2) Total 3-Year TCO per tool; (3) Cost per User/Month; (4) Hidden Costs — what is NOT included in vendor quotes; (5) Value Analysis — TCO relative to capability score. Present as a structured financial comparison table.',
    },
    {
      key: 'risk_comparison',
      type: 'consulting_risks_register',
    ...
    },
    {
      key: 'recommendation',
      type: 'recommendations',
      title: 'Final Recommendation & Decision Framework',
      required: true,
      order: 7,
      defaultLength: 'medium',
      defaultLanguage: 'executive',
...
const INTERVIEW_INSIGHTS: TemplateDefinition = {
  ...
  description:
    'Comprehensive analysis of discovery interview sessions capturing stakeholder perspectives, organizational pain points, opportunity mapping, cross-cutting themes, and strategic recommendations. Transforms raw interview data into actionable consulting insights. 15-25 pages.',
  ...
  sections: [
    {
      ...
      config: {
        ...
        showDate: true,
        showOrganization: true,
        subtitle: 'Discovery Interview — Insights Report',
      },
    },
    {
      key: 'executive_summary',
...
const INTERVIEW_BRIEF: TemplateDefinition = {
  ...
  description:
    'Concise summary of discovery interview findings for leadership and stakeholder communication. Highlights key themes, critical pain points, and immediate action items without overwhelming detail. Perfect for sharing interview outcomes with interviewees and sponsors. 5-10 pages.',
  source_type: 'INTERVIEW',
  ...
  sections: [
    {
      ...
      config: {
        ...
        showDate: true,
        showOrganization: true,
        subtitle: 'Discovery Interview — Summary Brief',
      },
    },
    {
      key: 'interview_overview',
      type: 'summary',
      ...
      defaultLanguage: 'executive',
      promptHints:
        'Provide a concise overview (200 words): (1) Scope — sessions conducted, roles covered, categories explored; (2) Completion — questions answered vs total, average confidence; (3) Overall Sentiment — one-sentence characterization; (4) Purpose — what these interviews will inform (assessment, roadmap, strategy). Keep it factual and professional.',
    },
    {
      key: 'key_themes',
      type: 'key_messages',
      title: 'Key Themes (Top 5)',
      required: true,
      order: 2,
      defaultLength: 'medium',
      defaultLanguage: 'executive',
      promptHints:
        'Present the 5 most important themes from interviews: Each theme: (1) Bold title (max 6 words); (2) 2-3 sentence explanation with evidence; (3) Indicator: 💡 Insight, ⚠️ Concern, ✅ Strength. Order by strategic importance. These themes should capture the "voice of the organization."',
    },
    {
      key: 'facts_discovered',
      type: 'findings',
      title: 'Key Facts & Observations',
      required: true,
      order: 3,
      defaultLength: 'medium',
      defaultLanguage: 'business',
      promptHints:
        'List 10-15 key facts discovered during interviews, grouped by category. Each fact: one clear sentence with specific data or observation. Mix quantitative facts ("OEE at 63%") with qualitative ("Middle management shows resistance to new tools"). These are the building blocks that inform recommendations.',
    },
    {
      ...
      defaultLanguage: 'business',
      promptHints:
        'Summarize top 5-7 pain points: Each: (1) Pain point (one sentence); (2) Business impact (one sentence); (3) Severity: 🔴 Critical / 🟡 Important / 🟢 Manageable. Focus on actionable pain points that the organization can address.',
    },
    {
      key: 'opportunities',
      type: 'recommendations',
    ...
    },
    {
      ...
      defaultLanguage: 'executive',
      promptHints:
        '4-5 next steps after this discovery: (1) Share this summary with interviewees for validation; (2) Complete any follow-up interviews/data collection; (3) Feed findings into assessment/strategy process; (4) Schedule stakeholder workshop to align on priorities; (5) Set timeline for detailed report. Each with responsible role and timeline.',
    },
  ],
};
...
async function main() {
  ...
  try {
    await db.query(
      `DELETE FROM report_builder_block_types WHERE id = '16c9db2d-23d7-4077-8044-7bb61c18bfca'`,
      []
    );
  ...
  for (const tpl of ALL_TEMPLATES) {
    ...
    log.step(
      `${emoji} ${tpl.source_type}/${tpl.report_type}: ${tpl.name} (${sectionCount} sections)${defaultBadge}`
    );
  }
  ...
  log.info(
    `Total: ${ALL_TEMPLATES.length} templates, ${ALL_TEMPLATES.reduce((sum, t) => sum + t.sections.length, 0)} sections`
  );
}
