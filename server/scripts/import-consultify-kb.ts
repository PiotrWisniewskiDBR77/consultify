 ...
 *
 * Outputs:
 *  - server/migrations/20260403_consultify_kb_import_v7.sql
...
const OUTPUT_PATH = path.join(ROOT, 'server', 'migrations', '20260403_consultify_kb_import_v7.sql');
...
function main() {
  ...
  sql.push(`-- Migration: 20260403_consultify_kb_import_v7.sql`);
