    ...
    try {
        ...
        if (user.length === 0) {
            ...
            addResult(
                'Default User',
                true,
                `Created ${testEmail} with password: ${testPassword}`,
                true
            );
            return true;
        } else {
            ...
            if (isValid) {
                addResult(
                    'Default User',
                    true,
                    `${testEmail} exists with correct password`
                );
                return true;
            } else {
                // Reset password
                ...
                addResult(
                    'Default User',
                    true,
                    `Password reset to: ${testPassword}`,
                    true
                );
                return true;
            }
