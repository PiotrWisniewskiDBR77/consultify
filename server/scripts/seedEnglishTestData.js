...
const USER_DATA = [
    { id: TEST_IDS.USER_JOHN, firstName: 'John', lastName: 'Smith', email: 'john.smith@acme.com', role: 'ADMIN', org: TEST_IDS.ORG_ACME },
    { id: TEST_IDS.USER_JANE, firstName: 'Jane', lastName: 'Doe', email: 'jane.doe@acme.com', role: 'USER', org: TEST_IDS.ORG_ACME },
    { id: TEST_IDS.USER_MIKE, firstName: 'Mike', lastName: 'Johnson', email: 'mike.johnson@acme.com', role: 'USER', org: TEST_IDS.ORG_ACME },
    { id: TEST_IDS.USER_SARAH, firstName: 'Sarah', lastName: 'Williams', email: 'sarah.williams@technova.com', role: 'ADMIN', org: TEST_IDS.ORG_TECHNOVA },
    { id: TEST_IDS.USER_DAVID, firstName: 'David', lastName: 'Brown', email: 'david.brown@technova.com', role: 'USER', org: TEST_IDS.ORG_TECHNOVA },
    { id: TEST_IDS.USER_EMILY, firstName: 'Emily', lastName: 'Davis', email: 'emily.davis@technova.com', role: 'USER', org: TEST_IDS.ORG_TECHNOVA },
    { id: TEST_IDS.USER_CHRIS, firstName: 'Chris', lastName: 'Miller', email: 'chris.miller@globex.com', role: 'ADMIN', org: TEST_IDS.ORG_GLOBEX },
    { id: TEST_IDS.USER_LISA, firstName: 'Lisa', lastName: 'Wilson', email: 'lisa.wilson@globex.com', role: 'USER', org: TEST_IDS.ORG_GLOBEX },
    { id: TEST_IDS.USER_ROBERT, firstName: 'Robert', lastName: 'Moore', email: 'robert.moore@innovate.com', role: 'ADMIN', org: TEST_IDS.ORG_INNOVATE },
    { id: TEST_IDS.USER_AMANDA, firstName: 'Amanda', lastName: 'Taylor', email: 'amanda.taylor@innovate.com', role: 'USER', org: TEST_IDS.ORG_INNOVATE },
    { id: TEST_IDS.USER_JAMES, firstName: 'James', lastName: 'Anderson', email: 'james.anderson@digital.com', role: 'ADMIN', org: TEST_IDS.ORG_DIGITAL },
    { id: TEST_IDS.USER_MARIA, firstName: 'Maria', lastName: 'Thomas', email: 'maria.thomas@digital.com', role: 'USER', org: TEST_IDS.ORG_DIGITAL },
    { id: TEST_IDS.USER_THOMAS, firstName: 'Thomas', lastName: 'Jackson', email: 'thomas.jackson@acme.com', role: 'VIEWER', org: TEST_IDS.ORG_ACME },
    { id: TEST_IDS.USER_JENNIFER, firstName: 'Jennifer', lastName: 'White', email: 'jennifer.white@technova.com', role: 'VIEWER', org: TEST_IDS.ORG_TECHNOVA },
    { id: TEST_IDS.USER_WILLIAM, firstName: 'William', lastName: 'Harris', email: 'william.harris@globex.com', role: 'USER', org: TEST_IDS.ORG_GLOBEX },
    { id: TEST_IDS.USER_PATRICIA, firstName: 'Patricia', lastName: 'Martin', email: 'patricia.martin@innovate.com', role: 'USER', org: TEST_IDS.ORG_INNOVATE },
    { id: TEST_IDS.USER_RICHARD, firstName: 'Richard', lastName: 'Thompson', email: 'richard.thompson@digital.com', role: 'USER', org: TEST_IDS.ORG_DIGITAL },
    { id: TEST_IDS.USER_LINDA, firstName: 'Linda', lastName: 'Garcia', email: 'linda.garcia@acme.com', role: 'USER', org: TEST_IDS.ORG_ACME },
    { id: TEST_IDS.USER_JOSEPH, firstName: 'Joseph', lastName: 'Martinez', email: 'joseph.martinez@technova.com', role: 'USER', org: TEST_IDS.ORG_TECHNOVA },
    { id: TEST_IDS.USER_BARBARA, firstName: 'Barbara', lastName: 'Robinson', email: 'barbara.robinson@globex.com', role: 'USER', org: TEST_IDS.ORG_GLOBEX },
    { id: TEST_IDS.USER_CHARLES, firstName: 'Charles', lastName: 'Clark', email: 'charles.clark@innovate.com', role: 'USER', org: TEST_IDS.ORG_INNOVATE },
    { id: TEST_IDS.USER_ELIZABETH, firstName: 'Elizabeth', lastName: 'Rodriguez', email: 'elizabeth.rodriguez@digital.com', role: 'USER', org: TEST_IDS.ORG_DIGITAL },
    { id: TEST_IDS.USER_DANIEL, firstName: 'Daniel', lastName: 'Lewis', email: 'daniel.lewis@acme.com', role: 'USER', org: TEST_IDS.ORG_ACME },
    { id: TEST_IDS.USER_SUSAN, firstName: 'Susan', lastName: 'Lee', email: 'susan.lee@technova.com', role: 'USER', org: TEST_IDS.ORG_TECHNOVA },
    { id: TEST_IDS.USER_MATTHEW, firstName: 'Matthew', lastName: 'Walker', email: 'matthew.walker@globex.com', role: 'USER', org: TEST_IDS.ORG_GLOBEX },
    { id: TEST_IDS.USER_NANCY, firstName: 'Nancy', lastName: 'Hall', email: 'nancy.hall@innovate.com', role: 'USER', org: TEST_IDS.ORG_INNOVATE },
    { id: TEST_IDS.USER_ANTHONY, firstName: 'Anthony', lastName: 'Allen', email: 'anthony.allen@digital.com', role: 'USER', org: TEST_IDS.ORG_DIGITAL },
    { id: TEST_IDS.USER_KAREN, firstName: 'Karen', lastName: 'Young', email: 'karen.young@acme.com', role: 'USER', org: TEST_IDS.ORG_ACME },
    { id: TEST_IDS.USER_MARK, firstName: 'Mark', lastName: 'King', email: 'mark.king@technova.com', role: 'USER', org: TEST_IDS.ORG_TECHNOVA },
    { id: TEST_IDS.USER_BETTY, firstName: 'Betty', lastName: 'Wright', email: 'betty.wright@globex.com', role: 'USER', org: TEST_IDS.ORG_GLOBEX },
];

// Organization data
const ORG_DATA = [
    { id: TEST_IDS.ORG_ACME, name: 'Acme Corporation', plan: 'professional', status: 'active', createdAt: new Date(Date.now() - 90 * 24 * 60 * 60 * 1000) },
    { id: TEST_IDS.ORG_TECHNOVA, name: 'Technova Solutions', plan: 'enterprise', status: 'active', createdAt: new Date(Date.now() - 60 * 24 * 60 * 60 * 1000) },
    { id: TEST_IDS.ORG_GLOBEX, name: 'Globex Industries', plan: 'professional', status: 'active', createdAt: new Date(Date.now() - 45 * 24 * 60 * 60 * 1000) },
    { id: TEST_IDS.ORG_INNOVATE, name: 'Innovate Labs', plan: 'free', status: 'trial', createdAt: new Date(Date.now() - 15 * 24 * 60 * 60 * 1000) },
    { id: TEST_IDS.ORG_DIGITAL, name: 'Digital Dynamics', plan: 'enterprise', status: 'active', createdAt: new Date(Date.now() - 30 * 24 * 60 * 60 * 1000) },
];
        ...
        try {
            await dbRun(
                `INSERT OR REPLACE INTO organizations (id, name, plan, status, created_at, organization_type)
                 VALUES (?, ?, ?, ?, ?, ?)`,
                [org.id, org.name, org.plan, org.status, org.createdAt.toISOString(), org.status === 'trial' ? 'TRIAL' : 'PAID']
            );
        } catch (error) {
    ...
    for (const user of USER_DATA) {
        try {
            await dbRun(
                ...
                [user.id, user.org, user.email, HASHED_PASSWORD, user.firstName, user.lastName, user.role, 'active']
            );
        } catch (error) {
...
async function seedBillingData() {
    ...
    for (const org of ORG_DATA) {
        ...
        for (let i = 0; i < numInvoices; i++) {
            ...
            const amount = org.plan === 'enterprise' ? 999 + Math.random() * 500 : 299 + Math.random() * 200;
            ...
            try {
                await dbRun(
                    ...
                    [
                        ...
                        status === 'paid' ? new Date(createdAt.getTime() + Math.random() * 10 * 24 * 60 * 60 * 1000).toISOString() : null
                    ]
                );
            } catch (error) {
...
async function seedNotifications() {
    ...
    const notificationTypes = [
        { type: 'system', title: 'System Update Available', message: 'A new system update is available. Please review the release notes.' },
        { type: 'task_assigned', title: 'New Task Assigned', message: 'You have been assigned a new task: Review Q1 Report' },
        { type: 'info', title: 'Feature Announcement', message: 'New AI capabilities have been added to the platform.' },
        { type: 'alert', title: 'Security Alert', message: 'New login detected from a new device.' },
        { type: 'ai_insight', title: 'AI Recommendation', message: 'Based on your recent activity, we suggest optimizing your workflow.' },
    ];
...
async function seedLoginHistory() {
    ...
    for (const user of USER_DATA) {
        ...
        for (let i = 0; i < numLogins; i++) {
            ...
            const status = statuses[Math.floor(Math.random() * statuses.length)];
            const timestamp = new Date(Date.now() - Math.random() * 30 * 24 * 60 * 60 * 1000);
            const locations = ['New York, USA', 'London, UK', 'San Francisco, USA', 'Toronto, Canada', 'Sydney, Australia'];
            const location = locations[Math.floor(Math.random() * locations.length)];
            const ip = `192.168.${Math.floor(Math.random() * 255)}.${Math.floor(Math.random() * 255)}`;
            const userAgent = ['Chrome on Windows', 'Safari on macOS', 'Firefox on Linux', 'Chrome on macOS'][Math.floor(Math.random() * 4)];
...
async function cleanup() {
    ...
    try {
        ...
        await dbRun(`DELETE FROM notifications WHERE user_id LIKE 'test-%' OR organization_id LIKE 'test-%'`);
        await dbRun(`DELETE FROM webhooks WHERE user_id LIKE 'test-%' OR organization_id LIKE 'test-%'`);
        await dbRun(`DELETE FROM api_keys WHERE user_id LIKE 'test-%' OR organization_id LIKE 'test-%'`);
        await dbRun(`DELETE FROM login_history WHERE user_id LIKE 'test-%'`);
        await dbRun(`DELETE FROM audit_logs WHERE user_id LIKE 'test-%' OR organization_id LIKE 'test-%'`);
...
async function verify() {
    ...
    try {
        const orgCount = await dbGet(`SELECT COUNT(*) as count FROM organizations WHERE id LIKE 'test-%'`);
        checks.push({ name: 'Organizations', passed: orgCount.count >= 5, details: `${orgCount.count} organizations` });
        
        const userCount = await dbGet(`SELECT COUNT(*) as count FROM users WHERE id LIKE 'test-%'`);
        checks.push({ name: 'Users', passed: userCount.count >= 20, details: `${userCount.count} users` });
        
        const projectCount = await dbGet(`SELECT COUNT(*) as count FROM projects WHERE organization_id LIKE 'test-%'`);
        checks.push({ name: 'Projects', passed: projectCount.count >= 15, details: `${projectCount.count} projects` });
        
        const invoiceCount = await dbGet(`SELECT COUNT(*) as count FROM invoices WHERE organization_id LIKE 'test-%'`);
        checks.push({ name: 'Invoices', passed: invoiceCount.count >= 10, details: `${invoiceCount.count} invoices` });
        
        const apiKeyCount = await dbGet(`SELECT COUNT(*) as count FROM api_keys WHERE user_id LIKE 'test-%'`);
        checks.push({ name: 'API Keys', passed: apiKeyCount.count >= 5, details: `${apiKeyCount.count} API keys` });
        
        const auditCount = await dbGet(`SELECT COUNT(*) as count FROM audit_logs WHERE organization_id LIKE 'test-%'`);
        checks.push({ name: 'Audit Logs', passed: auditCount.count >= 50, details: `${auditCount.count} audit logs` });
        
        const notifCount = await dbGet(`SELECT COUNT(*) as count FROM notifications WHERE user_id LIKE 'test-%'`);
        checks.push({ name: 'Notifications', passed: notifCount.count >= 30, details: `${notifCount.count} notifications` });
        
        const webhookCount = await dbGet(`SELECT COUNT(*) as count FROM webhooks WHERE user_id LIKE 'test-%'`);
        checks.push({ name: 'Webhooks', passed: webhookCount.count >= 5, details: `${webhookCount.count} webhooks` });
        
        const loginCount = await dbGet(`SELECT COUNT(*) as count FROM login_history WHERE user_id LIKE 'test-%'`);
        checks.push({ name: 'Login History', passed: loginCount.count >= 50, details: `${loginCount.count} login entries` });
