...
export function buildFixturePlan(ctx: FixtureContext): FixtureStatement[] {
  ...
  const presentationSlides = [
    ...
    { intent:'roadmap', key_message:'Trzy kroki prowadzą od zweryfikowanej bazy do utrwalonego rezultatu', source_refs:[presentationSource], content:{ type:'roadmap', phases:[{title:'Zweryfikować bazę',timing:'Sierpień',owner:'Piotr Wiśniewski'},{title:'Zamknąć lukę realizacji',timing:'Wrzesień',owner:'Właściciele inicjatyw'},{title:'Potwierdzić korzyści',timing:'Październik',owner:'Finance + Results'}] } },
    { intent:'risk_management', key_message:'Ryzyko adopcji jest jawne i ma przypisaną kontrolę', source_refs:[presentationSource], content:{ type:'risk_management', risks:[{risk:'Adopcja poniżej planu',likelihood:'Średnie',impact:'Wysoki',mitigation:'Miesięczny pomiar, właściciel i plan naprawczy'},{risk:'Niespójne dane korzyści',likelihood:'Niskie',impact:'Wysoki',mitigation:'Niezależne uzgodnienie Finance i KPI'}] } },
