...
describe('TrialCron', () => {
    ...
    describe('runDailyTrialTasks', () => {
        ...
        it('should throw error if demo cleanup fails', async () => {
            mockDemoService.cleanupExpiredDemos = vi.fn().mockRejectedValue(new Error('Demo cleanup failed'));
        ...
        it('should throw error if trial warnings fail', async () => {
            mockTrialService.sendTrialWarnings = vi.fn().mockRejectedValue(new Error('Warning send failed'));
        ...
        it('should throw error if trial processing fails', async () => {
            mockTrialService.processExpiredTrials = vi.fn().mockRejectedValue(new Error('Trial processing failed'));
