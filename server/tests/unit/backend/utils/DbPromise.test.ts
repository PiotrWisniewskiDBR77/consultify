...
describe('DbPromise', () => {
    ...
    describe('all', () => {
        ...
        it('should handle database errors', async () => {
            (mockDb.all as ReturnType<typeof vi.fn>).mockImplementation((sql: string, params: unknown[], callback: (err: Error | null) => void) => {
    ...
    describe('exec', () => {
        it('should execute SQL script', async () => {
            (mockDb.exec as ReturnType<typeof vi.fn>).mockImplementation((sql: string, callback: (err: Error | null) => void) => {
                callback(null);
            });
