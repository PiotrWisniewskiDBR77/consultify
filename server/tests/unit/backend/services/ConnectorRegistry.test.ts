 ...
 *
 * Unit tests for ConnectorRegistry - 85%+ coverage target
 */

import { beforeEach, describe, expect, it, vi } from 'vitest';

import type { IDatabase } from '../../../../src/database/IDatabase.js';
import ConnectorRegistry from '../../../../src/services/connectorRegistry.js';
...
describe('ConnectorRegistry', () => {
  ...
  beforeEach(() => {
    ...
    if (ConnectorRegistry.setDependencies) {
      ConnectorRegistry.setDependencies({ db: mockDb });
    }
  });
