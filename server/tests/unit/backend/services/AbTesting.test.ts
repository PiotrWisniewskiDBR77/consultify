 ...
 *
 * Unit tests for AbTesting - 85%+ coverage target
 */

import { beforeEach, describe, expect, it, vi } from 'vitest';

import type { IDatabase } from '../../../../src/database/IDatabase.js';
import AbTesting from '../../../../src/services/ai/abTesting.js';
...
describe('AbTesting', () => {
    ...
    beforeEach(() => {
        ...
        if (AbTesting.setDependencies) {
            AbTesting.setDependencies({ db: mockDb });
        }
    });
