/**
 * CreditNoteService Unit Tests
 * Enterprise SaaS Architecture - TypeScript Backend
 *
 * Unit tests for CreditNoteService - 85%+ coverage target
 */

import { beforeEach, describe, expect, it, vi } from 'vitest';

import type { IDatabase } from '../../../../src/database/IDatabase.js';
import CreditNoteService from '../../../../src/services/creditNoteService.js';
...
describe('CreditNoteService', () => {
  ...
  beforeEach(() => {
    ...
    if (CreditNoteService.setDependencies) {
      CreditNoteService.setDependencies({ db: mockDb });
    }
  });
