 ...
 *
 * Unit tests for DocxProcessor - 85%+ coverage target
 */

import { beforeEach, describe, expect, it, vi } from 'vitest';

import type { IDatabase } from '../../../../src/database/IDatabase.js';
import DocxProcessor from '../../../../src/services/ai/processors/docxProcessor.js';
...
describe('DocxProcessor', () => {
    ...
    beforeEach(() => {
        ...
        if (DocxProcessor.setDependencies) {
            DocxProcessor.setDependencies({ db: mockDb });
        }
    });
