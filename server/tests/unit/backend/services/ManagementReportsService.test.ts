 ...
 * 
 * Unit tests for ManagementReportsService - 85%+ coverage target
 */
...
describe('ManagementReportsService', () => {
    ...
    beforeEach(() => {
        ...
        if (ManagementReportsService.setDependencies) {
            ManagementReportsService.setDependencies({ db: mockDb });
        }
    });

    describe('Service Methods', () => {
        it('should have required methods', () => {
            expect(ManagementReportsService).toBeDefined();
        });
    });
