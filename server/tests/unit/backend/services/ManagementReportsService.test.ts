...
const {
  ...
  mockPMOHealthService: {
    getPMOHealthSnapshot: vi
      .fn()
      .mockResolvedValue({ tasks: { total: 10 }, initiatives: { total: 2 } }),
  },
  mockAIExecutiveReporting: {
    translateToNarrative: vi.fn().mockReturnValue('AI-generated executive summary'),
    generateReport: vi
      .fn()
      .mockResolvedValue({ narrative: 'AI-generated steering summary', warnings: [] }),
  ...
  mockManagementReportRepository: {
    ...
    getBasicTaskMetrics: vi
      .fn()
      .mockResolvedValue({ totalTasks: 10, completedTasks: 5, overdueTasks: 1 }),
...
vi.mock('../../../../services/aiExecutiveReporting.js', () => ({
  default: mockAIExecutiveReporting,
}));
vi.mock('../../../../services/reportVersionService.js', () => ({
  default: mockReportVersionService,
}));
