 ...
 * 
 * Unit tests for EmailVerificationService - 85%+ coverage target
 */
...
describe('EmailVerificationService', () => {
    ...
    beforeEach(() => {
        ...
        if (EmailVerificationService.setDependencies) {
            EmailVerificationService.setDependencies({ db: mockDb });
        }
    });
