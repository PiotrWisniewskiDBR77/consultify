 ...
 *
 * Unit tests for EnterpriseSecurity - 85%+ coverage target
 */

import { beforeEach, describe, expect, it, vi } from 'vitest';

import type { IDatabase } from '../../../../src/database/IDatabase.js';
import EnterpriseSecurity from '../../../../src/services/ai/enterpriseSecurity.js';
...
describe('EnterpriseSecurity', () => {
  ...
  beforeEach(() => {
    ...
    if (EnterpriseSecurity.setDependencies) {
      EnterpriseSecurity.setDependencies({ db: mockDb });
    }
  });
