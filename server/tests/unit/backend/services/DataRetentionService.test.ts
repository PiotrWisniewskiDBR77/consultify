 ...
 *
 * Unit tests for DataRetentionService - 85%+ coverage target
 */

import { beforeEach, describe, expect, it, vi } from 'vitest';

import type { IDatabase } from '../../../../src/database/IDatabase.js';
import DataRetentionService from '../../../../src/services/dataRetentionService.js';
...
describe('DataRetentionService', () => {
  ...
  beforeEach(() => {
    ...
    if (DataRetentionService.setDependencies) {
      DataRetentionService.setDependencies({ db: mockDb });
    }
  });
