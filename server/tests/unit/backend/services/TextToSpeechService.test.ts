 ...
 *
 * Unit tests for TextToSpeechService - 85%+ coverage target
 */

import { beforeEach, describe, expect, it, vi } from 'vitest';

import type { IDatabase } from '../../../../src/database/IDatabase.js';
import TextToSpeechService from '../../../../src/services/ai/textToSpeechService.js';
...
describe('TextToSpeechService', () => {
  ...
  beforeEach(() => {
    ...
    if (TextToSpeechService.setDependencies) {
      TextToSpeechService.setDependencies({ db: mockDb });
    }
  });
