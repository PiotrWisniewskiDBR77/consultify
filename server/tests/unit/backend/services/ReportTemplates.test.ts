/**
 * ReportTemplates Unit Tests
 * Enterprise SaaS Architecture - TypeScript Backend
 *
 * Unit tests for ReportTemplates - 85%+ coverage target
 */

import { beforeEach, describe, expect, it, vi } from 'vitest';

import type { IDatabase } from '../../../../src/database/IDatabase.js';
import ReportTemplates from '../../../../src/services/ai/reportTemplates.js';
...
describe('ReportTemplates', () => {
  ...
  beforeEach(() => {
    ...
    if (ReportTemplates.setDependencies) {
      ReportTemplates.setDependencies({ db: mockDb });
    }
  });
