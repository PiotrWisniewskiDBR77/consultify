 ...
 *
 * Unit tests for StartupValidator - 85%+ coverage target
 */

import { beforeEach, describe, expect, it, vi } from 'vitest';

import type { IDatabase } from '../../../../src/database/IDatabase.js';
import StartupValidator from '../../../../src/services/ai/startupValidator.js';
...
describe('StartupValidator', () => {
  ...
  beforeEach(() => {
    ...
    if (StartupValidator.setDependencies) {
      StartupValidator.setDependencies({ db: mockDb });
    }
  });
