 ...
 *
 * Unit tests for SecretManager - 85%+ coverage target
 */

import { beforeEach, describe, expect, it, vi } from 'vitest';

import type { IDatabase } from '../../../../src/database/IDatabase.js';
import SecretManager from '../../../../src/services/secretManager.js';
...
describe('SecretManager', () => {
    ...
    beforeEach(() => {
        ...
        if (SecretManager.setDependencies) {
            SecretManager.setDependencies({ db: mockDb });
        }
    });
