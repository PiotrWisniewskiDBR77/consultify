 ...
 * 
 * Unit tests for SecurityPolicyService - 85%+ coverage target
 */

import { describe, it, expect, beforeEach, vi } from 'vitest';
import type { IDatabase } from '../../../../src/database/IDatabase.js';
import SecurityPolicyService from '../../../../src/services/securityPolicyService.js';
...
describe('SecurityPolicyService', () => {
    ...
    beforeEach(() => {
        ...
        if (SecurityPolicyService.setDependencies) {
            SecurityPolicyService.setDependencies({ db: mockDb });
        }
    });
