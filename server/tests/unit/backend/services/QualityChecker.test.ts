 ...
 *
 * Unit tests for QualityChecker - 85%+ coverage target
 */

import { beforeEach, describe, expect, it, vi } from 'vitest';

import type { IDatabase } from '../../../../src/database/IDatabase.js';
import QualityChecker from '../../../../src/services/ai/qualityChecker.js';
...
describe('QualityChecker', () => {
  ...
  beforeEach(() => {
    ...
    if (QualityChecker.setDependencies) {
      QualityChecker.setDependencies({ db: mockDb });
    }
  });
