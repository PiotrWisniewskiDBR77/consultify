/**
 * ConsultantService Unit Tests
 * Enterprise SaaS Architecture - TypeScript Backend
 *
 * Unit tests for ConsultantService - 85%+ coverage target
 */

import { beforeEach, describe, expect, it, vi } from 'vitest';

import type { IDatabase } from '../../../../src/database/IDatabase.js';
import ConsultantService from '../../../../src/services/consultantService.js';
...
describe('ConsultantService', () => {
  ...
  beforeEach(() => {
    ...
    if (ConsultantService.setDependencies) {
      ConsultantService.setDependencies({ db: mockDb });
    }
  });
