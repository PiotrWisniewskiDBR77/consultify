 ...
 * 
 * Unit tests for PeriodComparisonService - 85%+ coverage target
 */
...
describe('PeriodComparisonService', () => {
    ...
    beforeEach(() => {
        ...
        if (PeriodComparisonService.setDependencies) {
            PeriodComparisonService.setDependencies({ db: mockDb });
        }
    });

    describe('Service Methods', () => {
        it('should have required methods', () => {
            expect(PeriodComparisonService).toBeDefined();
        });
    });
