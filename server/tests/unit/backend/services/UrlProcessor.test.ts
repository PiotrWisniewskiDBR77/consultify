 ...
 *
 * Unit tests for UrlProcessor - 85%+ coverage target
 */

import { beforeEach, describe, expect, it, vi } from 'vitest';

import type { IDatabase } from '../../../../src/database/IDatabase.js';
import UrlProcessor from '../../../../src/services/ai/processors/urlProcessor.js';
...
describe('UrlProcessor', () => {
  ...
  beforeEach(() => {
    ...
    if (UrlProcessor.setDependencies) {
      UrlProcessor.setDependencies({ db: mockDb });
    }
  });

  describe('Service Methods', () => {
    it('should have required methods', () => {
      expect(UrlProcessor).toBeDefined();
    });
  });
