/**
 * FinanceAgent Unit Tests
 * Enterprise SaaS Architecture - TypeScript Backend
 *
 * Unit tests for FinanceAgent - 85%+ coverage target
 */

import { beforeEach, describe, expect, it, vi } from 'vitest';

import type { IDatabase } from '../../../../src/database/IDatabase.js';
import FinanceAgent from '../../../../src/services/ai/agents/financeAgent.js';
...
describe('FinanceAgent', () => {
  ...
  beforeEach(() => {
    ...
    if (FinanceAgent.setDependencies) {
      FinanceAgent.setDependencies({ db: mockDb });
    }
  });
