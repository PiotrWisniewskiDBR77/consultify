 ...
 *
 * Unit tests for WebResearchService - 85%+ coverage target
 */

import { beforeEach, describe, expect, it, vi } from 'vitest';

import type { IDatabase } from '../../../../src/database/IDatabase.js';
import WebResearchService from '../../../../src/services/ai/webResearchService.js';
...
describe('WebResearchService', () => {
  ...
  beforeEach(() => {
    ...
    if (WebResearchService.setDependencies) {
      WebResearchService.setDependencies({ db: mockDb });
    }
  });
