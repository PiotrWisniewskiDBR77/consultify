 ...
 *
 * Unit tests for StatusMachine - 85%+ coverage target
 */

import { beforeEach, describe, expect, it, vi } from 'vitest';

import type { IDatabase } from '../../../../src/database/IDatabase.js';
import StatusMachine from '../../../../src/services/statusMachine.js';
...
describe('StatusMachine', () => {
  ...
  beforeEach(() => {
    ...
    if (StatusMachine.setDependencies) {
      StatusMachine.setDependencies({ db: mockDb });
    }
  });

  describe('Service Methods', () => {
    it('should have required methods', () => {
      expect(StatusMachine).toBeDefined();
    });
  });
