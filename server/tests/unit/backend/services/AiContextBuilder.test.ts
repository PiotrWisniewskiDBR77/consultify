/**
 * AiContextBuilder Unit Tests
 * Enterprise SaaS Architecture - TypeScript Backend
 *
 * Unit tests for AiContextBuilder - 85%+ coverage target
 */

import { beforeEach, describe, expect, it, vi } from 'vitest';

import type { IDatabase } from '../../../../src/database/IDatabase.js';
import AiContextBuilder from '../../../../src/services/aiContextBuilder.js';
...
describe('AiContextBuilder', () => {
  ...
  beforeEach(() => {
    ...
    if (AiContextBuilder.setDependencies) {
      AiContextBuilder.setDependencies({ db: mockDb });
    }
  });
