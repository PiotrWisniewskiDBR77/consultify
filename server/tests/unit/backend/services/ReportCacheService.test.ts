/**
 * ReportCacheService Unit Tests
 * Enterprise SaaS Architecture - TypeScript Backend
 *
 * Unit tests for ReportCacheService - 85%+ coverage target
 */

import { beforeEach, describe, expect, it, vi } from 'vitest';

import type { IDatabase } from '../../../../src/database/IDatabase.js';
import ReportCacheService from '../../../../src/services/reportCacheService.js';
...
describe('ReportCacheService', () => {
    ...
    beforeEach(() => {
        ...
        if (ReportCacheService.setDependencies) {
            ReportCacheService.setDependencies({ db: mockDb });
        }
    });
