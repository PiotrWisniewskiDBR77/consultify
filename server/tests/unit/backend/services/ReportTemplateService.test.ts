 ...
 * 
 * Unit tests for ReportTemplateService - 85%+ coverage target
 */

import { describe, it, expect, beforeEach, vi } from 'vitest';
import type { IDatabase } from '../../../../src/database/IDatabase.js';
import ReportTemplateService from '../../../../src/services/reportTemplateService.js';
...
describe('ReportTemplateService', () => {
    ...
    beforeEach(() => {
        ...
        if (ReportTemplateService.setDependencies) {
            ReportTemplateService.setDependencies({ db: mockDb });
        }
    });
