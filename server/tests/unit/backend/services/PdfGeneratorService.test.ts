 ...
 *
 * Unit tests for PdfGeneratorService - 85%+ coverage target
 */

import { beforeEach, describe, expect, it, vi } from 'vitest';

import type { IDatabase } from '../../../../src/database/IDatabase.js';
import PdfGeneratorService from '../../../../src/services/pdfGeneratorService.js';
...
describe('PdfGeneratorService', () => {
  ...
  beforeEach(() => {
    ...
    if (PdfGeneratorService.setDependencies) {
      PdfGeneratorService.setDependencies({ db: mockDb });
    }
  });
