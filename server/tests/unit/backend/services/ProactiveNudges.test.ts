 ...
 *
 * Unit tests for ProactiveNudges - 85%+ coverage target
 */
...
describe('ProactiveNudges', () => {
  ...
  beforeEach(() => {
    ...
    if (ProactiveNudges.setDependencies) {
      ProactiveNudges.setDependencies({ db: mockDb });
    }
  });

  describe('Service Methods', () => {
    it('should have required methods', () => {
      expect(ProactiveNudges).toBeDefined();
    });
  });
