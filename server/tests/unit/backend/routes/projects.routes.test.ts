...
describe('Projects Routes', () => {
    ...
    describe('GET /api/projects', () => {
        it('should return projects for organization', () => {
            ...
            mockProjectController.getProjects.mockImplementation((req: Partial<Request>, res: Partial<Response>) => {
    ...
    describe('POST /api/projects', () => {
        it('should create project with valid data', () => {
            ...
            mockProjectController.createProject.mockImplementation((req: Partial<Request>, res: Partial<Response>) => {
    ...
    describe('GET /api/projects/:id', () => {
        it('should return project by ID', () => {
            ...
            mockProjectController.getProjectById.mockImplementation((req: Partial<Request>, res: Partial<Response>) => {
    ...
    describe('PUT /api/projects/:id', () => {
        it('should update project with valid data', () => {
            ...
            mockProjectController.updateProject.mockImplementation((req: Partial<Request>, res: Partial<Response>) => {
    ...
    describe('DELETE /api/projects/:id', () => {
        it('should delete project', () => {
            ...
            mockProjectController.deleteProject.mockImplementation((req: Partial<Request>, res: Partial<Response>) => {
                res.status?.(204).json?.({});
            });
    ...
    describe('GET /api/projects/:id/ai-role', () => {
        it('should return AI role for project', () => {
            ...
            mockProjectController.getAIRole.mockImplementation((req: Partial<Request>, res: Partial<Response>) => {
    ...
    describe('PUT /api/projects/:id/ai-role', () => {
        it('should update AI role', () => {
            ...
            mockProjectController.updateAIRole.mockImplementation((req: Partial<Request>, res: Partial<Response>) => {
