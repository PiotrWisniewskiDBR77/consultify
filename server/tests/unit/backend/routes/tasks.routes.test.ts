...
describe('Tasks Routes', () => {
    ...
    describe('GET /api/tasks', () => {
        it('should return tasks with filters', () => {
            ...
            mockTaskController.getTasks.mockImplementation((req: Partial<Request>, res: Partial<Response>) => {
    ...
    describe('POST /api/tasks', () => {
        it('should create task with valid data', () => {
            ...
            mockTaskController.createTask.mockImplementation((req: Partial<Request>, res: Partial<Response>) => {
    ...
    describe('GET /api/tasks/:id', () => {
        it('should return task by ID', () => {
            ...
            mockTaskController.getTaskById.mockImplementation((req: Partial<Request>, res: Partial<Response>) => {
    ...
    describe('PUT /api/tasks/:id', () => {
        it('should update task with valid data', () => {
            ...
            mockTaskController.updateTask.mockImplementation((req: Partial<Request>, res: Partial<Response>) => {
    ...
    describe('DELETE /api/tasks/:id', () => {
        it('should delete task', () => {
            ...
            mockTaskController.deleteTask.mockImplementation((req: Partial<Request>, res: Partial<Response>) => {
                res.status?.(204).json?.({});
            });
    ...
    describe('POST /api/tasks/:id/assign', () => {
        it('should assign task to user', () => {
            ...
            mockTaskController.assignTask.mockImplementation((req: Partial<Request>, res: Partial<Response>) => {
    ...
    describe('POST /api/tasks/:id/reassign', () => {
        it('should reassign task to different user', () => {
            ...
            mockTaskController.reassignTask.mockImplementation((req: Partial<Request>, res: Partial<Response>) => {
    ...
    describe('POST /api/tasks/:id/escalate', () => {
        it('should escalate task', () => {
            ...
            mockTaskController.escalateTask.mockImplementation((req: Partial<Request>, res: Partial<Response>) => {
    ...
    describe('POST /api/tasks/:id/resolve-escalation', () => {
        it('should resolve escalation', () => {
            ...
            mockTaskController.resolveEscalation.mockImplementation((req: Partial<Request>, res: Partial<Response>) => {
    ...
    describe('GET /api/tasks/:taskId/comments', () => {
        it('should return task comments', () => {
            ...
            mockTaskController.getTaskComments.mockImplementation((req: Partial<Request>, res: Partial<Response>) => {
    ...
    describe('POST /api/tasks/:taskId/comments', () => {
        it('should add comment to task', () => {
            ...
            mockTaskController.addTaskComment.mockImplementation((req: Partial<Request>, res: Partial<Response>) => {
    ...
    describe('DELETE /api/tasks/:taskId/comments/:commentId', () => {
        it('should delete task comment', () => {
            ...
            mockTaskController.deleteTaskComment.mockImplementation((req: Partial<Request>, res: Partial<Response>) => {
                res.status?.(204).json?.({});
            });
