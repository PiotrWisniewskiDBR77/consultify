...
describe('ReportAuditService', () => {
  ...
  describe('getAuditLog', () => {
    ...
    it('should filter by date range', async () => {
      ...
      db.all.mockImplementation((sql, params, callback) => {
        callback(null, [{ id: 'log1', action: 'APPROVED', created_at: '2025-12-15' }]);
      });
    ...
    it('should filter by actor ID', async () => {
      ...
      db.all.mockImplementation((sql, params, callback) => {
        callback(null, [{ id: 'log1', action: 'SUBMITTED', actor_id: 'user2' }]);
      });
  ...
  describe('logStandardActions', () => {
    ...
    it('should log REJECTED action', async () => {
      await ReportAuditService.log('report1', 'REJECTED', 'user1', {
        level: 1,
    ...
    it('should log SHARED action', async () => {
      await ReportAuditService.log('report1', 'SHARED', 'user1', {
        shareToken: 'token123',
