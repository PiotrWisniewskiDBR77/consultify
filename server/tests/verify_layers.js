...
async function runTests() {
  ...
  console.log(
    ...
    benefitTest.benefit === 187500 ? 'PASS' : 'FAIL',
    benefitTest.benefit
  ); // 75000 * 2.5 = 187500
  ...
  console.log(
    'Total CAPEX:',
    simulation.totalCapex === 80000 ? 'PASS' : 'FAIL',
    `(${simulation.totalCapex})`
  ); // 75k + 5k
  console.log(
    'Total Benefit:',
    simulation.annualBenefit === 193500 ? 'PASS' : 'FAIL',
    `(${simulation.annualBenefit})`
  ); // 187500 + 6000
