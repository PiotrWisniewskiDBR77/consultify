...
describe('ReportApprovalService', () => {
    ...
    describe('submitForApproval', () => {
        ...
        it('should reject submission if report is not draft', async () => {
            ...
            await expect(
                ReportApprovalService.submitForApproval('report1', 'user1')
            ).rejects.toThrow('Cannot submit report with status FINAL');
        });
        ...
        it('should reject submission if report is locked', async () => {
            ...
            await expect(
                ReportApprovalService.submitForApproval('report1', 'user1')
            ).rejects.toThrow('Report is locked');
        });
    });
    ...
    describe('approve', () => {
        ...
        it('should reject if not pending approval', async () => {
            ...
            await expect(
                ReportApprovalService.approve('report1', 'user1')
            ).rejects.toThrow('Report is not pending approval');
        });
    });
    ...
    describe('reject', () => {
        ...
        it('should require rejection comment', async () => {
            await expect(
                ReportApprovalService.reject('report1', 'user1', '')
    ...
    describe('skipApprovalLevel', () => {
        it('should skip level with reason', async () => {
            ...
            const result = await ReportApprovalService.skipApprovalLevel('report1', 1, 'admin1', 'Urgent');
