-- Ported from: 20260411_v8_calendar_interop_p02d_bridge.sql (SQLite idioms fixed for Postgres)
-- P02-D: Calendar Interop bridge to P01 Integration
-- Adds connection_id FK, extends itemType for PMO completeness

-- Bridge to P01 connection
ALTER TABLE v8_calendar_sources ADD COLUMN IF NOT EXISTS connection_id TEXT REFERENCES integrations(id) ON DELETE SET NULL;
