-- Ported from: 20260409_fix_virtual_workers_postgres.sql (SQLite idioms fixed for Postgres)
-- Fix: create virtual_workers tables for PostgreSQL
-- Original 737_virtual_workers.sql uses SQLite TIMESTAMPTZ('now') which fails on Postgres
