-- Ported from: 20260411_v8_calendar_items_extended_itemtype.sql (SQLite idioms fixed for Postgres)
...
INSERT INTO v8_calendar_items_new SELECT * FROM v8_calendar_items
