...
DROP TRIGGER IF EXISTS trg_finance_digitization_analysis_duplicate_receipt_immutable
  ON finance_digitization_analysis_duplicate_command_receipts;
CREATE TRIGGER trg_finance_digitization_analysis_duplicate_receipt_immutable
