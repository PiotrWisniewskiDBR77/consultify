...
-- PORTABILITY (07-13): arkusze zakotwiczone w org 'atelier' (demo showcase) bo nie backfillują per-org jak doc/deck (org_id NULL). Na innym env podmień 'atelier' na docelową org. Doc/deck systemowe (org_id NULL) — bez zmian.
--
...
INSERT INTO v8_output_artifacts (
  ...
  delivery_state, origin_summary_json, created_at
) VALUES
('mck-sheet-cost-benefit', 'atelier', 'sheet', 'template',
 'Model kosztów i korzyści (Cost-Benefit Model)', 'system', 'system', 'outputs_library', 'organization', 'ready',
 ...
 NOW()),
('mck-sheet-kpi-dashboard', 'atelier', 'sheet', 'template',
 'Dashboard KPI (KPI Dashboard)', 'system', 'system', 'outputs_library', 'organization', 'ready',
 ...
 NOW()),
('mck-sheet-initiative-tracker', 'atelier', 'sheet', 'template',
 'Tracker inicjatyw (Initiative Tracker)', 'system', 'system', 'outputs_library', 'organization', 'ready',
 ...
 NOW()),
('mck-sheet-budget-actual', 'atelier', 'sheet', 'template',
 'Budżet vs wykonanie (Budget vs Actual)', 'system', 'system', 'outputs_library', 'organization', 'ready',
...
VALUES
('ol-mck-sheet-cost-benefit', 'mck-sheet-cost-benefit', 'atelier', 'sheet', 'mck-sheet-cost-benefit', 1),
('ol-mck-sheet-kpi-dashboard', 'mck-sheet-kpi-dashboard', 'atelier', 'sheet', 'mck-sheet-kpi-dashboard', 1),
('ol-mck-sheet-initiative-tracker', 'mck-sheet-initiative-tracker', 'atelier', 'sheet', 'mck-sheet-initiative-tracker', 1),
('ol-mck-sheet-budget-actual', 'mck-sheet-budget-actual', 'atelier', 'sheet', 'mck-sheet-budget-actual', 1)
