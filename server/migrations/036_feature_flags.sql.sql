...
CREATE TABLE IF NOT EXISTS feature_flags (
    id TEXT PRIMARY KEY,
    flag_key TEXT NOT NULL UNIQUE, -- e.g., 'new_ai_dashboard'
    description TEXT,
    enabled BOOLEAN DEFAULT 0, -- Global master switch
...
INSERT OR IGNORE INTO feature_flags (id, flag_key, description, enabled, rules) VALUES
