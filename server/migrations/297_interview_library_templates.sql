-- INTERVIEW-TEMPLATES-002: Interview Templates Library (non-conflicting table names)
-- Migration: 297_interview_library_templates.sql
-- Purpose:
--  - Create interview templates library tables without colliding with existing `interview_templates`
--    (used elsewhere for assessment templates).
--  - Seed 6 templates and their questions for Interview module.

-- ==========================================
-- TEMPLATES LIBRARY (Interview module)
-- ==========================================
...
CREATE TABLE IF NOT EXISTS interview_library_templates (
    ...
    visibility TEXT DEFAULT 'global',             -- global | org | role_based | admin_only
...
CREATE INDEX IF NOT EXISTS idx_interview_library_template_questions_template ON interview_library_template_questions(template_id);
CREATE INDEX IF NOT EXISTS idx_interview_library_template_questions_category ON interview_library_template_questions(category);
...
('rp_interview_tpl_view_tm', 'TEAM_MEMBER', 'INTERVIEW_TEMPLATE_VIEW', 'View interview templates'),
('rp_interview_tpl_use_tm', 'TEAM_MEMBER', 'INTERVIEW_TEMPLATE_USE', 'Use interview templates'),
