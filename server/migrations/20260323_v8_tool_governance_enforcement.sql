...
ALTER TABLE v8_tool_invocation_log ADD COLUMN IF NOT EXISTS deferred_at TEXT;
ALTER TABLE v8_tool_invocation_log ADD COLUMN IF NOT EXISTS deferred_resolved_at TEXT;
ALTER TABLE v8_tool_invocation_log ADD COLUMN IF NOT EXISTS deferred_resolved_by TEXT;
