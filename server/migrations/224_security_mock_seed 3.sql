...
SELECT 'sess-mock-1', usr.id, 'jti-mock-1', 'MacOS Chrome', '192.168.1.10', 'Chrome/120', 'Warsaw, PL', datetime('now','-2 days'), datetime('now','-1 hours'), datetime('now','+7 days'), 0 FROM usr;
...
UNION ALL
SELECT 'usage-mock-2', 'api-mock-1', '/api/ai/execute', 'POST', 200, 450, '10.0.0.5', 'Mobile Safari', datetime('now','-1 hours');
