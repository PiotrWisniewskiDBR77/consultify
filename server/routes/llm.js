...
router.get('/status', async (req, res) => {
    try {
        ...
        const { generateQuickHealthReport, testSingleProvider   } = await import('../services/ai/startupValidator.js');
        const circuitBreakerModule = await import('../services/ai/circuitBreaker.js');
...
router.post('/status/test/:provider', async (req, res) => {
    ...
    try {
        const { testSingleProvider   } = await import('../services/ai/startupValidator.js');
...
router.get('/redis-status', async (req, res) => {
    try {
        const { isRedisConnected, healthCheck   } = await import('../services/ai/redisClient.js');
...
router.get('/alerting-status', async (req, res) => {
    try {
        const { alertingService   } = await import('../services/ai/alerting.js');
...
router.get('/observability-status', async (req, res) => {
    try {
        const { getStatus, initLangfuse   } = await import('../services/ai/observability.js');
...
router.get('/comprehensive-report-status', async (req, res) => {
    try {
        ...
        const { webResearchService   } = await import('../services/ai/webResearchService.js');
        const { contextBuilder   } = await import('../services/ai/aiContext.js');
...
router.get('/metrics', async (req, res) => {
    try {
        const metricsModule = await import('../services/ai/metrics.js');
...
router.get('/health/status', verifyToken, async (req, res) => {
    try {
        const { AIHealthService   } = await import('../services/ai/aiHealthService.js');
...
router.post('/health/test/:capability', verifyToken, async (req, res) => {
    ...
    try {
        ...
        if (results.status === 'FAILED' && sendAlerts) {
            try {
                const AIHealthAlertServiceModule = await import('../services/ai/aiHealthAlertService.js');
...
router.get('/circuits', verifyToken, async (req, res) => {
    try {
        const { circuitBreaker   } = await import('../services/ai/llmService.js');
...
router.get('/observability/status', verifyToken, async (req, res) => {
    try {
        const { getStatus   } = await import('../services/ai/observability.js');
        const { alertingService   } = await import('../services/ai/alerting.js');
...
router.post('/magic-wand', async (req, res) => {
    ...
    try {
        const { magicWandService   } = await import('../services/ai/magicWandService.js');
...
router.get('/control/usage', verifyToken, async (req, res) => {
    try {
        const { quotaService   } = await import('../services/ai/quotaService.js');
...
router.get('/control/models', verifyToken, async (req, res) => {
    try {
        const { CAPABILITY_TIERS, TIER_DEFAULTS   } = await import('../services/ai/modelRouter.js');
...
router.get('/control/quotas', verifyToken, async (req, res) => {
    try {
        const { DEFAULT_QUOTAS   } = await import('../services/ai/quotaService.js');
...
router.post('/generate-report', async (req, res) => {
    ...
    try {
        const { reportGeneratorService   } = await import('../services/ai/reportGeneratorService.js');
...
const { modelRouter, TIER_HIERARCHY   } = await import('../services/ai/modelRouter.js');
