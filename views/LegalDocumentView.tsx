...
export const LegalDocumentView: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-navy-950 dark:via-navy-900 dark:to-navy-950">
            {/* Header */}
            <header className={`sticky top-0 z-50 bg-gradient-to-r ${docInfo?.color || 'from-purple-600 to-indigo-600'} text-white shadow-lg`}>
                            ...
                            <div className="flex flex-wrap items-center gap-6 text-sm">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-medium text-slate-700 dark:text-slate-200">{document.version}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                {Object.entries(DOCUMENT_ROUTES)
                                    ...
                                    .map(([slug, type]) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className={`w-9 h-9 bg-gradient-to-br ${info?.color || 'from-slate-400 to-slate-500'} rounded-lg flex items-center justify-center shrink-0`}>
