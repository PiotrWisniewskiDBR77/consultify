                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="bg-white dark:bg-navy-900 rounded-2xl p-8 border border-slate-200 dark:border-white/10"
                        >
                            <div className="flex items-center gap-3 mb-4">
                    ...
                    <div className="mt-12 bg-white dark:bg-navy-900 rounded-2xl p-8 border border-slate-200 dark:border-white/10">
                    ...
                    <div className="space-y-4">
                        {faqs.map((faq, idx) => (
                            <motion.div
                                ...
                                className="bg-white dark:bg-navy-900 rounded-2xl p-6 border border-slate-200 dark:border-white/10"
                            >
