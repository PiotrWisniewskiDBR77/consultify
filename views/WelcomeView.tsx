...
export const WelcomeView: React.FC<WelcomeViewProps> = ({ onStartSession, onLoginClick }) => {
    ...
    const text = {
        ...
        fullFeatures: [t('welcome.fullFeatures.drd'), t('welcome.fullFeatures.roadmap'), t('welcome.fullFeatures.ai')],
                ...
                <div className="w-1/2 p-8 lg:p-12 flex flex-col justify-center border-r border-slate-200 dark:border-elegant overflow-y-auto">
                    <div className="max-w-xl mx-auto w-full space-y-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div
                                className="group relative bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 hover:border-purple-500/50 rounded-lg p-5 transition-all duration-300 hover:shadow-md cursor-pointer"
                                onClick={() => onStartSession(SessionMode.FREE)}
                            >
                            ...
                            <div
                                className="group relative bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 hover:border-blue-500/50 rounded-lg p-6 transition-all duration-300 cursor-pointer hover:shadow-lg"
                            ...
                            <div
                                className="group relative bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 hover:border-emerald-500/50 rounded-lg p-6 transition-all duration-300 cursor-pointer hover:shadow-lg"
                            ...
                            >
                                <div className="flex items-start gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2 mt-1">
                                            <span className="text-xs text-slate-500">{t('welcome.consultingTag')}</span>
                                        </div>
                                    </div>
                                </div>
