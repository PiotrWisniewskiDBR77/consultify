...
export const PARTNER_BENEFITS: PartnerBenefit[] = [
    {
        ...
        description: 'Progresywny model prowizji rośnie wraz z Twoim zaangażowaniem i sukcesami w programie.',
    },
    {
        icon: Users,
    ...
    },
    {
        ...
        description: 'Kompleksowe szkolenia z metodologii DRD, sprzedaży i wdrożeń dla Twojego zespołu.',
    },
    {
        icon: Target,
    ...
    },
    {
        ...
        description: 'Widoczność w katalogu partnerów dla klientów szukających ekspertów w Twojej dziedzinie.',
    },
    {
        icon: Sparkles,
...
export const PARTNER_FAQS: PartnerFAQ[] = [
    {
        ...
        answer: 'Prowizja jest naliczana od wartości zamkniętych dealów. Stawka zależy od Twojego poziomu partnerskiego: Bronze (10%), Silver (12%), Gold (15%), Platinum (20%). Prowizje są rozliczane kwartalnie w ramach Commission Statements.',
    },
    {
        question: 'Jak awansować na wyższy poziom?',
        answer: 'Awans na wyższy poziom wymaga spełnienia określonych kryteriów: liczby zamkniętych dealów, ukończenia modułów Academy i minimalnego okresu aktywności. System automatycznie monitoruje Twój postęp i powiadomi Cię o możliwości awansu.',
    },
    {
        question: 'Co to jest Deal Registration?',
        answer: 'Deal Registration to proces rejestracji potencjalnych transakcji w systemie. Chroni Twoje deale przed duplikacją i zapewnia transparentność w przypisywaniu prowizji. Każdy deal jest mapowany do PMO domain GOVERNANCE_DECISION_MAKING.',
    },
    {
    ...
    },
    {
        ...
        answer: 'Silver partners otrzymują dostęp do marketing kit (szablony, case studies, prezentacje). Gold partners mogą uczestniczyć w joint marketing campaigns. Platinum partners mają możliwość co-branded solutions i dedykowanych kampanii.',
    },
    {
        question: 'Co to jest Partner Academy?',
        answer: 'Partner Academy to platforma szkoleniowa obejmująca metodologię DRD, techniki sprzedaży, best practices wdrożeniowe i certyfikacje. Ukończenie modułów jest wymagane do awansu na wyższe poziomy partnerskie.',
    },
    {
        question: 'Jak rozliczane są prowizje?',
        answer: 'Commission Statements są generowane kwartalnie. Po zamknięciu kwartału Finance Team weryfikuje wszystkie deale i generuje statement zgodny z PMO domain BENEFITS_REALIZATION. Payout następuje w ciągu 30 dni od approval.',
    },
    {
        question: 'Czy mogę negocjować indywidualne warunki?',
        answer: 'Partnerzy Platinum mogą negocjować custom agreement terms, w tym wyższe stawki prowizji dla określonych segmentów, dedykowane SLA i specjalne warunki współpracy strategicznej.',
    },
];
