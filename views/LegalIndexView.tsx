...
const DocumentCard: React.FC<{ doc: LegalDocumentCard }> = ({ doc }) => (
    <Link
        to={`/legal/${doc.slug}`}
        className="group relative overflow-hidden p-5 bg-white dark:bg-navy-900 rounded-2xl border border-slate-200/80 dark:border-white/10 
                   hover:border-slate-300 dark:hover:border-white/20 hover:shadow-xl hover:shadow-slate-200/50 dark:hover:shadow-black/20
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-navy-950 dark:via-navy-900 dark:to-navy-950">
            ...
            <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
                ...
                {/* Contact Section */}
                <section className="bg-white dark:bg-navy-900 rounded-3xl border border-slate-200 dark:border-white/10 p-8 sm:p-10 shadow-sm">
                ...
                {/* Company Details */}
                <section className="mt-10 p-8 bg-slate-100 dark:bg-white/5 rounded-2xl border border-slate-200/50 dark:border-white/5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-sm">
                        ...
                        <div className="space-y-1">
                            <p className="text-slate-600 dark:text-slate-400">
                                <span className="font-medium text-slate-700 dark:text-slate-300">NIP:</span> 8792725331
                            </p>
                            <p className="text-slate-600 dark:text-slate-400">
                                <span className="font-medium text-slate-700 dark:text-slate-300">KRS:</span> 0000860440
                            </p>
                            <p className="text-slate-600 dark:text-slate-400">
                                <span className="font-medium text-slate-700 dark:text-slate-300">REGON:</span> 387073039
                            </p>
                        </div>
                        <div className="space-y-1">
                            <p className="text-slate-600 dark:text-slate-400">
