    ...
    <div className="space-y-6">
      ...
      {stats && (
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
          ...
          <Card className="bg-gray-800 border-gray-700">
            <CardContent className="pt-4">
              <div className="text-lg font-bold text-indigo-400">{formatCurrency(stats.totalProration || 0)}</div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="mt-2 text-sm text-gray-400">
                      <span className="text-gray-500">{change.from_plan_name || change.from_plan_id || 'No plan'}</span>
                    ...
                    <div className="mt-2 flex flex-wrap gap-4 text-xs text-gray-500">
                      ...
                      {change.proration_amount !== 0 && (
                        <span className={change.proration_amount > 0 ? 'text-green-400' : 'text-red-400'}>
