        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl p-5 text-white shadow-lg">
                    ...
                    <p className="text-3xl font-bold mt-3">{formatNumber(usageStats?.totalTokensThisMonth || 0)}</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-navy-900 rounded-xl p-6 border border-white/10">
                    ...
                    <div className="space-y-4">
                        ...
                        {(!revenueStats?.planDistribution || revenueStats.planDistribution.length === 0) && (
                            <p className="text-slate-500 text-center py-8">No subscriptions yet</p>
                        )}
                    </div>
                </div>
                ...
                <div className="bg-navy-900 rounded-xl p-6 border border-white/10">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="bg-navy-950 rounded-lg p-4">
                            <p className="text-xs text-slate-500">Active Orgs</p>
                            <p className="text-2xl font-bold text-white mt-1">{usageStats?.activeOrganizations || 0}</p>
                            <p className="text-[10px] text-slate-600 mt-1">With usage</p>
                        </div>
                        ...
                        <tbody className="divide-y divide-white/5">
                            {revenueStats?.planDistribution.map(plan => (
                                <tr key={plan.name} className="text-white">
                                    ...
                                    <td className="py-3 text-slate-400">{plan.count}</td>
            ...
            <div className="bg-navy-900 rounded-xl p-6 border border-white/10">
                ...
                <p className="text-xs text-slate-500 mb-4">Estimated costs based on current provider pricing.</p>
                        ...
                        <tbody className="divide-y divide-white/5">
                            {operationalCosts?.items.map((item: any, idx: number) => (
                                <tr key={idx} className="text-white">
                                    ...
                                    <td className="py-3 text-slate-500 font-mono text-xs">{item.model}</td>
                                    <td className="py-3 text-right text-slate-400">{formatNumber(item.totalTokens)}</td>
...
const PlanForm: React.FC<{
    ...
    <div className="space-y-4">
        ...
        <div>
            <label className="text-xs font-medium text-slate-400 mb-1 block">Price ($/month)</label>
            <input
                type="number"
        ...
        {type === 'organization' && (
            <>
                <div className="grid grid-cols-2 gap-3">
                    <div>
                        <label className="text-xs font-medium text-slate-400 mb-1 block">Tokens</label>
                        <input
                            type="number"
                    ...
                    <div>
                        <label className="text-xs font-medium text-slate-400 mb-1 block">Storage (GB)</label>
                        <input
                            type="number"
                ...
                <div>
                    <label className="text-xs font-medium text-slate-400 mb-1 block">Stripe Price ID</label>
                    <input
                        type="text"
        ...
        <div className="flex gap-2 pt-2">
            ...
            <button
                onClick={onCancel}
                className="px-4 py-2 text-slate-400 hover:text-white hover:bg-white/5 rounded-lg text-sm"
            >
                <X className="w-4 h-4" />
            </button>
        </div>
...
const PlanCard: React.FC<{
    ...
    <>
        ...
        <div className="mt-4 flex gap-2">
            <button
                onClick={onEdit}
                className="flex-1 flex items-center justify-center gap-1 px-3 py-2 text-sm bg-white/5 text-slate-300 rounded-lg hover:bg-white/10 transition-colors"
            >
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="bg-navy-900 border border-white/5 rounded-xl p-5">
                    <div className="flex justify-between items-start mb-3">
                        <span className="text-slate-400 text-xs font-medium uppercase">Active AI Models</span>
                ...
                <div className="bg-navy-900 border border-white/5 rounded-xl p-5">
                    <div className="flex justify-between items-start mb-3">
                        <span className="text-slate-400 text-xs font-medium uppercase">Active Packages</span>
                ...
                <div className="bg-navy-900 border border-white/5 rounded-xl p-5">
                    <div className="flex justify-between items-start mb-3">
                        <span className="text-slate-400 text-xs font-medium uppercase">Platform Margin</span>
                ...
                <div className="bg-navy-900 border border-white/5 rounded-xl p-5">
                    <div className="flex justify-between items-start mb-3">
                        <span className="text-slate-400 text-xs font-medium uppercase">System Balance</span>
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-navy-900 rounded-xl border border-white/10 overflow-hidden">
                <table className="w-full">
                    <thead>
                        <tr className="bg-navy-950 text-xs text-slate-400 uppercase tracking-wider">
