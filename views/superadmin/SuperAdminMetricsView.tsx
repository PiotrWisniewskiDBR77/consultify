...
import { RefreshCw, TrendingUp, AlertTriangle, Users, BookOpen, Target, Loader2 } from 'lucide-react';
                            ...
                            warnings.map((warning, idx) => (
                                <div key={idx} className="flex items-start gap-3 p-3 border border-white/[0.04] rounded-lg hover:bg-white/[0.02] transition-colors">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-xs text-slate-500 mt-1">{warning.message}</p>
                                    </div>
                                </div>
                            ))
                        )}
                        ...
                        <table className="w-full text-left">
                            <thead>
                                <tr className="border-b border-white/[0.06]">
                                    <th className="pb-3 text-xs font-medium text-slate-500 uppercase tracking-wider">Channel</th>
                                    <th className="pb-3 text-xs font-medium text-slate-500 uppercase tracking-wider text-center">Trials</th>
                                    <th className="pb-3 text-xs font-medium text-slate-500 uppercase tracking-wider text-center">Paid</th>
                                    <th className="pb-3 text-xs font-medium text-slate-500 uppercase tracking-wider text-right">Conv. %</th>
                                </tr>
                            </thead>
                            <tbody>
