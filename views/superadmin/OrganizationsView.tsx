...
export const OrganizationsView: React.FC = () => {
    ...
    const handleDeleteOrg = async (id: string, name: string) => {
        if (!confirm(`Are you sure you want to delete "${name}" and all its users? This cannot be undone.`)) return;
        try {
        ...
        <div className="p-8 overflow-y-auto h-full relative">
            ...
            <div className="flex gap-2 mb-6">
                ...
                >
                    <Building2 size={16} />
                    All Organizations
                    <span className="ml-1 bg-white/20 px-1.5 py-0.5 rounded text-xs">{organizations.length}</span>
                </button>
                <button
                                                    ...
                                                    {isEditing ? (
                                                        ...
                                                        <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                                            ...
                                                            <button
                                                                ...
                                                                className="p-1.5 hover:bg-yellow-500/20 text-slate-400 hover:text-yellow-400 rounded transition-colors"
                                                                title="Quick Edit"
                                                            >
                                                                <Edit2 size={16} />
                                                            </button>
