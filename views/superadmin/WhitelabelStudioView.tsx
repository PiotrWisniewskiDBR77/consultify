        ...
        <div>
            ...
            <div className="flex items-center gap-2">
                ...
                <input
                    ...
                    value={value}
                    onChange={(e) => onChange(e.target.value)}
                    className="flex-1 px-3 py-2 bg-slate-50 dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-lg text-slate-900 dark:text-white font-mono text-sm"
                />
            </div>
        </div>
    );
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-xs text-slate-500 mt-1">
                        {type === 'favicon' ? '32x32 ICO/PNG' : type === 'icon' ? '64x64 PNG' : 'SVG or PNG, max 200KB'}
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2.5 bg-white dark:bg-navy-800 border border-slate-200 dark:border-white/10 rounded-lg text-slate-900 dark:text-white"
                            />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-end gap-2">
                <button
                    ...
                    className={`p-2 rounded-lg ${previewMode === 'light' ? 'bg-violet-100 dark:bg-violet-500/20 text-violet-600' : 'text-slate-400 hover:bg-slate-100 dark:hover:bg-white/10'}`}
                >
                    <Sun size={18} />
                </button>
                <button
                    onClick={() => setPreviewMode('dark')}
                    className={`p-2 rounded-lg ${previewMode === 'dark' ? 'bg-violet-100 dark:bg-violet-500/20 text-violet-600' : 'text-slate-400 hover:bg-slate-100 dark:hover:bg-white/10'}`}
                >
                    <Moon size={18} />
                </button>
            </div>
        ...
        <div className="space-y-6">
            <div className="grid grid-cols-2 gap-6">
                <div className="space-y-4">
                    ...
                    <LogoUploader label="Background Image" type="light" currentUrl={branding.loginBackgroundUrl} />
                </div>
                            ...
                            <div className="space-y-2 text-sm">
                                ...
                                <div className="bg-white dark:bg-navy-800 rounded p-3 font-mono text-xs">
                                    <div className="flex justify-between items-center mb-2">
                                        <span className="text-slate-500">CNAME Record:</span>
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {organizations.map((org) => (
                            <div
                                key={org.id}
                                className="p-6 bg-white dark:bg-navy-800 rounded-xl border border-slate-200 dark:border-white/10 hover:border-violet-300 dark:hover:border-violet-500/30 transition-all group"
                            >
