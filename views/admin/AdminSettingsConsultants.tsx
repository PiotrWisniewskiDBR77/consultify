...
export const AdminSettingsConsultants: React.FC = () => {
    ...
    const [selectedProjectAccess, setSelectedProjectAccess] = useState<ConsultantProject | null>(null);
        ...
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-slate-100 hover:bg-slate-200 dark:bg-white/5 dark:hover:bg-white/10 text-navy-900 dark:text-white rounded-lg font-medium transition-colors border border-slate-200 dark:border-white/10"
                >
                    <UserPlus size={18} />
                    Invite Consultant
                </button>
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex items-center justify-end gap-2">
                                                <button
                                                    ...
                                                    className="text-slate-500 hover:text-navy-900 dark:hover:text-white transition-colors p-2 hover:bg-slate-100 dark:hover:bg-white/5 rounded-lg"
                                                        ...
                                                        >
                                                            ...
                                                            <div className="flex items-center gap-2">
                                                                ...
                                                                <button
                                                                    ...
                                                                    className="text-slate-500 hover:text-navy-900 dark:hover:text-white transition-colors p-1.5 hover:bg-slate-200 dark:hover:bg-white/5 rounded"
                    ...
                    <div className="bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col">
                        <div className="p-6 border-b border-slate-200 dark:border-white/10 flex justify-between items-center flex-shrink-0">
                            ...
                            <button
                                ...
                                className="text-slate-500 hover:text-navy-900 dark:hover:text-white transition-colors"
                            >
                                <X size={20} />
                            </button>
                        </div>
                        ...
                        <form onSubmit={handleInvite} className="flex-1 overflow-y-auto">
                            ...
                            <div className="p-6 border-t border-white/10 flex gap-3 flex-shrink-0">
                                <button
                                    type="button"
                                    onClick={() => setShowInviteModal(false)}
                                    className="flex-1 px-4 py-2 bg-white/5 text-slate-300 rounded-lg hover:bg-white/10 transition-colors font-medium"
                                >
                                    Cancel
                                </button>
                                <button
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
                    <div className="bg-navy-900 border border-white/10 rounded-xl shadow-2xl w-full max-w-md">
                                ...
                                <div className="space-y-2 max-h-64 overflow-y-auto">
                                    {getUnassignedProjects(selectedConsultant).map((project) => (
                                        <button
                                            ...
                                            className="w-full flex items-center gap-3 p-3 bg-white/[0.02] hover:bg-white/5 border border-white/10 rounded-lg transition-colors text-left"
                                        >
                                            <Briefcase className="w-4 h-4 text-slate-500" />
                                            <div>
                        ...
                        <div className="p-6 border-t border-white/10">
                            <button
                                onClick={() => setShowAddProjectModal(false)}
                                className="w-full px-4 py-2 bg-white/5 text-slate-300 rounded-lg hover:bg-white/10 transition-colors font-medium"
                            >
                                Close
                            </button>
                        </div>
            ...
            <div className="bg-navy-900 border border-white/10 rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col">
                ...
                <div className="p-6 flex-1 overflow-y-auto">
                    ...
                    <div className="flex items-center gap-2 mb-4">
                        <span className="text-sm text-slate-500 mr-2">Quick:</span>
                        <button
