...
export const CostAllocationView: React.FC<CostAllocationViewProps> = ({ className = '' }) => {
    ...
    const totalBudget = useMemo(() => costCenters.reduce((sum, cc) => sum + cc.budget_monthly, 0), [costCenters]);

    const totalSpend = useMemo(() => costCenters.reduce((sum, cc) => sum + cc.current_spend, 0), [costCenters]);
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="border-b border-white/[0.05]">
                                ...
                                <th className="text-left text-xs font-medium text-slate-500 uppercase tracking-wider py-3 px-4 w-40">
                                    Usage
                                </th>
                                <th className="text-right text-xs font-medium text-slate-500 uppercase tracking-wider py-3 px-4">
                                    Actions
