...
import {
  FileText, Bell, Mail, Download, Building2, Globe, Shield,
  RefreshCw, Check, X, Plus, Trash2, Save, AlertCircle, BarChart3
} from 'lucide-react';
...
export const BillingSettingsView: React.FC<BillingSettingsViewProps> = ({ className = '' }) => {
  ...
  const [activeTab, setActiveTab] = useState<'tax' | 'notifications' | 'export'>('tax');
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setTaxSettings({ ...taxSettings, billing_name: e.target.value })}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setTaxSettings({ ...taxSettings, billing_email: e.target.value })}
                  className="admin-input w-full"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setTaxSettings({ ...taxSettings, tax_id_type: e.target.value })}
                  className="admin-input w-full"
                >
              ...
              <div className="flex items-end">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    onChange={(e) => setTaxSettings({ ...taxSettings, tax_exempt: e.target.checked })}
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setTaxSettings({ ...taxSettings, billing_address_line1: e.target.value })}
                  className="admin-input w-full"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setTaxSettings({ ...taxSettings, billing_address_line2: e.target.value })}
                  className="admin-input w-full"
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div>
                  <label className="block text-xs text-slate-500 uppercase tracking-wider mb-1.5">City</label>
                  <input
                    type="text"
                    value={taxSettings.billing_city || ''}
                    onChange={(e) => setTaxSettings({ ...taxSettings, billing_city: e.target.value })}
                    className="admin-input w-full"
                  />
                </div>
                <div>
                  <label className="block text-xs text-slate-500 uppercase tracking-wider mb-1.5">State/Region</label>
                  <input
                    type="text"
                    value={taxSettings.billing_state || ''}
                    onChange={(e) => setTaxSettings({ ...taxSettings, billing_state: e.target.value })}
                    className="admin-input w-full"
                  />
                </div>
                <div>
                  <label className="block text-xs text-slate-500 uppercase tracking-wider mb-1.5">Postal Code</label>
                  <input
                    type="text"
                    value={taxSettings.billing_postal_code || ''}
                    onChange={(e) => setTaxSettings({ ...taxSettings, billing_postal_code: e.target.value })}
                    className="admin-input w-full"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setTaxSettings({ ...taxSettings, billing_country: e.target.value })}
                    className="admin-input w-full"
                  />
                </div>
              </div>
          ...
          <div className="admin-card p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                />
                <p className="text-xs text-slate-500 mt-1">Prefix added to invoice numbers</p>
              </div>
              <div>
                <label className="block text-xs text-slate-500 uppercase tracking-wider mb-1.5">
                  PO Number
                ...
                />
                <p className="text-xs text-slate-500 mt-1">Included on all invoices</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {activeTab === 'notifications' && (
        <div className="space-y-6">
          ...
          <div className="admin-card p-6">
            ...
            <div className="space-y-4">
              {[
                { key: 'invoice_email', label: 'Invoice Available', desc: 'Get notified when a new invoice is ready' },
                { key: 'payment_success', label: 'Payment Successful', desc: 'Confirmation when payments are processed' },
                { key: 'payment_failed', label: 'Payment Failed', desc: 'Alert when a payment attempt fails' },
                { key: 'usage_warning', label: 'Usage Warnings', desc: 'Alerts when approaching usage limits' },
                { key: 'renewal_reminder', label: 'Renewal Reminders', desc: 'Reminder before subscription renews' }
              ].map((item) => (
            ...
            <div className="space-y-2">
              {contacts.length === 0 ? (
                <p className="text-sm text-slate-500 py-4 text-center">
                  No billing contacts configured. Notifications will be sent to the organization owner.
                </p>
              ) : (
                contacts.map((contact) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-xs text-slate-500 capitalize">{contact.role}</span>
                      <button
        ...
        <div className="space-y-6">
          <div className="admin-card p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-slate-500 mt-1">
                      Download all invoices for the selected year including amounts, dates, and status.
                    </p>
                    <button
              ...
              <div className="p-4 bg-white/[0.02] rounded-lg border border-white/[0.05]">
                <div className="flex items-start gap-3">
                  <BarChart3 size={20} className="text-slate-500 mt-0.5" />
                  <div className="flex-1">
                    <h4 className="text-sm font-medium text-white">Usage History</h4>
                    <p className="text-xs text-slate-500 mt-1">
                      Download daily usage data including tokens consumed, costs, and request counts.
                    </p>
                    <button
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-300/70 mt-1">
                    Billing data is retained for 7 years. Older data may not be available for export.
                  </p>
                </div>
              </div>
            </div>
