...
export const InvoicesView: React.FC<InvoicesViewProps> = ({ className = '' }) => {
    ...
    const getStatusBadge = (status: Invoice['status']) => {
        ...
        return (
            <span className={`flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium ${styles[status]}`}>
                {icons[status]}
        ...
        <div className={`space-y-6 ${className}`}>
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                    <p className="text-sm text-slate-500">Total Paid (All Time)</p>
            ...
            {filteredInvoices.length === 0 ? (
                <div className="p-12 text-center bg-white dark:bg-navy-800 rounded-xl border border-slate-200 dark:border-navy-700">
                    ...
                    <p className="text-slate-500 mt-1">No invoices match your filters</p>
                </div>
            ) : (
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <div className="flex items-center justify-end gap-2">
                                            <button
                                                ...
                                                className="p-2 hover:bg-slate-100 dark:hover:bg-navy-600 rounded-lg text-slate-500 hover:text-slate-700"
                                                title="View details"
                                            >
                                                <Eye size={16} />
                                            </button>
                                            <button
                                                ...
                                                className="p-2 hover:bg-slate-100 dark:hover:bg-navy-600 rounded-lg text-slate-500 hover:text-violet-600"
                                                title="Download PDF"
                                            >
                        ...
                        >
                            <div className="p-6 border-b border-slate-200 dark:border-navy-700 flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500">{formatDate(selectedInvoice.date)}</p>
                                </div>
