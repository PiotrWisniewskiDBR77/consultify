import { Calendar, Check, Copy, Key, Plus, Shield, Trash2, Users, X } from 'lucide-react';
        ...
        {codes.length === 0 ? (
          ...
          codes.map((code) => {
            ...
            return (
              <div
                key={code.id}
                className={`bg-white dark:bg-navy-900 border rounded-lg p-5 transition-all ${
                  isValid
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-4 gap-4 text-sm">
                      <div>
                        ...
                        <div className="font-medium text-navy-900 dark:text-white">{code.role}</div>
                      </div>
                      <div>
                        <div className="flex items-center gap-1 text-slate-500 dark:text-slate-400 mb-1">
                          <Users size={14} />
