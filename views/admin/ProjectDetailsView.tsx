...
export const ProjectDetailsView: React.FC<ProjectDetailsViewProps> = ({ projectId, onBack }) => {
    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center h-[60vh] space-y-4">
                ...
                <p className="text-slate-400 animate-pulse">Synchronizing project intelligence...</p>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 pb-20">
            ...
            <div className="flex flex-wrap justify-between items-start gap-4 bg-gradient-to-r from-primary-600 to-secondary-700 dark:bg-navy-900/40 dark:from-transparent dark:to-transparent backdrop-blur-md p-8 rounded-3xl border border-primary-500/20 dark:border-white/10 shadow-2xl relative overflow-hidden group">
                ...
                <div className="flex gap-6 items-start z-10">
                    <div className="p-5 rounded-2xl bg-white/20 dark:bg-gradient-to-br dark:from-purple-600 dark:to-indigo-600 text-white shadow-xl shadow-purple-900/20">
                        <Layers size={32} />
                    </div>
                    <div>
                ...
                <div className="flex items-center gap-3 mt-4 sm:mt-0 z-10">
                    ...
                    <button
                        onClick={onBack}
                        className="flex items-center gap-2 px-4 py-2 bg-navy-950 border border-white/5 text-slate-400 hover:text-white rounded-xl transition-all text-sm font-semibold"
                    >
            ...
            <div className="flex gap-2 p-1 bg-white dark:bg-navy-900/50 backdrop-blur-sm border border-slate-200 dark:border-white/5 rounded-2xl w-fit shadow-sm dark:shadow-none">
                {[
            ...
            <div className="mt-8 min-h-[500px]">
                ...
                {activeTab === 'overview' && (
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-in slide-in-from-bottom-2 duration-300">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-2xl p-6 shadow-sm dark:shadow-none">
                                ...
                                <div className="flex items-center gap-4 bg-slate-50 dark:bg-navy-950 p-4 rounded-xl border border-slate-200 dark:border-white/5">
                ...
                {activeTab === 'initiatives' && (
                    <div className="space-y-4 animate-in slide-in-from-bottom-2 duration-300">
                        <div className="flex justify-between items-center mb-6">
                            <h3 className="text-xl font-bold text-white">Project Initiatives</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {project.initiatives?.length === 0 ? (
                                <div className="col-span-full py-12 text-center bg-navy-900/50 border border-dashed border-white/10 rounded-2xl text-slate-500">
                ...
                {activeTab === 'documents' && (
                    <div className="space-y-6 animate-in slide-in-from-bottom-2 duration-300">
                        {/* Upload Panel */}
                        <div className="bg-navy-900 border border-white/10 p-8 rounded-3xl shadow-xl">
                            ...
                            <form onSubmit={handleUploadDocument} className="flex gap-4 items-center">
                                <div className="flex-1 relative">
                                    ...
                                    />
                                    <div className="bg-navy-950 border-2 border-dashed border-white/10 rounded-2xl p-4 text-center transition-all hover:bg-white/5 hover:border-blue-500 group">
                                        {uploadFile ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {project.documents?.length === 0 ? (
                                <div className="col-span-full py-12 text-center text-slate-500 bg-navy-900/30 border border-dashed border-white/10 rounded-3xl">
