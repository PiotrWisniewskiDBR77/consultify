        ...
        <div className={`space-y-6 ${className}`}>
            ...
            {paymentMethods.length === 0 ? (
                <div className="p-12 text-center bg-white dark:bg-navy-800 rounded-xl border border-slate-200 dark:border-navy-700">
                    ...
                    <p className="text-slate-500 mt-1 mb-4">Add a payment method to enable billing</p>
                    <button
                        onClick={() => setShowAddModal(true)}
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <button
                                        ...
                                        className="p-2 hover:bg-red-100 dark:hover:bg-red-900/30 rounded-lg text-slate-500 hover:text-red-600 disabled:opacity-50 disabled:cursor-not-allowed"
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="p-6 space-y-4">
                                ...
                                <div className="p-3 bg-slate-50 dark:bg-navy-900 rounded-lg flex items-center gap-2 text-xs text-slate-500">
                                    <Shield size={14} />
