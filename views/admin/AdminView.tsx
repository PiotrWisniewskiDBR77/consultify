...
import { OrgAISettingsView } from './OrgAISettingsView';
...
// New organization management components
...
// New fully implemented views (replacing placeholders)
...
const getAdminSection = (view: AppView): AdminSection => {
    ...
    // Team module
    if (view === AppView.ADMIN_USERS || view === AppView.ADMIN_INVITATIONS || view === AppView.ADMIN_WORK_MODE || view === AppView.ADMIN_SETTINGS_CONSULTANTS) {
        return 'team';
    }
    // Workspace module
    ...
    // AI module
    if (view === AppView.ADMIN_LLM || view === AppView.ADMIN_AI_HEALTH || view === AppView.HELP_ANALYTICS || view === AppView.ADMIN_TOKEN_MANAGEMENT) {
        return 'ai';
    }
    return 'overview';
};
        ...
        switch (activeSection) {
            ...
            case 'security':
                return {
                    ...
                    subtitle: t('admin.security.subtitle', 'Authentication, access control, audit logs, and data management')
                };
            case 'feedback':
                return {
                ...
                return (
                    <Tabs defaultValue="dashboard" className="w-full">
                        <TabsList className="admin-tabs bg-transparent p-0 h-auto">
                            <TabsTrigger value="dashboard" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <LayoutDashboard size={14} />
                                {t('admin.overview.tabs.dashboard', 'Dashboard')}
                            </TabsTrigger>
                            <TabsTrigger value="metrics" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <TrendingUp size={14} />
                                {t('admin.overview.tabs.metrics', 'Metrics')}
                            </TabsTrigger>
                            <TabsTrigger value="analytics" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <BarChart3 size={14} />
            ...
            case 'organization':
                return (
                    <Tabs defaultValue="profile" className="w-full">
                        <TabsList className="admin-tabs bg-transparent p-0 h-auto">
                            <TabsTrigger value="profile" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <Building2 size={14} />
                                {t('admin.organization.tabs.profile', 'Profile & Branding')}
                            </TabsTrigger>
                            <TabsTrigger value="ownership" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <Crown size={14} />
                ...
                return (
                    <Tabs defaultValue="users" className="w-full">
                        <TabsList className="admin-tabs bg-transparent p-0 h-auto flex-wrap">
                            <TabsTrigger value="users" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <Users size={14} />
                            ...
                            <TabsTrigger value="roles" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <Key size={14} />
                                {t('admin.team.tabs.roles', 'Roles')}
                            </TabsTrigger>
                            <TabsTrigger value="consultants" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <Briefcase size={14} />
            ...
            case 'workspace':
                ...
                return (
                    <Tabs defaultValue="projects" className="w-full">
                        <TabsList className="admin-tabs bg-transparent p-0 h-auto">
                            <TabsTrigger value="projects" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <Briefcase size={14} />
                                {t('admin.workspace.tabs.projects', 'Projects')}
                            </TabsTrigger>
                            <TabsTrigger value="knowledge" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <BookOpen size={14} />
                                {t('admin.workspace.tabs.knowledge', 'Knowledge')}
                            </TabsTrigger>
                            <TabsTrigger value="playbooks" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <PlayCircle size={14} />
                                {t('admin.workspace.tabs.playbooks', 'Playbooks')}
                            </TabsTrigger>
                            <TabsTrigger value="bulk-ops" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <Layers size={14} />
            ...
            case 'ai':
                return (
                    <Tabs defaultValue="models" className="w-full">
                        <TabsList className="admin-tabs bg-transparent p-0 h-auto flex-wrap">
                            <TabsTrigger value="models" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <Brain size={14} />
                                {t('admin.ai.tabs.models', 'Models & Providers')}
                            </TabsTrigger>
                            <TabsTrigger value="health" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <Activity size={14} />
                                {t('admin.ai.tabs.health', 'Health & Monitoring')}
                            </TabsTrigger>
                            <TabsTrigger value="policy" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <Shield size={14} />
                                {t('admin.ai.tabs.policy', 'Policy & Governance')}
                            </TabsTrigger>
                            <TabsTrigger value="access" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <Users size={14} />
                                {t('admin.ai.tabs.access', 'Access & Limits')}
                            </TabsTrigger>
                            <TabsTrigger value="features" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <Settings size={14} />
                                {t('admin.ai.tabs.features', 'Features & Privacy')}
                            </TabsTrigger>
                            <TabsTrigger value="audit" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <History size={14} />
                ...
                return (
                    <Tabs defaultValue="usage" className="w-full">
                        <TabsList className="admin-tabs bg-transparent p-0 h-auto flex-wrap">
                            ...
                            <TabsTrigger value="invoices" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <FileText size={14} />
                                {t('admin.billing.tabs.invoices', 'Invoices')}
                            </TabsTrigger>
                            <TabsTrigger value="alerts" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <Bell size={14} />
            ...
            case 'security':
                return (
                    <Tabs defaultValue="security-settings" className="w-full">
                        <TabsList className="admin-tabs bg-transparent p-0 h-auto flex-wrap">
                            <TabsTrigger value="security-settings" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <Shield size={14} />
                                {t('admin.security.tabs.settings', 'Security Settings')}
                            </TabsTrigger>
                            <TabsTrigger value="authentication" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <Lock size={14} />
                            ...
                            <TabsTrigger value="data" className="admin-tab data-[state=active]:admin-tab-active flex items-center gap-2 rounded-none bg-transparent shadow-none">
                                <Download size={14} />
