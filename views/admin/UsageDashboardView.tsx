        ...
        <div className={`space-y-6 ${className}`}>
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button onClick={handleExport} className="admin-btn admin-btn-subtle flex items-center gap-2">
                        <Download size={14} />
                        Export
                    </button>
                    <button onClick={loadUsageSummary} disabled={refreshing} className="admin-btn admin-btn-subtle">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="admin-card p-4">
                    ...
                    <div className="mb-2">
                        ...
                        <span className="text-slate-500 text-sm ml-1">/ {formatNumber(usage?.tokens.limit || 0)}</span>
                    </div>
                ...
                <div className="admin-card p-4">
                    ...
                    <div className="mb-2">
                        ...
                        <span className="text-slate-500 text-sm ml-1">/ {usage?.storage.limitFormatted || '5 GB'}</span>
                    </div>
                    <div className="w-full bg-white/[0.05] rounded-full h-1.5 mb-2">
                        <div
                ...
                <div className="admin-card p-4">
                    ...
                    <div className="mb-2">
                        ...
                        <span className="text-slate-500 text-sm ml-1">/ {usage?.seats.limit || 0}</span>
                    </div>
                    <div className="w-full bg-white/[0.05] rounded-full h-1.5 mb-2">
                        <div
                ...
                <div className="admin-card p-4">
                    ...
                    <p className="text-xs text-slate-500 mt-1">Base plan: ${usage?.cost.planBase || 0}/mo</p>
                </div>
            </div>
                    ...
                    <div className="h-64">
                        <ResponsiveContainer width="100%" height="100%">
                            <AreaChart data={usage?.trend || []}>
                                ...
                                />
                                <YAxis stroke="#64748b" fontSize={11} tickFormatter={(value) => formatNumber(value)} />
                                <Tooltip
                                    contentStyle={{
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="border-b border-white/[0.05]">
                                ...
                                <th className="text-left text-xs font-medium text-slate-500 uppercase tracking-wider py-3 px-4 w-32">
                                    Usage
                                </th>
                            </tr>
                        </thead>
