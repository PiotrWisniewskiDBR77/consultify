import { AlertCircle, ArrowRight, Briefcase, CheckCircle, Loader2, Play, Target, Users, Zap } from 'lucide-react';
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                {plan.steps?.map((step: any, idx: number) => (
                                    <div
                                        key={idx}
                                        className="bg-white dark:bg-navy-800 p-5 rounded-xl border border-slate-200 dark:border-white/10 relative overflow-hidden group hover:border-blue-500/30 transition-colors"
                                    >
