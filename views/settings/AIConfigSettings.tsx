import { Check, Cpu, Lock, Monitor } from 'lucide-react';
...
export const AIConfigSettings: React.FC<AIConfigSettingsProps> = ({
  ...
  const [localEndpoint, setLocalEndpoint] = useState(
    currentUser.aiConfig?.endpoint || 'http://localhost:11434'
  );
              ...
              <div className="mt-8 pt-8 border-t border-white/5 text-left bg-navy-950/50 rounded-lg p-6">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">
                      Select which model powers your organization.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  <select
                    ...
                    onChange={(e) =>
                      setOrgConfig({ ...orgConfig, activeProviderId: e.target.value || null })
                    }
