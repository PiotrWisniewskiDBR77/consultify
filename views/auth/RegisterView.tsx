    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-slate-50 dark:bg-navy-950 text-navy-900 dark:text-white">
            <form
                ...
                className="p-8 bg-white dark:bg-navy-900 border border-slate-200 dark:border-white/10 rounded-xl w-full max-w-md shadow-xl dark:shadow-none"
            >
                ...
                <button
                    type="submit"
                    className="w-full py-3 bg-blue-600 hover:bg-blue-500 text-white rounded font-bold transition-colors shadow-lg shadow-blue-500/30"
                >
                    Register
                </button>
            </form>
