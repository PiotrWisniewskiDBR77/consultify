        ...
        <div className="space-y-8 pb-12">
            ...
            <div className="flex justify-between items-start">
                ...
                <div className="flex gap-3">
                    ...
                    <button className="flex items-center gap-2 px-4 py-2 border border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-300 rounded-lg hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
                        <Printer size={16} />
                        Print
                    </button>
                    <button className="flex items-center gap-2 px-4 py-2 border border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-300 rounded-lg hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
            ...
            <div className="bg-white dark:bg-navy-800 rounded-xl shadow-lg border border-slate-100 dark:border-white/5 overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* Risks Summary */}
                <div className="bg-white dark:bg-navy-800 rounded-xl shadow-md border border-slate-100 dark:border-white/5 p-6">
                    ...
                    <div className="text-3xl font-bold text-navy-900 dark:text-white mb-2">
                        {risks.length} <span className="text-lg font-normal text-slate-400">identified</span>
                    </div>
                ...
                <div className="bg-white dark:bg-navy-800 rounded-xl shadow-md border border-slate-100 dark:border-white/5 p-6">
                    ...
                    <div className="text-3xl font-bold text-navy-900 dark:text-white mb-2">
                        {strengths.length} <span className="text-lg font-normal text-slate-400">identified</span>
                    </div>
                    <div className="text-sm text-slate-500 dark:text-slate-400">
            ...
            {!selectedScenario && (
                <div className="bg-slate-50 dark:bg-navy-900/50 rounded-xl border-2 border-dashed border-slate-200 dark:border-white/10 p-8 text-center">
                    <GitMerge className="w-12 h-12 text-slate-300 mx-auto mb-4" />
                    <h4 className="text-lg font-medium text-navy-900 dark:text-white mb-2">No Scenario Selected</h4>
