...
export const ChallengeMapModule: React.FC = () => {
    ...
    // Handlers
    const createHandler = (listName: 'declaredChallenges' | 'evidence', currentItems: DynamicListItem[]) => ({
                ...
                {activeTab === 'rootcause' && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="col-span-1 md:col-span-2 bg-blue-50 dark:bg-blue-900/10 p-4 rounded-lg border border-blue-100 dark:border-blue-900/20 text-sm text-blue-800 dark:text-blue-200">
                            <strong>Diagnostic Questions:</strong> These answers help AI identify hidden root causes
                            behind the declared challenges.
                        </div>
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                            <input
                                                                ...
                                                                value={blocker.title}
                                                                onChange={(e) =>
                                                                    updateBlocker(blocker.id, 'title', e.target.value)
                                                                }
                                                            ...
                                                            <select
                                                                value={blocker.type}
                                                                onChange={(e) =>
                                                                    updateBlocker(blocker.id, 'type', e.target.value)
                                                                }
                                                ...
                                                <div className="md:col-span-8">
                                                    <div className="relative">
                                                        <AITextArea
                                                            value={blocker.desc}
                                                            onChange={(e) =>
                                                                updateBlocker(blocker.id, 'desc', e.target.value)
                                                            }
